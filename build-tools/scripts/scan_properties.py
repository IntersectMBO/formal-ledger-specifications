...
#
# Usage:
#   python3 build-tools/scripts/scan_properties.py          # regenerate dashboard
#   python3 build-tools/scripts/scan_properties.py --check  # CI: fail on drift/staleness
#
...
def render_region(cat: dict, results: dict) -> str:
    ...
    lines.append(BEGIN)
    lines.append("")
    lines.append("_Generated by `build-tools/scripts/scan_properties.py` from the catalog "
