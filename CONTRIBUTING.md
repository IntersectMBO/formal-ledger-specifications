...
- [Available Packages and Derivations](#available-packages-and-derivations)
  - [Core Packages](#core-packages)
    - [`agdaWithPackages`](#agdawithpackages)
    - [`formalLedger`](#formalledger)
    - [`fls-shake`](#fls-shake)
  - [Generated Outputs](#generated-outputs)
    - [`html`](#html)
    - [`hsSrc`](#hssrc)
    - [`docs.conway.fullspec`](#docsconwayfullspec)
    - [`docs.conway.diffspec`](#docsconwaydiffspec)
  - [Development Environments](#development-environments)
    - [`devShells.ci`: a minimal environment for CI/CD builds](#devshellsci-a-minimal-environment-for-cicd-builds)
    - [`devShells.mkDocs`: dev environment focused on Agda development and documentation.](#devshellsmkdocs-dev-environment-focused-on-agda-development-and-documentation)
- [Usage Instructions](#usage-instructions)
  ...
  - [Development Workflow](#development-workflow)
    - [Agda Development with Documentation Tools](#agda-development-with-documentation-tools)
    - [Build System and Output Generation](#build-system-and-output-generation)
    - [Alternative: Build Outputs with Nix](#alternative-build-outputs-with-nix)
...
- [Integration with IDEs](#integration-with-ides)
  - [Emacs](#emacs)
    ...
    - [Advanced Setup (Multiple Agda Versions)](#advanced-setup-multiple-agda-versions)
    - [Troubleshooting Emacs Setup](#troubleshooting-emacs-setup)
  - [VS Code](#vs-code)
    - [Installation and Configuration](#installation-and-configuration)
    - [VS Code Usage](#vs-code-usage)
    - [Troubleshooting VS Code Setup](#troubleshooting-vs-code-setup)
