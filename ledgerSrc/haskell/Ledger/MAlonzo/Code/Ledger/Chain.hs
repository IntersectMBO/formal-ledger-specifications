...
d_NewEpochState_1982 a0 a1 = ()
-- Ledger.Chain.ChainState
d_ChainState_2078 a0 a1 = ()
newtype T_ChainState_2078
  = C_ChainState'46'constructor_3243 MAlonzo.Code.Ledger.Epoch.T_NewEpochState_2144
-- Ledger.Chain.ChainState.newEpochState
d_newEpochState_2082 ::
  T_ChainState_2078 -> MAlonzo.Code.Ledger.Epoch.T_NewEpochState_2144
d_newEpochState_2082 v0
  = case coe v0 of
...
d_ts_2090 ::
  T_Block_2084 -> [MAlonzo.Code.Ledger.Transaction.T_Tx_2710]
d_ts_2090 v0
  = case coe v0 of
      C_Block'46'constructor_3301 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Chain.Block.slot
d_slot_2092 :: T_Block_2084 -> AgdaAny
d_slot_2092 v0
  = case coe v0 of
...
d_maybePurpose_2104 v0 ~v1 v2 v3 v4
  = du_maybePurpose_2104 v0 v2 v3 v4
du_maybePurpose_2104 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Certs.T_DepositPurpose_768 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Integer -> Maybe Integer
du_maybePurpose_2104 v0 v1 v2 v3
  = case coe v2 of
...
d_maybePurpose'45'prop_2136 = erased
-- Ledger.Chain.filterPurpose
d_filterPurpose_2178 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1586 ->
  MAlonzo.Code.Ledger.Certs.T_DepositPurpose_768 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_filterPurpose_2178 v0 ~v1 v2 v3 = du_filterPurpose_2178 v0 v2 v3
du_filterPurpose_2178 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Certs.T_DepositPurpose_768 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_filterPurpose_2178 v0 v1 v2
  = coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.Axiom.Set.d_th_1430
            (coe MAlonzo.Code.Ledger.Set.Theory.d_List'45'Model'7496'_10))
         (coe du_maybePurpose_2104 (coe v0) (coe v1)) (coe v2))
-- Ledger.Chain.govActionDeposits
d_govActionDeposits_2192 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1586 ->
  MAlonzo.Code.Ledger.Ledger.T_LState_1972 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_govActionDeposits_2192 v0 ~v1 v2
  = du_govActionDeposits_2192 v0 v2
du_govActionDeposits_2192 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Ledger.T_LState_1972 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_govActionDeposits_2192 v0 v1
  = coe
...
d_calculateStakeDistrs_2246 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1586 ->
  MAlonzo.Code.Ledger.Ledger.T_LState_1972 ->
  MAlonzo.Code.Ledger.Ratify.T_StakeDistrs_1820
d_calculateStakeDistrs_2246 v0 ~v1 v2
  = du_calculateStakeDistrs_2246 v0 v2
du_calculateStakeDistrs_2246 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Ledger.T_LState_1972 ->
  MAlonzo.Code.Ledger.Ratify.T_StakeDistrs_1820
du_calculateStakeDistrs_2246 v0 v1
  = coe
      MAlonzo.Code.Ledger.Ratify.C_StakeDistrs'46'constructor_11039
      (coe du_govActionDeposits_2192 (coe v0) (coe v1))
-- Ledger.Chain._⊢_⇀⦇_,CHAIN⦈_
d__'8866'_'8640''10631'_'44'CHAIN'10632'__2294 a0 a1 a2 a3 a4 a5
  = ()
data T__'8866'_'8640''10631'_'44'CHAIN'10632'__2294
  = C_CHAIN_2338 MAlonzo.Code.Ledger.Epoch.T_NewEpochState_2144
                 MAlonzo.Code.Ledger.Epoch.T__'8866'_'8640''10631'_'44'NEWEPOCH'10632'__2424
                 MAlonzo.Code.Interface.STS.T__'8866'_'8640''10214'_'10215''42'__68
-- Ledger.Chain._.newEpochState
d_newEpochState_2298 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1586 ->
  T_GeneralizeTel_38777 ->
  MAlonzo.Code.Ledger.Epoch.T_NewEpochState_2144
d_newEpochState_2298 ~v0 ~v1 v2 = du_newEpochState_2298 v2
du_newEpochState_2298 ::
  T_GeneralizeTel_38777 ->
  MAlonzo.Code.Ledger.Epoch.T_NewEpochState_2144
du_newEpochState_2298 v0
  = coe
      d_newEpochState_2082 (coe d_'46'generalizedField'45's_38769 v0)
-- Ledger.Chain._.slot
d_slot_2302 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1586 ->
...
du_slot_2302 :: T_GeneralizeTel_38777 -> AgdaAny
du_slot_2302 v0
  = coe d_slot_2092 (coe d_'46'generalizedField'45'b_38771 v0)
-- Ledger.Chain._.ts
d_ts_2304 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1586 ->
  T_GeneralizeTel_38777 ->
  [MAlonzo.Code.Ledger.Transaction.T_Tx_2710]
d_ts_2304 ~v0 ~v1 v2 = du_ts_2304 v2
du_ts_2304 ::
  T_GeneralizeTel_38777 ->
  [MAlonzo.Code.Ledger.Transaction.T_Tx_2710]
du_ts_2304 v0
  = coe d_ts_2090 (coe d_'46'generalizedField'45'b_38771 v0)
...
d_epochState_2308 ~v0 ~v1 v2 = du_epochState_2308 v2
du_epochState_2308 ::
  T_GeneralizeTel_38777 ->
  MAlonzo.Code.Ledger.Epoch.T_EpochState_2120
du_epochState_2308 v0
  = coe
...
d_acnt_2316 ~v0 ~v1 v2 = du_acnt_2316 v2
du_acnt_2316 ::
  T_GeneralizeTel_38777 -> MAlonzo.Code.Ledger.PParams.T_Acnt_132
du_acnt_2316 v0
  = coe
...
d_es_2318 ~v0 ~v1 v2 = du_es_2318 v2
du_es_2318 ::
  T_GeneralizeTel_38777 -> MAlonzo.Code.Ledger.Enact.T_EnactState_784
du_es_2318 v0
  = coe
...
d_ls_2322 ~v0 ~v1 v2 = du_ls_2322 v2
du_ls_2322 ::
  T_GeneralizeTel_38777 -> MAlonzo.Code.Ledger.Ledger.T_LState_1972
du_ls_2322 v0
  = coe
...
d_constitution_2330 ~v0 ~v1 v2 = du_constitution_2330 v2
du_constitution_2330 ::
  T_GeneralizeTel_38777 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_constitution_2330 v0
  = coe
...
d_'46'generalizedField'45's_38769 ::
  T_GeneralizeTel_38777 -> T_ChainState_2078
...
d_'46'generalizedField'45'b_38771 ::
  T_GeneralizeTel_38777 -> T_Block_2084
...
data T_GeneralizeTel_38777
  = C_mkGeneralizeTel_38779 T_ChainState_2078 T_Block_2084
                            MAlonzo.Code.Ledger.Epoch.T_NewEpochState_2144
                            MAlonzo.Code.Ledger.Ledger.T_LState_1972
