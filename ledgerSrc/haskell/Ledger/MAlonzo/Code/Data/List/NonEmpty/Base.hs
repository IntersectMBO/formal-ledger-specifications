  ...
  = case coe v0 of
      ...
      (:) v2 v3
        -> coe
             C__'8759'__34 (coe v2)
             (coe
                MAlonzo.Code.Data.List.Base.du__'8759''691'__540 (coe v3) (coe v1))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Data.List.NonEmpty.Base._⁺∷ʳ_
...
du_snocView_308 v0
  = case coe v0 of
      C__'8759'__34 v1 v2
        -> let v3
                 = coe MAlonzo.Code.Data.List.Base.du_initLast_564 (coe v2) in
           coe
             (case coe v3 of
                ...
                MAlonzo.Code.Data.List.Base.C__'8759''691''8242'__560 v4 v5
                  -> coe
                       C__'8759''691''8242'__304
                       (coe
