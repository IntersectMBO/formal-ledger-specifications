...
du_isDistributiveLattice_304 v0 v1 v2 v3 v4
  = coe
      MAlonzo.Code.Algebra.Lattice.Structures.Biased.du_isDistributiveLattice'691''690''7504'_738
      (coe
         MAlonzo.Code.Algebra.Lattice.Bundles.Raw.d__'8744'__32 (coe v0))
      (coe
         MAlonzo.Code.Algebra.Lattice.Bundles.Raw.d__'8743'__30 (coe v0))
      (coe
         MAlonzo.Code.Algebra.Lattice.Structures.Biased.C_IsDistributiveLattice'691''690''7504''46'constructor_6385
         (coe
