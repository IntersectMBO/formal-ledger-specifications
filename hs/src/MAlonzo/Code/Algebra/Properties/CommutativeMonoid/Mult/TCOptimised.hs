...
du__'215''8242'__152 v0
  = let v1
    ...
    coe
      (let v2
             = coe MAlonzo.Code.Algebra.Bundles.du_rawMonoid_958 (coe v1) in
       coe
         (coe
            (\ v3 v4 ->
               ...
               coe
                 (let v6
                        = coe
                            MAlonzo.Code.Algebra.Bundles.Raw.d__'8729'__88 v2
                            (coe
                  ...
                  coe
                    (case coe v3 of
                       0 -> coe MAlonzo.Code.Algebra.Bundles.Raw.d_ε_90 (coe v2)
                       1 -> coe v4
                       _ -> coe v6)))))
...
du_'215''45'distrib'45''43'_172 v0 v1 v2 v3
  = coe
      ...
      (let v4
       ...
       coe
         (let v5
                = coe MAlonzo.Code.Algebra.Bundles.d__'8729'__986 v0 v1 v2 in
          coe
         ...
         (let v4
          ...
          coe
            (coe
               ...
               (coe MAlonzo.Code.Algebra.Bundles.du_rawMonoid_958 (coe v4))
               (coe v3)
            ...
            (coe
               ...
               (coe
                  ...
                  (let v4
                   ...
                   coe
                     (let v5
                            = coe MAlonzo.Code.Algebra.Bundles.du_rawMonoid_958 (coe v4) in
                      coe
                        (let v6 = subInt (coe v3) (coe (1 :: Integer)) in
                         coe
                           (let v7
                  ...
                  (coe
                     MAlonzo.Code.Algebra.Properties.Monoid.Mult.TCOptimised.du_'215''7524''8776''215'_156
                     (coe MAlonzo.Code.Algebra.Bundles.du_monoid_1036 (coe v0)) (coe v3)
                     (coe v1))
                  (coe
                     MAlonzo.Code.Algebra.Properties.Monoid.Mult.TCOptimised.du_'215''7524''8776''215'_156
                     (coe MAlonzo.Code.Algebra.Bundles.du_monoid_1036 (coe v0)) (coe v3)
                     (coe v2))))
            (coe
               MAlonzo.Code.Algebra.Properties.CommutativeMonoid.Mult.du_'215''45'distrib'45''43'_216
