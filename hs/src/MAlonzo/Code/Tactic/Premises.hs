...
d_errorP_6 v0 v1 v2
  = coe
      ...
      v0 v2
-- Tactic.Premises._.genSimpleDef
d_genSimpleDef_8 ::
  AgdaAny ->
...
d_print_10
  = coe
      ...
      (coe
         MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
         (coe ("tactic.premises" :: Data.Text.Text)) (coe (100 :: Integer)))
-- Tactic.Premises._.printContext
d_printContext_12 ::
...
d_printContext_12
  = coe
      ...
      (coe
         MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
         (coe ("tactic.premises" :: Data.Text.Text)) (coe (100 :: Integer)))
-- Tactic.Premises._.printCurrentContext
...
-- Tactic.Premises.ℝ
d_ℝ_134 a0 a1 = ()
data T_ℝ_134 = C_base_136 | C_step_142 T_ℝ_134
-- Tactic.Premises.ℚ
d_ℚ_178 a0 a1 a2 a3 a4 = ()
data T_ℚ_178
  = C_base_186 |
    C_step_196 AgdaAny AgdaAny AgdaAny AgdaAny
               MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
-- Tactic.Premises.ℝ′
d_ℝ'8242'_240 a0 a1 = ()
data T_ℝ'8242'_240
  = C_base_242 |
    C_step_252 (Integer -> Integer) (Integer -> Integer)
               MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
-- Tactic.Premises.𝕍
d_𝕍_336 a0 a1 a2 a3 a4 = ()
data T_𝕍_336
  = C_base_344 |
    C_step_358 AgdaAny AgdaAny AgdaAny AgdaAny
               MAlonzo.Code.Class.Show.Core.T_Show_10
               MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
-- Tactic.Premises.𝕍′
d_𝕍'8242'_408 a0 a1 a2 a3 a4 = ()
data T_𝕍'8242'_408
  = C_base_416 |
    C_step_432 AgdaAny AgdaAny AgdaAny AgdaAny
               MAlonzo.Code.Class.Show.Core.T_Show_10
               MAlonzo.Code.Agda.Builtin.Reflection.T_Term_154
               MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
-- Tactic.Premises.ℚ′
d_ℚ'8242'_482 a0 a1 a2 a3 a4 = ()
data T_ℚ'8242'_482
  = C_base_490 |
    C_step_502 AgdaAny AgdaAny AgdaAny AgdaAny
               MAlonzo.Code.Class.Show.Core.T_Show_10
               MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
