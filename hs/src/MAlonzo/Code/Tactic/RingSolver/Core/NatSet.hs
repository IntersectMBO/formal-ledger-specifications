...
import qualified MAlonzo.Code.Data.List.Scans.Base
...
d_lookup_152 v0 v1
  = coe
      MAlonzo.Code.Data.List.Base.du_foldr_216 (coe du_f_162)
      (let v2
...
d_fromList_216
  = coe
      MAlonzo.Code.Data.List.Base.du_foldr_216 (coe d_insert_32)
      (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)
