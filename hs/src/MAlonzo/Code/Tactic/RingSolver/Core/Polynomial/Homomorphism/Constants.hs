...
d_κ_306 ~v0 v1 v2 = du_κ_306 v1 v2
du_κ_306 ::
  Integer ->
  AgdaAny ->
  MAlonzo.Code.Tactic.RingSolver.Core.Polynomial.Base.T_Poly_176
...
d_'10214'_'10215'_390 ~v0 ~v1 ~v2 ~v3 v4 ~v5 v6 v7
  = du_'10214'_'10215'_390 v4 v6 v7
du_'10214'_'10215'_390 ::
  MAlonzo.Code.Tactic.RingSolver.Core.Polynomial.Parameters.T_Homomorphism_68 ->
  MAlonzo.Code.Tactic.RingSolver.Core.Polynomial.Base.T_Poly_176 ->
  MAlonzo.Code.Data.Vec.Base.T_Vec_28 -> AgdaAny
du_'10214'_'10215'_390 v0 v1 v2
  = case coe v1 of
...
d_κ'45'hom_398 ~v0 ~v1 ~v2 ~v3 v4 ~v5 v6 ~v7
  = du_κ'45'hom_398 v4 v6
du_κ'45'hom_398 ::
  MAlonzo.Code.Tactic.RingSolver.Core.Polynomial.Parameters.T_Homomorphism_68 ->
  AgdaAny -> AgdaAny
du_κ'45'hom_398 v0 v1
  = coe
