...
module MAlonzo.Code.Ledger.Core.Specification.TokenAlgebra.Coin where
...
-- Ledger.Core.Specification.TokenAlgebra.Coin._.TokenAlgebra
d_TokenAlgebra_16 a0 = ()
-- Ledger.Core.Specification.TokenAlgebra.Coin._.TokenAlgebra._≤ᵗ_
d__'8804''7511'__26 ::
  MAlonzo.Code.Ledger.Core.Specification.TokenAlgebra.Base.T_TokenAlgebra_14 ->
  AgdaAny -> AgdaAny -> ()
d__'8804''7511'__26 = erased
-- Ledger.Core.Specification.TokenAlgebra.Coin._.TokenAlgebra.Dec-≤ᵗ
...
d_Dec'45''8804''7511'_28 v0
  = coe
      ...
      (coe v0)
-- Ledger.Core.Specification.TokenAlgebra.Coin._.TokenAlgebra.DecEq-Value
d_DecEq'45'Value_30 ::
  MAlonzo.Code.Ledger.Core.Specification.TokenAlgebra.Base.T_TokenAlgebra_14 ->
...
d_DecEq'45'Value_30 v0
  = coe
      ...
      (coe v0)
-- Ledger.Core.Specification.TokenAlgebra.Coin._.TokenAlgebra.Value
d_Value_44 ::
  MAlonzo.Code.Ledger.Core.Specification.TokenAlgebra.Base.T_TokenAlgebra_14 ->
  ()
d_Value_44 = erased
-- Ledger.Core.Specification.TokenAlgebra.Coin._.TokenAlgebra.Value-CommutativeMonoid
...
d_Value'45'CommutativeMonoid_46 v0
  = coe
      ...
      (coe v0)
-- Ledger.Core.Specification.TokenAlgebra.Coin._.TokenAlgebra.coin
d_coin_50 ::
  MAlonzo.Code.Ledger.Core.Specification.TokenAlgebra.Base.T_TokenAlgebra_14 ->
  AgdaAny -> Integer
d_coin_50 v0
  = coe
      ...
      (coe v0)
-- Ledger.Core.Specification.TokenAlgebra.Coin._.TokenAlgebra.coinIsMonoidHomomorphism
...
d_coinIsMonoidHomomorphism_54 v0
  = coe
      ...
      (coe v0)
-- Ledger.Core.Specification.TokenAlgebra.Coin._.TokenAlgebra.coin∘inject≗id
d_coin'8728'inject'8791'id_56 ::
  MAlonzo.Code.Ledger.Core.Specification.TokenAlgebra.Base.T_TokenAlgebra_14 ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_coin'8728'inject'8791'id_56 = erased
-- Ledger.Core.Specification.TokenAlgebra.Coin._.TokenAlgebra.inject
d_inject_58 ::
  MAlonzo.Code.Ledger.Core.Specification.TokenAlgebra.Base.T_TokenAlgebra_14 ->
  Integer -> AgdaAny
d_inject_58 v0
  = coe
      ...
      (coe v0)
-- Ledger.Core.Specification.TokenAlgebra.Coin._.TokenAlgebra.policies
d_policies_62 ::
  MAlonzo.Code.Ledger.Core.Specification.TokenAlgebra.Base.T_TokenAlgebra_14 ->
  AgdaAny -> [AgdaAny]
d_policies_62 v0
  = coe
      ...
      (coe v0)
-- Ledger.Core.Specification.TokenAlgebra.Coin._.TokenAlgebra.size
d_size_66 ::
  MAlonzo.Code.Ledger.Core.Specification.TokenAlgebra.Base.T_TokenAlgebra_14 ->
  AgdaAny -> Integer
d_size_66 v0
  = coe
      ...
      (coe v0)
-- Ledger.Core.Specification.TokenAlgebra.Coin.Coin-TokenAlgebra
...
-- Ledger.Core.Specification.TokenAlgebra.Coin..extendedlambda0
...
du_'46'extendedlambda0_134
  = coe
      MAlonzo.Code.Ledger.Core.Specification.TokenAlgebra.Base.C_constructor_256
      (coe
