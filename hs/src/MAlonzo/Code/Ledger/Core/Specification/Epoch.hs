...
data T_GlobalConstants_260
  = C_constructor_336 MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
...
d_Network_284 :: T_GlobalConstants_260 -> ()
d_Network_284 = erased
-- Ledger.Core.Specification.Epoch.GlobalConstants.DecEq-Netw
d_DecEq'45'Netw_286 ::
  T_GlobalConstants_260 -> MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'Netw_286 v0
  = case coe v0 of
      C_constructor_336 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Core.Specification.Epoch.GlobalConstants.Show-Network
d_Show'45'Network_288 ::
  T_GlobalConstants_260 -> MAlonzo.Code.Class.Show.Core.T_Show_10
d_Show'45'Network_288 v0
  = case coe v0 of
      C_constructor_336 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Core.Specification.Epoch.GlobalConstants.SlotsPerEpochᶜ
d_SlotsPerEpoch'7580'_290 :: T_GlobalConstants_260 -> Integer
d_SlotsPerEpoch'7580'_290 v0
  = case coe v0 of
      C_constructor_336 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Core.Specification.Epoch.GlobalConstants.NonZero-SlotsPerEpochᶜ
d_NonZero'45'SlotsPerEpoch'7580'_292 ::
  T_GlobalConstants_260 -> MAlonzo.Code.Data.Nat.Base.T_NonZero_112
d_NonZero'45'SlotsPerEpoch'7580'_292 v0
  = case coe v0 of
      C_constructor_336 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Core.Specification.Epoch.GlobalConstants.ActiveSlotCoeff
d_ActiveSlotCoeff_294 ::
  T_GlobalConstants_260 -> MAlonzo.Code.Data.Rational.Base.T_ℚ_6
d_ActiveSlotCoeff_294 v0
  = case coe v0 of
      C_constructor_336 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Core.Specification.Epoch.GlobalConstants.Positive-ActiveSlotCoeff
d_Positive'45'ActiveSlotCoeff_296 ::
  T_GlobalConstants_260 ->
  MAlonzo.Code.Data.Integer.Base.T_Positive_134
d_Positive'45'ActiveSlotCoeff_296 v0
  = case coe v0 of
      C_constructor_336 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Core.Specification.Epoch.GlobalConstants.StabilityWindowᶜ
d_StabilityWindow'7580'_298 :: T_GlobalConstants_260 -> Integer
d_StabilityWindow'7580'_298 v0
  = case coe v0 of
      C_constructor_336 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Core.Specification.Epoch.GlobalConstants.MaxLovelaceSupplyᶜ
d_MaxLovelaceSupply'7580'_300 :: T_GlobalConstants_260 -> Integer
d_MaxLovelaceSupply'7580'_300 v0
  = case coe v0 of
      C_constructor_336 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v9
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Core.Specification.Epoch.GlobalConstants.Quorum
d_Quorum_302 :: T_GlobalConstants_260 -> Integer
d_Quorum_302 v0
  = case coe v0 of
      C_constructor_336 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v10
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Core.Specification.Epoch.GlobalConstants.NetworkId
d_NetworkId_304 :: T_GlobalConstants_260 -> AgdaAny
d_NetworkId_304 v0
  = case coe v0 of
      C_constructor_336 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v11
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Core.Specification.Epoch.GlobalConstants.NonZero-ActiveSlotCoeff
d_NonZero'45'ActiveSlotCoeff_306 ::
  T_GlobalConstants_260 -> MAlonzo.Code.Data.Nat.Base.T_NonZero_112
d_NonZero'45'ActiveSlotCoeff_306 v0
  = coe
      MAlonzo.Code.Data.Rational.Base.d_'62''45'nonZero_224
      (coe d_ActiveSlotCoeff_294 (coe v0))
      (coe
         MAlonzo.Code.Data.Rational.Properties.du_positive'8315''185'_3986
         (coe d_ActiveSlotCoeff_294 (coe v0)))
-- Ledger.Core.Specification.Epoch.GlobalConstants.ℕ+ᵉ≡+ᵉ'
d_ℕ'43''7497''8801''43''7497'''_312 ::
  T_GlobalConstants_260 ->
  Integer ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_ℕ'43''7497''8801''43''7497'''_312 = erased
-- Ledger.Core.Specification.Epoch.GlobalConstants.ℕEpochStructure
d_ℕEpochStructure_320 ::
  T_GlobalConstants_260 -> T_EpochStructure_22
d_ℕEpochStructure_320 v0
  = coe
      C_constructor_258
      ...
      (\ v1 ->
         coe
           ...
           (coe d_SlotsPerEpoch'7580'_290 (coe v0)))
      (\ v1 -> mulInt (coe v1) (coe d_SlotsPerEpoch'7580'_290 (coe v0)))
      (d_StabilityWindow'7580'_298 (coe v0))
