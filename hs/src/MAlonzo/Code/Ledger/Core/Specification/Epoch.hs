...
data T_GlobalConstants_292
  = C_constructor_386 MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
...
d_NetworkId_344 :: T_GlobalConstants_292 -> AgdaAny
d_NetworkId_344 v0
  = case coe v0 of
      C_constructor_386 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v12
...
d_MaxKESEvo'7580'_346 :: T_GlobalConstants_292 -> Integer
d_MaxKESEvo'7580'_346 v0
  = case coe v0 of
      C_constructor_386 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v13
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Core.Specification.Epoch.GlobalConstants.SlotsPerKESPeriodᶜ
d_SlotsPerKESPeriod'7580'_348 :: T_GlobalConstants_292 -> Integer
d_SlotsPerKESPeriod'7580'_348 v0
  = case coe v0 of
      C_constructor_386 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v14
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Core.Specification.Epoch.GlobalConstants.NonZero-ActiveSlotCoeff
d_NonZero'45'ActiveSlotCoeff_350 ::
  T_GlobalConstants_292 -> MAlonzo.Code.Data.Nat.Base.T_NonZero_112
d_NonZero'45'ActiveSlotCoeff_350 v0
  = coe
      MAlonzo.Code.Data.Rational.Base.d_'62''45'nonZero_224
      (coe d_ActiveSlotCoeff_332 (coe v0))
      (coe
         MAlonzo.Code.Data.Rational.Properties.du_positive'8315''185'_3986
         (coe d_ActiveSlotCoeff_332 (coe v0)))
-- Ledger.Core.Specification.Epoch.GlobalConstants.maxKeyAgeEpochs
d_maxKeyAgeEpochs_352 :: T_GlobalConstants_292 -> Integer
d_maxKeyAgeEpochs_352 v0
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (addInt
               (coe d_SlotsPerEpoch'7580'_328 (coe v0))
               (coe
                  mulInt (coe d_MaxKESEvo'7580'_346 (coe v0))
                  (coe d_SlotsPerKESPeriod'7580'_348 (coe v0))))
            (1 :: Integer))
         (coe d_SlotsPerEpoch'7580'_328 (coe v0)))
-- Ledger.Core.Specification.Epoch.GlobalConstants.ℕ+ᵉ≡+ᵉ'
d_ℕ'43''7497''8801''43''7497'''_358 ::
  T_GlobalConstants_292 ->
  Integer ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_ℕ'43''7497''8801''43''7497'''_358 = erased
-- Ledger.Core.Specification.Epoch.GlobalConstants.ℕEpochStructure
d_ℕEpochStructure_366 ::
  T_GlobalConstants_292 -> T_EpochStructure_22
d_ℕEpochStructure_366 v0 = coe d_'46'extendedlambda0_372 (coe v0)
-- Ledger.Core.Specification.Epoch.GlobalConstants._..extendedlambda0
d_'46'extendedlambda0_372 ::
  T_GlobalConstants_292 -> T_EpochStructure_22
d_'46'extendedlambda0_372 v0
  = coe
      C_constructor_290
      ...
      (\ v1 ->
         coe
           ...
           (coe d_SlotsPerEpoch'7580'_328 (coe v0)))
      (\ v1 -> mulInt (coe v1) (coe d_SlotsPerEpoch'7580'_328 (coe v0)))
      (d_RandomnessStabilisationWindow'7580'_336 (coe v0))
      (d_StabilityWindow'7580'_338 (coe v0))
      (\ v1 -> addInt (coe (1 :: Integer)) (coe v1)) addInt
      (\ v1 ->
         coe
           MAlonzo.Code.Data.Nat.Properties.d_'43''45'mono'737''45''8804'_3682
           (mulInt (coe v1) (coe d_SlotsPerEpoch'7580'_328 (coe v0)))
           (1 :: Integer) (d_SlotsPerEpoch'7580'_328 (coe v0))
           ...
           (\ v3 ->
              coe
                ...
                (coe
                   ...
                   (coe d_SlotsPerEpoch'7580'_328 (coe v0)) (coe v3)))
