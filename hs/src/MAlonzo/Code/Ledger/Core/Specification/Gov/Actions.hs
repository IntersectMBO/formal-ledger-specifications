                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (896 :: Integer) (13110945787946992658 :: Integer)
                                 "Ledger.Core.Specification.Gov.Actions.GovVote"
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (862 :: Integer) (13110945787946992658 :: Integer)
                                 "Ledger.Core.Specification.Gov.Actions.GovActionID"
                                 (MAlonzo.RTE.Fixity MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                           (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
               (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe
                                 (MAlonzo.RTE.QName
                                    (872 :: Integer) (13110945787946992658 :: Integer)
                                    "Ledger.Core.Specification.Gov.Actions.GovVoter"
                                    (MAlonzo.RTE.Fixity
                                       MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                              (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
        ...
        -> let v3
           ...
           coe
             (case coe v1 of
                ...
                _ -> coe v3)
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Core.Specification.Gov.Actions.DReps
d_DReps_1226 ::
  MAlonzo.Code.Ledger.Core.Specification.Gov.Base.T_GovStructure_10 ->
  ()
d_DReps_1226 = erased
-- Ledger.Core.Specification.Gov.Actions.HasDReps
d_HasDReps_1232 a0 a1 a2 = ()
newtype T_HasDReps_1232
  = C_constructor_1242 (AgdaAny ->
                        MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14)
-- Ledger.Core.Specification.Gov.Actions.HasDReps.DRepsOf
d_DRepsOf_1240 ::
  T_HasDReps_1232 ->
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_DRepsOf_1240 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Core.Specification.Gov.Actions._.DRepsOf
d_DRepsOf_1246 ::
  T_HasDReps_1232 ->
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_DRepsOf_1246 v0 = coe d_DRepsOf_1240 (coe v0)
-- Ledger.Core.Specification.Gov.Actions.activeInEpoch
d_activeInEpoch_1248 ::
  MAlonzo.Code.Ledger.Core.Specification.Gov.Base.T_GovStructure_10 ->
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> ()
d_activeInEpoch_1248 = erased
-- Ledger.Core.Specification.Gov.Actions.activeDRepsOf
