...
data T_ScriptPurpose_1740
  = C_Cert_1742 MAlonzo.Code.Ledger.Certs.T_DCert_856 |
    C_Rwrd_1744 MAlonzo.Code.Ledger.Address.T_RwdAddr_76 |
    C_Mint_1746 AgdaAny |
    C_Spend_1748 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 |
    C_Vote_1750 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 |
    C_Propose_1752 MAlonzo.Code.Ledger.GovernanceActions.T_GovProposal_758
-- Ledger.ScriptValidation.rdptr
d_rdptr_1754 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1736 ->
  MAlonzo.Code.Ledger.Transaction.T_TxBody_2518 ->
  T_ScriptPurpose_1740 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_rdptr_1754 v0 v1 v2 v3
  = case coe v3 of
      C_Cert_1742 v4
        -> coe
             ...
             (coe
                MAlonzo.Code.Ledger.Abstract.d_indexOfDCert_1724
                (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1752 (coe v1)) v4
                (MAlonzo.Code.Ledger.Transaction.d_txcerts_2572 (coe v2)))
      C_Rwrd_1744 v4
        -> coe
             MAlonzo.Code.Data.Maybe.Base.du_map_64
             (\ v5 ->
             ...
             (coe
                MAlonzo.Code.Ledger.Abstract.d_indexOfRwdAddr_1726
                (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1752 (coe v1)) v4
                (MAlonzo.Code.Ledger.Transaction.d_txwdrls_2574 (coe v2)))
      C_Mint_1746 v4
        -> coe
             MAlonzo.Code.Data.Maybe.Base.du_map_64
             (\ v5 ->
             ...
             (coe
                MAlonzo.Code.Ledger.Abstract.d_indexOfPolicyId_1730
                (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1752 (coe v1)) v4
                (coe
      ...
      C_Spend_1748 v4
        -> coe
             ...
             (coe
                MAlonzo.Code.Ledger.Abstract.d_indexOfTxIn_1728
                (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1752 (coe v1)) v4
                (MAlonzo.Code.Ledger.Transaction.d_txins_2560 (coe v2)))
      C_Vote_1750 v4
        -> coe
             MAlonzo.Code.Data.Maybe.Base.du_map_64
             (\ v5 ->
             ...
             (coe
                MAlonzo.Code.Ledger.Abstract.d_indexOfVote_1732
                (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1752 (coe v1)) v4
                (coe
      ...
      C_Propose_1752 v4
        -> coe
             ...
             (coe
                MAlonzo.Code.Ledger.Abstract.d_indexOfProposal_1734
                (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1752 (coe v1)) v4
                (MAlonzo.Code.Ledger.Transaction.d_txprop_2578 (coe v2)))
...
d_indexedRdmrs_1830 ::
  ...
  T_ScriptPurpose_1740 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_indexedRdmrs_1830 v0 v1 v2 v3
  = coe
...
d_getDatum_1864 ::
  ...
  MAlonzo.Code.Ledger.Transaction.T_Tx_2620 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  T_ScriptPurpose_1740 -> [AgdaAny]
d_getDatum_1864 v0 ~v1 v2 v3 v4 = du_getDatum_1864 v0 v2 v3 v4
du_getDatum_1864 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2620 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  T_ScriptPurpose_1740 -> [AgdaAny]
du_getDatum_1864 v0 v1 v2 v3
...
d_TxInfo_1904 a0 a1 = ()
data T_TxInfo_1904
  = C_TxInfo'46'constructor_17019 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_realizedInputs_1926 ::
  T_TxInfo_1904 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_realizedInputs_1926 v0
  = case coe v0 of
      C_TxInfo'46'constructor_17019 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_fee_1930 :: T_TxInfo_1904 -> AgdaAny
d_fee_1930 v0
  = case coe v0 of
      C_TxInfo'46'constructor_17019 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v3
...
d_mint_1932 :: T_TxInfo_1904 -> AgdaAny
d_mint_1932 v0
  = case coe v0 of
      C_TxInfo'46'constructor_17019 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v4
...
d_txcerts_1934 ::
  T_TxInfo_1904 -> [MAlonzo.Code.Ledger.Certs.T_DCert_856]
d_txcerts_1934 v0
  = case coe v0 of
      C_TxInfo'46'constructor_17019 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v5
...
d_vkKey_1940 :: T_TxInfo_1904 -> [AgdaAny]
d_vkKey_1940 v0
  = case coe v0 of
      C_TxInfo'46'constructor_17019 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v8
...
d_txid_1944 :: T_TxInfo_1904 -> AgdaAny
d_txid_1944 v0
  = case coe v0 of
      C_TxInfo'46'constructor_17019 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v10
...
d_txInfo_1946 ::
  ...
  MAlonzo.Code.Ledger.PParams.T_PParams_244 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2620 -> T_TxInfo_1904
d_txInfo_1946 v0 ~v1 ~v2 ~v3 v4 v5 = du_txInfo_1946 v0 v4 v5
du_txInfo_1946 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2620 -> T_TxInfo_1904
du_txInfo_1946 v0 v1 v2
  = coe
      C_TxInfo'46'constructor_17019
      (coe
...
d_DelegateOrDeReg_2070 a0 a1 a2 = ()
data T_DelegateOrDeReg_2070
  = C_reg_2076 | C_delegate_2086 | C_dereg_2092 | C_regdrep_2100 |
    C_deregdrep_2106
-- Ledger.ScriptValidation.Dec-DelegateOrDeReg
d_Dec'45'DelegateOrDeReg_2108 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1736 ->
  MAlonzo.Code.Ledger.Certs.T_DCert_856 ->
  MAlonzo.Code.Class.Decidable.Core.T__'8263'_10
d_Dec'45'DelegateOrDeReg_2108 ~v0 ~v1 v2
  = du_Dec'45'DelegateOrDeReg_2108 v2
du_Dec'45'DelegateOrDeReg_2108 ::
  MAlonzo.Code.Ledger.Certs.T_DCert_856 ->
  MAlonzo.Code.Class.Decidable.Core.T__'8263'_10
du_Dec'45'DelegateOrDeReg_2108 v0
  = coe
      ...
      (case coe v0 of
         ...
         MAlonzo.Code.Ledger.Certs.C_reg_872 v1 v2
           -> coe
                ...
                (coe
                   MAlonzo.Code.Relation.Nullary.Reflects.C_of'696'_22
                   (\ v3 v4 -> coe C_reg_2076))
         _ -> MAlonzo.RTE.mazUnreachableError)
-- Ledger.ScriptValidation.UTxOSH
d_UTxOSH_2132 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1736 -> ()
d_UTxOSH_2132 = erased
-- Ledger.ScriptValidation.scriptOutWithHash
d_scriptOutWithHash_2134 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1736 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_scriptOutWithHash_2134 ~v0 ~v1 ~v2 v3
  = du_scriptOutWithHash_2134 v3
du_scriptOutWithHash_2134 ::
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_scriptOutWithHash_2134 v0
  = case coe v0 of
...
d_scriptOutsWithHash_2144 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1736 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_scriptOutsWithHash_2144 ~v0 ~v1 v2
  = du_scriptOutsWithHash_2144 v2
du_scriptOutsWithHash_2144 ::
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_scriptOutsWithHash_2144 v0
  = coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.QabstractZ45ZsetZ45Ztheory.FiniteSetTheory.d_List'45'Model'7496'_8))
      (\ v1 v2 -> coe du_scriptOutWithHash_2134 v2) (coe v0)
...
d_spendScripts_2148 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_spendScripts_2148 v0 ~v1 v2 v3 = du_spendScripts_2148 v0 v2 v3
du_spendScripts_2148 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_spendScripts_2148 v0 v1 v2
  = coe
      MAlonzo.Code.Class.ToBool.du_if_then_else__42
      (coe MAlonzo.Code.Class.ToBool.du_ToBool'45''8263'_108) erased
      (coe
...
d_rwdScripts_2156 ::
  ...
  MAlonzo.Code.Ledger.Address.T_RwdAddr_76 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_rwdScripts_2156 ~v0 ~v1 v2 = du_rwdScripts_2156 v2
du_rwdScripts_2156 ::
  MAlonzo.Code.Ledger.Address.T_RwdAddr_76 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_rwdScripts_2156 v0
  = coe
      MAlonzo.Code.Class.ToBool.du_if_then_else__42
      (coe MAlonzo.Code.Class.ToBool.du_ToBool'45''8263'_108) erased
      (coe
...
d_certScripts_2164 ::
  ...
  MAlonzo.Code.Ledger.Certs.T_DCert_856 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_certScripts_2164 ~v0 ~v1 v2 = du_certScripts_2164 v2
du_certScripts_2164 ::
  MAlonzo.Code.Ledger.Certs.T_DCert_856 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_certScripts_2164 v0
  = case coe v0 of
      MAlonzo.Code.Ledger.Certs.C_delegate_858 v1 v2 v3 v4
        -> case coe v1 of
...
du_scriptsNeeded_2236 v0 v1 v2
  = coe
      ...
      (coe
         ...
         (\ v3 ->
            coe
              du_spendScripts_2148 (coe v0) (coe v3)
              (coe du_scriptOutsWithHash_2144 (coe v1)))
         (MAlonzo.Code.Ledger.Transaction.d_txins_2560 (coe v2)))
      (coe
         MAlonzo.Code.Axiom.Set.du__'8746'__680
         (coe
...
d_valContext_2296 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1736 ->
  T_TxInfo_1904 -> T_ScriptPurpose_1740 -> AgdaAny
                 ...
                 = coe
                     ...
                     (coe
                        ...
                        (coe
                           MAlonzo.Code.Axiom.Set.Map.du__'738'_550
                           (coe
                              MAlonzo.Code.Ledger.Transaction.du_m_2752 (coe v0) (coe v3)
                              (coe v4)))) in
           coe
             (case coe v8 of
                                                      ...
                                                      (case coe v6 of
                                                         C_Cert_1742 v15
                                                           -> coe
                                                                ...
                                                                (coe
                                                                   MAlonzo.Code.Ledger.Abstract.d_indexOfDCert_1724
                                                                   (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1752
                                                                      (coe v1))
                                                                   v15
                                                                   (MAlonzo.Code.Ledger.Transaction.d_txcerts_2572
                                                                      (coe v14)))
...
d_'10214'_'10215''44'_'44'_'44'__2386 v0 v1 v2 v3 v4
  = coe
      MAlonzo.Code.Ledger.Abstract.d_runPLCScript_1754 v0 v2 v1 v3 v4
                             ...
                             -> case coe v10 of
                                  MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v11 v12
                                    -> coe
                                         MAlonzo.Code.Data.Bool.Base.d__'8743'__24
                                         (coe
                                            MAlonzo.Code.Ledger.Abstract.d_runPLCScript_1754 v1 v12
                                            v8 v11 v9)
                                         (coe
