...
module MAlonzo.Code.Ledger.Prelude.Epoch where
...
-- Ledger.Prelude.Epoch.additionVia
d_additionVia_8 ::
...
-- Ledger.Prelude.Epoch.EpochStructure
d_EpochStructure_20 = ()
data T_EpochStructure_20
  = C_EpochStructure'46'constructor_1323 MAlonzo.Code.Algebra.Bundles.T_Semiring_2304
                                         ...
                                         (AgdaAny -> AgdaAny) (Integer -> AgdaAny -> AgdaAny)
-- Ledger.Prelude.Epoch.EpochStructure.Slotʳ
d_Slot'691'_54 ::
...
-- Ledger.Prelude.Epoch.EpochStructure.Epoch
d_Epoch_56 :: T_EpochStructure_20 -> ()
d_Epoch_56 = erased
-- Ledger.Prelude.Epoch.EpochStructure.DecEq-Epoch
d_DecEq'45'Epoch_58 ::
...
d_DecEq'45'Epoch_58 v0
  = case coe v0 of
      C_EpochStructure'46'constructor_1323 v1 v3 v4 v5 v6 v7 v8 v9 v10 v11
        -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Prelude.Epoch.EpochStructure.Show-Epoch
d_Show'45'Epoch_60 ::
...
d_Show'45'Epoch_60 v0
  = case coe v0 of
      C_EpochStructure'46'constructor_1323 v1 v3 v4 v5 v6 v7 v8 v9 v10 v11
        -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Prelude.Epoch.EpochStructure.Slot
d_Slot_62 :: T_EpochStructure_20 -> ()
d_Slot_62 = erased
-- Ledger.Prelude.Epoch.EpochStructure.DecPo-Slot
d_DecPo'45'Slot_64 ::
  T_EpochStructure_20 ->
  MAlonzo.Code.Class.HasOrder.Core.T_HasDecPartialOrder_256
d_DecPo'45'Slot_64 v0
  = case coe v0 of
      C_EpochStructure'46'constructor_1323 v1 v3 v4 v5 v6 v7 v8 v9 v10 v11
        -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Prelude.Epoch.EpochStructure.DecEq-Slot
d_DecEq'45'Slot_66 ::
  T_EpochStructure_20 -> MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
...
d_epoch_68 v0
  = case coe v0 of
      C_EpochStructure'46'constructor_1323 v1 v3 v4 v5 v6 v7 v8 v9 v10 v11
        -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Prelude.Epoch.EpochStructure.firstSlot
...
d_firstSlot_70 v0
  = case coe v0 of
      C_EpochStructure'46'constructor_1323 v1 v3 v4 v5 v6 v7 v8 v9 v10 v11
        -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Prelude.Epoch.EpochStructure.StabilityWindow
...
d_StabilityWindow_72 v0
  = case coe v0 of
      C_EpochStructure'46'constructor_1323 v1 v3 v4 v5 v6 v7 v8 v9 v10 v11
        -> coe v9
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Prelude.Epoch.EpochStructure.sucᵉ
...
d__'43''7497'''__78 v0
  = case coe v0 of
      C_EpochStructure'46'constructor_1323 v1 v3 v4 v5 v6 v7 v8 v9 v10 v11
        -> coe v11
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Prelude.Epoch.EpochStructure.+ᵉ≡+ᵉ'
d_'43''7497''8801''43''7497'''_84 ::
  T_EpochStructure_20 ->
  Integer ->
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_'43''7497''8801''43''7497'''_84 = erased
-- Ledger.Prelude.Epoch.EpochStructure.preoEpoch
d_preoEpoch_86 ::
  T_EpochStructure_20 ->
...
-- Ledger.Prelude.Epoch.EpochStructure.ℕtoEpoch
...
-- Ledger.Prelude.Epoch.EpochStructure.addSlot
d_addSlot_244 ::
...
d_addSlot_244 v0
  = coe
      ...
      (coe
         ...
         (coe d_Slot'691'_54 (coe v0)))
-- Ledger.Prelude.Epoch.EpochStructure.addEpoch
d_addEpoch_246 ::
  T_EpochStructure_20 -> MAlonzo.Code.Class.HasAdd.Core.T_HasAdd_10
d_addEpoch_246 v0
  = coe
...
-- Ledger.Prelude.Epoch.EpochStructure.Number-Epoch
...
-- Ledger.Prelude.Epoch.GlobalConstants
...
d_DecEq'45'Netw_280 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_6529 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Prelude.Epoch.GlobalConstants.Show-Network
...
d_Show'45'Network_282 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_6529 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Prelude.Epoch.GlobalConstants.SlotsPerEpochᶜ
...
d_SlotsPerEpoch'7580'_284 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_6529 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Prelude.Epoch.GlobalConstants.NonZero-SlotsPerEpochᶜ
...
d_NonZero'45'SlotsPerEpoch'7580'_286 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_6529 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Prelude.Epoch.GlobalConstants.ActiveSlotCoeff
...
d_ActiveSlotCoeff_288 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_6529 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Prelude.Epoch.GlobalConstants.Positive-ActiveSlotCoeff
d_Positive'45'ActiveSlotCoeff_290 ::
  T_GlobalConstants_256 ->
  MAlonzo.Code.Data.Integer.Base.T_Positive_134
d_Positive'45'ActiveSlotCoeff_290 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_6529 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Prelude.Epoch.GlobalConstants.StabilityWindowᶜ
...
d_StabilityWindow'7580'_292 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_6529 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Prelude.Epoch.GlobalConstants.Quorum
...
d_NetworkId_296 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_6529 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v10
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Prelude.Epoch.GlobalConstants.NonZero-ActiveSlotCoeff
d_NonZero'45'ActiveSlotCoeff_298 ::
  T_GlobalConstants_256 -> MAlonzo.Code.Data.Nat.Base.T_NonZero_112
d_NonZero'45'ActiveSlotCoeff_298 v0
  = coe
      MAlonzo.Code.Data.Rational.Base.d_'62''45'nonZero_224
      (coe d_ActiveSlotCoeff_288 (coe v0))
      (coe
         MAlonzo.Code.Data.Rational.Properties.du_positive'8315''185'_3916
         (coe d_ActiveSlotCoeff_288 (coe v0)))
-- Ledger.Prelude.Epoch.GlobalConstants.ℕ+ᵉ≡+ᵉ'
d_ℕ'43''7497''8801''43''7497'''_304 ::
  T_GlobalConstants_256 ->
  Integer ->
  Integer -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_ℕ'43''7497''8801''43''7497'''_304 = erased
-- Ledger.Prelude.Epoch.GlobalConstants.ℕEpochStructure
