...
d_indexOf_1718 a0 = ()
data T_indexOf_1718
  = C_indexOf'46'constructor_3117 (MAlonzo.Code.Ledger.Certs.T_DCert_856 ->
...
d_indexOfDCert_1732 v0
  = case coe v0 of
      C_indexOf'46'constructor_3117 v1 v2 v3 v4 v5 v6 -> coe v1
...
d_indexOfRwdAddr_1734 v0
  = case coe v0 of
      C_indexOf'46'constructor_3117 v1 v2 v3 v4 v5 v6 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfTxIn_1736 v0
  = case coe v0 of
      C_indexOf'46'constructor_3117 v1 v2 v3 v4 v5 v6 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfPolicyId_1738 v0
  = case coe v0 of
      C_indexOf'46'constructor_3117 v1 v2 v3 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfVote_1740 v0
  = case coe v0 of
      C_indexOf'46'constructor_3117 v1 v2 v3 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfProposal_1742 v0
  = case coe v0 of
      C_indexOf'46'constructor_3117 v1 v2 v3 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Abstract.AbstractFunctions
d_AbstractFunctions_1744 a0 = ()
data T_AbstractFunctions_1744
  = C_AbstractFunctions'46'constructor_3409 (AgdaAny ->
                                             AgdaAny -> Integer)
...
d_txscriptfee_1756 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_3409 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Abstract.AbstractFunctions.serSize
d_serSize_1758 :: T_AbstractFunctions_1744 -> AgdaAny -> Integer
d_serSize_1758 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_3409 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfImp_1760 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_3409 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_runPLCScript_1762 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_3409 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_scriptSize_1764 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_3409 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
