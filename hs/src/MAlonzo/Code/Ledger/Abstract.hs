...
d_indexOf_1734 a0 = ()
data T_indexOf_1734
  = C_indexOf'46'constructor_3129 (MAlonzo.Code.Ledger.Certs.T_DCert_872 ->
...
d_indexOfDCert_1748 ::
  ...
  [MAlonzo.Code.Ledger.Certs.T_DCert_872] -> Maybe AgdaAny
d_indexOfDCert_1748 v0
  = case coe v0 of
      C_indexOf'46'constructor_3129 v1 v2 v3 v4 v5 v6 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Abstract.indexOf.indexOfRwdAddr
d_indexOfRwdAddr_1750 ::
  T_indexOf_1734 ->
  MAlonzo.Code.Ledger.Address.T_RwdAddr_76 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Maybe AgdaAny
d_indexOfRwdAddr_1750 v0
  = case coe v0 of
      C_indexOf'46'constructor_3129 v1 v2 v3 v4 v5 v6 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfTxIn_1752 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> Maybe AgdaAny
d_indexOfTxIn_1752 v0
  = case coe v0 of
      C_indexOf'46'constructor_3129 v1 v2 v3 v4 v5 v6 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Abstract.indexOf.indexOfPolicyId
d_indexOfPolicyId_1754 ::
  T_indexOf_1734 -> AgdaAny -> [AgdaAny] -> Maybe AgdaAny
d_indexOfPolicyId_1754 v0
  = case coe v0 of
      C_indexOf'46'constructor_3129 v1 v2 v3 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfVote_1756 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> Maybe AgdaAny
d_indexOfVote_1756 v0
  = case coe v0 of
      C_indexOf'46'constructor_3129 v1 v2 v3 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Abstract.indexOf.indexOfProposal
d_indexOfProposal_1758 ::
  T_indexOf_1734 ->
  MAlonzo.Code.Ledger.GovernanceActions.T_GovProposal_758 ->
  [MAlonzo.Code.Ledger.GovernanceActions.T_GovProposal_758] ->
  Maybe AgdaAny
d_indexOfProposal_1758 v0
  = case coe v0 of
      C_indexOf'46'constructor_3129 v1 v2 v3 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Abstract.AbstractFunctions
d_AbstractFunctions_1760 a0 = ()
data T_AbstractFunctions_1760
  = C_AbstractFunctions'46'constructor_3421 (AgdaAny ->
                                             AgdaAny -> Integer)
                                            (AgdaAny -> Integer) T_indexOf_1734
                                            (AgdaAny -> AgdaAny -> AgdaAny -> [AgdaAny] -> Bool)
                                            (MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Integer)
-- Ledger.Abstract.AbstractFunctions.txscriptfee
d_txscriptfee_1772 ::
  T_AbstractFunctions_1760 -> AgdaAny -> AgdaAny -> Integer
d_txscriptfee_1772 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_3421 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Abstract.AbstractFunctions.serSize
d_serSize_1774 :: T_AbstractFunctions_1760 -> AgdaAny -> Integer
d_serSize_1774 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_3421 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Abstract.AbstractFunctions.indexOfImp
d_indexOfImp_1776 :: T_AbstractFunctions_1760 -> T_indexOf_1734
d_indexOfImp_1776 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_3421 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Abstract.AbstractFunctions.runPLCScript
d_runPLCScript_1778 ::
  T_AbstractFunctions_1760 ->
  AgdaAny -> AgdaAny -> AgdaAny -> [AgdaAny] -> Bool
d_runPLCScript_1778 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_3421 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Abstract.AbstractFunctions.scriptSize
d_scriptSize_1780 ::
  T_AbstractFunctions_1760 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Integer
d_scriptSize_1780 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_3421 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
