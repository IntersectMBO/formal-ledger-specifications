...
d_Conv'45'BalanceInterval_14
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Dijkstra.Specification.Account.C_'10214'_'44'_'10630'_894 v1 v2
                -> coe C_Both_921 (coe v1) (coe v2)
              MAlonzo.Code.Ledger.Dijkstra.Specification.Account.C_'10214'_'44''8734''10630'_896 v1
                -> coe C_Lower_977 (coe v1)
              MAlonzo.Code.Ledger.Dijkstra.Specification.Account.C_'10214'0'44'_'10630'_898 v1
                -> coe C_Upper_991 (coe v1)
              MAlonzo.Code.Ledger.Dijkstra.Specification.Account.C_Exact_900 v1
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              C_Both_921 v1 v2
                -> coe
                     MAlonzo.Code.Ledger.Dijkstra.Specification.Account.C_'10214'_'44'_'10630'_894
                     (coe v1) (coe v2)
              C_Lower_977 v1
                -> coe
                     MAlonzo.Code.Ledger.Dijkstra.Specification.Account.C_'10214'_'44''8734''10630'_896
                     (coe v1)
              C_Upper_991 v1
                -> coe
                     MAlonzo.Code.Ledger.Dijkstra.Specification.Account.C_'10214'0'44'_'10630'_898
                     (coe v1)
              C_Exact_1005 v1
                -> coe
                     MAlonzo.Code.Ledger.Dijkstra.Specification.Account.C_Exact_900
                     (coe v1)
              _ -> MAlonzo.RTE.mazUnreachableError))
