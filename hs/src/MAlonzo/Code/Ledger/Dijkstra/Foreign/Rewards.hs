...
d_HasCast'45'Snapshot_14
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.du_HasCast'45'Snapshot_3784
-- Ledger.Dijkstra.Foreign.Rewards._.HasCast-Snapshots
d_HasCast'45'Snapshots_16 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'Snapshots_16
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.du_HasCast'45'Snapshots_3862
-- Ledger.Dijkstra.Foreign.Rewards._.HasFees-Snapshots
d_HasFees'45'Snapshots_18 ::
  MAlonzo.Code.Ledger.Prelude.Base.T_HasFees_40
d_HasFees'45'Snapshots_18
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.du_HasFees'45'Snapshots_3860
...
d_HasPools'45'Snapshot_20
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.du_HasPools'45'Snapshot_3782
...
d_HasStake'45'Snapshot_26
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.du_HasStake'45'Snapshot_3778
...
d_HasStakeDelegs'45'Snapshot_28
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.du_HasStakeDelegs'45'Snapshot_3780
...
d_SnapshotsOf_44 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.d_SnapshotsOf_3852
      (coe v0)
...
d_maxPool_46
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.du_maxPool_3456
...
d_mkApparentPerformance_48
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.du_mkApparentPerformance_3492
...
d_nonZero'45'1'43'max0'45'x_50
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.du_nonZero'45'1'43'max0'45'x_3452
...
d_nonZero'45'max'45'1_54
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.du_nonZero'45'max'45'1_3436
...
d_poolStake_56
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.du_poolStake_3600
      (coe
...
d_reward_58
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.du_reward_3656
      (coe
         MAlonzo.Code.Ledger.Dijkstra.Foreign.ExternalStructures.d_HSTransactionStructure_636
         (coe
            MAlonzo.Code.Ledger.Core.Foreign.ExternalFunctions.d_dummyExternalFunctions_20))
...
d_rewardMember_60
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.du_rewardMember_3530
...
d_rewardOnePool_62
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.du_rewardOnePool_3550
      (coe
         MAlonzo.Code.Ledger.Dijkstra.Foreign.ExternalStructures.d_HSTransactionStructure_636
         (coe
            MAlonzo.Code.Ledger.Core.Foreign.ExternalFunctions.d_dummyExternalFunctions_20))
...
d_rewardOwners_64
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.du_rewardOwners_3510
...
d_stakeDistr_66
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.du_stakeDistr_3790
      (coe
         MAlonzo.Code.Ledger.Dijkstra.Foreign.ExternalStructures.d_HSTransactionStructure_636
         (coe
            MAlonzo.Code.Ledger.Core.Foreign.ExternalFunctions.d_dummyExternalFunctions_20))
...
d_uncurry'7504'_68 v0 v1 v2 v3 v4 v5
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.du_uncurry'7504'_3620
      v3 v4 v5
...
d_rs_82 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.d_rs_3750
      (coe v0)
...
d_Δf_84 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.d_Δf_3748
      (coe v0)
...
d_Δf'45'nonpositive_86 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.d_Δf'45'nonpositive_3758
      (coe v0)
...
d_Δr_88 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.d_Δr_3746
      (coe v0)
...
d_Δt_90 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.d_Δt_3744
      (coe v0)
...
d_Δt'45'nonnegative_92 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.d_Δt'45'nonnegative_3756
      (coe v0)
...
d_Conv'45'Snapshot_114
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.C_constructor_3776 v1 v2 v3
                -> coe
                     C_MkSnapshot_187
                     (coe
...
d_Conv'45'Snapshots_118
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.C_constructor_3838 v1 v2 v3 v4
                -> coe
                     C_MkSnapshots_2907
                     (coe
                        C_MkSnapshot_187
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (\ v5 ->
                                 case coe v5 of
                                   MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.C_constructor_3776 v6 v7 v8
                                     -> coe
                                          C_MkSnapshot_187
                                          (coe
                                             MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.C_MkHSMap_56
