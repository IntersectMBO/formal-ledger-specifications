...
d_HasWithdrawals'45'EnactState_44
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Enact.du_HasWithdrawals'45'EnactState_1332
...
d_HasccMaxTermLength'45'EnactState_46
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Enact.du_HasccMaxTermLength'45'EnactState_1330
...
d_epoch_72 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Enact.T_EnactEnv_1268 ->
  Integer
d_epoch_72 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Enact.d_epoch_1280
      (coe v0)
...
d_gid_74 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Enact.d_gid_1276
      (coe v0)
...
d_treasury_76 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Enact.d_treasury_1278
      (coe v0)
...
d_ENACT'45'deterministic_98 ::
  ...
  MAlonzo.Code.Ledger.Dijkstra.Specification.Enact.T_EnactState_1284 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Enact.T_EnactState_1284 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Enact.T__'8866'_'8640''10631'_'44'ENACT'10632'__1396 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Enact.T__'8866'_'8640''10631'_'44'ENACT'10632'__1396 ->
...
d_Conv'45'EnactEnv_102
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Dijkstra.Specification.Enact.C_constructor_1282 v1 v2 v3
                -> coe
                     C_MkEnactEnv_169
                     (coe
         ...
         (\ v0 ->
            case coe v0 of
              C_MkEnactEnv_169 v1 v2 v3
                -> coe
                     MAlonzo.Code.Ledger.Dijkstra.Specification.Enact.C_constructor_1282
                     (coe
                        MAlonzo.Code.Data.Product.Base.du_map_128
                        (coe
...
d_Conv'45'EnactState_106
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Dijkstra.Specification.Enact.C_constructor_1306 v1 v2 v3 v4 v5
                -> coe
                     C_MkEnactState_1623
                     (coe
                        MAlonzo.Code.Foreign.Haskell.Coerce.d_coerce_44 () erased () erased
...
enactStep ::
  ...
  MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.T_HSComputationResult_110
    MAlonzo.Code.Agda.Builtin.String.T_String_6 T_EnactState_1621
...
d_EnactState_1621 = ()
type T_EnactState_1621 = EnactState
pattern C_MkEnactState_1623 a0 a1 a2 a3 a4 = MkEnactState a0 a1 a2 a3 a4
check_MkEnactState_1623 ::
  MAlonzo.Code.Foreign.Haskell.Pair.T_Pair_22
    () ()
  ...
  MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.T_HSMap_46
    ...
    Integer ->
  T_EnactState_1621
check_MkEnactState_1623 = MkEnactState
cover_EnactState_1621 :: EnactState -> ()
cover_EnactState_1621 x
  = case x of
