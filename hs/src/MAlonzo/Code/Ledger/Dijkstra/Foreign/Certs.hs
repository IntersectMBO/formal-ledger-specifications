...
delegStep = coe d_deleg'45'step_48
d_deleg'45'step_48 ::
  T_DelegEnv_9213 ->
  T_DState_16869 ->
  T_DCert_2851 ->
...
poolStep = coe d_pool'45'step_50
d_pool'45'step_50 ::
  MAlonzo.Code.Ledger.Dijkstra.Foreign.PParams.T_PParams_12421 ->
  T_PState_12551 ->
  T_DCert_2851 ->
...
govCertStep ::
  ...
  T_DCert_2851 ->
  MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.T_HSComputationResult_110
    MAlonzo.Code.Agda.Builtin.String.T_String_6 T_GState_21355
govCertStep = coe d_govcert'45'step_52
d_govcert'45'step_52 ::
  T_GovCertEnv_11143 ->
  T_GState_21355 ->
  T_DCert_2851 ->
  MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.T_HSComputationResult_110
    MAlonzo.Code.Agda.Builtin.String.T_String_6 T_GState_21355
d_govcert'45'step_52 v0
  = coe
      MAlonzo.Code.Class.Convertible.Core.d_to_20
      (coe
         MAlonzo.Code.Class.Convertible.Instances.du_Convertible'45'Fun_34
         (coe d_Conv'45'GState_42)
         (coe
            MAlonzo.Code.Class.Convertible.Instances.du_Convertible'45'Fun_34
            (coe d_Conv'45'DCert_22)
            (coe
