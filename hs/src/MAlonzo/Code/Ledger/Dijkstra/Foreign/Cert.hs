...
certStep ::
  MAlonzo.Code.Ledger.Dijkstra.Foreign.Certs.T_CertEnv_35113 ->
...
d_cert'45'step_14 v0
  = coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.Class.Convertible.Instances.du_Convertible'45'Fun_34
            (coe MAlonzo.Code.Ledger.Dijkstra.Foreign.Certs.d_Conv'45'DCert_26)
            (coe
      ...
      (coe
         ...
         (coe
            ...
            MAlonzo.Code.Ledger.Dijkstra.Foreign.Certs.d_Conv'45'CertEnv_50
            v0))
