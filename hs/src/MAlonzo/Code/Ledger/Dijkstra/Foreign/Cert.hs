...
certStep ::
  MAlonzo.Code.Ledger.Dijkstra.Foreign.Certs.T_CertEnv_27297 ->
...
d_cert'45'step_14 v0
  = coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.Class.Convertible.Instances.du_Convertible'45'Fun_34
            (coe MAlonzo.Code.Ledger.Dijkstra.Foreign.Certs.d_Conv'45'DCert_30)
            (coe
      ...
      (coe
         ...
         (coe
            ...
            MAlonzo.Code.Ledger.Dijkstra.Foreign.Certs.d_Conv'45'CertEnv_54
            v0))
