...
module MAlonzo.Code.Ledger.Dijkstra.Foreign.Script.Base where
...
data HSLanguage = PV1  | PV2  | PV3  | PV4 
  deriving (Show, Eq, Generic)
-- Ledger.Dijkstra.Foreign.Script.Base.HSLanguage
d_HSLanguage_10 = ()
data T_HSLanguage_10 = C_PV1_12 | C_PV2_14 | C_PV3_16 | C_PV4_18
-- Ledger.Dijkstra.Foreign.Script.Base.HSLanguage
d_HSLanguage_15 = ()
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              ...
              C_PV4_23 -> coe C_PV4_18
              _ -> MAlonzo.RTE.mazUnreachableError))
-- Ledger.Dijkstra.Foreign.Script.Base.DecEq-HSLanguage
d_DecEq'45'HSLanguage_24 ::
                ...
                -> coe
                     (\ v1 ->
                        case coe v1 of
                          ...
                          _ -> MAlonzo.RTE.mazUnreachableError)
              _ -> MAlonzo.RTE.mazUnreachableError))
-- Ledger.Dijkstra.Foreign.Script.Base.Show-HSLanguage
d_Show'45'HSLanguage_26 :: MAlonzo.Code.Class.Show.Core.T_Show_10
d_Show'45'HSLanguage_26
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              ...
              C_PV4_18 -> coe ("PV4" :: Data.Text.Text)
              _ -> MAlonzo.RTE.mazUnreachableError))
