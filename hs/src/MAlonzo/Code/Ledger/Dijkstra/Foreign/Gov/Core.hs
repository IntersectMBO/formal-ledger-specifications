...
module MAlonzo.Code.Ledger.Dijkstra.Foreign.Gov.Core where
...
data Vote = Yes  | No  | Abstain 
  deriving (Show, Eq, Generic)
data GovVotes = GovVotes {gvCC :: (MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.HSMap MAlonzo.Code.Ledger.Core.Foreign.Address.Credential MAlonzo.Code.Ledger.Dijkstra.Foreign.Gov.Core.Vote), gvDRep :: (MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.HSMap MAlonzo.Code.Ledger.Core.Foreign.Address.Credential MAlonzo.Code.Ledger.Dijkstra.Foreign.Gov.Core.Vote), gvSPO :: (MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.HSMap Integer MAlonzo.Code.Ledger.Dijkstra.Foreign.Gov.Core.Vote)}
  deriving (Show, Eq, Generic)
type GovVoter = (MAlonzo.Code.Ledger.Dijkstra.Foreign.Gov.Core.GovRole, MAlonzo.Code.Ledger.Core.Foreign.Address.Credential)
data GovVote = MkGovVote {gid :: (Integer, Integer), voter :: (MAlonzo.Code.Ledger.Dijkstra.Foreign.Gov.Core.GovRole, MAlonzo.Code.Ledger.Core.Foreign.Address.Credential), vote :: MAlonzo.Code.Ledger.Dijkstra.Foreign.Gov.Core.Vote, anchor :: (Maybe MAlonzo.Code.Ledger.Dijkstra.Foreign.Gov.Core.Anchor)}
  deriving (Show, Eq, Generic)
-- Ledger.Dijkstra.Foreign.Gov.Core._.Vote
d_Vote_12 = ()
-- Ledger.Dijkstra.Foreign.Gov.Core.GovRole
d_GovRole_17 = ()
...
cover_GovRole_17 x
  = case x of
      ...
      DRep -> ()
      SPO -> ()
-- Ledger.Dijkstra.Foreign.Gov.Core.HsTy-GovRole
d_HsTy'45'GovRole_22 ::
  MAlonzo.Code.Class.HasHsType.Core.T_HasHsType_10
d_HsTy'45'GovRole_22 = erased
-- Ledger.Dijkstra.Foreign.Gov.Core.Conv-GovRole
...
-- Ledger.Dijkstra.Foreign.Gov.Core.Conv-Anchor
d_Conv'45'Anchor_28 ::
  MAlonzo.Code.Class.Convertible.Core.T_Convertible_10
d_Conv'45'Anchor_28
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.C_constructor_930 v1 v2
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              C_Anchor_149 v1 v2
                -> coe
                     MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.C_constructor_930
                     (coe v1) (coe v2)
              _ -> MAlonzo.RTE.mazUnreachableError))
...
-- Ledger.Dijkstra.Foreign.Gov.Core.Conv-VDeleg
d_Conv'45'VDeleg_32 ::
  MAlonzo.Code.Class.Convertible.Core.T_Convertible_10
d_Conv'45'VDeleg_32
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.C_vDelegCredential_970 v1
                -> coe
...
-- Ledger.Dijkstra.Foreign.Gov.Core.Conv-Vote
d_Conv'45'Vote_36 ::
  MAlonzo.Code.Class.Convertible.Core.T_Convertible_10
d_Conv'45'Vote_36
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.C_yes_902
                -> coe C_Yes_1139
              MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.C_no_904
                -> coe C_No_1141
              MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.C_abstain_906
                -> coe C_Abstain_1143
              _ -> MAlonzo.RTE.mazUnreachableError))
      (coe
         (\ v0 ->
...
-- Ledger.Dijkstra.Foreign.Gov.Core.Conv-GovVotes
...
d_Conv'45'GovVotes_40
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.C_constructor_966 v1 v2 v3
                -> coe
                     C_GovVotes_1269
                     (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.d_assocList_54
                              (coe v3))))
              _ -> MAlonzo.RTE.mazUnreachableError))
-- Ledger.Dijkstra.Foreign.Gov.Core.GovVoter'
d_GovVoter''_42 :: ()
d_GovVoter''_42 = erased
-- Ledger.Dijkstra.Foreign.Gov.Core.mkGovVoter'
d_mkGovVoter''_44 ::
  MAlonzo.Code.Class.Convertible.Core.T_Convertible_10
d_mkGovVoter''_44
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.C_'10214'_'44'_'10215''7501''7515'_918 v1 v2
                -> case coe v1 of
                     MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.C_CC_860
                       -> coe
            ...
            case coe v0 of
              MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v1 v2
                -> case coe v1 of
                     MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.C_CC_860
                       -> coe
                            MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.C_'10214'_'44'_'10215''7501''7515'_918
                            (coe v1) (coe v2)
                     MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.C_DRep_862
                       -> coe
                            MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.C_'10214'_'44'_'10215''7501''7515'_918
                     ...
                     _ -> MAlonzo.RTE.mazUnreachableError
              _ -> MAlonzo.RTE.mazUnreachableError))
-- Ledger.Dijkstra.Foreign.Gov.Core.HsTy-GovVoter
d_HsTy'45'GovVoter_62 ::
  MAlonzo.Code.Class.HasHsType.Core.T_HasHsType_10
d_HsTy'45'GovVoter_62 = erased
-- Ledger.Dijkstra.Foreign.Gov.Core.Conv-GovVoter
...
d_gid_76 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Foreign.Gov.Core.GovVote'.voter
d_voter_78 ::
  T_GovVote''_66 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_voter_78 v0
  = case coe v0 of
...
d_vote_80 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Foreign.Gov.Core.GovVote'.anchor
d_anchor_82 ::
  T_GovVote''_66 ->
  Maybe
    MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.T_Anchor_920
d_anchor_82 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Foreign.Gov.Core.mkGovVote'
d_mkGovVote''_86 ::
  MAlonzo.Code.Class.Convertible.Core.T_Convertible_10
d_mkGovVote''_86
  = coe
      ...
      (coe
         (\ v0 ->
            coe
              MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.C_constructor_950
              (coe d_gid_76 (coe v0))
              (coe
                 MAlonzo.Code.Class.Convertible.Core.d_from_22 d_mkGovVoter''_44
                 (d_voter_78 (coe v0)))
              (coe d_vote_80 (coe v0)) (coe d_anchor_82 (coe v0))))
-- Ledger.Dijkstra.Foreign.Gov.Core.v.anchor
d_anchor_106 ::
  T_GovVote''_66 ->
  Maybe
    MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.T_Anchor_920
...
-- Ledger.Dijkstra.Foreign.Gov.Core.HsTy-GovVote'
d_HsTy'45'GovVote''_114 ::
  MAlonzo.Code.Class.HasHsType.Core.T_HasHsType_10
d_HsTy'45'GovVote''_114 = erased
-- Ledger.Dijkstra.Foreign.Gov.Core.Conv-GovVote'
...
-- Ledger.Dijkstra.Foreign.Gov.Core.Anchor
d_Anchor_147 = ()
...
cover_Anchor_147 x
  = case x of
      Anchor _ _ -> ()
-- Ledger.Dijkstra.Foreign.Gov.Core.VDeleg
d_VDeleg_731 = ()
