...
d_HSTransactionStructure_648 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.C_constructor_4696
...
d_poolOwners_3520 ::
  ...
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1308 ->
  [Integer]
d_poolOwners_3520 ~v0 = du_poolOwners_3520
du_poolOwners_3520 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1308 ->
  [Integer]
du_poolOwners_3520
...
d_indexOfImp_3738 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3166 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_indexOf_3134
...
d_HSAbstractFunctions_3764 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.C_constructor_3192
      (coe (\ v1 v2 -> 0 :: Integer)) (coe (\ v1 -> 0 :: Integer))
      (coe (\ v1 v2 -> coe MAlonzo.Code.Agda.Builtin.Unit.C_tt_8))
      (coe
         MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.C_constructor_3164
         (coe
            (\ v1 v2 ->
               coe
