...
d_ScriptPurposeData_3102 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tag_40 ->
  ()
d_ScriptPurposeData_3102 = erased
-- Ledger.Dijkstra.Specification.Script.ScriptPurpose.ScriptPurpose
d_ScriptPurpose_3104 a0 = ()
data T_ScriptPurpose_3104
  = C_'10214'_'44'_'10215''738''7510'_3114 MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tag_40
                                           AgdaAny
-- Ledger.Dijkstra.Specification.Script.ScriptPurpose.ScriptPurpose.tag
d_tag_3110 ::
  T_ScriptPurpose_3104 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tag_40
d_tag_3110 v0
  = case coe v0 of
      C_'10214'_'44'_'10215''738''7510'_3114 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Script.ScriptPurpose.ScriptPurpose.data′
d_data'8242'_3112 :: T_ScriptPurpose_3104 -> AgdaAny
d_data'8242'_3112 v0
  = case coe v0 of
      C_'10214'_'44'_'10215''738''7510'_3114 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Script.ScriptPurpose.TxInfo
d_TxInfo_3116 a0 = ()
data T_TxInfo_3116
  = C_constructor_3176 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       ...
                       [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
                       [AgdaAny] AgdaAny (Maybe [T_TxInfo_3116])
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_SubTxInfo_3118 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  ()
d_SubTxInfo_3118 = erased
-- Ledger.Dijkstra.Specification.Script.ScriptPurpose.TxInfo.realizedInputs
d_realizedInputs_3148 ::
  T_TxInfo_3116 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_realizedInputs_3148 v0
  = case coe v0 of
      C_constructor_3176 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_txFee_3152 :: T_TxInfo_3116 -> Maybe Integer
d_txFee_3152 v0
  = case coe v0 of
      C_constructor_3176 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v3
...
d_mint_3154 :: T_TxInfo_3116 -> AgdaAny
d_mint_3154 v0
  = case coe v0 of
      C_constructor_3176 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v4
...
d_txWithdrawals_3158 ::
  T_TxInfo_3116 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_txWithdrawals_3158 v0
  = case coe v0 of
      C_constructor_3176 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_vkKey_3162 :: T_TxInfo_3116 -> [AgdaAny]
d_vkKey_3162 v0
  = case coe v0 of
      C_constructor_3176 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v8
...
d_txData_3166 :: T_TxInfo_3116 -> [AgdaAny]
d_txData_3166 v0
  = case coe v0 of
      C_constructor_3176 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v10
...
d_txId_3168 :: T_TxInfo_3116 -> AgdaAny
d_txId_3168 v0
  = case coe v0 of
      C_constructor_3176 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v11
...
d_txInfoSubTxs_3170 :: T_TxInfo_3116 -> Maybe [T_TxInfo_3116]
d_txInfoSubTxs_3170 v0
  = case coe v0 of
      C_constructor_3176 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v12
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_txBalanceIntervals_3174 ::
  T_TxInfo_3116 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_txBalanceIntervals_3174 v0
  = case coe v0 of
      C_constructor_3176 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v14
      _ -> MAlonzo.RTE.mazUnreachableError
