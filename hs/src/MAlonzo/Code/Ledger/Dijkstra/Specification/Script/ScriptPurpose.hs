...
d_ScriptPurposeData_3162 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tag_40 ->
  ()
d_ScriptPurposeData_3162 = erased
-- Ledger.Dijkstra.Specification.Script.ScriptPurpose.ScriptPurpose
d_ScriptPurpose_3164 a0 = ()
data T_ScriptPurpose_3164
  = C_'10214'_'44'_'10215''738''7510'_3174 MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tag_40
                                           AgdaAny
-- Ledger.Dijkstra.Specification.Script.ScriptPurpose.ScriptPurpose.tag
d_tag_3170 ::
  T_ScriptPurpose_3164 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tag_40
d_tag_3170 v0
  = case coe v0 of
      C_'10214'_'44'_'10215''738''7510'_3174 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Script.ScriptPurpose.ScriptPurpose.data′
d_data'8242'_3172 :: T_ScriptPurpose_3164 -> AgdaAny
d_data'8242'_3172 v0
  = case coe v0 of
      C_'10214'_'44'_'10215''738''7510'_3174 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Script.ScriptPurpose.TxInfo
d_TxInfo_3176 a0 = ()
data T_TxInfo_3176
  = C_constructor_3236 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       ...
                       [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
                       [AgdaAny] AgdaAny (Maybe [T_TxInfo_3176])
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_SubTxInfo_3178 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  ()
d_SubTxInfo_3178 = erased
-- Ledger.Dijkstra.Specification.Script.ScriptPurpose.TxInfo.realizedInputs
d_realizedInputs_3208 ::
  T_TxInfo_3176 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_realizedInputs_3208 v0
  = case coe v0 of
      C_constructor_3236 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_txFee_3212 :: T_TxInfo_3176 -> Maybe Integer
d_txFee_3212 v0
  = case coe v0 of
      C_constructor_3236 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v3
...
d_mint_3214 :: T_TxInfo_3176 -> AgdaAny
d_mint_3214 v0
  = case coe v0 of
      C_constructor_3236 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v4
...
d_vkKey_3222 :: T_TxInfo_3176 -> [AgdaAny]
d_vkKey_3222 v0
  = case coe v0 of
      C_constructor_3236 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v8
...
d_txData_3226 :: T_TxInfo_3176 -> [AgdaAny]
d_txData_3226 v0
  = case coe v0 of
      C_constructor_3236 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v10
...
d_txId_3228 :: T_TxInfo_3176 -> AgdaAny
d_txId_3228 v0
  = case coe v0 of
      C_constructor_3236 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v11
...
d_txInfoSubTxs_3230 :: T_TxInfo_3176 -> Maybe [T_TxInfo_3176]
...
d_txDirectDeposits_3232 ::
  T_TxInfo_3176 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_txDirectDeposits_3232 v0
  = case coe v0 of
      C_constructor_3236 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v13
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Script.ScriptPurpose.TxInfo.txBalanceIntervals
d_txBalanceIntervals_3234 ::
  T_TxInfo_3176 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_txBalanceIntervals_3234 v0
  = case coe v0 of
      C_constructor_3236 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v14
      _ -> MAlonzo.RTE.mazUnreachableError
