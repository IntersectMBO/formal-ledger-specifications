...
d_ScriptPurposeData_2970 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tag_40 ->
  ()
d_ScriptPurposeData_2970 = erased
-- Ledger.Dijkstra.Specification.Script.ScriptPurpose.ScriptPurpose
d_ScriptPurpose_2972 a0 = ()
data T_ScriptPurpose_2972
  = C_'10214'_'44'_'10215''738''7510'_2982 MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tag_40
                                           AgdaAny
-- Ledger.Dijkstra.Specification.Script.ScriptPurpose.ScriptPurpose.tag
d_tag_2978 ::
  T_ScriptPurpose_2972 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tag_40
d_tag_2978 v0
  = case coe v0 of
      C_'10214'_'44'_'10215''738''7510'_2982 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Script.ScriptPurpose.ScriptPurpose.data′
d_data'8242'_2980 :: T_ScriptPurpose_2972 -> AgdaAny
d_data'8242'_2980 v0
  = case coe v0 of
      C_'10214'_'44'_'10215''738''7510'_2982 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Script.ScriptPurpose.TxInfo
d_TxInfo_2984 a0 = ()
data T_TxInfo_2984
  = C_constructor_3044 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       ...
                       [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
                       [AgdaAny] AgdaAny (Maybe [T_TxInfo_2984])
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_SubTxInfo_2986 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  ()
d_SubTxInfo_2986 = erased
-- Ledger.Dijkstra.Specification.Script.ScriptPurpose.TxInfo.realizedInputs
d_realizedInputs_3016 ::
  T_TxInfo_2984 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_realizedInputs_3016 v0
  = case coe v0 of
      C_constructor_3044 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_txFee_3020 :: T_TxInfo_2984 -> Maybe Integer
d_txFee_3020 v0
  = case coe v0 of
      C_constructor_3044 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v3
...
d_mint_3022 :: T_TxInfo_2984 -> AgdaAny
d_mint_3022 v0
  = case coe v0 of
      C_constructor_3044 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v4
...
d_vkKey_3030 :: T_TxInfo_2984 -> [AgdaAny]
d_vkKey_3030 v0
  = case coe v0 of
      C_constructor_3044 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v8
...
d_txData_3034 :: T_TxInfo_2984 -> [AgdaAny]
d_txData_3034 v0
  = case coe v0 of
      C_constructor_3044 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v10
...
d_txId_3036 :: T_TxInfo_2984 -> AgdaAny
d_txId_3036 v0
  = case coe v0 of
      C_constructor_3044 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v11
...
d_txInfoSubTxs_3038 :: T_TxInfo_2984 -> Maybe [T_TxInfo_2984]
d_txInfoSubTxs_3038 v0
  = case coe v0 of
      C_constructor_3044 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v12
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Script.ScriptPurpose.TxInfo.txDirectDeposits
d_txDirectDeposits_3040 ::
  T_TxInfo_2984 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_txDirectDeposits_3040 v0
  = case coe v0 of
      C_constructor_3044 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14
        -> coe v13
      _ -> MAlonzo.RTE.mazUnreachableError
