                                    ...
                                    MAlonzo.Code.Relation.Nullary.Decidable.Core.C__because__32 v8 v9
                                      -> if coe v8
                                           then let v10
                                                      = coe
                                                          MAlonzo.Code.Class.DecEq.Core.d__'8799'__16
                                                          (MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.d_DecEq'45'DocHash_694
                                                             (coe v0))
                                                          v3 v6 in
                                                coe
                                                  (case coe v10 of
      ...
      C_ChangePParams_922
        -> coe
             ...
             (coe
                ...
                (coe
                   MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.d_govParams_1362
                   (coe v0)))
      C_TreasuryWithdrawal_924
        -> coe
             (\ v2 v3 ->
         ...
         C_NoConfidence_914
           -> coe
                ...
                (coe
                   ...
                   (MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.d_DecEq'45'TxId_692
                      (coe v0))
                   (coe
                      MAlonzo.Code.Class.DecEq.Core.C_constructor_32
