...
d_Epoch_158 = erased
-- _.HasRewardAddress
d_HasRewardAddress_212 a0 a1 a2 a3 a4 a5 = ()
-- _.THash
d_THash_238 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.T_GovStructure_10 ->
  ()
...
-- _.RewardAddressOf
d_RewardAddressOf_316 ::
  MAlonzo.Code.Ledger.Core.Specification.Address.T_HasRewardAddress_134 ->
  AgdaAny ->
  MAlonzo.Code.Ledger.Core.Specification.Address.T_RewardAddress_116
d_RewardAddressOf_316 v0
  = coe
      ...
      C_ChangePParams_904
        -> coe
             ...
             (coe
                ...
                (coe
                   MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.d_govParams_1326
                   (coe v0)))
      C_TreasuryWithdrawal_906
        -> coe
             (\ v2 v3 ->
         ...
         C_NoConfidence_896
           -> coe
                ...
                (coe
                   ...
                   (MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.d_DecEq'45'TxId_674
                      (coe v0))
                   (coe
                      MAlonzo.Code.Class.DecEq.Core.C_constructor_32
