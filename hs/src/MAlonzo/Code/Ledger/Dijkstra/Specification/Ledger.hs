...
du_HasCast'45'GovEnv_2774
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.du_HasCast'45'GovEnv_2170
...
du_HasGState'45'LedgerState_3962
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.C_constructor_1854
      (coe
         (\ v0 ->
            coe
              MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.d_GStateOf_1852
...
du_HasCCHotKeys'45'LedgerState_3974
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.C_constructor_1654
      (coe
         (\ v0 ->
            coe
              MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.d_CCHotKeysOf_1652
