...
d_BlsVKey_46 = erased
-- _.Dec-<ᵏʰ
d_Dec'45''60''7503''688'_68 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.T_GovStructure_10 ->
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Class.Decidable.Core.T__'8263'_10
d_Dec'45''60''7503''688'_68 v0
  = coe
...
d_isSignedByAggregate_482 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.T_GovStructure_10 ->
  [AgdaAny] -> AgdaAny -> AgdaAny -> ()
d_isSignedByAggregate_482 = erased
-- _.PParams.Emax
d_Emax_686 ::
...
d_fromNat_1456 ::
  ...
  MAlonzo.Code.Data.Rational.Base.T_ℚ_6
d_fromNat_1456 ~v0 v1 ~v2 = du_fromNat_1456 v1
du_fromNat_1456 :: Integer -> MAlonzo.Code.Data.Rational.Base.T_ℚ_6
du_fromNat_1456 v0
  = coe MAlonzo.Code.Data.Rational.Literals.d_fromℤ_6 (coe v0)
-- Ledger.Dijkstra.Specification.Leios.LeiosSeat
d_LeiosSeat_1458 a0 = ()
data T_LeiosSeat_1458
  = C_constructor_1472 AgdaAny Integer (Maybe AgdaAny)
-- Ledger.Dijkstra.Specification.Leios.LeiosSeat.pool
d_pool_1466 :: T_LeiosSeat_1458 -> AgdaAny
d_pool_1466 v0
  = case coe v0 of
      C_constructor_1472 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Leios.LeiosSeat.weight
d_weight_1468 :: T_LeiosSeat_1458 -> Integer
d_weight_1468 v0
  = case coe v0 of
      C_constructor_1472 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Leios.LeiosSeat.key
d_key_1470 :: T_LeiosSeat_1458 -> Maybe AgdaAny
d_key_1470 v0
  = case coe v0 of
      C_constructor_1472 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Leios.LeiosCommittee
d_LeiosCommittee_1474 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.T_GovStructure_10 ->
  ()
d_LeiosCommittee_1474 = erased
-- Ledger.Dijkstra.Specification.Leios.HasCast-LeiosSeat
d_HasCast'45'LeiosSeat_1476 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'LeiosSeat_1476 ~v0 = du_HasCast'45'LeiosSeat_1476
du_HasCast'45'LeiosSeat_1476 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'LeiosSeat_1476
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (1458 :: Integer) (7543865900978448762 :: Integer)
                                 "Ledger.Dijkstra.Specification.Leios.LeiosSeat"
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (244 :: Integer) (7543865900978448762 :: Integer) "_.THash"
                                 (MAlonzo.RTE.Fixity MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                           (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
               (coe
                  MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
...
d_honouredBlsKey_1478 ::
  ...
  Maybe
    MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_BlsKeyState_1382 ->
  Maybe AgdaAny
d_honouredBlsKey_1478 v0 v1 v2 v3
  = case coe v3 of
...
d_selectCommittee_1512 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_selectCommittee_1512 v0 v1 v2 v3 v4
  = coe
      ...
      (coe
         ...
         (\ v5 ->
            coe
              ...
              (coe d_seatIndex_1506 (coe v0) (coe v3) (coe v5))
              (coe du_mkSeat_1532 (coe v0) (coe v2) (coe v4) (coe v5)))
         (coe
            MAlonzo.Code.QabstractZ45ZsetZ45Ztheory.FiniteSetTheory.du_filter'738'_1266
            (\ v5 ->
               coe
...
d_nc_1530 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Integer
d_nc_1530 ~v0 v1 ~v2 ~v3 ~v4 = du_nc_1530 v1
du_nc_1530 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.PParams.T_PParams_312 ->
  Integer
du_nc_1530 v0
...
d_mkSeat_1532 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> T_LeiosSeat_1458
d_mkSeat_1532 v0 ~v1 v2 ~v3 v4 v5 = du_mkSeat_1532 v0 v2 v4 v5
du_mkSeat_1532 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.T_GovStructure_10 ->
  AgdaAny ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> T_LeiosSeat_1458
du_mkSeat_1532 v0 v1 v2 v3
  = case coe v3 of
                            ...
                            (coe
                               ...
                               (coe
                                  ...
                                  (coe
                                     ...
                                     (coe
                                        (MAlonzo.RTE.QName
                                           (244 :: Integer) (7543865900978448762 :: Integer)
                                           "_.THash"
                                           (MAlonzo.RTE.Fixity
                                              MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                     (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
...
d_LeiosCert_1542 a0 = ()
data T_LeiosCert_1542 = C_constructor_1552 [Integer] AgdaAny
-- Ledger.Dijkstra.Specification.Leios.LeiosCert.signers
d_signers_1548 :: T_LeiosCert_1542 -> [Integer]
d_signers_1548 v0
  = case coe v0 of
      C_constructor_1552 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Leios.LeiosCert.sig
d_sig_1550 :: T_LeiosCert_1542 -> AgdaAny
d_sig_1550 v0
  = case coe v0 of
      C_constructor_1552 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Leios.HasCast-LeiosCert
d_HasCast'45'LeiosCert_1554 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'LeiosCert_1554 ~v0 = du_HasCast'45'LeiosCert_1554
du_HasCast'45'LeiosCert_1554 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'LeiosCert_1554
  = coe
      MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.C_constructor_30
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (1542 :: Integer) (7543865900978448762 :: Integer)
                                 "Ledger.Dijkstra.Specification.Leios.LeiosCert"
                                 (MAlonzo.RTE.Fixity MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                           (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))
                     (coe
...
d_keyedSeats_1556 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_keyedSeats_1556 ~v0 = du_keyedSeats_1556
du_keyedSeats_1556 ::
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_keyedSeats_1556
  = coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.QabstractZ45ZsetZ45Ztheory.FiniteSetTheory.d_List'45'Model'7496'_8))
      (coe (\ v0 v1 -> d_key_1470 (coe v1)))
-- Ledger.Dijkstra.Specification.Leios.signedStake
d_signedStake_1562 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> [Integer] -> Integer
d_signedStake_1562 ~v0 v1 v2 = du_signedStake_1562 v1 v2
du_signedStake_1562 ::
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> [Integer] -> Integer
du_signedStake_1562 v0 v1
  = coe
...
d_totalActiveStake_1570 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Integer
d_totalActiveStake_1570 v0 v1
  = coe
      MAlonzo.Code.QabstractZ45ZsetZ45Ztheory.FiniteSetTheory.du_indexedSum'7515'''_1446
      (coe
         MAlonzo.Code.Ledger.Core.Specification.Crypto.d_DecEq'45'THash_26
...
d_ValidLeiosCert_1586 a0 a1 a2 a3 a4 a5 = ()
data T_ValidLeiosCert_1586
  = C_constructor_1610 (Integer ->
...
d_signersKeyed_1604 ::
  T_ValidLeiosCert_1586 ->
  Integer ->
  MAlonzo.Code.Data.List.Relation.Unary.Any.T_Any_34 ->
  MAlonzo.Code.Data.List.Relation.Unary.Any.T_Any_34
d_signersKeyed_1604 v0
  = case coe v0 of
      C_constructor_1610 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Leios.ValidLeiosCert.validSignature
d_validSignature_1606 :: T_ValidLeiosCert_1586 -> AgdaAny
d_validSignature_1606 v0
  = case coe v0 of
      C_constructor_1610 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_quorum_1608 v0
  = case coe v0 of
      C_constructor_1610 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
