...
d_govSt_4496 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3056 ->
  T_GeneralizeTel_95075 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
...
du_govSt_4496 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.d_govSt_3696
      (coe d_'46'generalizedField'45'ls_95059 (coe v0))
-- Ledger.Dijkstra.Specification.Epoch._.utxoSt
d_utxoSt_4498 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3056 ->
  T_GeneralizeTel_95075 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Utxo.T_UTxOState_3106
...
du_es_4504 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Ratify.d_es_1950
      (coe d_'46'generalizedField'45'fut_95061 (coe v0))
...
d_'46'generalizedField'45'ls_95059 ::
  T_GeneralizeTel_95075 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.T_LedgerState_3686
d_'46'generalizedField'45'ls_95059 v0
  = case coe v0 of
      C_mkGeneralizeTel_95077 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Epoch..generalizedField-fut
d_'46'generalizedField'45'fut_95061 ::
  T_GeneralizeTel_95075 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Ratify.T_RatifyState_1942
d_'46'generalizedField'45'fut_95061 v0
  = case coe v0 of
      C_mkGeneralizeTel_95077 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Epoch..generalizedField-e
d_'46'generalizedField'45'e_95063 ::
  T_GeneralizeTel_95075 -> AgdaAny
d_'46'generalizedField'45'e_95063 v0
  = case coe v0 of
      C_mkGeneralizeTel_95077 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Epoch..generalizedField-acnt
d_'46'generalizedField'45'acnt_95065 ::
  T_GeneralizeTel_95075 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.PParams.T_Acnt_194
d_'46'generalizedField'45'acnt_95065 v0
  = case coe v0 of
      C_mkGeneralizeTel_95077 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Epoch..generalizedField-ss'
d_'46'generalizedField'45'ss''_95067 ::
  T_GeneralizeTel_95075 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.T_Snapshots_3794
d_'46'generalizedField'45'ss''_95067 v0
  = case coe v0 of
      C_mkGeneralizeTel_95077 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Epoch..generalizedField-fut'
d_'46'generalizedField'45'fut''_95069 ::
  T_GeneralizeTel_95075 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Ratify.T_RatifyState_1942
d_'46'generalizedField'45'fut''_95069 v0
  = case coe v0 of
      C_mkGeneralizeTel_95077 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Epoch..generalizedField-ss
d_'46'generalizedField'45'ss_95071 ::
  T_GeneralizeTel_95075 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.T_Snapshots_3794
d_'46'generalizedField'45'ss_95071 v0
  = case coe v0 of
      C_mkGeneralizeTel_95077 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Epoch..generalizedField-es₀
d_'46'generalizedField'45'es'8320'_95073 ::
  T_GeneralizeTel_95075 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Enact.T_EnactState_1228
d_'46'generalizedField'45'es'8320'_95073 v0
  = case coe v0 of
      C_mkGeneralizeTel_95077 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Epoch.GeneralizeTel
d_GeneralizeTel_95075 a0 a1 = ()
data T_GeneralizeTel_95075
  = C_mkGeneralizeTel_95077 MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.T_LedgerState_3686
                            MAlonzo.Code.Ledger.Dijkstra.Specification.Ratify.T_RatifyState_1942
                            AgdaAny
                            MAlonzo.Code.Ledger.Dijkstra.Specification.PParams.T_Acnt_194
                            MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.T_Snapshots_3794
