...
d_HasCast'45'LedgerState_3252 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3060 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'LedgerState_3252 ~v0 ~v1
  = du_HasCast'45'LedgerState_3252
du_HasCast'45'LedgerState_3252 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'LedgerState_3252
  = coe
...
d_govSt_4496 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3060 ->
  T_GeneralizeTel_95123 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
...
du_govSt_4496 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.d_govSt_3708
      (coe d_'46'generalizedField'45'ls_95107 (coe v0))
-- Ledger.Dijkstra.Specification.Epoch._.utxoSt
d_utxoSt_4498 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3060 ->
  T_GeneralizeTel_95123 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Utxo.T_UTxOState_3110
...
du_es_4504 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Ratify.d_es_1954
      (coe d_'46'generalizedField'45'fut_95109 (coe v0))
...
d_'46'generalizedField'45'ls_95107 ::
  T_GeneralizeTel_95123 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.T_LedgerState_3698
d_'46'generalizedField'45'ls_95107 v0
  = case coe v0 of
      C_mkGeneralizeTel_95125 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Epoch..generalizedField-fut
d_'46'generalizedField'45'fut_95109 ::
  T_GeneralizeTel_95123 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Ratify.T_RatifyState_1946
d_'46'generalizedField'45'fut_95109 v0
  = case coe v0 of
      C_mkGeneralizeTel_95125 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Epoch..generalizedField-e
d_'46'generalizedField'45'e_95111 ::
  T_GeneralizeTel_95123 -> AgdaAny
d_'46'generalizedField'45'e_95111 v0
  = case coe v0 of
      C_mkGeneralizeTel_95125 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Epoch..generalizedField-acnt
d_'46'generalizedField'45'acnt_95113 ::
  T_GeneralizeTel_95123 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.PParams.T_Acnt_194
d_'46'generalizedField'45'acnt_95113 v0
  = case coe v0 of
      C_mkGeneralizeTel_95125 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Epoch..generalizedField-ss'
d_'46'generalizedField'45'ss''_95115 ::
  T_GeneralizeTel_95123 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.T_Snapshots_3804
d_'46'generalizedField'45'ss''_95115 v0
  = case coe v0 of
      C_mkGeneralizeTel_95125 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Epoch..generalizedField-fut'
d_'46'generalizedField'45'fut''_95117 ::
  T_GeneralizeTel_95123 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Ratify.T_RatifyState_1946
d_'46'generalizedField'45'fut''_95117 v0
  = case coe v0 of
      C_mkGeneralizeTel_95125 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Epoch..generalizedField-ss
d_'46'generalizedField'45'ss_95119 ::
  T_GeneralizeTel_95123 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.T_Snapshots_3804
d_'46'generalizedField'45'ss_95119 v0
  = case coe v0 of
      C_mkGeneralizeTel_95125 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Epoch..generalizedField-es₀
d_'46'generalizedField'45'es'8320'_95121 ::
  T_GeneralizeTel_95123 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Enact.T_EnactState_1228
d_'46'generalizedField'45'es'8320'_95121 v0
  = case coe v0 of
      C_mkGeneralizeTel_95125 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Epoch.GeneralizeTel
d_GeneralizeTel_95123 a0 a1 = ()
data T_GeneralizeTel_95123
  = C_mkGeneralizeTel_95125 MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.T_LedgerState_3698
                            MAlonzo.Code.Ledger.Dijkstra.Specification.Ratify.T_RatifyState_1946
                            AgdaAny
                            MAlonzo.Code.Ledger.Dijkstra.Specification.PParams.T_Acnt_194
                            MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.T_Snapshots_3804
