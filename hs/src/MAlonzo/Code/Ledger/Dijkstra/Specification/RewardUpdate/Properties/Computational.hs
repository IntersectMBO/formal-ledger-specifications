...
d_Computational'45'RUPD_2910 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3098 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'RUPD_2910 v0 ~v1
  = du_Computational'45'RUPD_2910 v0
du_Computational'45'RUPD_2910 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
du_Computational'45'RUPD_2910 v0
  = coe
                  ...
                  (\ v4 ->
                     coe
                       ...
                       (coe
                          ...
                          (coe
                             MAlonzo.Code.Ledger.Dijkstra.Specification.RewardUpdate.C_RUPD'45'Reward'45'Update'45'Exists_2964)))
                                 ...
                                 then case coe v6 of
                                                     ...
                                                     (coe
                                                        ...
                                                        (coe
                                                           ...
                                                           (coe
                                                              ...
                                                              (coe v0)))))
                                                  (coe
                                                     MAlonzo.Code.Ledger.Dijkstra.Specification.RewardUpdate.C_RUPD'45'Create'45'Reward'45'Update_2954
                                                     v7))
                                        ...
                                        (coe
                                           ...
                                           (coe
                                              MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 (coe v2)
                                              (coe
                                                 MAlonzo.Code.Ledger.Dijkstra.Specification.RewardUpdate.C_RUPD'45'Reward'45'Too'45'Early_2972)))
                          _ -> MAlonzo.RTE.mazUnreachableError))
           _ -> MAlonzo.RTE.mazUnreachableError)
-- Ledger.Dijkstra.Specification.RewardUpdate.Properties.Computational.Computational-TICK
d_Computational'45'TICK_2990 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3098 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'TICK_2990 v0 ~v1
  = du_Computational'45'TICK_2990 v0
du_Computational'45'TICK_2990 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
du_Computational'45'TICK_2990 v0
  = coe
           ...
           (case coe v4 of
              MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v5 v6
                -> coe
                     ...
                     (coe
                        MAlonzo.Code.Interface.ComputationalRelation.d_computeProof_272
                        (coe du_Computational'45'RUPD_2910 (coe v0))
                        (coe
                           MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                           (coe
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          ...
                                          (coe v5)))
                                    (coe
                                       MAlonzo.Code.Ledger.Dijkstra.Specification.RewardUpdate.C_TICK_2984
                                       v5
                                       (coe
