...
d__'8866'_'8640''10631'_'44'SNAP'10632'__2762 a0 a1 a2 a3 a4 a5
  = ()
-- Ledger.Dijkstra.Specification.Rewards.Properties.Computational._.Snapshots
d_Snapshots_2792 a0 a1 = ()
            ...
            (coe
               ...
               (coe
                  ...
                  (coe
                     ...
                     v1)))))
      (coe
         MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.C_SNAP_3910)
