...
d__'8866'_'8640''10631'_'44'SNAP'10632'__2780 a0 a1 a2 a3 a4 a5
  = ()
-- Ledger.Dijkstra.Specification.Rewards.Properties.Computational._.Snapshots
d_Snapshots_2810 a0 a1 = ()
...
d_SNAP'45'deterministic'45''8801'_2932 ::
  ...
  MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.T__'8866'_'8640''10631'_'44'SNAP'10632'__3932 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_SNAP'45'deterministic'45''8801'_2932 = erased
  ...
  = coe
      ...
      (\ v1 v2 v3 ->
         coe
           ...
           (coe du_SNAP'45'total_2916 (coe v0) (coe v2) (coe v1)))
