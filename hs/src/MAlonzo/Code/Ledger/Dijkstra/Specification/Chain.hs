...
d_HasEnactState'45'EpochState_3192 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3088 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Enact.T_HasEnactState_1256
d_HasEnactState'45'EpochState_3192 ~v0 ~v1
  = du_HasEnactState'45'EpochState_3192
du_HasEnactState'45'EpochState_3192 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Enact.T_HasEnactState_1256
du_HasEnactState'45'EpochState_3192
  = coe
...
d_HasEpochState_3196 a0 a1 a2 a3 = ()
-- Ledger.Dijkstra.Specification.Chain._.HasEpochState-NewEpochState
d_HasEpochState'45'NewEpochState_3200 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3088 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Epoch.T_HasEpochState_4046
d_HasEpochState'45'NewEpochState_3200 ~v0 ~v1
  = du_HasEpochState'45'NewEpochState_3200
du_HasEpochState'45'NewEpochState_3200 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Epoch.T_HasEpochState_4046
du_HasEpochState'45'NewEpochState_3200
  = coe
...
d_HasLastEpoch_3206 a0 a1 a2 a3 = ()
...
d_HasLedgerState'45'EpochState_3212 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3088 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.T_HasLedgerState_3718
d_HasLedgerState'45'EpochState_3212 ~v0 ~v1
  = du_HasLedgerState'45'EpochState_3212
du_HasLedgerState'45'EpochState_3212 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.T_HasLedgerState_3718
du_HasLedgerState'45'EpochState_3212
  = coe
...
d_HasCertState'45'LedgerState_3514 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3088 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_HasCertState_1650
d_HasCertState'45'LedgerState_3514 ~v0 ~v1
  = du_HasCertState'45'LedgerState_3514
du_HasCertState'45'LedgerState_3514 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_HasCertState_1650
du_HasCertState'45'LedgerState_3514
  = coe
...
d_HasLedgerState_3534 a0 a1 a2 a3 = ()
-- Ledger.Dijkstra.Specification.Chain._.HasUTxO-LedgerState
d_HasUTxO'45'LedgerState_3548 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3088 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_HasUTxO_3634
d_HasUTxO'45'LedgerState_3548 ~v0 ~v1
  = du_HasUTxO'45'LedgerState_3548
du_HasUTxO'45'LedgerState_3548 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_HasUTxO_3634
du_HasUTxO'45'LedgerState_3548
  = coe
...
d_HasUTxOState'45'LedgerState_3552 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3088 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Utxo.T_HasUTxOState_3146
d_HasUTxOState'45'LedgerState_3552 ~v0 ~v1
  = du_HasUTxOState'45'LedgerState_3552
du_HasUTxOState'45'LedgerState_3552 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Utxo.T_HasUTxOState_3146
du_HasUTxOState'45'LedgerState_3552
  = coe
...
d_LedgerStateOf_3600 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.T_HasLedgerState_3718 ->
  AgdaAny ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.T_LedgerState_3698
d_LedgerStateOf_3600 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.d_LedgerStateOf_3726
      (coe v0)
...
d__'8866'_'8640''10631'_'44'TICK'10632'__3828 a0 a1 a2 a3 a4 a5
  = ()
...
du_HasLedgerState'45'ChainState_4120
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.C_constructor_3728
      (coe
         (\ v0 ->
            coe
              MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.d_LedgerStateOf_3726
...
d_'46'generalizedField'45'ls''_22765 ::
  T_GeneralizeTel_22767 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.T_LedgerState_3698
d_'46'generalizedField'45'ls''_22765 v0
  = case coe v0 of
      C_mkGeneralizeTel_22769 v1 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Chain.GeneralizeTel
d_GeneralizeTel_22767 a0 a1 = ()
newtype T_GeneralizeTel_22767
  = C_mkGeneralizeTel_22769 MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.T_LedgerState_3698
