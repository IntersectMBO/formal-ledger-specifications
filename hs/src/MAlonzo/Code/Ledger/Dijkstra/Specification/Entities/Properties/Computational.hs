...
d_HasRewards'45'CertState_550 ~v0 = du_HasRewards'45'CertState_550
du_HasRewards'45'CertState_550 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_HasRewards_1552
du_HasRewards'45'CertState_550
  = coe
...
d_pp_854 v0
  = coe
      ...
      (coe v0)
-- Ledger.Dijkstra.Specification.Entities.Properties.Computational._.EntitiesEnv.votes
d_votes_856 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.T_EntitiesEnv_1692 ->
...
d_votes_856 v0
  = coe
      ...
      (coe v0)
-- Ledger.Dijkstra.Specification.Entities.Properties.Computational._.EntitiesEnv.withdrawals
d_withdrawals_858 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.T_EntitiesEnv_1692 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_withdrawals_858 v0
  = coe
...
d_DecEq'45'Credential_1094 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'Credential_1094 ~v0 ~v1 v2 v3
  = du_DecEq'45'Credential_1094 v2 v3
du_DecEq'45'Credential_1094 ::
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
du_DecEq'45'Credential_1094 v0 v1
  = coe
...
d_failure'8658''8704''172'STS_1874 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertEnv_1326 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1398 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1288] ->
...
d_failure'8658''8704''172'STS_1874 = erased
-- Ledger.Dijkstra.Specification.Entities.Properties.Computational.Computational-CERTS.failure⇔∀¬STS
d_failure'8660''8704''172'STS_1876 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertEnv_1326 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1398 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1288] ->
  MAlonzo.Code.Function.Bundles.T_Equivalence_1858
d_failure'8660''8704''172'STS_1876 v0
  = coe
...
d_recomputeProof_1878 ::
  ...
  MAlonzo.Code.Interface.STS.T__'8866'_'8640''10214'_'10215''42'__80 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_recomputeProof_1878 v0 v1 v2 v3 v4 v5
  = coe
...
d_'8704''172'STS'8658'failure_1880 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertEnv_1326 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1398 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1288] ->
  (MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1398 ->
   ...
   MAlonzo.Code.Data.Irrelevant.T_Irrelevant_20) ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_'8704''172'STS'8658'failure_1880 v0 v1 v2 v3 v4
  = coe
...
d_'8801''45'success'8660'STS_1882 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertEnv_1326 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1398 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1288] ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1398 ->
  MAlonzo.Code.Function.Bundles.T_Equivalence_1858
d_'8801''45'success'8660'STS_1882 v0
  = coe
...
d_Computational'45'ENTITIES_1884 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'ENTITIES_1884 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (d_computeProof_1926 (coe v0))
...
d_s'8321'_1924 ::
  ...
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1288] ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1398
d_s'8321'_1924 v0 v1 v2 ~v3 = du_s'8321'_1924 v0 v1 v2
du_s'8321'_1924 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.T_EntitiesEnv_1692 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1398 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1398
du_s'8321'_1924 v0 v1 v2
  = coe
                    ...
                    (coe
                       ...
                       (coe
                          ...
                          (coe
                             MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.d_coldCredentials_1712
                             (coe v1)))))
                 (coe du_s'8321'_1924 (coe v0) (coe v1) (coe v2)) v3 in
       coe
         (case coe v4 of
                                                                                              ...
                                                                                              (coe
                                                                                                 ...
                                                                                                 (coe
                                                                                                    ...
                                                                                                    (coe
                                                                                                       v14)))))
                                                                                        (coe
                                                                                           MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.C_ENTITIES_1812
                                                                                           (MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.d_voteDelegs_1352
                                                                                              (coe
                                                                                                 MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.d_dState_1406
                                                                                                 (coe
