...
d_DecEq'45'RewardAddress_206 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'RewardAddress_206 v0
  = coe
...
d_HasNetworkId'45'RewardAddress_514 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Core.Specification.Address.T_HasNetworkId_154
d_HasNetworkId'45'RewardAddress_514 ~v0
  = du_HasNetworkId'45'RewardAddress_514
du_HasNetworkId'45'RewardAddress_514 ::
  MAlonzo.Code.Ledger.Core.Specification.Address.T_HasNetworkId_154
du_HasNetworkId'45'RewardAddress_514
  = coe
...
d_HasWithdrawals'45'Tx_658 ~v0 = du_HasWithdrawals'45'Tx_658
du_HasWithdrawals'45'Tx_658 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TxLevel_8 ->
  MAlonzo.Code.Ledger.Core.Specification.Address.T_HasWithdrawals_194
du_HasWithdrawals'45'Tx_658 v0
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.du_HasWithdrawals'45'Tx_4534
-- _.InBalanceInterval
d_InBalanceInterval_672 a0 a1 a2 = ()
-- _.SubLevelTx
d_SubLevelTx_922 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  ()
...
d_HasRewards'45'CertState_2822 ~v0
...
d_compute_3344 v0
  = coe
      ...
      (coe
         MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.Properties.Computational.d_Computational'45'CERTS_2464
         (coe
...
d_failure'8658''8704''172'STS_3350 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertEnv_1394 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1466 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1354] ->
...
d_failure'8658''8704''172'STS_3350 = erased
-- Ledger.Dijkstra.Specification.Entities.Properties.Computational.Computational-CERTS.failure⇔∀¬STS
d_failure'8660''8704''172'STS_3352 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertEnv_1394 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1466 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1354] ->
  MAlonzo.Code.Function.Bundles.T_Equivalence_1858
d_failure'8660''8704''172'STS_3352 v0
  = coe
...
d_recomputeProof_3354 ::
  ...
  MAlonzo.Code.Interface.STS.T__'8866'_'8640''10214'_'10215''42'__80 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_recomputeProof_3354 v0 v1 v2 v3 v4 v5
  = coe
...
d_'8704''172'STS'8658'failure_3356 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertEnv_1394 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1466 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1354] ->
  (MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1466 ->
   ...
   MAlonzo.Code.Data.Irrelevant.T_Irrelevant_20) ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_'8704''172'STS'8658'failure_3356 v0 v1 v2 v3 v4
  = coe
...
d_'8801''45'success'8660'STS_3358 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertEnv_1394 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1466 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1354] ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1466 ->
  MAlonzo.Code.Function.Bundles.T_Equivalence_1858
d_'8801''45'success'8660'STS_3358 v0
  = coe
...
d_Computational'45'SUBENTITIES_3360 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'SUBENTITIES_3360 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (d_computeProof_3404 (coe v0))
            ...
            (coe
               ...
               (coe
                  ...
                  (coe
                     MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                     (coe
                        MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.d_applyWithdrawals_3178
                        v0
...
d_computeProof_3404 ::
  ...
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tx_3798 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_computeProof_3404 v0 v1 v2 v3
  = let v4
          = coe
      ...
      (let v5
             = coe
                 ...
                 (coe
                    ...
                    (coe
                       MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.Properties.Computational.d_Computational'45'CERT_2240
                       (coe
                          MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.d_govStructure_2876
                          (coe v0)))
                    (coe
                             ...
                             (coe
                                ...
                                (coe
                                   ...
                                   (coe
                                      ...
                                      (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                          (coe
                             MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.C_constructor_1408)))
                    (coe
                       MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                       (coe
                          MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.d_epoch_3138
                       ...
                       (coe
                          ...
                          (coe
                             MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.d_coldCredentials_3142
                             (coe v1)))))
                 (d_s'8321'_3402 (coe v0) (coe v1) (coe v2) (coe v3))
                                                                                                                      ...
                                                                                                                      (coe
                                                                                                                         ...
                                                                                                                         (coe
                                                                                                                            ...
                                                                                                                            (coe
                                                                                                                               MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                                                                                                                               (coe
                                                                                                                                  MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.d_applyDirectDeposits_3176
                                                                                                                                  v0
                                                                                                                                  (coe
                                                                                                                   ...
                                                                                                                   (coe
                                                                                                                      ...
                                                                                                                      (coe
                                                                                                                         ...
                                                                                                                         (coe
                                                                                                                            v20)))))
                                                                                                             (coe
                                                                                                                MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.C_SUBENTITIES_3248
                                                                                                                (MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.d_rewards_1424
                                                                                                                   (coe
                                                                                                                      MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.d_dState_1474
                                                                                                                      (coe
...
d_completeness_3482 ::
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_completeness_3482 = erased
-- Ledger.Dijkstra.Specification.Entities.Properties.Computational.Computational-ENTITIES
d_Computational'45'ENTITIES_3666 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'ENTITIES_3666 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (d_computeProof_3718 (coe v0))
-- Ledger.Dijkstra.Specification.Entities.Properties.Computational._._.go.s₁
d_s'8321'_3716 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.T_EntitiesEnv_3104 ->
...
d_computeProof_3718 ::
  ...
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tx_3798 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_computeProof_3718 v0 v1 v2 v3
  = let v4
          = coe
              MAlonzo.Code.Relation.Nullary.Decidable.Core.du__'215''45'dec__84
              (coe
                    ...
                    (coe
                       ...
                       (coe
                          ...
                          (coe
                             MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.d_coldCredentials_3120
                             (coe v1)))))
                 (d_s'8321'_3716 (coe v0) (coe v1) (coe v2) (coe v3))
                 (MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.d_txCerts_3886
                    (coe
                       MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.d_txBody_3818
                       (coe v3))) in
