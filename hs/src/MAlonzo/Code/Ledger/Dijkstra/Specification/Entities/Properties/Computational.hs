...
d__'8866'_'8640''10631'_'44'ENTITIES'10632'__3038 a0 a1 a2 a3 a4
  = ()
...
d_compute_3272 v0
  = coe
      ...
      (coe
         MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.Properties.Computational.d_Computational'45'CERTS_2156
         (coe
...
d_failure'8658''8704''172'STS_3278 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertEnv_1336 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1408 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1296] ->
...
d_failure'8658''8704''172'STS_3278 = erased
-- Ledger.Dijkstra.Specification.Entities.Properties.Computational.Computational-CERTS.failure⇔∀¬STS
d_failure'8660''8704''172'STS_3280 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertEnv_1336 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1408 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1296] ->
  MAlonzo.Code.Function.Bundles.T_Equivalence_1858
d_failure'8660''8704''172'STS_3280 v0
  = coe
...
d_recomputeProof_3282 ::
  ...
  MAlonzo.Code.Interface.STS.T__'8866'_'8640''10214'_'10215''42'__80 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_recomputeProof_3282 v0 v1 v2 v3 v4 v5
  = coe
...
d_'8704''172'STS'8658'failure_3284 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertEnv_1336 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1408 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1296] ->
  (MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1408 ->
   ...
   MAlonzo.Code.Data.Irrelevant.T_Irrelevant_20) ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_'8704''172'STS'8658'failure_3284 v0 v1 v2 v3 v4
  = coe
...
d_'8801''45'success'8660'STS_3286 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertEnv_1336 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1408 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1296] ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1408 ->
  MAlonzo.Code.Function.Bundles.T_Equivalence_1858
d_'8801''45'success'8660'STS_3286 v0
  = coe
...
d_Computational'45'SUBENTITIES_3288 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'SUBENTITIES_3288 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (d_computeProof_3332 (coe v0))
            ...
            (coe
               ...
               (coe
                  ...
                  (coe
                     MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                     (coe
                        MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.d_applyWithdrawals_3106
                        v0
...
d_computeProof_3332 ::
  ...
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tx_3672 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_computeProof_3332 v0 v1 v2 v3
  = let v4
          = coe
      ...
      (let v5
             = coe
                 ...
                 (coe
                    ...
                    (coe
                       MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.Properties.Computational.d_Computational'45'CERT_1932
                       (coe
                          MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.d_govStructure_2768
                          (coe v0)))
                    (coe
                    ...
                    (coe
                       ...
                       (coe
                          ...
                          (coe
                             MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.d_coldCredentials_3070
                             (coe v1)))))
                 (d_s'8321'_3330 (coe v0) (coe v1) (coe v2) (coe v3))
                                                                                                                      ...
                                                                                                                      (coe
                                                                                                                         ...
                                                                                                                         (coe
                                                                                                                            ...
                                                                                                                            (coe
                                                                                                                               MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                                                                                                                               (coe
                                                                                                                                  MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.d_applyDirectDeposits_3104
                                                                                                                                  v0
                                                                                                                                  (coe
...
d_completeness_3410 ::
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_completeness_3410 = erased
-- Ledger.Dijkstra.Specification.Entities.Properties.Computational.Computational-ENTITIES
d_Computational'45'ENTITIES_3594 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'ENTITIES_3594 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (d_computeProof_3646 (coe v0))
-- Ledger.Dijkstra.Specification.Entities.Properties.Computational._._.go.s₁
d_s'8321'_3644 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.T_EntitiesEnv_3032 ->
...
d_computeProof_3646 ::
  ...
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tx_3672 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_computeProof_3646 v0 v1 v2 v3
  = let v4
          = coe
              MAlonzo.Code.Relation.Nullary.Decidable.Core.du__'215''45'dec__84
              (coe
                    ...
                    (coe
                       ...
                       (coe
                          ...
                          (coe
                             MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.d_coldCredentials_3048
                             (coe v1)))))
                 (d_s'8321'_3644 (coe v0) (coe v1) (coe v2) (coe v3))
                 (MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.d_txCerts_3760
                    (coe
                       MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.d_txBody_3692
                       (coe v3))) in
                                                                                                                          ...
                                                                                                                          (coe
                                                                                                                             ...
                                                                                                                             (coe
                                                                                                                                ...
                                                                                                                                (coe
                                                                                                                                   v22)))))
                                                                                                                    (coe
                                                                                                                       MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.C_ENTITIES_3228
                                                                                                                       (MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.d_rewards_1366
                                                                                                                          (coe
                                                                                                                             MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.d_dState_1416
                                                                                                                             (coe
