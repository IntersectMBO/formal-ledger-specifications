...
d__'8866'_'8640''10631'_'44'ENTITIES'10632'__3080 a0 a1 a2 a3 a4
  = ()
...
d_failure'8658''8704''172'STS_3320 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertEnv_1348 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1420 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1308] ->
...
d_failure'8658''8704''172'STS_3320 = erased
-- Ledger.Dijkstra.Specification.Entities.Properties.Computational.Computational-CERTS.failure⇔∀¬STS
d_failure'8660''8704''172'STS_3322 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertEnv_1348 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1420 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1308] ->
  MAlonzo.Code.Function.Bundles.T_Equivalence_1858
d_failure'8660''8704''172'STS_3322 v0
  = coe
...
d_recomputeProof_3324 ::
  ...
  MAlonzo.Code.Interface.STS.T__'8866'_'8640''10214'_'10215''42'__80 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_recomputeProof_3324 v0 v1 v2 v3 v4 v5
  = coe
...
d_'8704''172'STS'8658'failure_3326 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertEnv_1348 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1420 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1308] ->
  (MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1420 ->
   ...
   MAlonzo.Code.Data.Irrelevant.T_Irrelevant_20) ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_'8704''172'STS'8658'failure_3326 v0 v1 v2 v3 v4
  = coe
...
d_'8801''45'success'8660'STS_3328 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertEnv_1348 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1420 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1308] ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1420 ->
  MAlonzo.Code.Function.Bundles.T_Equivalence_1858
d_'8801''45'success'8660'STS_3328 v0
  = coe
...
d_Computational'45'SUBENTITIES_3330 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'SUBENTITIES_3330 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (d_computeProof_3374 (coe v0))
...
d_computeProof_3374 ::
  ...
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tx_3706 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_computeProof_3374 v0 v1 v2 v3
  = let v4
          = coe
                    ...
                    (coe
                       ...
                       (coe
                          ...
                          (coe
                             MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.d_coldCredentials_3112
                             (coe v1)))))
                 (d_s'8321'_3372 (coe v0) (coe v1) (coe v2) (coe v3))
                                                                                                                   ...
                                                                                                                   (coe
                                                                                                                      ...
                                                                                                                      (coe
                                                                                                                         ...
                                                                                                                         (coe
                                                                                                                            v20)))))
                                                                                                             (coe
                                                                                                                MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.C_SUBENTITIES_3218
                                                                                                                (MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.d_rewards_1378
                                                                                                                   (coe
                                                                                                                      MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.d_dState_1428
                                                                                                                      (coe
...
d_completeness_3452 ::
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_completeness_3452 = erased
-- Ledger.Dijkstra.Specification.Entities.Properties.Computational.Computational-ENTITIES
d_Computational'45'ENTITIES_3636 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'ENTITIES_3636 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (d_computeProof_3690 (coe v0))
-- Ledger.Dijkstra.Specification.Entities.Properties.Computational._._.go.s₁
d_s'8321'_3688 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.T_EntitiesEnv_3074 ->
...
d_computeProof_3690 ::
  ...
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tx_3706 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_computeProof_3690 v0 v1 v2 v3
  = let v4
          = coe
              MAlonzo.Code.Relation.Nullary.Decidable.Core.du__'215''45'dec__84
              (coe
                    ...
                    (coe
                       ...
                       (coe
                          ...
                          (coe
                             MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.d_coldCredentials_3090
                             (coe v1)))))
                 (d_s'8321'_3688 (coe v0) (coe v1) (coe v2) (coe v3))
                 (MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.d_txCerts_3796
                    (coe
                       MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.d_txBody_3726
                       (coe v3))) in
                                                                                                                                        ...
                                                                                                                                        (coe
                                                                                                                                           ...
                                                                                                                                           (coe
                                                                                                                                              ...
                                                                                                                                              (coe
                                                                                                                                                 v26)))))
                                                                                                                                  (coe
                                                                                                                                     MAlonzo.Code.Ledger.Dijkstra.Specification.Entities.C_ENTITIES_3278
                                                                                                                                     (MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.d_rewards_1378
                                                                                                                                        (coe
                                                                                                                                           MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.d_dState_1428
                                                                                                                                           (coe
