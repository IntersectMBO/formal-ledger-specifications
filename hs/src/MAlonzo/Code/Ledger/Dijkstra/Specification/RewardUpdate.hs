...
d__'8866'_'8640''10631'_'44'NEWEPOCH'10632'__2592 a0 a1 a2 a3 a4 a5
  = ()
-- Ledger.Dijkstra.Specification.RewardUpdate._.EpochState
d_EpochState_2596 a0 a1 = ()
...
d_createRUpd_2702 v0 ~v1 = du_createRUpd_2702 v0
du_createRUpd_2702 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  Integer ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
...
d_RUpdEnv_2940 ::
  ...
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3096 ->
  ()
d_RUpdEnv_2940 = erased
-- Ledger.Dijkstra.Specification.RewardUpdate._⊢_⇀⦇_,RUPD⦈_
d__'8866'_'8640''10631'_'44'RUPD'10632'__2942 a0 a1 a2 a3 a4 a5
  = ()
data T__'8866'_'8640''10631'_'44'RUPD'10632'__2942
  = C_RUPD'45'Create'45'Reward'45'Update_2952 AgdaAny |
    C_RUPD'45'Reward'45'Update'45'Exists_2962 |
    C_RUPD'45'Reward'45'Too'45'Early_2970
-- Ledger.Dijkstra.Specification.RewardUpdate._⊢_⇀⦇_,TICK⦈_
d__'8866'_'8640''10631'_'44'TICK'10632'__2972 a0 a1 a2 a3 a4 a5
  = ()
data T__'8866'_'8640''10631'_'44'TICK'10632'__2972
  = C_TICK_2982 MAlonzo.Code.Ledger.Dijkstra.Specification.Epoch.T_NewEpochState_4036
                MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
