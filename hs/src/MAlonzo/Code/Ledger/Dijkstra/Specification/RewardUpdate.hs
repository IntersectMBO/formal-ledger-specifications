...
d_createRUpd_2776 v0 ~v1 = du_createRUpd_2776 v0
du_createRUpd_2776 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  Integer ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
...
d_flowConservation_2980 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.T_RewardUpdate_3860 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_flowConservation_2980 = erased
...
d_Δf'45'nonpositive_2986 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.T_RewardUpdate_3860 ->
  MAlonzo.Code.Data.Integer.Base.T__'8804'__26
d_Δf'45'nonpositive_2986 v0
  = coe
...
d_Δt'45'nonnegative_2992 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Rewards.T_RewardUpdate_3860 ->
  MAlonzo.Code.Data.Integer.Base.T__'8804'__26
d_Δt'45'nonnegative_2992 v0
  = coe
...
d_RUpdEnv_3012 ::
  ...
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3244 ->
  ()
d_RUpdEnv_3012 = erased
-- Ledger.Dijkstra.Specification.RewardUpdate._⊢_⇀⦇_,RUPD⦈_
d__'8866'_'8640''10631'_'44'RUPD'10632'__3014 a0 a1 a2 a3 a4 a5
  = ()
data T__'8866'_'8640''10631'_'44'RUPD'10632'__3014
  = C_RUPD'45'Create'45'Reward'45'Update_3024 AgdaAny |
    C_RUPD'45'Reward'45'Update'45'Exists_3034 |
    C_RUPD'45'Reward'45'Too'45'Early_3042
-- Ledger.Dijkstra.Specification.RewardUpdate._⊢_⇀⦇_,TICK⦈_
d__'8866'_'8640''10631'_'44'TICK'10632'__3044 a0 a1 a2 a3 a4 a5
  = ()
data T__'8866'_'8640''10631'_'44'TICK'10632'__3044
  = C_TICK_3054 MAlonzo.Code.Ledger.Dijkstra.Specification.Epoch.T_NewEpochState_4194
                MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
