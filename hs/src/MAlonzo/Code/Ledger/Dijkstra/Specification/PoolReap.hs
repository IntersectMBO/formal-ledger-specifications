...
d_toRewardAddress_2984 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3052 ->
  MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20 ->
  MAlonzo.Code.Ledger.Core.Specification.Address.T_RewardAddress_116
d_toRewardAddress_2984 v0 ~v1 v2 = du_toRewardAddress_2984 v0 v2
du_toRewardAddress_2984 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20 ->
  MAlonzo.Code.Ledger.Core.Specification.Address.T_RewardAddress_116
du_toRewardAddress_2984 v0 v1
  = coe
...
d_PoolReapState_2988 a0 a1 = ()
data T_PoolReapState_2988
  = C_'10214'_'44'_'10215''7510'_2998 MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1400
                                      MAlonzo.Code.Ledger.Dijkstra.Specification.PParams.T_Acnt_194
-- Ledger.Dijkstra.Specification.PoolReap.PoolReapState.certState
d_certState_2994 ::
  T_PoolReapState_2988 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_CertState_1400
d_certState_2994 v0
  = case coe v0 of
      C_'10214'_'44'_'10215''7510'_2998 v1 v2 -> coe v1
...
d_acnt_2996 v0
  = case coe v0 of
      C_'10214'_'44'_'10215''7510'_2998 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.PoolReap._⊢_⇀⦇_,POOLREAP⦈_
d__'8866'_'8640''10631'_'44'POOLREAP'10632'__3004 a0 a1 a2 a3 a4 a5
  = ()
data T__'8866'_'8640''10631'_'44'POOLREAP'10632'__3004
  = C_POOLREAP_3040
