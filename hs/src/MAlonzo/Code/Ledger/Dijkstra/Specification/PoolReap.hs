...
d_PoolReapState_3074 a0 = ()
data T_PoolReapState_3074
  = C_'10214'_'44'_'44'_'10215''7510'_3088 MAlonzo.Code.Ledger.Dijkstra.Specification.PParams.T_Acnt_194
                                           MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DState_1364
                                           MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_PState_1384
-- Ledger.Dijkstra.Specification.PoolReap.PoolReapState.acnt
d_acnt_3082 ::
  T_PoolReapState_3074 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.PParams.T_Acnt_194
d_acnt_3082 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'10215''7510'_3088 v1 v2 v3 -> coe v1
...
d_dState_3084 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'10215''7510'_3088 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pState_3086 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'10215''7510'_3088 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.PoolReap.HasCast-PoolReapState
d_HasCast'45'PoolReapState_3090 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'PoolReapState_3090 ~v0
  = du_HasCast'45'PoolReapState_3090
du_HasCast'45'PoolReapState_3090 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'PoolReapState_3090
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (3074 :: Integer) (10528932768775107529 :: Integer)
                                 "Ledger.Dijkstra.Specification.PoolReap.PoolReapState"
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                     (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
         (coe C_'10214'_'44'_'44'_'10215''7510'_3088))
-- Ledger.Dijkstra.Specification.PoolReap._⊢_⇀⦇_,POOLREAP⦈_
d__'8866'_'8640''10631'_'44'POOLREAP'10632'__3114 a0 a1 a2 a3 a4
  = ()
data T__'8866'_'8640''10631'_'44'POOLREAP'10632'__3114
  = C_POOLREAP_3126
