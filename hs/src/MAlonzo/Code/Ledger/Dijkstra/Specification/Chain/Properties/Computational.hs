...
d_Computational'45'BBODY_2668 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3202 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'BBODY_2668 v0 v1
  = coe
      MAlonzo.Code.Ledger.Dijkstra.Specification.BlockBody.Properties.Computational.d_Computational'45'BBODY_3198
      (coe v0) (coe v1)
...
d_totalRefScriptsSize_2720 ::
  ...
  Integer
d_totalRefScriptsSize_2720 v0 v1
  = coe
...
d_HasLedgerState'45'NewEpochState_2836 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3202 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.T_HasLedgerState_3892
d_HasLedgerState'45'NewEpochState_2836 ~v0 ~v1
  = du_HasLedgerState'45'NewEpochState_2836
du_HasLedgerState'45'NewEpochState_2836 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.T_HasLedgerState_3892
du_HasLedgerState'45'NewEpochState_2836
  = coe
...
d__'8866'_'8640''10631'_'44'TICK'10632'__3184 a0 a1 a2 a3 a4 a5
  = ()
...
d_maxRefScriptSizePerBlock_3264 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3202 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Epoch.T_NewEpochState_4152 ->
  Integer
d_maxRefScriptSizePerBlock_3264 ~v0 ~v1 v2
  = du_maxRefScriptSizePerBlock_3264 v2
du_maxRefScriptSizePerBlock_3264 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Epoch.T_NewEpochState_4152 ->
  Integer
du_maxRefScriptSizePerBlock_3264 v0
  = coe
...
d_refScriptSize'8804''63'Bound_3268 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3202 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Epoch.T_NewEpochState_4152 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tx_3786] ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
d_refScriptSize'8804''63'Bound_3268 v0 v1 v2 v3
  = coe
...
d_Computational'45'CHAIN_3270 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3202 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'CHAIN_3270 v0 v1
  = coe
                          ...
                          MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v8 v9
                            -> coe
                                 ...
                                 (coe
                                    MAlonzo.Code.Interface.ComputationalRelation.d_computeProof_272
                                    (coe
                                       MAlonzo.Code.Ledger.Dijkstra.Specification.RewardUpdate.Properties.Computational.du_Computational'45'RUPD_2976
                                       (coe v0))
                                    (coe
                                                                     ...
                                                                     (coe
                                                                        ...
                                                                        (coe
                                                                           ...
                                                                           (coe
                                                                              ...
                                                                              (coe v6))))
                                                                     (coe
                                                                        MAlonzo.Code.Ledger.Dijkstra.Specification.Chain.C_CHAIN_4408
                                                                        v6
                                                                        (coe
                                                                           MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                                                                           (coe v16)
