...
d_realizedInputs_3046 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Script.ScriptPurpose.T_TxInfo_3036 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_realizedInputs_3046 v0
  = coe
...
d_txDirectDeposits_3054 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Script.ScriptPurpose.T_TxInfo_3036 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_txDirectDeposits_3054 v0
  = coe
...
d_indexOf_3072 a0 = ()
data T_indexOf_3072
  = C_constructor_3102 (MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1296 ->
                        [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1296] ->
                        Maybe AgdaAny)
                       (MAlonzo.Code.Ledger.Core.Specification.Address.T_RewardAddress_116 ->
...
d_indexOfTxIn_3092 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> Maybe AgdaAny
d_indexOfTxIn_3092 v0
  = case coe v0 of
      C_constructor_3102 v1 v2 v3 v4 v5 v6 v7 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Abstract.indexOf.indexOfPolicyId
d_indexOfPolicyId_3094 ::
  T_indexOf_3072 -> AgdaAny -> [AgdaAny] -> Maybe AgdaAny
d_indexOfPolicyId_3094 v0
  = case coe v0 of
...
data T_AbstractFunctions_3104
  = C_constructor_3130 (AgdaAny -> AgdaAny -> Integer)
                       (AgdaAny -> Integer)
                       (MAlonzo.Code.Ledger.Dijkstra.Specification.PParams.T_PParams_312 ->
                        AgdaAny -> AgdaAny)
                       T_indexOf_3072
...
d_txScriptFee_3118 ::
  T_AbstractFunctions_3104 -> AgdaAny -> AgdaAny -> Integer
d_txScriptFee_3118 v0
  = case coe v0 of
      C_constructor_3130 v1 v2 v3 v4 v5 v6 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Abstract.AbstractFunctions.serializedSize
d_serializedSize_3120 ::
  T_AbstractFunctions_3104 -> AgdaAny -> Integer
d_serializedSize_3120 v0
  = case coe v0 of
...
d_indexOfImp_3124 :: T_AbstractFunctions_3104 -> T_indexOf_3072
