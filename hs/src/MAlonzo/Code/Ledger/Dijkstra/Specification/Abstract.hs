...
d_realizedInputs_3052 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Script.ScriptPurpose.T_TxInfo_3042 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_realizedInputs_3052 v0
  = coe
...
d_txBalanceIntervals_3054 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Script.ScriptPurpose.T_TxInfo_3042 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_txBalanceIntervals_3054 v0
  = coe
...
d_indexOf_3078 a0 = ()
data T_indexOf_3078
  = C_constructor_3108 (MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1296 ->
                        [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1296] ->
                        Maybe AgdaAny)
                       (MAlonzo.Code.Ledger.Core.Specification.Address.T_RewardAddress_116 ->
...
d_indexOfTxIn_3098 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> Maybe AgdaAny
d_indexOfTxIn_3098 v0
  = case coe v0 of
      C_constructor_3108 v1 v2 v3 v4 v5 v6 v7 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Abstract.indexOf.indexOfPolicyId
d_indexOfPolicyId_3100 ::
  T_indexOf_3078 -> AgdaAny -> [AgdaAny] -> Maybe AgdaAny
d_indexOfPolicyId_3100 v0
  = case coe v0 of
...
data T_AbstractFunctions_3110
  = C_constructor_3136 (AgdaAny -> AgdaAny -> Integer)
                       (AgdaAny -> Integer)
                       (MAlonzo.Code.Ledger.Dijkstra.Specification.PParams.T_PParams_312 ->
                        AgdaAny -> AgdaAny)
                       T_indexOf_3078
...
d_txScriptFee_3124 ::
  T_AbstractFunctions_3110 -> AgdaAny -> AgdaAny -> Integer
...
d_serializedSize_3126 ::
  T_AbstractFunctions_3110 -> AgdaAny -> Integer
d_serializedSize_3126 v0
  = case coe v0 of
...
d_indexOfImp_3130 :: T_AbstractFunctions_3110 -> T_indexOf_3078
