...
d_indexOf_3212 a0 = ()
data T_indexOf_3212
  = C_constructor_3242 (MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1454 ->
                        [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1454] ->
                        Maybe AgdaAny)
                       (MAlonzo.Code.Ledger.Core.Specification.Address.T_RewardAddress_116 ->
...
d_indexOfDCert_3228 ::
  ...
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1454] ->
  Maybe AgdaAny
d_indexOfDCert_3228 v0
  = case coe v0 of
      C_constructor_3242 v1 v2 v3 v4 v5 v6 v7 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Abstract.indexOf.indexOfRewardAddress
d_indexOfRewardAddress_3230 ::
  T_indexOf_3212 ->
  MAlonzo.Code.Ledger.Core.Specification.Address.T_RewardAddress_116 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Maybe AgdaAny
d_indexOfRewardAddress_3230 v0
  = case coe v0 of
      C_constructor_3242 v1 v2 v3 v4 v5 v6 v7 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfTxIn_3232 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> Maybe AgdaAny
d_indexOfTxIn_3232 v0
  = case coe v0 of
      C_constructor_3242 v1 v2 v3 v4 v5 v6 v7 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Abstract.indexOf.indexOfPolicyId
d_indexOfPolicyId_3234 ::
  T_indexOf_3212 -> AgdaAny -> [AgdaAny] -> Maybe AgdaAny
d_indexOfPolicyId_3234 v0
  = case coe v0 of
      C_constructor_3242 v1 v2 v3 v4 v5 v6 v7 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfVote_3236 ::
  ...
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.T_GovVoter_986] ->
  Maybe AgdaAny
d_indexOfVote_3236 v0
  = case coe v0 of
      C_constructor_3242 v1 v2 v3 v4 v5 v6 v7 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Abstract.indexOf.indexOfProposal
d_indexOfProposal_3238 ::
  T_indexOf_3212 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.T_GovProposal_1064 ->
  [MAlonzo.Code.Ledger.Dijkstra.Specification.Gov.Actions.T_GovProposal_1064] ->
  Maybe AgdaAny
d_indexOfProposal_3238 v0
  = case coe v0 of
      C_constructor_3242 v1 v2 v3 v4 v5 v6 v7 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfGuard_3240 ::
  ...
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20] ->
  Maybe AgdaAny
d_indexOfGuard_3240 v0
  = case coe v0 of
      C_constructor_3242 v1 v2 v3 v4 v5 v6 v7 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Abstract.AbstractFunctions
d_AbstractFunctions_3244 a0 = ()
data T_AbstractFunctions_3244
  = C_constructor_3270 (AgdaAny -> AgdaAny -> Integer)
                       (AgdaAny -> Integer)
                       (MAlonzo.Code.Ledger.Dijkstra.Specification.PParams.T_PParams_312 ->
                        AgdaAny -> AgdaAny)
                       T_indexOf_3212
...
d_txScriptFee_3258 ::
  T_AbstractFunctions_3244 -> AgdaAny -> AgdaAny -> Integer
d_txScriptFee_3258 v0
  = case coe v0 of
      C_constructor_3270 v1 v2 v3 v4 v5 v6 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Abstract.AbstractFunctions.serializedSize
d_serializedSize_3260 ::
  T_AbstractFunctions_3244 -> AgdaAny -> Integer
d_serializedSize_3260 v0
  = case coe v0 of
      C_constructor_3270 v1 v2 v3 v4 v5 v6 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Abstract.AbstractFunctions.getLanguageView
d_getLanguageView_3262 ::
  T_AbstractFunctions_3244 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.PParams.T_PParams_312 ->
  AgdaAny -> AgdaAny
d_getLanguageView_3262 v0
  = case coe v0 of
      C_constructor_3270 v1 v2 v3 v4 v5 v6 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Abstract.AbstractFunctions.indexOfImp
d_indexOfImp_3264 :: T_AbstractFunctions_3244 -> T_indexOf_3212
d_indexOfImp_3264 v0
  = case coe v0 of
      C_constructor_3270 v1 v2 v3 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Abstract.AbstractFunctions.scriptSize
d_scriptSize_3266 ::
  T_AbstractFunctions_3244 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Integer
d_scriptSize_3266 v0
  = case coe v0 of
      C_constructor_3270 v1 v2 v3 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_valContext_3268 ::
  ...
  MAlonzo.Code.Ledger.Dijkstra.Specification.Script.ScriptPurpose.T_ScriptPurpose_3164 ->
  AgdaAny
d_valContext_3268 v0
  = case coe v0 of
      C_constructor_3270 v1 v2 v3 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
