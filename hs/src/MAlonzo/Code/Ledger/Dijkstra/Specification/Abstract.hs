...
d_realizedInputs_3016 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Script.ScriptPurpose.T_TxInfo_3006 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_realizedInputs_3016 v0
  = coe
...
d_txDirectDeposits_3024 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Script.ScriptPurpose.T_TxInfo_3006 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_txDirectDeposits_3024 v0
  = coe
...
d_indexOf_3042 a0 = ()
data T_indexOf_3042
  = C_constructor_3072 (MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1290 ->
                        [MAlonzo.Code.Ledger.Dijkstra.Specification.Certs.T_DCert_1290] ->
                        Maybe AgdaAny)
                       (MAlonzo.Code.Ledger.Core.Specification.Address.T_RewardAddress_116 ->
...
d_indexOfTxIn_3062 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> Maybe AgdaAny
d_indexOfTxIn_3062 v0
  = case coe v0 of
      C_constructor_3072 v1 v2 v3 v4 v5 v6 v7 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Abstract.indexOf.indexOfPolicyId
d_indexOfPolicyId_3064 ::
  T_indexOf_3042 -> AgdaAny -> [AgdaAny] -> Maybe AgdaAny
d_indexOfPolicyId_3064 v0
  = case coe v0 of
...
data T_AbstractFunctions_3074
  = C_constructor_3100 (AgdaAny -> AgdaAny -> Integer)
                       (AgdaAny -> Integer)
                       (MAlonzo.Code.Ledger.Dijkstra.Specification.PParams.T_PParams_312 ->
                        AgdaAny -> AgdaAny)
                       T_indexOf_3042
...
d_txScriptFee_3088 ::
  T_AbstractFunctions_3074 -> AgdaAny -> AgdaAny -> Integer
d_txScriptFee_3088 v0
  = case coe v0 of
      C_constructor_3100 v1 v2 v3 v4 v5 v6 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Abstract.AbstractFunctions.serializedSize
d_serializedSize_3090 ::
  T_AbstractFunctions_3074 -> AgdaAny -> Integer
d_serializedSize_3090 v0
  = case coe v0 of
      C_constructor_3100 v1 v2 v3 v4 v5 v6 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Abstract.AbstractFunctions.getLanguageView
d_getLanguageView_3092 ::
  T_AbstractFunctions_3074 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.PParams.T_PParams_312 ->
  AgdaAny -> AgdaAny
d_getLanguageView_3092 v0
  = case coe v0 of
      C_constructor_3100 v1 v2 v3 v4 v5 v6 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Abstract.AbstractFunctions.indexOfImp
d_indexOfImp_3094 :: T_AbstractFunctions_3074 -> T_indexOf_3042
d_indexOfImp_3094 v0
  = case coe v0 of
      C_constructor_3100 v1 v2 v3 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.Abstract.AbstractFunctions.scriptSize
d_scriptSize_3096 ::
  T_AbstractFunctions_3074 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Integer
d_scriptSize_3096 v0
  = case coe v0 of
      C_constructor_3100 v1 v2 v3 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_valContext_3098 ::
  ...
  MAlonzo.Code.Ledger.Dijkstra.Specification.Script.ScriptPurpose.T_ScriptPurpose_2994 ->
  AgdaAny
d_valContext_3098 v0
  = case coe v0 of
      C_constructor_3100 v1 v2 v3 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
