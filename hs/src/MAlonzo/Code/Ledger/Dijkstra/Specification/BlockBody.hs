...
d_totExUnits_2918 ::
  ...
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tx_3620 ->
  AgdaAny
d_totExUnits_2918 v0 ~v1 = du_totExUnits_2918 v0
du_totExUnits_2918 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TxLevel_8 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tx_3620 ->
  AgdaAny
du_totExUnits_2918 v0 v1 v2
  = coe
...
d_Block_2956 a0 a1 = ()
data T_Block_2956
  = C_constructor_2982 T_BHeader_2944
                       [MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tx_3620]
                       Integer AgdaAny
-- Ledger.Dijkstra.Specification.BlockBody.Block.bheader
d_bheader_2970 :: T_Block_2956 -> T_BHeader_2944
d_bheader_2970 v0
  = case coe v0 of
      C_constructor_2982 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_ts_2972 v0
  = case coe v0 of
      C_constructor_2982 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.BlockBody.Block.bBodySize
d_bBodySize_2974 :: T_Block_2956 -> Integer
d_bBodySize_2974 v0
  = case coe v0 of
      C_constructor_2982 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.BlockBody.Block.bBodyHash
d_bBodyHash_2976 :: T_Block_2956 -> AgdaAny
d_bBodyHash_2976 v0
  = case coe v0 of
      C_constructor_2982 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.BlockBody.Block.≡-bBodySize
d_'8801''45'bBodySize_2978 ::
  T_Block_2956 -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_'8801''45'bBodySize_2978 = erased
-- Ledger.Dijkstra.Specification.BlockBody.Block.≡-bBodyHash
d_'8801''45'bBodyHash_2980 ::
  T_Block_2956 -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_'8801''45'bBodyHash_2980 = erased
-- Ledger.Dijkstra.Specification.BlockBody.BBodyEnv
d_BBodyEnv_2984 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3052 ->
  ()
d_BBodyEnv_2984 = erased
-- Ledger.Dijkstra.Specification.BlockBody.BBodyState
d_BBodyState_2986 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3052 ->
  ()
d_BBodyState_2986 = erased
...
d_incrBlocks_2988 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_incrBlocks_2988 v0 ~v1 v2 v3 = du_incrBlocks_2988 v0 v2 v3
du_incrBlocks_2988 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  AgdaAny ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_incrBlocks_2988 v0 v1 v2
  = coe
...
d__'8866'_'8640''10631'_'44'BBODY'10632'__2994 a0 a1 a2 a3 a4 a5
  = ()
newtype T__'8866'_'8640''10631'_'44'BBODY'10632'__2994
  = C_BBODY'45'Block'45'Body_3020 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
