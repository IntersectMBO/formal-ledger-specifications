...
d_totExUnits_2930 ::
  ...
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tx_3626 ->
  AgdaAny
d_totExUnits_2930 v0 ~v1 = du_totExUnits_2930 v0
du_totExUnits_2930 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TxLevel_8 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tx_3626 ->
  AgdaAny
du_totExUnits_2930 v0 v1 v2
  = coe
...
d_BHBody_2932 a0 a1 = ()
data T_BHBody_2932
  = C_constructor_2954 AgdaAny Integer AgdaAny AgdaAny Integer
-- Ledger.Dijkstra.Specification.BlockBody.BHBody.bvkcold
d_bvkcold_2944 :: T_BHBody_2932 -> AgdaAny
d_bvkcold_2944 v0
  = case coe v0 of
      C_constructor_2954 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.BlockBody.BHBody.bsize
d_bsize_2946 :: T_BHBody_2932 -> Integer
d_bsize_2946 v0
  = case coe v0 of
      C_constructor_2954 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.BlockBody.BHBody.slot
d_slot_2948 :: T_BHBody_2932 -> AgdaAny
d_slot_2948 v0
  = case coe v0 of
      C_constructor_2954 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.BlockBody.BHBody.bhash
d_bhash_2950 :: T_BHBody_2932 -> AgdaAny
d_bhash_2950 v0
  = case coe v0 of
      C_constructor_2954 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.BlockBody.BHBody.hBbsize
d_hBbsize_2952 :: T_BHBody_2932 -> Integer
d_hBbsize_2952 v0
  = case coe v0 of
      C_constructor_2954 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.BlockBody.BHeader
d_BHeader_2956 a0 a1 = ()
data T_BHeader_2956 = C_constructor_2966 T_BHBody_2932 AgdaAny
-- Ledger.Dijkstra.Specification.BlockBody.BHeader.bhbody
d_bhbody_2962 :: T_BHeader_2956 -> T_BHBody_2932
d_bhbody_2962 v0
  = case coe v0 of
      C_constructor_2966 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.BlockBody.BHeader.bhsig
d_bhsig_2964 :: T_BHeader_2956 -> AgdaAny
d_bhsig_2964 v0
  = case coe v0 of
      C_constructor_2966 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.BlockBody.Block
d_Block_2968 a0 a1 = ()
data T_Block_2968
  = C_constructor_2994 T_BHeader_2956
                       [MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tx_3626]
                       Integer AgdaAny
-- Ledger.Dijkstra.Specification.BlockBody.Block.bheader
d_bheader_2982 :: T_Block_2968 -> T_BHeader_2956
d_bheader_2982 v0
  = case coe v0 of
...
d_bBodySize_2986 :: T_Block_2968 -> Integer
d_bBodySize_2986 v0
  = case coe v0 of
      C_constructor_2994 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.BlockBody.Block.bBodyHash
d_bBodyHash_2988 :: T_Block_2968 -> AgdaAny
d_bBodyHash_2988 v0
  = case coe v0 of
      C_constructor_2994 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.BlockBody.Block.≡-bBodySize
d_'8801''45'bBodySize_2990 ::
  T_Block_2968 -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_'8801''45'bBodySize_2990 = erased
-- Ledger.Dijkstra.Specification.BlockBody.Block.≡-bBodyHash
d_'8801''45'bBodyHash_2992 ::
  T_Block_2968 -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_'8801''45'bBodyHash_2992 = erased
-- Ledger.Dijkstra.Specification.BlockBody.BBodyEnv
d_BBodyEnv_2996 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3072 ->
  ()
d_BBodyEnv_2996 = erased
-- Ledger.Dijkstra.Specification.BlockBody.BBodyState
d_BBodyState_2998 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3072 ->
  ()
d_BBodyState_2998 = erased
...
d_incrBlocks_3000 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_incrBlocks_3000 v0 ~v1 v2 v3 = du_incrBlocks_3000 v0 v2 v3
du_incrBlocks_3000 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  AgdaAny ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_incrBlocks_3000 v0 v1 v2
  = coe
...
d__'8866'_'8640''10631'_'44'BBODY'10632'__3006 a0 a1 a2 a3 a4 a5
  = ()
newtype T__'8866'_'8640''10631'_'44'BBODY'10632'__3006
  = C_BBODY'45'Block'45'Body_3032 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
