...
d__'8866'_'8640''10631'_'44'LEDGERS'10632'__2676 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  ...
  MAlonzo.Code.Ledger.Dijkstra.Specification.Ledger.T_LedgerState_3732 ->
  ()
d__'8866'_'8640''10631'_'44'LEDGERS'10632'__2676 = erased
-- Ledger.Dijkstra.Specification.BlockBody._.LedgerState
d_LedgerState_2744 a0 a1 = ()
...
d_totExUnits_2928 ::
  ...
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tx_3654 ->
  AgdaAny
d_totExUnits_2928 v0 ~v1 = du_totExUnits_2928 v0
du_totExUnits_2928 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TxLevel_8 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_Tx_3654 ->
  AgdaAny
du_totExUnits_2928 v0 v1 v2
  = coe
...
d_ts_2982 v0
  = case coe v0 of
      C_constructor_2992 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.BlockBody.Block.bBodySize
d_bBodySize_2984 :: T_Block_2966 -> Integer
d_bBodySize_2984 v0
  = case coe v0 of
      C_constructor_2992 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.BlockBody.Block.bBodyHash
d_bBodyHash_2986 :: T_Block_2966 -> AgdaAny
d_bBodyHash_2986 v0
  = case coe v0 of
      C_constructor_2992 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Dijkstra.Specification.BlockBody.Block.≡-bBodySize
d_'8801''45'bBodySize_2988 ::
  T_Block_2966 -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_'8801''45'bBodySize_2988 = erased
-- Ledger.Dijkstra.Specification.BlockBody.Block.≡-bBodyHash
d_'8801''45'bBodyHash_2990 ::
  T_Block_2966 -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_'8801''45'bBodyHash_2990 = erased
-- Ledger.Dijkstra.Specification.BlockBody.BBodyEnv
d_BBodyEnv_2994 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3096 ->
  ()
d_BBodyEnv_2994 = erased
-- Ledger.Dijkstra.Specification.BlockBody.BBodyState
d_BBodyState_2996 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  MAlonzo.Code.Ledger.Dijkstra.Specification.Abstract.T_AbstractFunctions_3096 ->
  ()
d_BBodyState_2996 = erased
...
d_incrBlocks_2998 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_incrBlocks_2998 v0 ~v1 v2 v3 = du_incrBlocks_2998 v0 v2 v3
du_incrBlocks_2998 ::
  MAlonzo.Code.Ledger.Dijkstra.Specification.Transaction.T_TransactionStructure_58 ->
  AgdaAny ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_incrBlocks_2998 v0 v1 v2
  = coe
...
d__'8866'_'8640''10631'_'44'BBODY'10632'__3004 a0 a1 a2 a3 a4 a5
  = ()
newtype T__'8866'_'8640''10631'_'44'BBODY'10632'__3004
  = C_BBODY'45'Block'45'Body_3030 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
