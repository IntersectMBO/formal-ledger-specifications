...
d_GovEnv_1920 a0 = ()
data T_GovEnv_1920
  = C_GovEnv'46'constructor_3213 AgdaAny AgdaAny
...
d_txid_1936 v0
  = case coe v0 of
      C_GovEnv'46'constructor_3213 v1 v2 v3 v4 v5 v6 v7 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Gov.GovEnv.epoch
d_epoch_1938 :: T_GovEnv_1920 -> AgdaAny
d_epoch_1938 v0
  = case coe v0 of
      C_GovEnv'46'constructor_3213 v1 v2 v3 v4 v5 v6 v7 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pparams_1940 v0
  = case coe v0 of
      C_GovEnv'46'constructor_3213 v1 v2 v3 v4 v5 v6 v7 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Gov.GovEnv.ppolicy
d_ppolicy_1942 :: T_GovEnv_1920 -> Maybe AgdaAny
d_ppolicy_1942 v0
  = case coe v0 of
      C_GovEnv'46'constructor_3213 v1 v2 v3 v4 v5 v6 v7 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Gov.GovEnv.enactState
d_enactState_1944 ::
  T_GovEnv_1920 -> MAlonzo.Code.Ledger.Enact.T_EnactState_850
d_enactState_1944 v0
  = case coe v0 of
      C_GovEnv'46'constructor_3213 v1 v2 v3 v4 v5 v6 v7 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Gov.GovEnv.certState
d_certState_1946 ::
  T_GovEnv_1920 -> MAlonzo.Code.Ledger.Certs.T_CertState_968
d_certState_1946 v0
  = case coe v0 of
      C_GovEnv'46'constructor_3213 v1 v2 v3 v4 v5 v6 v7 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_rewardCreds_1948 v0
  = case coe v0 of
      C_GovEnv'46'constructor_3213 v1 v2 v3 v4 v5 v6 v7 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
                                          ...
                                          (coe
                                             ...
                                             (coe
                                                ...
                                                (coe
                                                   MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
                                 (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))))))
         (coe C_GovEnv'46'constructor_3213))
...
data T__'8866'_'8640''10631'_'44'GOV'10632'__2096
  = C_GOV'45'Vote_2552 MAlonzo.Code.Ledger.GovernanceActions.T_GovActionState_784
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 |
