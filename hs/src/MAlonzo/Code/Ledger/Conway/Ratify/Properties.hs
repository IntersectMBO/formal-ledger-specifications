...
d_exp'63'_2038 v0 v1 ~v2 v3 = du_exp'63'_2038 v0 v1 v3
du_exp'63'_2038 ::
  MAlonzo.Code.Ledger.Conway.Transaction.T_TransactionStructure_22 ->
  MAlonzo.Code.Ledger.Conway.Ratify.T_RatifyEnv_2250 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
du_exp'63'_2038 v0 v1 v2
  = coe
      MAlonzo.Code.Ledger.Conway.Ratify.d_expired'63'_2850 (coe v0)
      (coe
         MAlonzo.Code.Ledger.Conway.Ratify.d_currentEpoch_2268 (coe v1))
      (coe MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe v2))
-- Ledger.Conway.Ratify.Properties.Implementation.acceptConds?
d_acceptConds'63'_2044 ::
  MAlonzo.Code.Ledger.Conway.Transaction.T_TransactionStructure_22 ->
  MAlonzo.Code.Ledger.Conway.Ratify.T_RatifyEnv_2250 ->
  MAlonzo.Code.Ledger.Conway.Ratify.T_RatifyState_2280 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
d_acceptConds'63'_2044 v0 v1 v2 ~v3 v4
  = du_acceptConds'63'_2044 v0 v1 v2 v4
du_acceptConds'63'_2044 ::
  MAlonzo.Code.Ledger.Conway.Transaction.T_TransactionStructure_22 ->
  MAlonzo.Code.Ledger.Conway.Ratify.T_RatifyEnv_2250 ->
  MAlonzo.Code.Ledger.Conway.Ratify.T_RatifyState_2280 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
du_acceptConds'63'_2044 v0 v1 v2 v3
  = coe
      MAlonzo.Code.Relation.Nullary.Decidable.Core.du__'215''45'dec__76
      (coe
         MAlonzo.Code.Ledger.Conway.Ratify.d_accepted'63'_2834 (coe v0)
         (coe v1) (coe MAlonzo.Code.Ledger.Conway.Ratify.d_es_2288 (coe v2))
      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.Ledger.Conway.Ratify.d_delayed'63'_2790 (coe v0)
               (coe
               ...
               (coe
                  ...
                  (coe MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe v3)))
               (coe MAlonzo.Code.Ledger.Conway.Ratify.d_es_2288 (coe v2))
               (coe MAlonzo.Code.Ledger.Conway.Ratify.d_delay_2292 (coe v2)))
            (coe
         ...
         (coe
            ...
            (coe
               ...
               (coe
                  ...
                  (coe
                     MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                     (coe MAlonzo.Code.Ledger.Conway.Ratify.d_treasury_2274 (coe v1))
                     (coe
                        MAlonzo.Code.Ledger.Conway.Ratify.d_currentEpoch_2268 (coe v1)))))
            (coe MAlonzo.Code.Ledger.Conway.Ratify.d_es_2288 (coe v2))
            (coe
...
d_RATIFY'45'total_2048 ::
  MAlonzo.Code.Ledger.Conway.Transaction.T_TransactionStructure_22 ->
  MAlonzo.Code.Ledger.Conway.Ratify.T_RatifyEnv_2250 ->
  MAlonzo.Code.Ledger.Conway.Ratify.T_RatifyState_2280 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_RATIFY'45'total_2048 v0 v1 v2 v3
  = let v4
          = coe
              du_acceptConds'63'_2044 (coe v0) (coe v1) (coe v2) (coe v3) in
    coe
      (let v5
                                                                ...
                                                                coe
                                                                  (coe
                                                                     ...
                                                                     (coe
                                                                        ...
                                                                        (coe v2))))
                                                               (coe
                                                                  MAlonzo.Code.Ledger.Conway.Ratify.du_delayingAction_2680
                                                                  (coe
                                                                     MAlonzo.Code.Ledger.Conway.GovernanceActions.d_gaType_784
                                                                     (coe
                                                                        MAlonzo.Code.Ledger.Conway.GovernanceActions.d_action_876
                                                                        (coe
                                                                           ...
                                                                           (coe v3))))))))
                                                      (coe
                                                         MAlonzo.Code.Ledger.Conway.Ratify.C_RATIFY'45'Accept_2882
                                                         (coe
                                                            MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                                                            (coe v8) (coe v14)))
                                                     ...
                                                     (coe
                                                        ...
                                                        (coe
                                                           ...
                                                           (coe
                                                              ...
                                                              (coe v2)))))
                                                  (coe
                                                     MAlonzo.Code.Ledger.Conway.Ratify.C_RATIFY'45'Reject_2890
                                                     (coe
                                                        MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                                                        erased (coe v10)))
                                           _ -> MAlonzo.RTE.mazUnreachableError
                                                 ...
                                                 (coe
                                                    ...
                                                    (coe
                                                       ...
                                                       (coe
                                                          ...
                                                          (coe v2)))))
                                              (coe
                                                 MAlonzo.Code.Ledger.Conway.Ratify.C_RATIFY'45'Continue_2898
                                                 (coe
                                                    MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                                                    erased erased)))
                             _ -> MAlonzo.RTE.mazUnreachableError)
...
d_computeProof_2066 v0 v1 v2 v3
  = coe
      ...
      (coe d_RATIFY'45'total_2048 (coe v0) (coe v1) (coe v2) (coe v3))
-- Ledger.Conway.Ratify.Properties.Implementation.RATIFY-completeness
d_RATIFY'45'completeness_2070 ::
  MAlonzo.Code.Ledger.Conway.Transaction.T_TransactionStructure_22 ->
  MAlonzo.Code.Ledger.Conway.Ratify.T_RatifyEnv_2250 ->
  MAlonzo.Code.Ledger.Conway.Ratify.T_RatifyState_2280 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Conway.Ratify.T_RatifyState_2280 ->
  MAlonzo.Code.Ledger.Conway.Ratify.T__'8866'_'8640''10631'_'44'RATIFY'10632'__2868 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_RATIFY'45'completeness_2070 = erased
...
d_RATIFIES'45'complete_2152 ::
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_RATIFIES'45'complete_2152 = erased
-- Ledger.Conway.Ratify.Properties.RATIFIES-total'
d_RATIFIES'45'total''_2162 ::
  MAlonzo.Code.Ledger.Conway.Transaction.T_TransactionStructure_22 ->
  MAlonzo.Code.Ledger.Conway.Ratify.T_RatifyEnv_2250 ->
  MAlonzo.Code.Ledger.Conway.Ratify.T_RatifyState_2280 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_RATIFIES'45'total''_2162 v0 v1 v2 v3
  = coe d_RATIFIES'45'total_2142 (coe v0) (coe v1) (coe v2) (coe v3)
-- Ledger.Conway.Ratify.Properties.RATIFIES-complete'
d_RATIFIES'45'complete''_2172 ::
  MAlonzo.Code.Ledger.Conway.Transaction.T_TransactionStructure_22 ->
  MAlonzo.Code.Ledger.Conway.Ratify.T_RatifyEnv_2250 ->
  MAlonzo.Code.Ledger.Conway.Ratify.T_RatifyState_2280 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  ...
  MAlonzo.Code.Interface.STS.T__'8866'_'8640''10214'_'10215''42'__38 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_RATIFIES'45'complete''_2172 = erased
