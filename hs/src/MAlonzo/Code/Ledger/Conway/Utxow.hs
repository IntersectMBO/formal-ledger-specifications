...
d_txAD_2582 ::
  MAlonzo.Code.Ledger.Conway.Transaction.T_TransactionStructure_22 ->
  MAlonzo.Code.Ledger.Conway.Abstract.T_AbstractFunctions_1992 ->
  T_GeneralizeTel_36393 -> Maybe AgdaAny
d_txAD_2582 ~v0 ~v1 v2 = du_txAD_2582 v2
du_txAD_2582 :: T_GeneralizeTel_36393 -> Maybe AgdaAny
du_txAD_2582 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Transaction.d_txAD_3214
      (coe d_'46'generalizedField'45'tx_36387 (coe v0))
-- Ledger.Conway.Utxow._.body
d_body_2584 ::
  MAlonzo.Code.Ledger.Conway.Transaction.T_TransactionStructure_22 ->
  MAlonzo.Code.Ledger.Conway.Abstract.T_AbstractFunctions_1992 ->
  T_GeneralizeTel_36393 ->
  MAlonzo.Code.Ledger.Conway.Transaction.T_TxBody_3006
...
d_refInputs_2596 ::
  MAlonzo.Code.Ledger.Conway.Transaction.T_TransactionStructure_22 ->
  MAlonzo.Code.Ledger.Conway.Abstract.T_AbstractFunctions_1992 ->
  T_GeneralizeTel_36393 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
...
du_txADhash_2602 :: T_GeneralizeTel_36393 -> Maybe AgdaAny
du_txADhash_2602 v0
  = coe
...
d_txid_2612 ::
  MAlonzo.Code.Ledger.Conway.Transaction.T_TransactionStructure_22 ->
  MAlonzo.Code.Ledger.Conway.Abstract.T_AbstractFunctions_1992 ->
  T_GeneralizeTel_36393 -> AgdaAny
d_txid_2612 ~v0 ~v1 v2 = du_txid_2612 v2
du_txid_2612 :: T_GeneralizeTel_36393 -> AgdaAny
du_txid_2612 v0
  = coe
...
d_scripts_2632 ::
  MAlonzo.Code.Ledger.Conway.Transaction.T_TransactionStructure_22 ->
  MAlonzo.Code.Ledger.Conway.Abstract.T_AbstractFunctions_1992 ->
  T_GeneralizeTel_36393 -> [MAlonzo.Code.Data.Sum.Base.T__'8846'__30]
...
d_'46'generalizedField'45's_36385 ::
  T_GeneralizeTel_36393 ->
  MAlonzo.Code.Ledger.Conway.Utxo.T_UTxOState_2296
d_'46'generalizedField'45's_36385 v0
  = case coe v0 of
      C_mkGeneralizeTel_36395 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Utxow..generalizedField-tx
d_'46'generalizedField'45'tx_36387 ::
  T_GeneralizeTel_36393 ->
  MAlonzo.Code.Ledger.Conway.Transaction.T_Tx_3198
d_'46'generalizedField'45'tx_36387 v0
  = case coe v0 of
      C_mkGeneralizeTel_36395 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Utxow..generalizedField-Γ
d_'46'generalizedField'45'Γ_36389 ::
  T_GeneralizeTel_36393 ->
  MAlonzo.Code.Ledger.Conway.Utxo.T_UTxOEnv_2278
d_'46'generalizedField'45'Γ_36389 v0
  = case coe v0 of
      C_mkGeneralizeTel_36395 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Utxow..generalizedField-s'
d_'46'generalizedField'45's''_36391 ::
  T_GeneralizeTel_36393 ->
  MAlonzo.Code.Ledger.Conway.Utxo.T_UTxOState_2296
d_'46'generalizedField'45's''_36391 v0
  = case coe v0 of
      C_mkGeneralizeTel_36395 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Utxow.GeneralizeTel
d_GeneralizeTel_36393 a0 a1 = ()
data T_GeneralizeTel_36393
  = C_mkGeneralizeTel_36395 MAlonzo.Code.Ledger.Conway.Utxo.T_UTxOState_2296
                            MAlonzo.Code.Ledger.Conway.Transaction.T_Tx_3198
                            MAlonzo.Code.Ledger.Conway.Utxo.T_UTxOEnv_2278
                            MAlonzo.Code.Ledger.Conway.Utxo.T_UTxOState_2296
