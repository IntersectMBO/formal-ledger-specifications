...
du_HasCast'45'UTxOEnv_1836 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'UTxOEnv_1836
  = coe MAlonzo.Code.Ledger.Conway.Utxo.du_HasCast'45'UTxOEnv_2106
...
du_HasDeposits'45'UTxOState_1844
  = coe
      MAlonzo.Code.Ledger.Conway.Utxo.du_HasDeposits'45'UTxOState_2102
...
du_HasUTxO'45'UTxOState_1848 ::
  MAlonzo.Code.Ledger.Conway.Transaction.T_HasUTxO_2928
du_HasUTxO'45'UTxOState_1848
  = coe MAlonzo.Code.Ledger.Conway.Utxo.du_HasUTxO'45'UTxOState_2104
...
d_UTxOStateOf_1870 ::
  MAlonzo.Code.Ledger.Conway.Utxo.T_HasUTxOState_2088 ->
  AgdaAny -> MAlonzo.Code.Ledger.Conway.Utxo.T_UTxOState_2064
d_UTxOStateOf_1870 v0
  = coe MAlonzo.Code.Ledger.Conway.Utxo.d_UTxOStateOf_2096 (coe v0)
...
d_LState_2412 a0 a1 = ()
data T_LState_2412
  = C_'10214'_'44'_'44'_'10215''737'_2426 MAlonzo.Code.Ledger.Conway.Utxo.T_UTxOState_2064
                                          [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
                                          MAlonzo.Code.Ledger.Conway.Certs.T_CertState_1216
-- Ledger.Conway.Ledger.LState.utxoSt
d_utxoSt_2420 ::
  T_LState_2412 -> MAlonzo.Code.Ledger.Conway.Utxo.T_UTxOState_2064
d_utxoSt_2420 v0
  = case coe v0 of
...
du_HasUTxOState'45'LState_2446
  = coe
      MAlonzo.Code.Ledger.Conway.Utxo.C_HasUTxOState'46'constructor_6507
...
du_txcerts_2594 v0
  = coe
      ...
      (coe
         ...
         (coe d_'46'generalizedField'45'tx_18165 (coe v0)))
-- Ledger.Conway.Ledger._.txid
d_txid_2600 ::
  MAlonzo.Code.Ledger.Conway.Transaction.T_TransactionStructure_22 ->
  MAlonzo.Code.Ledger.Conway.Abstract.T_AbstractFunctions_1956 ->
  T_GeneralizeTel_18189 -> AgdaAny
d_txid_2600 ~v0 ~v1 v2 = du_txid_2600 v2
du_txid_2600 :: T_GeneralizeTel_18189 -> AgdaAny
du_txid_2600 v0
  = coe
...
d_txwdrls_2616 ::
  MAlonzo.Code.Ledger.Conway.Transaction.T_TransactionStructure_22 ->
  MAlonzo.Code.Ledger.Conway.Abstract.T_AbstractFunctions_1956 ->
  T_GeneralizeTel_18189 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_'46'generalizedField'45'tx_18165 ::
  T_GeneralizeTel_18189 ->
  MAlonzo.Code.Ledger.Conway.Transaction.T_Tx_3134
d_'46'generalizedField'45'tx_18165 v0
  = case coe v0 of
      C_mkGeneralizeTel_18191 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Ledger..generalizedField-certState
d_'46'generalizedField'45'certState_18167 ::
  T_GeneralizeTel_18189 ->
  MAlonzo.Code.Ledger.Conway.Certs.T_CertState_1216
d_'46'generalizedField'45'certState_18167 v0
  = case coe v0 of
      C_mkGeneralizeTel_18191 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Ledger..generalizedField-slot
d_'46'generalizedField'45'slot_18169 ::
  T_GeneralizeTel_18189 -> AgdaAny
d_'46'generalizedField'45'slot_18169 v0
  = case coe v0 of
      C_mkGeneralizeTel_18191 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Ledger..generalizedField-pp
d_'46'generalizedField'45'pp_18171 ::
  T_GeneralizeTel_18189 ->
  MAlonzo.Code.Ledger.Conway.PParams.T_PParams_296
d_'46'generalizedField'45'pp_18171 v0
  = case coe v0 of
      C_mkGeneralizeTel_18191 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Ledger..generalizedField-treasury
d_'46'generalizedField'45'treasury_18173 ::
  T_GeneralizeTel_18189 -> Integer
d_'46'generalizedField'45'treasury_18173 v0
  = case coe v0 of
      C_mkGeneralizeTel_18191 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Ledger..generalizedField-utxoSt
d_'46'generalizedField'45'utxoSt_18175 ::
  T_GeneralizeTel_18189 ->
  MAlonzo.Code.Ledger.Conway.Utxo.T_UTxOState_2064
d_'46'generalizedField'45'utxoSt_18175 v0
  = case coe v0 of
      C_mkGeneralizeTel_18191 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Ledger..generalizedField-utxoSt'
d_'46'generalizedField'45'utxoSt''_18177 ::
  T_GeneralizeTel_18189 ->
  MAlonzo.Code.Ledger.Conway.Utxo.T_UTxOState_2064
d_'46'generalizedField'45'utxoSt''_18177 v0
  = case coe v0 of
      C_mkGeneralizeTel_18191 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Ledger..generalizedField-govSt
d_'46'generalizedField'45'govSt_18179 ::
  T_GeneralizeTel_18189 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
d_'46'generalizedField'45'govSt_18179 v0
  = case coe v0 of
      C_mkGeneralizeTel_18191 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Ledger..generalizedField-enactState
d_'46'generalizedField'45'enactState_18181 ::
  T_GeneralizeTel_18189 ->
  MAlonzo.Code.Ledger.Conway.Enact.T_EnactState_942
d_'46'generalizedField'45'enactState_18181 v0
  = case coe v0 of
      C_mkGeneralizeTel_18191 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v9
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Ledger..generalizedField-certState'
d_'46'generalizedField'45'certState''_18183 ::
  T_GeneralizeTel_18189 ->
  MAlonzo.Code.Ledger.Conway.Certs.T_CertState_1216
d_'46'generalizedField'45'certState''_18183 v0
  = case coe v0 of
      C_mkGeneralizeTel_18191 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v10
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Ledger..generalizedField-ppolicy
d_'46'generalizedField'45'ppolicy_18185 ::
  T_GeneralizeTel_18189 -> Maybe AgdaAny
d_'46'generalizedField'45'ppolicy_18185 v0
  = case coe v0 of
      C_mkGeneralizeTel_18191 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v11
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Ledger..generalizedField-govSt'
d_'46'generalizedField'45'govSt''_18187 ::
  T_GeneralizeTel_18189 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
d_'46'generalizedField'45'govSt''_18187 v0
  = case coe v0 of
      C_mkGeneralizeTel_18191 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v12
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Ledger.GeneralizeTel
d_GeneralizeTel_18189 a0 a1 = ()
data T_GeneralizeTel_18189
  = C_mkGeneralizeTel_18191 MAlonzo.Code.Ledger.Conway.Transaction.T_Tx_3134
