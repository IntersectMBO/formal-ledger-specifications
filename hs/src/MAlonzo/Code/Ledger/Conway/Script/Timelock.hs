                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (MAlonzo.Code.Ledger.Prelude.Crypto.d_DecEq'45'THash_24
                                          (coe
                                             MAlonzo.Code.Ledger.Prelude.Crypto.d_khs_202 (coe v0)))
                                       v5 v3))
                                 (coe
                                    MAlonzo.Code.Function.Bundles.du_mk'8660'_2414 erased
                                    (coe
             ...
             (coe
                ...
                (coe
                   ...
                   (coe
                      ...
                      erased
                      (MAlonzo.Code.Ledger.Prelude.Crypto.d_DecEq'45'THash_24
                         (coe MAlonzo.Code.Ledger.Prelude.Crypto.d_khs_202 (coe v0))))
                   (coe v6)
                   (coe
                   ...
                   (coe
                      ...
                      (coe
                         ...
                         (coe
                            ...
                            (MAlonzo.Code.Ledger.Prelude.Epoch.d_DecPo'45'Slot_64 (coe v1))
                            v6)))
                      ...
                      (coe
                         ...
                         (coe
                            (\ v7 ->
                               coe
                                 MAlonzo.Code.Class.HasOrder.Core.d_dec'45''8804'_266
                                 (MAlonzo.Code.Ledger.Prelude.Epoch.d_DecPo'45'Slot_64 (coe v1)) v7
                                 v6))))
