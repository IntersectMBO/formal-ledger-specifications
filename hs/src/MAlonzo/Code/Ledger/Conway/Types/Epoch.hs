...
module MAlonzo.Code.Ledger.Conway.Types.Epoch where
...
-- Ledger.Conway.Types.Epoch.additionVia
d_additionVia_10 ::
...
-- Ledger.Conway.Types.Epoch.EpochStructure
d_EpochStructure_22 = ()
data T_EpochStructure_22
  = C_EpochStructure'46'constructor_1323 MAlonzo.Code.Algebra.Bundles.T_Semiring_2304
                                         ...
                                         (AgdaAny -> AgdaAny) (Integer -> AgdaAny -> AgdaAny)
-- Ledger.Conway.Types.Epoch.EpochStructure.Slotʳ
d_Slot'691'_56 ::
...
-- Ledger.Conway.Types.Epoch.EpochStructure.Epoch
d_Epoch_58 :: T_EpochStructure_22 -> ()
d_Epoch_58 = erased
-- Ledger.Conway.Types.Epoch.EpochStructure.DecEq-Epoch
d_DecEq'45'Epoch_60 ::
...
d_DecEq'45'Epoch_60 v0
  = case coe v0 of
      C_EpochStructure'46'constructor_1323 v1 v3 v4 v5 v6 v7 v8 v9 v10 v11
        -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Types.Epoch.EpochStructure.Show-Epoch
d_Show'45'Epoch_62 ::
...
d_Show'45'Epoch_62 v0
  = case coe v0 of
      C_EpochStructure'46'constructor_1323 v1 v3 v4 v5 v6 v7 v8 v9 v10 v11
        -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Types.Epoch.EpochStructure.Slot
d_Slot_64 :: T_EpochStructure_22 -> ()
d_Slot_64 = erased
-- Ledger.Conway.Types.Epoch.EpochStructure.DecPo-Slot
d_DecPo'45'Slot_66 ::
  T_EpochStructure_22 ->
  MAlonzo.Code.Class.HasOrder.Core.T_HasDecPartialOrder_256
d_DecPo'45'Slot_66 v0
  = case coe v0 of
      C_EpochStructure'46'constructor_1323 v1 v3 v4 v5 v6 v7 v8 v9 v10 v11
        -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Types.Epoch.EpochStructure.DecEq-Slot
d_DecEq'45'Slot_68 ::
  T_EpochStructure_22 -> MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
...
d_epoch_70 v0
  = case coe v0 of
      C_EpochStructure'46'constructor_1323 v1 v3 v4 v5 v6 v7 v8 v9 v10 v11
        -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Types.Epoch.EpochStructure.firstSlot
...
d_firstSlot_72 v0
  = case coe v0 of
      C_EpochStructure'46'constructor_1323 v1 v3 v4 v5 v6 v7 v8 v9 v10 v11
        -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Types.Epoch.EpochStructure.StabilityWindow
...
d_StabilityWindow_74 v0
  = case coe v0 of
      C_EpochStructure'46'constructor_1323 v1 v3 v4 v5 v6 v7 v8 v9 v10 v11
        -> coe v9
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Types.Epoch.EpochStructure.sucᵉ
...
d_suc'7497'_76 v0
  = case coe v0 of
      C_EpochStructure'46'constructor_1323 v1 v3 v4 v5 v6 v7 v8 v9 v10 v11
        -> coe v10
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Types.Epoch.EpochStructure._+ᵉ_
d__'43''7497'__78 ::
  T_EpochStructure_22 -> Integer -> AgdaAny -> AgdaAny
d__'43''7497'__78 v0
  = coe du_additionVia_10 (coe d_suc'7497'_76 (coe v0))
-- Ledger.Conway.Types.Epoch.EpochStructure._+ᵉ'_
d__'43''7497'''__80 ::
  T_EpochStructure_22 -> Integer -> AgdaAny -> AgdaAny
d__'43''7497'''__80 v0
  = case coe v0 of
      C_EpochStructure'46'constructor_1323 v1 v3 v4 v5 v6 v7 v8 v9 v10 v11
        -> coe v11
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Types.Epoch.EpochStructure.+ᵉ≡+ᵉ'
d_'43''7497''8801''43''7497'''_86 ::
  T_EpochStructure_22 ->
  Integer ->
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_'43''7497''8801''43''7497'''_86 = erased
-- Ledger.Conway.Types.Epoch.EpochStructure.preoEpoch
d_preoEpoch_88 ::
  T_EpochStructure_22 ->
...
-- Ledger.Conway.Types.Epoch.EpochStructure.ℕtoEpoch
...
-- Ledger.Conway.Types.Epoch.EpochStructure.addSlot
d_addSlot_246 ::
...
d_addSlot_246 v0
  = coe
      ...
      (coe
         ...
         (coe d_Slot'691'_56 (coe v0)))
-- Ledger.Conway.Types.Epoch.EpochStructure.addEpoch
d_addEpoch_248 ::
  T_EpochStructure_22 -> MAlonzo.Code.Class.HasAdd.Core.T_HasAdd_10
d_addEpoch_248 v0
  = coe
...
-- Ledger.Conway.Types.Epoch.EpochStructure.Number-Epoch
...
-- Ledger.Conway.Types.Epoch.GlobalConstants
...
d_DecEq'45'Netw_282 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_6529 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Types.Epoch.GlobalConstants.Show-Network
...
d_Show'45'Network_284 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_6529 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Types.Epoch.GlobalConstants.SlotsPerEpochᶜ
...
d_SlotsPerEpoch'7580'_286 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_6529 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Types.Epoch.GlobalConstants.NonZero-SlotsPerEpochᶜ
...
d_NonZero'45'SlotsPerEpoch'7580'_288 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_6529 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Types.Epoch.GlobalConstants.ActiveSlotCoeff
...
d_NonZero'45'ActiveSlotCoeff_292 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_6529 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Types.Epoch.GlobalConstants.StabilityWindowᶜ
...
d_StabilityWindow'7580'_294 v0
  = case coe v0 of
      C_GlobalConstants'46'constructor_6529 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Types.Epoch.GlobalConstants.Quorum
