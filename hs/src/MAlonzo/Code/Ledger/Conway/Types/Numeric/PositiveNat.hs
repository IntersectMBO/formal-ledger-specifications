...
module MAlonzo.Code.Ledger.Conway.Types.Numeric.PositiveNat where
...
-- Ledger.Conway.Types.Numeric.PositiveNat.PosNat
d_PosNat_10 :: ()
d_PosNat_10 = erased
-- Ledger.Conway.Types.Numeric.PositiveNat.Show-PosNat
d_Show'45'PosNat_14 :: MAlonzo.Code.Class.Show.Core.T_Show_10
d_Show'45'PosNat_14
  = coe
...
-- Ledger.Conway.Types.Numeric.PositiveNat.fromPosNat
d_fromPosNat_18 ::
  MAlonzo.Code.Data.Refinement.Base.T_Refinement_28 -> Integer
d_fromPosNat_18 v0
  = coe MAlonzo.Code.Data.Refinement.Base.d_value_38 (coe v0)
-- Ledger.Conway.Types.Numeric.PositiveNat.toPosNat
d_toPosNat_20 ::
  ...
  = let v1
    ...
    coe
      (case coe v1 of
         ...
         _ -> MAlonzo.RTE.mazUnreachableError)
-- Ledger.Conway.Types.Numeric.PositiveNat.mkPosNat
d_mkPosNat_38 ::
  Integer ->
  AgdaAny -> MAlonzo.Code.Data.Refinement.Base.T_Refinement_28
d_mkPosNat_38 v0 ~v1 = du_mkPosNat_38 v0
du_mkPosNat_38 ::
  ...
  = let v1
    ...
    coe
      (case coe v1 of
         ...
         _ -> MAlonzo.RTE.mazUnreachableError)
-- Ledger.Conway.Types.Numeric.PositiveNat.PosNat-IsNonZero
d_PosNat'45'IsNonZero_62 ::
  MAlonzo.Code.Data.Refinement.Base.T_Refinement_28 ->
  MAlonzo.Code.Data.Nat.Base.T_NonZero_112
d_PosNat'45'IsNonZero_62 v0
  = coe
      MAlonzo.Code.Data.Nat.Base.C_NonZero'46'constructor_3575
      (coe seq (coe v0) (coe MAlonzo.Code.Agda.Builtin.Unit.C_tt_8))
-- Ledger.Conway.Types.Numeric.PositiveNat.PosNat-Is>0
d_PosNat'45'Is'62'0_70 ::
  MAlonzo.Code.Data.Refinement.Base.T_Refinement_28 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
d_PosNat'45'Is'62'0_70 v0
  = coe
      seq (coe v0)
      (coe
         MAlonzo.Code.Data.Nat.Base.C_s'8804's_34
         (coe MAlonzo.Code.Data.Nat.Base.C_z'8804'n_26))
-- Ledger.Conway.Types.Numeric.PositiveNat.Number-PosNat
d_Number'45'PosNat_76 ::
