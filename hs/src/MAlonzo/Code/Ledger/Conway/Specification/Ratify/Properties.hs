...
import qualified MAlonzo.Code.Ledger.Conway.Specification.GovernanceActions.Properties
      ...
      (coe
         ...
         (coe
            ...
            (coe
               ...
               (coe MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe v3)))
            (coe
               MAlonzo.Code.Ledger.Conway.Specification.GovernanceActions.Properties.d_Computational'45'ENACT_1028
               (coe
