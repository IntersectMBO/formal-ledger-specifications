...
d__'8866'_'8640''10631'_'44'POOLREAP'10632'__1774 a0 a1 a2 a3 a4 a5
  = ()
-- Ledger.Conway.Specification.PoolReap.Properties.Computational._.PoolReapState
d_PoolReapState_1780 a0 a1 = ()
-- Ledger.Conway.Specification.PoolReap.Properties.Computational._.PoolReapState.acnt
d_acnt_1792 ::
  MAlonzo.Code.Ledger.Conway.Specification.PoolReap.T_PoolReapState_2376 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_166
d_acnt_1792 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.PoolReap.d_acnt_2388
      (coe v0)
...
d_dState_1794 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.PoolReap.d_dState_2390
      (coe v0)
...
d_pState_1796 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.PoolReap.d_pState_2392
      (coe v0)
...
d_utxoSt_1798 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.PoolReap.d_utxoSt_2386
      (coe v0)
-- Ledger.Conway.Specification.PoolReap.Properties.Computational._.POOLREAP-total
d_POOLREAP'45'total_1830 ::
  MAlonzo.Code.Ledger.Core.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Core.Specification.Abstract.T_AbstractFunctions_2266 ->
  AgdaAny ->
  MAlonzo.Code.Ledger.Conway.Specification.PoolReap.T_PoolReapState_2376 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_POOLREAP'45'total_1830 v0 ~v1 v2 v3
  = du_POOLREAP'45'total_1830 v0 v2 v3
du_POOLREAP'45'total_1830 ::
  MAlonzo.Code.Ledger.Core.Specification.Transaction.T_TransactionStructure_24 ->
  AgdaAny ->
  MAlonzo.Code.Ledger.Conway.Specification.PoolReap.T_PoolReapState_2376 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_POOLREAP'45'total_1830 v0 v1 v2
  = coe
         ...
         (coe
            ...
            (coe
               ...
               (coe
                  ...
                  (let v3
                         = coe
                             MAlonzo.Code.Ledger.Conway.Specification.PoolReap.C_mkGeneralizeTel_11151
                             (coe v2) (coe v1) in
                   coe
                     (coe
                        MAlonzo.Code.Ledger.Conway.Specification.PoolReap.d_utxoSt_2386
                        (coe
                           MAlonzo.Code.Ledger.Conway.Specification.PoolReap.d_'46'generalizedField'45'poolReapState_11145
                           (coe v3)))))
               (coe
                                 ...
                                 (let v4
                                  ...
                                  coe
                                    (coe
                                       ...
                                       (coe v1))))))))))))
      (coe
         MAlonzo.Code.Ledger.Conway.Specification.PoolReap.C_POOLREAP_2438
         v2)
-- Ledger.Conway.Specification.PoolReap.Properties.Computational._.POOLREAP-complete
d_POOLREAP'45'complete_1834 ::
  MAlonzo.Code.Ledger.Core.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Core.Specification.Abstract.T_AbstractFunctions_2266 ->
  AgdaAny ->
  MAlonzo.Code.Ledger.Conway.Specification.PoolReap.T_PoolReapState_2376 ->
  MAlonzo.Code.Ledger.Conway.Specification.PoolReap.T_PoolReapState_2376 ->
  MAlonzo.Code.Ledger.Conway.Specification.PoolReap.T__'8866'_'8640''10631'_'44'POOLREAP'10632'__2404 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_POOLREAP'45'complete_1834 = erased
-- Ledger.Conway.Specification.PoolReap.Properties.Computational._.POOLREAP-deterministic
d_POOLREAP'45'deterministic_1842 ::
  MAlonzo.Code.Ledger.Core.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Core.Specification.Abstract.T_AbstractFunctions_2266 ->
  AgdaAny ->
  MAlonzo.Code.Ledger.Conway.Specification.PoolReap.T_PoolReapState_2376 ->
...
d_POOLREAP'45'deterministic'45''8801'_1856 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.PoolReap.T__'8866'_'8640''10631'_'44'POOLREAP'10632'__2404 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_POOLREAP'45'deterministic'45''8801'_1856 = erased
