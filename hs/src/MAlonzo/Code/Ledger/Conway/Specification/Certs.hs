...
data T_DelegEnv_1482
  = C_constructor_1496 MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_286
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          ...
                                          (coe
                                             ...
                                             (coe
                                                (MAlonzo.RTE.QName
                                                   (132 :: Integer) (3005244792873517680 :: Integer)
                                                   "_.Epoch"
                                                   (MAlonzo.RTE.Fixity
                                                      MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                             (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))
...
d__'8866'_'8640''10631'_'44'DELEG'10632'__1708 a0 a1 a2 a3 a4 = ()
data T__'8866'_'8640''10631'_'44'DELEG'10632'__1708
  = C_DELEG'45'delegate_1710 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 |
    C_DELEG'45'dereg_1712 MAlonzo.Code.Data.List.Relation.Unary.Any.T_Any_34 |
    C_DELEG'45'reg_1714 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
-- Ledger.Conway.Specification.Certs.isPoolRegistered
d_isPoolRegistered_1716 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  AgdaAny -> Maybe T_StakePoolParams_1166
d_isPoolRegistered_1716 v0 v1 v2
  = coe
...
d__'8866'_'8640''10631'_'44'POOL'10632'__1722 a0 a1 a2 a3 a4 = ()
data T__'8866'_'8640''10631'_'44'POOL'10632'__1722
  = C_POOL'45'regpool_1726 | C_POOL'45'retirepool_1728
-- Ledger.Conway.Specification.Certs._⊢_⇀⦇_,GOVCERT⦈_
d__'8866'_'8640''10631'_'44'GOVCERT'10632'__1730 a0 a1 a2 a3 a4
  = ()
data T__'8866'_'8640''10631'_'44'GOVCERT'10632'__1730
  = C_GOVCERT'45'regdrep_1732 MAlonzo.Code.Data.Sum.Base.T__'8846'__30 |
    C_GOVCERT'45'deregdrep_1734 MAlonzo.Code.Data.List.Relation.Unary.Any.T_Any_34 |
    C_GOVCERT'45'ccreghot_1736 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
-- Ledger.Conway.Specification.Certs._⊢_⇀⦇_,CERT⦈_
d__'8866'_'8640''10631'_'44'CERT'10632'__1738 a0 a1 a2 a3 a4 = ()
data T__'8866'_'8640''10631'_'44'CERT'10632'__1738
  = C_CERT'45'deleg_1740 T__'8866'_'8640''10631'_'44'DELEG'10632'__1708 |
    C_CERT'45'pool_1742 T__'8866'_'8640''10631'_'44'POOL'10632'__1722 |
    C_CERT'45'vdel_1744 T__'8866'_'8640''10631'_'44'GOVCERT'10632'__1730
-- Ledger.Conway.Specification.Certs._⊢_⇀⦇_,PRE-CERT⦈_
d__'8866'_'8640''10631'_'44'PRE'45'CERT'10632'__1746 a0 a1 a2 a3 a4
  = ()
newtype T__'8866'_'8640''10631'_'44'PRE'45'CERT'10632'__1746
  = C_CERT'45'pre_1754 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
-- Ledger.Conway.Specification.Certs._⊢_⇀⦇_,CERTS⦈_
d__'8866'_'8640''10631'_'44'CERTS'10632'__1756 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  T_CertEnv_1398 ->
  T_CertState_1466 -> [T_DCert_1358] -> T_CertState_1466 -> ()
d__'8866'_'8640''10631'_'44'CERTS'10632'__1756 = erased
