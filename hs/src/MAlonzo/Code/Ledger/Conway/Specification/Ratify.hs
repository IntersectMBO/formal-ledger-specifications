...
du_SPODefaultVote_2438 v0 v1 v2 v3
  = let v4
          = coe
              MAlonzo.Code.Ledger.Conway.Specification.GovernanceActions.C_no_834 in
    coe
      (case coe v3 of
         MAlonzo.Code.Ledger.Conway.Specification.GovernanceActions.C_credVoter_768 v5 v6
           -> case coe v5 of
                MAlonzo.Code.Ledger.Conway.Specification.GovernanceActions.C_SPO_760
                  -> case coe v6 of
