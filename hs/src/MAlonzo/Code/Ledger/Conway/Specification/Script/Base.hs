...
data T_ScriptStructure_272
  = C_ScriptStructure'46'constructor_7641 T_P1ScriptStructure_100
                                          (() ->
                                           () ->
                                           () ->
                                           MAlonzo.Code.Interface.Hashable.T_Hashable_8 ->
...
d_DecEq'45'P1Script_280 ::
  T_P1ScriptStructure_100 -> MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'P1Script_280 v0 = coe d_DecEq'45'P1Script_120 (coe v0)
...
d_P1Script_284 :: T_P1ScriptStructure_100 -> ()
...
d_p1s_298 :: T_ScriptStructure_272 -> T_P1ScriptStructure_100
d_p1s_298 v0
  = case coe v0 of
...
d_Dec'45'validP1Script_302 v0
  = coe d_Dec'45'validP1Script_116 (coe d_p1s_298 (coe v0))
...
d_DecEq'45'P1Script_304 v0
  = coe d_DecEq'45'P1Script_120 (coe d_p1s_298 (coe v0))
...
d_Hashable'45'P1Script_306 v0
  = coe d_Hashable'45'P1Script_118 (coe d_p1s_298 (coe v0))
...
d_ps_320 :: T_ScriptStructure_272 -> T_PlutusStructure_122
d_ps_320 v0
  = case coe v0 of
...
d_Data'688'_332 ::
  T_ScriptStructure_272 ->
  MAlonzo.Code.Ledger.Core.Specification.Crypto.T_HashableSet_36
d_Data'688'_332 v0 = coe d_Data'688'_198 (coe d_ps_320 (coe v0))
...
d_DecEq'45'LangDepView_344 v0
  = coe d_DecEq'45'LangDepView_226 (coe d_ps_320 (coe v0))
...
d_DecEq'45'Language_346 v0
  = coe d_DecEq'45'Language_222 (coe d_ps_320 (coe v0))
-- Ledger.Conway.Specification.Script.Base.ScriptStructure._.DecEq-T
d_DecEq'45'T_348 ::
  T_ScriptStructure_272 -> MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'T_348 v0
  = let v1 = d_Data'688'_198 (coe d_ps_320 (coe v0)) in
    coe
      (coe
         MAlonzo.Code.Ledger.Core.Specification.Crypto.d_DecEq'45'T_30
         (coe
...
d_ExUnit'45'CommutativeMonoid_352 v0
  = coe d_ExUnit'45'CommutativeMonoid_218 (coe d_ps_320 (coe v0))
...
d_Hashable'45'PlutusScript_356 v0
  = coe d_Hashable'45'PlutusScript_220 (coe d_ps_320 (coe v0))
...
d_T'45'isHashable_384 v0
  = coe
      MAlonzo.Code.Ledger.Core.Specification.Crypto.d_T'45'isHashable_44
      (coe d_Data'688'_198 (coe d_ps_320 (coe v0)))
-- Ledger.Conway.Specification.Script.Base.ScriptStructure._.language
d_language_386 :: T_ScriptStructure_272 -> AgdaAny -> AgdaAny
d_language_386 v0 = coe d_language_266 (coe d_ps_320 (coe v0))
-- Ledger.Conway.Specification.Script.Base.ScriptStructure._.toData
d_toData_388 :: T_ScriptStructure_272 -> () -> AgdaAny -> AgdaAny
d_toData_388 v0 = coe d_toData_270 (coe d_ps_320 (coe v0))
...
d_Hashable'45'Script_394 ::
  ...
  T_ScriptStructure_272 ->
  MAlonzo.Code.Interface.Hashable.T_Hashable_8
d_Hashable'45'Script_394 ~v0 ~v1 v2 = du_Hashable'45'Script_394 v2
du_Hashable'45'Script_394 ::
  T_ScriptStructure_272 ->
  MAlonzo.Code.Interface.Hashable.T_Hashable_8
du_Hashable'45'Script_394 v0
  = coe
      d_hashRespectsUnion_318 v0 erased erased erased
      (d_Hashable'45'P1Script_118 (coe d_p1s_298 (coe v0)))
      (d_Hashable'45'PlutusScript_220 (coe d_ps_320 (coe v0)))
...
d_isP1Script_396 = erased
-- Ledger.Conway.Specification.Script.Base.ScriptStructure.isP1Script?
d_isP1Script'63'_400 ::
  MAlonzo.Code.Ledger.Core.Specification.Crypto.T_CryptoStructure_138 ->
  MAlonzo.Code.Ledger.Core.Specification.Epoch.T_EpochStructure_22 ->
  T_ScriptStructure_272 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  MAlonzo.Code.Class.Decidable.Core.T__'8263'_10
d_isP1Script'63'_400 ~v0 ~v1 ~v2 v3 = du_isP1Script'63'_400 v3
du_isP1Script'63'_400 ::
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  MAlonzo.Code.Class.Decidable.Core.T__'8263'_10
du_isP1Script'63'_400 v0
  = coe
...
d_isNativeScript_406 ::
  MAlonzo.Code.Ledger.Core.Specification.Crypto.T_CryptoStructure_138 ->
  MAlonzo.Code.Ledger.Core.Specification.Epoch.T_EpochStructure_22 ->
  T_ScriptStructure_272 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> ()
d_isNativeScript_406 = erased
...
d_toP1Script_408 ~v0 ~v1 ~v2 = du_toP1Script_408
du_toP1Script_408 ::
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Maybe AgdaAny
du_toP1Script_408 = coe MAlonzo.Code.Data.Sum.du_isInj'8321'_24
...
d_isP2Script_410 ::
  ...
  T_ScriptStructure_272 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> ()
d_isP2Script_410 = erased
-- Ledger.Conway.Specification.Script.Base.ScriptStructure.isP2Script?
d_isP2Script'63'_414 ::
  MAlonzo.Code.Ledger.Core.Specification.Crypto.T_CryptoStructure_138 ->
  MAlonzo.Code.Ledger.Core.Specification.Epoch.T_EpochStructure_22 ->
  T_ScriptStructure_272 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  MAlonzo.Code.Class.Decidable.Core.T__'8263'_10
d_isP2Script'63'_414 ~v0 ~v1 ~v2 v3 = du_isP2Script'63'_414 v3
du_isP2Script'63'_414 ::
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  MAlonzo.Code.Class.Decidable.Core.T__'8263'_10
du_isP2Script'63'_414 v0
  = coe
      MAlonzo.Code.Class.Decidable.Core.C_'8263'__30
      (case coe v0 of
         MAlonzo.Code.Data.Sum.Base.C_inj'8321'_38 v1
...
d_toP2Script_420 ::
  ...
  T_ScriptStructure_272 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Maybe AgdaAny
d_toP2Script_420 ~v0 ~v1 ~v2 = du_toP2Script_420
du_toP2Script_420 ::
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Maybe AgdaAny
du_toP2Script_420 = coe MAlonzo.Code.Data.Sum.du_isInj'8322'_30
