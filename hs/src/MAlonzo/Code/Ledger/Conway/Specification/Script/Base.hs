...
d_PlutusV2_218 :: T_PlutusStructure_128 -> AgdaAny
d_PlutusV2_218 v0
  = case coe v0 of
      C_constructor_274 v1 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17 v19 v20 v21 v22 v24 v25
        -> coe v9
...
d_PlutusV3_220 :: T_PlutusStructure_128 -> AgdaAny
d_PlutusV3_220 v0
  = case coe v0 of
      C_constructor_274 v1 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17 v19 v20 v21 v22 v24 v25
        -> coe v10
...
d_DecEq'45'P1Script_284 ::
  T_P1ScriptStructure_104 -> MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'P1Script_284 v0 = coe d_DecEq'45'P1Script_124 (coe v0)
...
d_P1Script_288 :: T_P1ScriptStructure_104 -> ()
...
d_p1s_302 :: T_ScriptStructure_276 -> T_P1ScriptStructure_104
d_p1s_302 v0
  = case coe v0 of
...
d_Dec'45'validP1Script_306 v0
  = coe d_Dec'45'validP1Script_120 (coe d_p1s_302 (coe v0))
...
d_DecEq'45'P1Script_308 v0
  = coe d_DecEq'45'P1Script_124 (coe d_p1s_302 (coe v0))
...
d_Hashable'45'P1Script_310 v0
  = coe d_Hashable'45'P1Script_122 (coe d_p1s_302 (coe v0))
...
d_ps_324 :: T_ScriptStructure_276 -> T_PlutusStructure_128
d_ps_324 v0
  = case coe v0 of
...
d_Data'688'_336 ::
  T_ScriptStructure_276 ->
  MAlonzo.Code.Ledger.Core.Specification.Crypto.T_HashableSet_36
d_Data'688'_336 v0 = coe d_Data'688'_202 (coe d_ps_324 (coe v0))
...
d_DecEq'45'LangDepView_348 v0
  = coe d_DecEq'45'LangDepView_230 (coe d_ps_324 (coe v0))
...
d_DecEq'45'Language_350 v0
  = coe d_DecEq'45'Language_226 (coe d_ps_324 (coe v0))
-- Ledger.Conway.Specification.Script.Base.ScriptStructure._.DecEq-T
d_DecEq'45'T_352 ::
  T_ScriptStructure_276 -> MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'T_352 v0
  = let v1 = d_Data'688'_202 (coe d_ps_324 (coe v0)) in
    coe
      (coe
         MAlonzo.Code.Ledger.Core.Specification.Crypto.d_DecEq'45'T_30
         (coe
...
d_ExUnit'45'CommutativeMonoid_356 v0
  = coe d_ExUnit'45'CommutativeMonoid_222 (coe d_ps_324 (coe v0))
...
d_Hashable'45'PlutusScript_360 v0
  = coe d_Hashable'45'PlutusScript_224 (coe d_ps_324 (coe v0))
...
d_T'45'isHashable_390 ::
  T_ScriptStructure_276 ->
  MAlonzo.Code.Ledger.Core.Specification.Crypto.T_isHashableSet_10
d_T'45'isHashable_390 v0
  = coe
      MAlonzo.Code.Ledger.Core.Specification.Crypto.d_T'45'isHashable_44
      (coe d_Data'688'_202 (coe d_ps_324 (coe v0)))
-- Ledger.Conway.Specification.Script.Base.ScriptStructure._.language
d_language_392 :: T_ScriptStructure_276 -> AgdaAny -> AgdaAny
d_language_392 v0 = coe d_language_272 (coe d_ps_324 (coe v0))
...
du_Hashable'45'Script_398 v0
  = coe
      ...
      (d_Hashable'45'P1Script_122 (coe d_p1s_302 (coe v0)))
      (d_Hashable'45'PlutusScript_224 (coe d_ps_324 (coe v0)))
...
d_getLanguage_426 ::
  ...
  T_ScriptStructure_276 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Maybe AgdaAny
d_getLanguage_426 ~v0 ~v1 v2 v3 = du_getLanguage_426 v2 v3
du_getLanguage_426 ::
  T_ScriptStructure_276 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Maybe AgdaAny
du_getLanguage_426 v0 v1
  = coe
      MAlonzo.Code.Class.Functor.Core.du__'60''38''62'__30
      (coe MAlonzo.Code.Class.Functor.Instances.d_Functor'45'Maybe_6)
      (coe ()) (coe ()) (coe du_toP2Script_424 v1)
      (coe d_language_272 (coe d_ps_324 (coe v0)))
