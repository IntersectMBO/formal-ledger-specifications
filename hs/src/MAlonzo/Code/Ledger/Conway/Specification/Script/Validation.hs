...
data T_ScriptPurpose_1966
  = C_Cert_1968 MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1030 |
    ...
    C_Propose_1978 MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovProposal_860
