...
d_RdmrPtr_392 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  ()
d_RdmrPtr_392 = erased
-- _.Redeemer
d_Redeemer_394 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  ()
d_Redeemer_394 = erased
-- _.RwdAddr
d_RwdAddr_396 a0 = ()
-- _.ScriptHash
d_ScriptHash_414 ::
...
d_ScriptPurpose_2092 a0 a1 = ()
data T_ScriptPurpose_2092
  = C_Cert_2094 MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1082 |
    C_Rwrd_2096 MAlonzo.Code.Ledger.Core.Specification.Address.T_RwdAddr_104 |
    C_Mint_2098 AgdaAny |
    C_Spend_2100 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 |
    C_Vote_2102 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 |
    C_Propose_2104 MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovProposal_902
...
d_rdptr_2106 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TxBody_3108 ->
  T_ScriptPurpose_2092 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_rdptr_2106 v0 v1 v2 v3
  = case coe v3 of
      C_Cert_2094 v4
        -> coe
             ...
             (\ v5 ->
                coe
                  ...
                  (coe v5))
             (coe
                MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfDCert_2076
        ...
        -> coe
             ...
             (\ v5 ->
                coe
                  ...
                  (coe v5))
             (coe
                MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfRwdAddr_2078
                (MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfImp_2106
                   (coe v1))
                v4
                (MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txwdrls_3162
        ...
        -> coe
             ...
             (\ v5 ->
                coe
                  ...
                  (coe v5))
             (coe
                MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfPolicyId_2082
                (MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfImp_2106
                   (coe v1))
                v4
                (coe
        ...
        -> coe
             ...
             (\ v5 ->
                coe
                  ...
                  (coe v5))
             (coe
                MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfTxIn_2080
                (MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfImp_2106
                   (coe v1))
                v4
                (MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txins_3148
        ...
        -> coe
             ...
             (\ v5 ->
                coe
                  ...
                  (coe v5))
             (coe
                MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfVote_2084
                (MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfImp_2106
                   (coe v1))
                v4
                (coe
        ...
        -> coe
             ...
             (\ v5 ->
                coe
                  ...
                  (coe v5))
             (coe
                MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfProposal_2086
                (MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfImp_2106
                   (coe v1))
                v4
                (MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txprop_3166
...
d_indexedRdmrs_2180 ::
  ...
  T_ScriptPurpose_2092 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_indexedRdmrs_2180 v0 v1 v2 v3
  = coe
...
d_getDatum_2216 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3310 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  T_ScriptPurpose_2092 -> Maybe AgdaAny
d_getDatum_2216 v0 ~v1 v2 v3 v4 = du_getDatum_2216 v0 v2 v3 v4
du_getDatum_2216 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3310 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  T_ScriptPurpose_2092 -> Maybe AgdaAny
du_getDatum_2216 v0 v1 v2 v3
...
d_m_2228 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_m_2228 v0 ~v1 v2 ~v3 ~v4 = du_m_2228 v0 v2
du_m_2228 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3310 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_TxInfo_2244 a0 a1 = ()
data T_TxInfo_2244
  = C_constructor_2286 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_realizedInputs_2266 ::
  T_TxInfo_2244 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_realizedInputs_2266 v0
  = case coe v0 of
      C_constructor_2286 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_txouts_2268 v0
  = case coe v0 of
      C_constructor_2286 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Script.Validation.TxInfo.fee
d_fee_2270 :: T_TxInfo_2244 -> AgdaAny
d_fee_2270 v0
  = case coe v0 of
      C_constructor_2286 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Script.Validation.TxInfo.mint
d_mint_2272 :: T_TxInfo_2244 -> AgdaAny
d_mint_2272 v0
  = case coe v0 of
      C_constructor_2286 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_txcerts_2274 v0
  = case coe v0 of
      C_constructor_2286 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_txwdrls_2276 v0
  = case coe v0 of
      C_constructor_2286 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_txvldt_2278 v0
  = case coe v0 of
      C_constructor_2286 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Script.Validation.TxInfo.vkKey
d_vkKey_2280 :: T_TxInfo_2244 -> [AgdaAny]
d_vkKey_2280 v0
  = case coe v0 of
      C_constructor_2286 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Script.Validation.TxInfo.txdats
d_txdats_2282 :: T_TxInfo_2244 -> [AgdaAny]
d_txdats_2282 v0
  = case coe v0 of
      C_constructor_2286 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v9
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Script.Validation.TxInfo.txid
d_txid_2284 :: T_TxInfo_2244 -> AgdaAny
d_txid_2284 v0
  = case coe v0 of
      C_constructor_2286 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v10
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Script.Validation.txInfo
d_txInfo_2288 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3310 ->
  T_TxInfo_2244
d_txInfo_2288 v0 ~v1 ~v2 ~v3 v4 v5 = du_txInfo_2288 v0 v4 v5
du_txInfo_2288 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3310 ->
  T_TxInfo_2244
du_txInfo_2288 v0 v1 v2
  = coe
      C_constructor_2286
      (coe
...
d_credsNeeded_2410 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TxBody_3108 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
d_credsNeeded_2410 v0 ~v1 v2 v3 = du_credsNeeded_2410 v0 v2 v3
du_credsNeeded_2410 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TxBody_3108 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
du_credsNeeded_2410 v0 v1 v2
  = coe
...
d_valContext_2480 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2090 ->
  T_TxInfo_2244 -> T_ScriptPurpose_2092 -> AgdaAny
d_valContext_2480 v0 ~v1 v2 v3 = du_valContext_2480 v0 v2 v3
du_valContext_2480 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  T_TxInfo_2244 -> T_ScriptPurpose_2092 -> AgdaAny
du_valContext_2480 v0 v1 v2
  = coe
...
d_txOutToDataHash_2486 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2090 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Maybe AgdaAny
d_txOutToDataHash_2486 ~v0 ~v1 v2 = du_txOutToDataHash_2486 v2
du_txOutToDataHash_2486 ::
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Maybe AgdaAny
du_txOutToDataHash_2486 v0
  = case coe v0 of
...
d_txOutToP2Script_2490 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2090 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3310 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Maybe AgdaAny
d_txOutToP2Script_2490 v0 ~v1 v2 v3 v4
  = du_txOutToP2Script_2490 v0 v2 v3 v4
du_txOutToP2Script_2490 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3310 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Maybe AgdaAny
du_txOutToP2Script_2490 v0 v1 v2 v3
  = case coe v3 of
...
d_collectP2ScriptsWithContext_2502 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2090 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_310 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3310 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
d_collectP2ScriptsWithContext_2502 v0 v1 v2 v3 v4
  = coe
      MAlonzo.Code.Axiom.Set.du_mapPartial_578
      (MAlonzo.Code.Axiom.Set.d_th_1480
         (coe
...
d_toScriptInput_2514 v0 v1 v2 v3 v4 v5 v6
  = coe
      MAlonzo.Code.Data.Maybe.Base.du__'62''62''61'__72
      (coe
         MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_lookupScriptHash_3448
            ...
            coe
              ...
              (\ v8 ->
                 coe
                   MAlonzo.Code.Class.Monad.Core.d__'62''62''61'__22
                   MAlonzo.Code.Class.Monad.Instances.d_Monad'45'Maybe_18 () erased ()
                   erased (d_indexedRdmrs_2180 (coe v0) (coe v1) (coe v3) (coe v5))
                   (\ v9 ->
                      case coe v9 of
                                  ...
                                  (coe
                                     ...
                                     (coe
                                        ...
                                        (coe
                                           ...
                                           (coe
                                              du_getDatum_2216 (coe v0) (coe v3) (coe v4) (coe v5)))
                                        (coe
                                           MAlonzo.Code.Agda.Builtin.List.C__'8759'__22 (coe v10)
                                           (coe
                                              MAlonzo.Code.Data.List.Base.du_'91'_'93'_270
                                              (coe
                                                 du_valContext_2480 (coe v0)
                                                 (coe du_txInfo_2288 (coe v0) (coe v4) (coe v3))
                                                 (coe v5)))))
                                     (coe
...
d_evalP2Scripts_2542 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2090 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> Bool
d_evalP2Scripts_2542 ~v0 v1 = du_evalP2Scripts_2542 v1
du_evalP2Scripts_2542 ::
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2090 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> Bool
du_evalP2Scripts_2542 v0
  = coe
