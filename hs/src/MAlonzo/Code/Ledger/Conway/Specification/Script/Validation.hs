...
d_ScriptPurpose_1964 a0 a1 = ()
data T_ScriptPurpose_1964
  = C_Cert_1966 MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1028 |
    C_Rwrd_1968 MAlonzo.Code.Ledger.Core.Specification.Address.T_RwdAddr_98 |
    C_Mint_1970 AgdaAny |
    C_Spend_1972 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 |
    C_Vote_1974 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 |
    C_Propose_1976 MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovProposal_858
...
d_rdptr_1978 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TxBody_2946 ->
  T_ScriptPurpose_1964 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_rdptr_1978 v0 v1 v2 v3
  = case coe v3 of
      C_Cert_1966 v4
        -> coe
             ...
             (\ v5 ->
                coe
                  ...
                  (coe v5))
             (coe
                MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfDCert_1948
                (MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfImp_1976
                   (coe v1))
                v4
                (MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txcerts_2998
                   (coe v2)))
        ...
        -> coe
             ...
             (\ v5 ->
                coe
                  ...
                  (coe v5))
             (coe
                MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfRwdAddr_1950
                (MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfImp_1976
                   (coe v1))
                v4
                (MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txwdrls_3000
        ...
        -> coe
             ...
             (\ v5 ->
                coe
                  ...
                  (coe v5))
             (coe
                MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfPolicyId_1954
                (MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfImp_1976
                   (coe v1))
                v4
                (coe
        ...
        -> coe
             ...
             (\ v5 ->
                coe
                  ...
                  (coe v5))
             (coe
                MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfTxIn_1952
                (MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfImp_1976
                   (coe v1))
                v4
                (MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txins_2986
        ...
        -> coe
             ...
             (\ v5 ->
                coe
                  ...
                  (coe v5))
             (coe
                MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfVote_1956
                (MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfImp_1976
                   (coe v1))
                v4
                (coe
        ...
        -> coe
             ...
             (\ v5 ->
                coe
                  ...
                  (coe v5))
             (coe
                MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfProposal_1958
                (MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_indexOfImp_1976
                   (coe v1))
                v4
                (MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txprop_3004
...
d_indexedRdmrs_2052 ::
  ...
  T_ScriptPurpose_1964 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_indexedRdmrs_2052 v0 v1 v2 v3
  = coe
...
d_getDatum_2088 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3134 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  T_ScriptPurpose_1964 -> Maybe AgdaAny
d_getDatum_2088 v0 ~v1 v2 v3 v4 = du_getDatum_2088 v0 v2 v3 v4
du_getDatum_2088 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3134 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  T_ScriptPurpose_1964 -> Maybe AgdaAny
du_getDatum_2088 v0 v1 v2 v3
...
d_m_2100 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_m_2100 v0 ~v1 v2 ~v3 ~v4 = du_m_2100 v0 v2
du_m_2100 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3134 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_TxInfo_2116 a0 a1 = ()
data T_TxInfo_2116
  = C_TxInfo'46'constructor_19929 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_realizedInputs_2138 ::
  T_TxInfo_2116 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_realizedInputs_2138 v0
  = case coe v0 of
      C_TxInfo'46'constructor_19929 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_fee_2142 :: T_TxInfo_2116 -> AgdaAny
d_fee_2142 v0
  = case coe v0 of
      C_TxInfo'46'constructor_19929 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v3
...
d_mint_2144 :: T_TxInfo_2116 -> AgdaAny
d_mint_2144 v0
  = case coe v0 of
      C_TxInfo'46'constructor_19929 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v4
...
d_vkKey_2152 :: T_TxInfo_2116 -> [AgdaAny]
d_vkKey_2152 v0
  = case coe v0 of
      C_TxInfo'46'constructor_19929 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v8
...
d_txdats_2154 :: T_TxInfo_2116 -> [AgdaAny]
d_txdats_2154 v0
  = case coe v0 of
      C_TxInfo'46'constructor_19929 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v9
...
d_txid_2156 :: T_TxInfo_2116 -> AgdaAny
d_txid_2156 v0
  = case coe v0 of
      C_TxInfo'46'constructor_19929 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v10
...
d_txInfo_2158 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3134 ->
  T_TxInfo_2116
d_txInfo_2158 v0 ~v1 ~v2 ~v3 v4 v5 = du_txInfo_2158 v0 v4 v5
du_txInfo_2158 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3134 ->
  T_TxInfo_2116
du_txInfo_2158 v0 v1 v2
  = coe
      C_TxInfo'46'constructor_19929
      (coe
...
d_credsNeeded_2280 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TxBody_2946 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
d_credsNeeded_2280 v0 ~v1 v2 v3 = du_credsNeeded_2280 v0 v2 v3
du_credsNeeded_2280 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TxBody_2946 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
du_credsNeeded_2280 v0 v1 v2
  = coe
...
d_valContext_2350 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1960 ->
  T_TxInfo_2116 -> T_ScriptPurpose_1964 -> AgdaAny
d_valContext_2350 v0 ~v1 v2 v3 = du_valContext_2350 v0 v2 v3
du_valContext_2350 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  T_TxInfo_2116 -> T_ScriptPurpose_1964 -> AgdaAny
du_valContext_2350 v0 v1 v2
  = coe
...
d_txOutToDataHash_2356 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1960 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Maybe AgdaAny
d_txOutToDataHash_2356 ~v0 ~v1 v2 = du_txOutToDataHash_2356 v2
du_txOutToDataHash_2356 ::
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Maybe AgdaAny
du_txOutToDataHash_2356 v0
  = case coe v0 of
...
d_txOutToP2Script_2360 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1960 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3134 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Maybe AgdaAny
d_txOutToP2Script_2360 v0 ~v1 v2 v3 v4
  = du_txOutToP2Script_2360 v0 v2 v3 v4
du_txOutToP2Script_2360 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3134 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Maybe AgdaAny
du_txOutToP2Script_2360 v0 v1 v2 v3
  = case coe v3 of
             ...
             (coe
                (\ v6 ->
                   coe
                     ...
                     erased
                     (MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_lookupScriptHash_3270
...
d_collectP2ScriptsWithContext_2372 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1960 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_298 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3134 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
d_collectP2ScriptsWithContext_2372 v0 v1 v2 v3 v4
  = coe
      MAlonzo.Code.Axiom.Set.du_mapPartial_576
      (MAlonzo.Code.Axiom.Set.d_th_1470
         (coe
...
d_toScriptInput_2384 v0 v1 v2 v3 v4 v5 v6
  = coe
      MAlonzo.Code.Data.Maybe.Base.du__'62''62''61'__72
      (coe
         MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_lookupScriptHash_3270
            ...
            coe
              ...
              (\ v8 ->
                 coe
                   MAlonzo.Code.Class.Monad.Core.d__'62''62''61'__18
                   MAlonzo.Code.Class.Monad.Instances.d_Monad'45'Maybe_18 () erased ()
                   erased (d_indexedRdmrs_2052 (coe v0) (coe v1) (coe v3) (coe v5))
                   (\ v9 ->
                      case coe v9 of
                                  ...
                                  (coe
                                     ...
                                     (coe
                                        ...
                                        (coe
                                           ...
                                           (coe
                                              du_getDatum_2088 (coe v0) (coe v3) (coe v4) (coe v5)))
                                        (coe
                                           MAlonzo.Code.Agda.Builtin.List.C__'8759'__22 (coe v10)
                                           (coe
                                              MAlonzo.Code.Data.List.Base.du_'91'_'93'_286
                                              (coe
                                                 du_valContext_2350 (coe v0)
                                                 (coe du_txInfo_2158 (coe v0) (coe v4) (coe v3))
                                                 (coe v5)))))
                                     (coe
...
d_evalP2Scripts_2412 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1960 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> Bool
d_evalP2Scripts_2412 ~v0 v1 = du_evalP2Scripts_2412 v1
du_evalP2Scripts_2412 ::
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1960 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> Bool
du_evalP2Scripts_2412 v0
  = coe
      MAlonzo.Code.Data.List.Base.du_all_276
      (coe
         (\ v1 ->
            coe
              MAlonzo.Code.Ledger.Conway.Specification.Abstract.d_runPLCScript_1978
              v0
