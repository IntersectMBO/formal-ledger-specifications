...
data T_ScriptPurpose_2306
  = C_Cert_2308 MAlonzo.Code.Ledger.Core.Specification.Certs.T_DCert_1282 |
    ...
    C_Vote_2316 MAlonzo.Code.Ledger.Core.Specification.Gov.Actions.T_GovVoter_872 |
    C_Propose_2318 MAlonzo.Code.Ledger.Core.Specification.Gov.Actions.T_GovProposal_976
