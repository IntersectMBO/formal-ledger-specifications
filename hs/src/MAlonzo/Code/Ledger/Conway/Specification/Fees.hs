...
d_scriptsCost_1906 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_276 ->
  Integer -> Integer
d_scriptsCost_1906 v0 v1 v2
  = coe
      du_scriptsCostAux_1924 (coe v0) (coe v1) (coe v2)
      (coe MAlonzo.Code.Data.Rational.Base.d_0ℚ_178)
      (coe du_minFeeRefScriptCoinsPerByte_1916 (coe v1)) (coe v2)
-- Ledger.Conway.Specification.Fees._.minFeeRefScriptCoinsPerByte
d_minFeeRefScriptCoinsPerByte_1916 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_276 ->
  Integer -> MAlonzo.Code.Data.Rational.Base.T_ℚ_6
d_minFeeRefScriptCoinsPerByte_1916 ~v0 v1 ~v2
  = du_minFeeRefScriptCoinsPerByte_1916 v1
du_minFeeRefScriptCoinsPerByte_1916 ::
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_276 ->
  MAlonzo.Code.Data.Rational.Base.T_ℚ_6
du_minFeeRefScriptCoinsPerByte_1916 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.PParams.d_minFeeRefScriptCoinsPerByte_380
      (coe v0)
...
d_refScriptCostMultiplier_1918 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_276 ->
  Integer -> MAlonzo.Code.Data.Rational.Base.T_ℚ_6
d_refScriptCostMultiplier_1918 ~v0 v1 ~v2
  = du_refScriptCostMultiplier_1918 v1
du_refScriptCostMultiplier_1918 ::
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_276 ->
  MAlonzo.Code.Data.Rational.Base.T_ℚ_6
du_refScriptCostMultiplier_1918 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.PParams.d_refScriptCostMultiplier_388
      (coe v0)
...
d_refScriptCostStride_1920 ~v0 v1 ~v2
  = du_refScriptCostStride_1920 v1
du_refScriptCostStride_1920 ::
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_276 ->
  MAlonzo.Code.Data.Refinement.Base.T_Refinement_28
du_refScriptCostStride_1920 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.PParams.d_refScriptCostStride_386
      (coe v0)
-- Ledger.Conway.Specification.Fees._.scriptsCostAux
d_scriptsCostAux_1924 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_276 ->
  Integer ->
  MAlonzo.Code.Data.Rational.Base.T_ℚ_6 ->
...
d_scriptsCostAux_1924 v0 v1 v2 v3 v4 v5 ~v6
  = du_scriptsCostAux_1924 v0 v1 v2 v3 v4 v5
du_scriptsCostAux_1924 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_276 ->
  Integer ->
  MAlonzo.Code.Data.Rational.Base.T_ℚ_6 ->
...
du_scriptsCostAux_1924 v0 v1 v2 v3 v4 v5
  = coe
      du_'46'extendedlambda0_1952 (coe v0) (coe v1) (coe v2) (coe v3)
      (coe v4) (coe v5)
      (coe
         ...
         (MAlonzo.Code.Ledger.Prelude.Numeric.PositiveNat.d_fromPosNat_16
            (coe du_refScriptCostStride_1920 (coe v1))))
-- Ledger.Conway.Specification.Fees._._.suc∸≤
d_suc'8760''8804'_1942 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_276 ->
  Integer ->
  MAlonzo.Code.Data.Rational.Base.T_ℚ_6 ->
  ...
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
d_suc'8760''8804'_1942 ~v0 ~v1 ~v2 ~v3 ~v4 ~v5 ~v6 v7 v8 ~v9 v10
  = du_suc'8760''8804'_1942 v7 v8 v10
du_suc'8760''8804'_1942 ::
  Integer ->
  Integer ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804'__22
du_suc'8760''8804'_1942 v0 v1 v2
  = case coe v2 of
...
d_'46'extendedlambda0_1952 v0 v1 v2 v3 v4 v5 ~v6 v7
  = du_'46'extendedlambda0_1952 v0 v1 v2 v3 v4 v5 v7
du_'46'extendedlambda0_1952 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_276 ->
  Integer ->
  MAlonzo.Code.Data.Rational.Base.T_ℚ_6 ->
  ...
  Integer ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20 -> Integer
du_'46'extendedlambda0_1952 v0 v1 v2 v3 v4 v5 v6
  = case coe v6 of
        ...
        -> if coe v7
             then coe
                    ...
                    (coe
                       ...
                       (coe
                          MAlonzo.Code.Data.Rational.Base.d__'42'__276
                          (coe du_refScriptCostMultiplier_1918 (coe v1)) (coe v4))
                       (coe
