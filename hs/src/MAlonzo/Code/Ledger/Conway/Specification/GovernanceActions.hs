...
module MAlonzo.Code.Ledger.Conway.Specification.GovernanceActions where
...
-- Ledger.Conway.Specification.GovernanceActions.GovRole
d_GovRole_754 a0 = ()
data T_GovRole_754 = C_CC_756 | C_DRep_758 | C_SPO_760
-- Ledger.Conway.Specification.GovernanceActions.Voter
d_Voter_762 ::
  MAlonzo.Code.Ledger.Conway.Specification.Types.GovStructure.T_GovStructure_10 ->
  ()
d_Voter_762 = erased
-- Ledger.Conway.Specification.GovernanceActions.GovActionID
d_GovActionID_764 ::
  MAlonzo.Code.Ledger.Conway.Specification.Types.GovStructure.T_GovStructure_10 ->
  ()
d_GovActionID_764 = erased
-- Ledger.Conway.Specification.GovernanceActions.VDeleg
d_VDeleg_766 a0 = ()
data T_VDeleg_766
  = C_credVoter_768 T_GovRole_754
                    MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20 |
    C_abstainRep_770 | C_noConfidenceRep_772
-- Ledger.Conway.Specification.GovernanceActions.Anchor
d_Anchor_774 a0 = ()
data T_Anchor_774
  = C_Anchor'46'constructor_2407 MAlonzo.Code.Agda.Builtin.String.T_String_6
                                 AgdaAny
-- Ledger.Conway.Specification.GovernanceActions.Anchor.url
d_url_780 ::
...
-- Ledger.Conway.Specification.GovernanceActions.Anchor.hash
d_hash_782 :: T_Anchor_774 -> AgdaAny
d_hash_782 v0
  = case coe v0 of
      C_Anchor'46'constructor_2407 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.GovernanceActions.GovActionType
...
-- Ledger.Conway.Specification.GovernanceActions.GovActionData
d_GovActionData_800 ::
  MAlonzo.Code.Ledger.Conway.Specification.Types.GovStructure.T_GovStructure_10 ->
  T_GovActionType_784 -> ()
d_GovActionData_800 = erased
-- Ledger.Conway.Specification.GovernanceActions.GovAction
d_GovAction_802 a0 = ()
data T_GovAction_802
  = C_'10214'_'44'_'10215''7501''7491'_812 T_GovActionType_784
                                           AgdaAny
-- Ledger.Conway.Specification.GovernanceActions.GovAction.gaType
d_gaType_808 :: T_GovAction_802 -> T_GovActionType_784
d_gaType_808 v0
  = case coe v0 of
      C_'10214'_'44'_'10215''7501''7491'_812 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.GovernanceActions.GovAction.gaData
d_gaData_810 :: T_GovAction_802 -> AgdaAny
d_gaData_810 v0
  = case coe v0 of
      C_'10214'_'44'_'10215''7501''7491'_812 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.GovernanceActions.HasCast-GovAction-Sigma
...
-- Ledger.Conway.Specification.GovernanceActions.NeedsHash
d_NeedsHash_818 ::
  MAlonzo.Code.Ledger.Conway.Specification.Types.GovStructure.T_GovStructure_10 ->
  T_GovActionType_784 -> ()
d_NeedsHash_818 = erased
-- Ledger.Conway.Specification.GovernanceActions.HashProtected
d_HashProtected_820 ::
  MAlonzo.Code.Ledger.Conway.Specification.Types.GovStructure.T_GovStructure_10 ->
  () -> ()
d_HashProtected_820 = erased
-- Ledger.Conway.Specification.GovernanceActions.HasCast-HashProtected
...
-- Ledger.Conway.Specification.GovernanceActions.HasCast-HashProtected-MaybeScriptHash
...
d_gid_848 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.GovernanceActions.GovVote.voter
d_voter_850 ::
  T_GovVote_838 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_voter_850 v0
  = case coe v0 of
...
d_returnAddr_878 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.GovernanceActions.GovProposal.anchor
d_anchor_880 :: T_GovProposal_856 -> T_Anchor_774
d_anchor_880 v0
  = case coe v0 of
      C_GovProposal'46'constructor_4893 v1 v2 v3 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.GovernanceActions.GovActionState
...
data T_GovActionState_882
  = C_GovActionState'46'constructor_5261 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                                         MAlonzo.Code.Ledger.Core.Specification.Address.T_RwdAddr_98
                                         AgdaAny T_GovAction_802 AgdaAny
-- Ledger.Conway.Specification.GovernanceActions.GovActionState.votes
d_votes_894 ::
...
d_votes_894 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.GovernanceActions.GovActionState.returnAddr
d_returnAddr_896 ::
                ...
                -> coe
                     (\ v1 ->
                        case coe v1 of
                          ...
                          _ -> MAlonzo.RTE.mazUnreachableError)
              _ -> MAlonzo.RTE.mazUnreachableError))
-- Ledger.Conway.Specification.GovernanceActions.DecEq-GovRole
                ...
                -> coe
                     (\ v1 ->
                        case coe v1 of
                          ...
                          _ -> MAlonzo.RTE.mazUnreachableError)
              _ -> MAlonzo.RTE.mazUnreachableError))
-- Ledger.Conway.Specification.GovernanceActions.DecEq-Vote
d_DecEq'45'Vote_908 ::
  MAlonzo.Code.Ledger.Conway.Specification.Types.GovStructure.T_GovStructure_10 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
                ...
                -> coe
                     (\ v1 ->
                        case coe v1 of
                          ...
                          _ -> MAlonzo.RTE.mazUnreachableError)
              _ -> MAlonzo.RTE.mazUnreachableError))
-- Ledger.Conway.Specification.GovernanceActions.DecEq-VDeleg
                ...
                -> coe
                     (\ v2 ->
                        case coe v2 of
                          ...
                          _ -> MAlonzo.RTE.mazUnreachableError)
              _ -> MAlonzo.RTE.mazUnreachableError))
-- Ledger.Conway.Specification.GovernanceActions.HasCast-GovVote
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (838 :: Integer) (7690690926833967782 :: Integer)
                                 "Ledger.Conway.Specification.GovernanceActions.GovVote"
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (764 :: Integer) (7690690926833967782 :: Integer)
                                 "Ledger.Conway.Specification.GovernanceActions.GovActionID"
                                 (MAlonzo.RTE.Fixity MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                           (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
               (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe
                                 (MAlonzo.RTE.QName
                                    (762 :: Integer) (7690690926833967782 :: Integer)
                                    "Ledger.Conway.Specification.GovernanceActions.Voter"
                                    (MAlonzo.RTE.Fixity
                                       MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                              (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe
                                    (MAlonzo.RTE.QName
                                       (830 :: Integer) (7690690926833967782 :: Integer)
                                       "Ledger.Conway.Specification.GovernanceActions.Vote"
                                       (MAlonzo.RTE.Fixity
                                          MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                 (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
...
-- Ledger.Conway.Specification.GovernanceActions.getDRepVote
d_getDRepVote_914 ::
  MAlonzo.Code.Ledger.Conway.Specification.Types.GovStructure.T_GovStructure_10 ->
  T_GovVote_838 ->
  Maybe
  ...
  = case coe v0 of
      C_GovVote'46'constructor_4503 v1 v2 v3 v4
        -> case coe v2 of
             ...
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.GovernanceActions.proposedCC
d_proposedCC_918 ::
  MAlonzo.Code.Ledger.Conway.Specification.Types.GovStructure.T_GovStructure_10 ->
  T_GovAction_802 ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
