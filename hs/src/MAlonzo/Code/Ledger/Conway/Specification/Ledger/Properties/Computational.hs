...
d_Computational'45'CERT_2480 v0 ~v1
  = du_Computational'45'CERT_2480 v0
du_Computational'45'CERT_2480 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
du_Computational'45'CERT_2480 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Certs.Properties.Computational.d_Computational'45'CERT_2186
      (coe
...
d_Computational'45'PRE'45'CERT_2490 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2538 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'PRE'45'CERT_2490 v0 ~v1
  = du_Computational'45'PRE'45'CERT_2490 v0
du_Computational'45'PRE'45'CERT_2490 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
du_Computational'45'PRE'45'CERT_2490 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Certs.Properties.Computational.d_Computational'45'PRE'45'CERT_2524
      (coe
         MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_govStructure_2718
         (coe v0))
...
d__'8866'_'8640''10631'_'44'UTXOW'10632'__2938 a0 a1 a2 a3 a4 a5
  = ()
...
d_utxoΓ_3136 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3690 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOEnv_2516
d_utxoΓ_3136 ~v0 ~v1 v2 ~v3 ~v4 = du_utxoΓ_3136 v2
du_utxoΓ_3136 ::
  MAlonzo.Code.Ledger.Conway.Specification.Ledger.T_LEnv_2966 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOEnv_2516
du_utxoΓ_3136 v0
...
d_certΓ_3152 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3690 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_CertEnv_1420
d_certΓ_3152 v0 ~v1 v2 v3 v4 = du_certΓ_3152 v0 v2 v3 v4
du_certΓ_3152 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Ledger.T_LEnv_2966 ->
  MAlonzo.Code.Ledger.Conway.Specification.Ledger.T_LState_2992 ->
...
d_govΓ_3154 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_CertState_1488 ->
  MAlonzo.Code.Ledger.Conway.Specification.Gov.T_GovEnv_1894
d_govΓ_3154 v0 ~v1 v2 v3 v4 v5 = du_govΓ_3154 v0 v2 v3 v4 v5
du_govΓ_3154 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Ledger.T_LEnv_2966 ->
  MAlonzo.Code.Ledger.Conway.Specification.Ledger.T_LState_2992 ->
                ...
                then case coe v7 of
                       MAlonzo.Code.Relation.Nullary.Reflects.C_of'696'_22 v8
                         -> coe
                              ...
                              (coe
                                 du_computeUtxow_3040
                                 (MAlonzo.Code.Ledger.Conway.Specification.Utxow.Properties.Computational.d_Computational'45'UTXOW_2342
                                    (coe v0) (coe v1))
                                 (coe du_utxoΓ_3136 (coe v2))
                                 (MAlonzo.Code.Ledger.Conway.Specification.Ledger.d_utxoSt_3000
                                    (coe v3))
                                 v4)
                              (\ v9 ->
                                     ...
                                     -> coe
                                          ...
                                          (coe
                                             ...
                                             (coe
                                                ...
                                                (coe
                                                   MAlonzo.Code.Interface.ComputationalRelation.du_InjectError'45'Id_732))
                                             (coe du_certΓ_3152 (coe v0) (coe v2) (coe v3) (coe v4))
                                             (MAlonzo.Code.Ledger.Conway.Specification.Ledger.d_certState_3004
                                                (coe v3))
                                                      ...
                                                      (coe
                                                         ...
                                                         (coe
                                                            ...
                                                            (coe
                                                               MAlonzo.Code.Interface.ComputationalRelation.du_InjectError'45'Id_732))
                                                         (coe
                                                            du_govΓ_3154 (coe v0) (coe v2) (coe v3)
                                                            (coe v4) (coe v13))
                                                         (coe
                                                                     ...
                                                                     (coe
                                                                        ...
                                                                        (coe
                                                                           ...
                                                                           (coe
                                                                              ...
                                                                              (coe v16) (coe v13))))
                                                                     (coe
                                                                        MAlonzo.Code.Ledger.Conway.Specification.Ledger.C_LEDGER'45'V_3208
                                                                        (coe
                                                                           MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                                                                           (coe v8)
                                                                           (coe
                                            ...
                                            (coe
                                               ...
                                               (coe
                                                  ...
                                                  (coe
                                                     ...
                                                     (coe v3)))))
                                         (coe
                                            MAlonzo.Code.Ledger.Conway.Specification.Ledger.C_LEDGER'45'I_3210
                                            (coe
...
d_completeness_3194 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3690 ->
  MAlonzo.Code.Ledger.Conway.Specification.Ledger.T_LState_2992 ->
  MAlonzo.Code.Ledger.Conway.Specification.Ledger.T__'8866'_'8640''10631'_'44'LEDGER'10632'__3166 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_completeness_3194 = erased
-- Ledger.Conway.Specification.Ledger.Properties.Computational.Computational-LEDGERS
d_Computational'45'LEDGERS_3324 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2538 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'LEDGERS_3324 v0 v1
  = coe
