...
d_EnactEnv_1080 a0 = ()
data T_EnactEnv_1080
  = C_constructor_1094 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 Integer
                       AgdaAny
-- Ledger.Conway.Specification.Enact.EnactEnv.gid
d_gid_1088 ::
  T_EnactEnv_1080 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_gid_1088 v0
  = case coe v0 of
      C_constructor_1094 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Enact.EnactEnv.treasury
d_treasury_1090 :: T_EnactEnv_1080 -> Integer
d_treasury_1090 v0
  = case coe v0 of
      C_constructor_1094 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Enact.EnactEnv.epoch
d_epoch_1092 :: T_EnactEnv_1080 -> AgdaAny
d_epoch_1092 v0
  = case coe v0 of
      C_constructor_1094 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Enact.EnactState
d_EnactState_1096 a0 = ()
data T_EnactState_1096
  = C_constructor_1118 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_cc_1108 ::
  T_EnactState_1096 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_cc_1108 v0
  = case coe v0 of
      C_constructor_1118 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Enact.EnactState.constitution
d_constitution_1110 ::
  T_EnactState_1096 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_constitution_1110 v0
  = case coe v0 of
      C_constructor_1118 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pv_1112 v0
  = case coe v0 of
      C_constructor_1118 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pparams_1114 v0
  = case coe v0 of
      C_constructor_1118 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Enact.EnactState.withdrawals
d_withdrawals_1116 ::
  T_EnactState_1096 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_withdrawals_1116 v0
  = case coe v0 of
      C_constructor_1118 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Enact.HasEnactState
d_HasEnactState_1124 a0 a1 a2 = ()
newtype T_HasEnactState_1124
  = C_constructor_1134 (AgdaAny -> T_EnactState_1096)
-- Ledger.Conway.Specification.Enact.HasEnactState.EnactStateOf
d_EnactStateOf_1132 ::
  T_HasEnactState_1124 -> AgdaAny -> T_EnactState_1096
d_EnactStateOf_1132 v0
  = case coe v0 of
...
d_EnactStateOf_1138 ::
  T_HasEnactState_1124 -> AgdaAny -> T_EnactState_1096
d_EnactStateOf_1138 v0 = coe d_EnactStateOf_1132 (coe v0)
-- Ledger.Conway.Specification.Enact.HasPParams-EnactState
d_HasPParams'45'EnactState_1140 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_HasPParams_424
d_HasPParams'45'EnactState_1140 ~v0
  = du_HasPParams'45'EnactState_1140
du_HasPParams'45'EnactState_1140 ::
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_HasPParams_424
du_HasPParams'45'EnactState_1140
  = coe
...
d_HasWithdrawals'45'EnactState_1144 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Ledger.Core.Specification.Address.T_HasWithdrawals_142
d_HasWithdrawals'45'EnactState_1144 ~v0
  = du_HasWithdrawals'45'EnactState_1144
du_HasWithdrawals'45'EnactState_1144 ::
  MAlonzo.Code.Ledger.Core.Specification.Address.T_HasWithdrawals_142
du_HasWithdrawals'45'EnactState_1144
  = coe
      MAlonzo.Code.Ledger.Core.Specification.Address.C_constructor_152
      (coe (\ v0 -> d_withdrawals_1116 (coe v0)))
-- Ledger.Conway.Specification.Enact.HasCast-EnactEnv
d_HasCast'45'EnactEnv_1146 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'EnactEnv_1146 ~v0 = du_HasCast'45'EnactEnv_1146
du_HasCast'45'EnactEnv_1146 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'EnactEnv_1146
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (1080 :: Integer) (7895255245290171660 :: Integer)
                                 "Ledger.Conway.Specification.Enact.EnactEnv"
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (810 :: Integer) (7895255245290171660 :: Integer)
                                 "Ledger.Conway.Specification.Enact._.GovActionID"
                                 (MAlonzo.RTE.Fixity MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                           (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
               (coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                     (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
         (coe C_constructor_1094))
-- Ledger.Conway.Specification.Enact.ccCreds
d_ccCreds_1148 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
d_ccCreds_1148 ~v0 v1 = du_ccCreds_1148 v1
du_ccCreds_1148 ::
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
du_ccCreds_1148 v0
...
d_getHash_1154 ~v0 v1 v2 = du_getHash_1154 v1 v2
du_getHash_1154 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovActionType_830 ->
  AgdaAny -> Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_getHash_1154 v0 v1
  = case coe v0 of
...
d_getHashES_1166 ~v0 v1 v2 = du_getHashES_1166 v1 v2
du_getHashES_1166 ::
  T_EnactState_1096 ->
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovActionType_830 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_getHashES_1166 v0 v1
  = case coe v1 of
      MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_NoConfidence_832
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
                MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe d_cc_1108 (coe v0)))
      MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_UpdateCommittee_834
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
      ...
      MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_NewConstitution_836
        -> coe
             ...
             (coe
                ...
                (coe d_constitution_1110 (coe v0)))
      MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_TriggerHardFork_838
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
                MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe d_pv_1112 (coe v0)))
      MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_ChangePParams_840
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
...
d__'8866'_'8640''10631'_'44'ENACT'10632'__1182 a0 a1 a2 a3 a4 = ()
data T__'8866'_'8640''10631'_'44'ENACT'10632'__1182
  = C_Enact'45'NoConf_1210 |
    C_Enact'45'UpdComm_1218 (AgdaAny ->
                             MAlonzo.Code.Data.List.Relation.Unary.Any.T_Any_34 ->
                             MAlonzo.Code.Data.Sum.Base.T__'8846'__30) |
    C_Enact'45'NewConst_1220 | C_Enact'45'HF_1222 |
    C_Enact'45'PParams_1224 |
    C_Enact'45'Wdrl_1230 MAlonzo.Code.Data.Nat.Base.T__'8804'__22 |
    C_Enact'45'Info_1232
