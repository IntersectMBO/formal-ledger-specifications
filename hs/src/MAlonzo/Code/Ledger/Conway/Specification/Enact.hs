...
d_EnactEnv_1096 a0 = ()
data T_EnactEnv_1096
  = C_constructor_1110 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 Integer
                       AgdaAny
-- Ledger.Conway.Specification.Enact.EnactEnv.gid
d_gid_1104 ::
  T_EnactEnv_1096 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_gid_1104 v0
  = case coe v0 of
      C_constructor_1110 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Enact.EnactEnv.treasury
d_treasury_1106 :: T_EnactEnv_1096 -> Integer
d_treasury_1106 v0
  = case coe v0 of
      C_constructor_1110 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Enact.EnactEnv.epoch
d_epoch_1108 :: T_EnactEnv_1096 -> AgdaAny
d_epoch_1108 v0
  = case coe v0 of
      C_constructor_1110 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Enact.EnactState
d_EnactState_1112 a0 = ()
data T_EnactState_1112
  = C_constructor_1134 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_cc_1124 ::
  T_EnactState_1112 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_cc_1124 v0
  = case coe v0 of
      C_constructor_1134 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Enact.EnactState.constitution
d_constitution_1126 ::
  T_EnactState_1112 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_constitution_1126 v0
  = case coe v0 of
      C_constructor_1134 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pv_1128 v0
  = case coe v0 of
      C_constructor_1134 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pparams_1130 v0
  = case coe v0 of
      C_constructor_1134 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Enact.EnactState.withdrawals
d_withdrawals_1132 ::
  T_EnactState_1112 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_withdrawals_1132 v0
  = case coe v0 of
      C_constructor_1134 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Enact.HasEnactState
d_HasEnactState_1140 a0 a1 a2 = ()
newtype T_HasEnactState_1140
  = C_constructor_1150 (AgdaAny -> T_EnactState_1112)
-- Ledger.Conway.Specification.Enact.HasEnactState.EnactStateOf
d_EnactStateOf_1148 ::
  T_HasEnactState_1140 -> AgdaAny -> T_EnactState_1112
d_EnactStateOf_1148 v0
  = case coe v0 of
...
d_EnactStateOf_1154 ::
  T_HasEnactState_1140 -> AgdaAny -> T_EnactState_1112
d_EnactStateOf_1154 v0 = coe d_EnactStateOf_1148 (coe v0)
-- Ledger.Conway.Specification.Enact.HasPParams-EnactState
d_HasPParams'45'EnactState_1156 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_HasPParams_424
d_HasPParams'45'EnactState_1156 ~v0
  = du_HasPParams'45'EnactState_1156
du_HasPParams'45'EnactState_1156 ::
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_HasPParams_424
du_HasPParams'45'EnactState_1156
  = coe
      ...
      (coe
         (\ v0 ->
            MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
              (coe d_pparams_1130 (coe v0))))
-- Ledger.Conway.Specification.Enact.HasccMaxTermLength-EnactState
d_HasccMaxTermLength'45'EnactState_1158 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_HasCCMaxTermLength_444
d_HasccMaxTermLength'45'EnactState_1158 ~v0
  = du_HasccMaxTermLength'45'EnactState_1158
du_HasccMaxTermLength'45'EnactState_1158 ::
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_HasCCMaxTermLength_444
du_HasccMaxTermLength'45'EnactState_1158
  = coe
...
d_HasWithdrawals'45'EnactState_1160 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Ledger.Core.Specification.Address.T_HasWithdrawals_142
d_HasWithdrawals'45'EnactState_1160 ~v0
  = du_HasWithdrawals'45'EnactState_1160
du_HasWithdrawals'45'EnactState_1160 ::
  MAlonzo.Code.Ledger.Core.Specification.Address.T_HasWithdrawals_142
du_HasWithdrawals'45'EnactState_1160
  = coe
      MAlonzo.Code.Ledger.Core.Specification.Address.C_constructor_152
      (coe (\ v0 -> d_withdrawals_1132 (coe v0)))
-- Ledger.Conway.Specification.Enact.HasCast-EnactEnv
d_HasCast'45'EnactEnv_1162 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'EnactEnv_1162 ~v0 = du_HasCast'45'EnactEnv_1162
du_HasCast'45'EnactEnv_1162 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'EnactEnv_1162
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (1096 :: Integer) (7895255245290171660 :: Integer)
                                 "Ledger.Conway.Specification.Enact.EnactEnv"
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (814 :: Integer) (7895255245290171660 :: Integer)
                                 "Ledger.Conway.Specification.Enact._.GovActionID"
                                 (MAlonzo.RTE.Fixity MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                           (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
               (coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                     (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
         (coe C_constructor_1110))
-- Ledger.Conway.Specification.Enact.ccCreds
d_ccCreds_1164 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
d_ccCreds_1164 ~v0 v1 = du_ccCreds_1164 v1
du_ccCreds_1164 ::
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
du_ccCreds_1164 v0
...
d_getHash_1170 ~v0 v1 v2 = du_getHash_1170 v1 v2
du_getHash_1170 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovActionType_796 ->
  AgdaAny -> Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_getHash_1170 v0 v1
  = case coe v0 of
...
d_getHashES_1182 ~v0 v1 v2 = du_getHashES_1182 v1 v2
du_getHashES_1182 ::
  T_EnactState_1112 ->
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovActionType_796 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_getHashES_1182 v0 v1
  = case coe v1 of
      MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_NoConfidence_798
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
                MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe d_cc_1124 (coe v0)))
      MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_UpdateCommittee_800
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
      ...
      MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_NewConstitution_802
        -> coe
             ...
             (coe
                ...
                (coe d_constitution_1126 (coe v0)))
      MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_TriggerHardFork_804
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
                MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe d_pv_1128 (coe v0)))
      MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_ChangePParams_806
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
...
d__'8866'_'8640''10631'_'44'ENACT'10632'__1198 a0 a1 a2 a3 a4 = ()
data T__'8866'_'8640''10631'_'44'ENACT'10632'__1198
  = C_Enact'45'NoConf_1226 |
    C_Enact'45'UpdComm_1234 (AgdaAny ->
                             MAlonzo.Code.Data.List.Relation.Unary.Any.T_Any_34 ->
                             MAlonzo.Code.Data.Sum.Base.T__'8846'__30) |
    C_Enact'45'NewConst_1236 | C_Enact'45'HF_1238 |
    C_Enact'45'PParams_1240 |
    C_Enact'45'Wdrl_1246 MAlonzo.Code.Data.Nat.Base.T__'8804'__22 |
    C_Enact'45'Info_1248
