...
d_CCMaxTermLengthOf_534 ::
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_HasCCMaxTermLength_448 ->
  AgdaAny -> Integer
d_CCMaxTermLengthOf_534 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.PParams.d_CCMaxTermLengthOf_456
      (coe v0)
...
d_EnactEnv_1102 a0 = ()
data T_EnactEnv_1102
  = C_constructor_1116 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 Integer
                       AgdaAny
-- Ledger.Conway.Specification.Enact.EnactEnv.gid
d_gid_1110 ::
  T_EnactEnv_1102 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_gid_1110 v0
  = case coe v0 of
      C_constructor_1116 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Enact.EnactEnv.treasury
d_treasury_1112 :: T_EnactEnv_1102 -> Integer
d_treasury_1112 v0
  = case coe v0 of
      C_constructor_1116 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Enact.EnactEnv.epoch
d_epoch_1114 :: T_EnactEnv_1102 -> AgdaAny
d_epoch_1114 v0
  = case coe v0 of
      C_constructor_1116 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Enact.EnactState
d_EnactState_1118 a0 = ()
data T_EnactState_1118
  = C_constructor_1140 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                       MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_cc_1130 ::
  T_EnactState_1118 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_cc_1130 v0
  = case coe v0 of
...
d_withdrawals_1138 ::
  T_EnactState_1118 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_withdrawals_1138 v0
  = case coe v0 of
      C_constructor_1140 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Enact.HasEnactState
d_HasEnactState_1146 a0 a1 a2 = ()
newtype T_HasEnactState_1146
  = C_constructor_1156 (AgdaAny -> T_EnactState_1118)
-- Ledger.Conway.Specification.Enact.HasEnactState.EnactStateOf
d_EnactStateOf_1154 ::
  T_HasEnactState_1146 -> AgdaAny -> T_EnactState_1118
d_EnactStateOf_1154 v0
  = case coe v0 of
...
d_EnactStateOf_1160 ::
  T_HasEnactState_1146 -> AgdaAny -> T_EnactState_1118
d_EnactStateOf_1160 v0 = coe d_EnactStateOf_1154 (coe v0)
-- Ledger.Conway.Specification.Enact.HasPParams-EnactState
d_HasPParams'45'EnactState_1162 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_HasPParams_428
d_HasPParams'45'EnactState_1162 ~v0
  = du_HasPParams'45'EnactState_1162
du_HasPParams'45'EnactState_1162 ::
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_HasPParams_428
du_HasPParams'45'EnactState_1162
  = coe
      ...
      (coe
         (\ v0 ->
            MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
              (coe d_pparams_1136 (coe v0))))
-- Ledger.Conway.Specification.Enact.HasccMaxTermLength-EnactState
d_HasccMaxTermLength'45'EnactState_1164 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_HasCCMaxTermLength_448
d_HasccMaxTermLength'45'EnactState_1164 ~v0
  = du_HasccMaxTermLength'45'EnactState_1164
du_HasccMaxTermLength'45'EnactState_1164 ::
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_HasCCMaxTermLength_448
du_HasccMaxTermLength'45'EnactState_1164
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.PParams.C_constructor_458
      (coe
         (\ v0 ->
            MAlonzo.Code.Ledger.Conway.Specification.PParams.d_ccMaxTermLength_410
              (coe
...
d_HasWithdrawals'45'EnactState_1166 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Ledger.Core.Specification.Address.T_HasWithdrawals_142
d_HasWithdrawals'45'EnactState_1166 ~v0
  = du_HasWithdrawals'45'EnactState_1166
du_HasWithdrawals'45'EnactState_1166 ::
  MAlonzo.Code.Ledger.Core.Specification.Address.T_HasWithdrawals_142
du_HasWithdrawals'45'EnactState_1166
  = coe
      MAlonzo.Code.Ledger.Core.Specification.Address.C_constructor_152
      (coe (\ v0 -> d_withdrawals_1138 (coe v0)))
-- Ledger.Conway.Specification.Enact.HasCast-EnactEnv
d_HasCast'45'EnactEnv_1168 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'EnactEnv_1168 ~v0 = du_HasCast'45'EnactEnv_1168
du_HasCast'45'EnactEnv_1168 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'EnactEnv_1168
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (1102 :: Integer) (7895255245290171660 :: Integer)
                                 "Ledger.Conway.Specification.Enact.EnactEnv"
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                     (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
         (coe C_constructor_1116))
-- Ledger.Conway.Specification.Enact.ccCreds
d_ccCreds_1170 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
d_ccCreds_1170 ~v0 v1 = du_ccCreds_1170 v1
du_ccCreds_1170 ::
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
du_ccCreds_1170 v0
...
d_getHash_1176 ~v0 v1 v2 = du_getHash_1176 v1 v2
du_getHash_1176 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovActionType_802 ->
  AgdaAny -> Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_getHash_1176 v0 v1
  = case coe v0 of
...
d_getHashES_1188 ~v0 v1 v2 = du_getHashES_1188 v1 v2
du_getHashES_1188 ::
  T_EnactState_1118 ->
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovActionType_802 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_getHashES_1188 v0 v1
  = case coe v1 of
      MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_NoConfidence_804
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
                MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe d_cc_1130 (coe v0)))
      MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_UpdateCommittee_806
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
      ...
      MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_NewConstitution_808
        -> coe
             ...
             (coe
                ...
                (coe d_constitution_1132 (coe v0)))
      MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_TriggerHardFork_810
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
                MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe d_pv_1134 (coe v0)))
      MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_ChangePParams_812
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
...
d__'8866'_'8640''10631'_'44'ENACT'10632'__1204 a0 a1 a2 a3 a4 = ()
data T__'8866'_'8640''10631'_'44'ENACT'10632'__1204
  = C_Enact'45'NoConf_1232 |
    C_Enact'45'UpdComm_1240 (AgdaAny ->
                             MAlonzo.Code.Data.List.Relation.Unary.Any.T_Any_34 ->
                             MAlonzo.Code.Data.Sum.Base.T__'8846'__30) |
    C_Enact'45'NewConst_1242 | C_Enact'45'HF_1244 |
    C_Enact'45'PParams_1246 |
    C_Enact'45'Wdrl_1252 MAlonzo.Code.Data.Nat.Base.T__'8804'__22 |
    C_Enact'45'Info_1254
