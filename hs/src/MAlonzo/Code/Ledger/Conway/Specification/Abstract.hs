...
d_Wdrl_454 ::
  ...
  ()
d_Wdrl_454 = erased
-- Ledger.Conway.Specification.Abstract._.GovProposal.action
d_action_770 ::
...
d_action_770 v0
  = coe
      ...
      (coe v0)
-- Ledger.Conway.Specification.Abstract._.GovProposal.anchor
d_anchor_772 ::
  MAlonzo.Code.Ledger.Conway.Specification.GovernanceActions.T_GovProposal_856 ->
...
d_anchor_772 v0
  = coe
      ...
      (coe v0)
-- Ledger.Conway.Specification.Abstract._.GovProposal.deposit
d_deposit_774 ::
  MAlonzo.Code.Ledger.Conway.Specification.GovernanceActions.T_GovProposal_856 ->
  Integer
d_deposit_774 v0
  = coe
      ...
      (coe v0)
-- Ledger.Conway.Specification.Abstract._.GovProposal.policy
d_policy_776 ::
  MAlonzo.Code.Ledger.Conway.Specification.GovernanceActions.T_GovProposal_856 ->
  Maybe AgdaAny
d_policy_776 v0
  = coe
      ...
      (coe v0)
-- Ledger.Conway.Specification.Abstract._.GovProposal.prevAction
d_prevAction_778 ::
  MAlonzo.Code.Ledger.Conway.Specification.GovernanceActions.T_GovProposal_856 ->
  AgdaAny
d_prevAction_778 v0
  = coe
      ...
      (coe v0)
-- Ledger.Conway.Specification.Abstract._.GovProposal.returnAddr
d_returnAddr_780 ::
  MAlonzo.Code.Ledger.Conway.Specification.GovernanceActions.T_GovProposal_856 ->
...
d_returnAddr_780 v0
  = coe
      ...
      (coe v0)
-- Ledger.Conway.Specification.Abstract._.GovernanceActions.GovProposal
