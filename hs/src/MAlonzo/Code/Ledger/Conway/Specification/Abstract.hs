...
d_indexOf_2296 a0 = ()
data T_indexOf_2296
  = C_constructor_2322 (MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1304 ->
...
d_indexOfDCert_2310 ::
  ...
  [MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1304] ->
  Maybe AgdaAny
d_indexOfDCert_2310 v0
  = case coe v0 of
      C_constructor_2322 v1 v2 v3 v4 v5 v6 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfRwdAddr
d_indexOfRwdAddr_2312 ::
  T_indexOf_2296 ->
  MAlonzo.Code.Ledger.Core.Specification.Address.T_RwdAddr_104 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Maybe AgdaAny
d_indexOfRwdAddr_2312 v0
  = case coe v0 of
      C_constructor_2322 v1 v2 v3 v4 v5 v6 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfTxIn_2314 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> Maybe AgdaAny
d_indexOfTxIn_2314 v0
  = case coe v0 of
      C_constructor_2322 v1 v2 v3 v4 v5 v6 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfPolicyId
d_indexOfPolicyId_2316 ::
  T_indexOf_2296 -> AgdaAny -> [AgdaAny] -> Maybe AgdaAny
d_indexOfPolicyId_2316 v0
  = case coe v0 of
      C_constructor_2322 v1 v2 v3 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfVote_2318 ::
  ...
  [MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovVoter_874] ->
  Maybe AgdaAny
d_indexOfVote_2318 v0
  = case coe v0 of
      C_constructor_2322 v1 v2 v3 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfProposal
d_indexOfProposal_2320 ::
  T_indexOf_2296 ->
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovProposal_978 ->
  [MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovProposal_978] ->
  Maybe AgdaAny
d_indexOfProposal_2320 v0
  = case coe v0 of
      C_constructor_2322 v1 v2 v3 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions
d_AbstractFunctions_2324 a0 = ()
data T_AbstractFunctions_2324
  = C_constructor_2346 (AgdaAny -> AgdaAny -> Integer)
                       (AgdaAny -> Integer) T_indexOf_2296
                       (AgdaAny -> AgdaAny -> AgdaAny -> [AgdaAny] -> Bool)
                       (MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Integer)
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.txscriptfee
d_txscriptfee_2336 ::
  T_AbstractFunctions_2324 -> AgdaAny -> AgdaAny -> Integer
d_txscriptfee_2336 v0
  = case coe v0 of
      C_constructor_2346 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.serSize
d_serSize_2338 :: T_AbstractFunctions_2324 -> AgdaAny -> Integer
d_serSize_2338 v0
  = case coe v0 of
      C_constructor_2346 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.indexOfImp
d_indexOfImp_2340 :: T_AbstractFunctions_2324 -> T_indexOf_2296
