...
d_indexOf_1976 a0 = ()
data T_indexOf_1976
  = C_indexOf'46'constructor_4433 (MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1028 ->
...
d_indexOfDCert_1990 ::
  ...
  [MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1028] ->
  Maybe AgdaAny
d_indexOfDCert_1990 v0
  = case coe v0 of
      C_indexOf'46'constructor_4433 v1 v2 v3 v4 v5 v6 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfRwdAddr
d_indexOfRwdAddr_1992 ::
  T_indexOf_1976 ->
  MAlonzo.Code.Ledger.Core.Specification.Address.T_RwdAddr_98 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Maybe AgdaAny
d_indexOfRwdAddr_1992 v0
  = case coe v0 of
      C_indexOf'46'constructor_4433 v1 v2 v3 v4 v5 v6 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfTxIn_1994 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> Maybe AgdaAny
d_indexOfTxIn_1994 v0
  = case coe v0 of
      C_indexOf'46'constructor_4433 v1 v2 v3 v4 v5 v6 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfPolicyId
d_indexOfPolicyId_1996 ::
  T_indexOf_1976 -> AgdaAny -> [AgdaAny] -> Maybe AgdaAny
d_indexOfPolicyId_1996 v0
  = case coe v0 of
      C_indexOf'46'constructor_4433 v1 v2 v3 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfVote_1998 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> Maybe AgdaAny
d_indexOfVote_1998 v0
  = case coe v0 of
      C_indexOf'46'constructor_4433 v1 v2 v3 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfProposal
d_indexOfProposal_2000 ::
  T_indexOf_1976 ->
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovProposal_862 ->
  [MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovProposal_862] ->
  Maybe AgdaAny
d_indexOfProposal_2000 v0
  = case coe v0 of
      C_indexOf'46'constructor_4433 v1 v2 v3 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions
d_AbstractFunctions_2002 a0 = ()
data T_AbstractFunctions_2002
  = C_AbstractFunctions'46'constructor_4725 (AgdaAny ->
                                             AgdaAny -> Integer)
                                            (AgdaAny -> Integer) T_indexOf_1976
                                            (AgdaAny -> AgdaAny -> AgdaAny -> [AgdaAny] -> Bool)
                                            (MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Integer)
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.txscriptfee
d_txscriptfee_2014 ::
  T_AbstractFunctions_2002 -> AgdaAny -> AgdaAny -> Integer
d_txscriptfee_2014 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_4725 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.serSize
d_serSize_2016 :: T_AbstractFunctions_2002 -> AgdaAny -> Integer
d_serSize_2016 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_4725 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.indexOfImp
d_indexOfImp_2018 :: T_AbstractFunctions_2002 -> T_indexOf_1976
d_indexOfImp_2018 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_4725 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.runPLCScript
d_runPLCScript_2020 ::
  T_AbstractFunctions_2002 ->
  AgdaAny -> AgdaAny -> AgdaAny -> [AgdaAny] -> Bool
d_runPLCScript_2020 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_4725 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.scriptSize
d_scriptSize_2022 ::
  T_AbstractFunctions_2002 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Integer
d_scriptSize_2022 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_4725 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
