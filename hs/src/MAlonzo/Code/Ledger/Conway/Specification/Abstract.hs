...
d_txPOSIXTimeVldt_2472 ::
  MAlonzo.Code.Ledger.Conway.Specification.Script.ScriptPurpose.T_TxInfo_2440 ->
  AgdaAny
d_txPOSIXTimeVldt_2472 v0
  = coe
...
d_indexOf_2482 a0 = ()
data T_indexOf_2482
  = C_constructor_2508 (MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1354 ->
                        [MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1354] ->
                        Maybe AgdaAny)
                       (MAlonzo.Code.Ledger.Core.Specification.Address.T_RewardAddress_116 ->
...
d_indexOfDCert_2496 ::
  ...
  [MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1354] ->
  Maybe AgdaAny
d_indexOfDCert_2496 v0
  = case coe v0 of
      C_constructor_2508 v1 v2 v3 v4 v5 v6 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfRewardAddress
d_indexOfRewardAddress_2498 ::
  T_indexOf_2482 ->
  MAlonzo.Code.Ledger.Core.Specification.Address.T_RewardAddress_116 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Maybe AgdaAny
d_indexOfRewardAddress_2498 v0
  = case coe v0 of
      C_constructor_2508 v1 v2 v3 v4 v5 v6 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfTxIn_2500 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> Maybe AgdaAny
d_indexOfTxIn_2500 v0
  = case coe v0 of
      C_constructor_2508 v1 v2 v3 v4 v5 v6 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfPolicyId
d_indexOfPolicyId_2502 ::
  T_indexOf_2482 -> AgdaAny -> [AgdaAny] -> Maybe AgdaAny
d_indexOfPolicyId_2502 v0
  = case coe v0 of
      C_constructor_2508 v1 v2 v3 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfVote_2504 ::
  ...
  [MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovVoter_998] ->
  Maybe AgdaAny
d_indexOfVote_2504 v0
  = case coe v0 of
      C_constructor_2508 v1 v2 v3 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfProposal
d_indexOfProposal_2506 ::
  T_indexOf_2482 ->
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovProposal_1102 ->
  [MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovProposal_1102] ->
  Maybe AgdaAny
d_indexOfProposal_2506 v0
  = case coe v0 of
      C_constructor_2508 v1 v2 v3 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.ValidityInterval
d_ValidityInterval_2510 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  ()
d_ValidityInterval_2510 = erased
-- Ledger.Conway.Specification.Abstract.AbstractFunctions
d_AbstractFunctions_2512 a0 = ()
data T_AbstractFunctions_2512
  = C_constructor_2554 MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
                       (AgdaAny -> AgdaAny -> Integer) (AgdaAny -> Integer) T_indexOf_2482
...
d_UTCTime_2534 :: T_AbstractFunctions_2512 -> ()
d_UTCTime_2534 = erased
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.DecEq-UTCTime
d_DecEq'45'UTCTime_2536 ::
  T_AbstractFunctions_2512 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'UTCTime_2536 v0
  = case coe v0 of
      C_constructor_2554 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.txscriptfee
d_txscriptfee_2538 ::
  T_AbstractFunctions_2512 -> AgdaAny -> AgdaAny -> Integer
d_txscriptfee_2538 v0
  = case coe v0 of
      C_constructor_2554 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.serSize
d_serSize_2540 :: T_AbstractFunctions_2512 -> AgdaAny -> Integer
d_serSize_2540 v0
  = case coe v0 of
      C_constructor_2554 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.indexOfImp
d_indexOfImp_2542 :: T_AbstractFunctions_2512 -> T_indexOf_2482
d_indexOfImp_2542 v0
  = case coe v0 of
      C_constructor_2554 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.scriptSize
d_scriptSize_2544 ::
  T_AbstractFunctions_2512 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Integer
d_scriptSize_2544 v0
  = case coe v0 of
      C_constructor_2554 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_valContext_2546 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Script.ScriptPurpose.T_ScriptPurpose_2426 ->
  AgdaAny
d_valContext_2546 v0
  = case coe v0 of
      C_constructor_2554 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.getLanguageView
d_getLanguageView_2548 ::
  T_AbstractFunctions_2512 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_286 ->
  AgdaAny -> AgdaAny
d_getLanguageView_2548 v0
  = case coe v0 of
      C_constructor_2554 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.epochInfoSlotToUTCTime
d_epochInfoSlotToUTCTime_2550 ::
  T_AbstractFunctions_2512 -> AgdaAny -> Maybe AgdaAny
d_epochInfoSlotToUTCTime_2550 v0
  = case coe v0 of
      C_constructor_2554 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v9
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.transVITime
d_transVITime_2552 ::
  T_AbstractFunctions_2512 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> AgdaAny
d_transVITime_2552 v0
  = case coe v0 of
      C_constructor_2554 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v10
      _ -> MAlonzo.RTE.mazUnreachableError
