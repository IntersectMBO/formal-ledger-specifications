...
d_txPOSIXTimeVldt_2516 ::
  MAlonzo.Code.Ledger.Conway.Specification.Script.ScriptPurpose.T_TxInfo_2484 ->
  AgdaAny
d_txPOSIXTimeVldt_2516 v0
  = coe
...
d_indexOf_2526 a0 = ()
data T_indexOf_2526
  = C_constructor_2552 (MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1398 ->
                        [MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1398] ->
                        Maybe AgdaAny)
                       (MAlonzo.Code.Ledger.Core.Specification.Address.T_RewardAddress_116 ->
...
d_indexOfDCert_2540 ::
  ...
  [MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1398] ->
  Maybe AgdaAny
d_indexOfDCert_2540 v0
  = case coe v0 of
      C_constructor_2552 v1 v2 v3 v4 v5 v6 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfRewardAddress
d_indexOfRewardAddress_2542 ::
  T_indexOf_2526 ->
  MAlonzo.Code.Ledger.Core.Specification.Address.T_RewardAddress_116 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Maybe AgdaAny
d_indexOfRewardAddress_2542 v0
  = case coe v0 of
      C_constructor_2552 v1 v2 v3 v4 v5 v6 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfTxIn_2544 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> Maybe AgdaAny
d_indexOfTxIn_2544 v0
  = case coe v0 of
      C_constructor_2552 v1 v2 v3 v4 v5 v6 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfPolicyId
d_indexOfPolicyId_2546 ::
  T_indexOf_2526 -> AgdaAny -> [AgdaAny] -> Maybe AgdaAny
d_indexOfPolicyId_2546 v0
  = case coe v0 of
      C_constructor_2552 v1 v2 v3 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfVote_2548 ::
  ...
  [MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovVoter_1042] ->
  Maybe AgdaAny
d_indexOfVote_2548 v0
  = case coe v0 of
      C_constructor_2552 v1 v2 v3 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfProposal
d_indexOfProposal_2550 ::
  T_indexOf_2526 ->
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovProposal_1146 ->
  [MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovProposal_1146] ->
  Maybe AgdaAny
d_indexOfProposal_2550 v0
  = case coe v0 of
      C_constructor_2552 v1 v2 v3 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.ValidityInterval
d_ValidityInterval_2554 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  ()
d_ValidityInterval_2554 = erased
-- Ledger.Conway.Specification.Abstract.AbstractFunctions
d_AbstractFunctions_2556 a0 = ()
data T_AbstractFunctions_2556
  = C_constructor_2598 MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
                       (AgdaAny -> AgdaAny -> Integer) (AgdaAny -> Integer) T_indexOf_2526
...
d_UTCTime_2578 :: T_AbstractFunctions_2556 -> ()
d_UTCTime_2578 = erased
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.DecEq-UTCTime
d_DecEq'45'UTCTime_2580 ::
  T_AbstractFunctions_2556 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'UTCTime_2580 v0
  = case coe v0 of
      C_constructor_2598 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.txscriptfee
d_txscriptfee_2582 ::
  T_AbstractFunctions_2556 -> AgdaAny -> AgdaAny -> Integer
d_txscriptfee_2582 v0
  = case coe v0 of
      C_constructor_2598 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.serSize
d_serSize_2584 :: T_AbstractFunctions_2556 -> AgdaAny -> Integer
d_serSize_2584 v0
  = case coe v0 of
      C_constructor_2598 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.indexOfImp
d_indexOfImp_2586 :: T_AbstractFunctions_2556 -> T_indexOf_2526
d_indexOfImp_2586 v0
  = case coe v0 of
      C_constructor_2598 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_scriptSize_2588 v0
  = case coe v0 of
      C_constructor_2598 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_valContext_2590 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Script.ScriptPurpose.T_ScriptPurpose_2470 ->
  AgdaAny
d_valContext_2590 v0
  = case coe v0 of
      C_constructor_2598 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.getLanguageView
d_getLanguageView_2592 ::
  T_AbstractFunctions_2556 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_286 ->
  AgdaAny -> AgdaAny
d_getLanguageView_2592 v0
  = case coe v0 of
      C_constructor_2598 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.epochInfoSlotToUTCTime
d_epochInfoSlotToUTCTime_2594 ::
  T_AbstractFunctions_2556 -> AgdaAny -> Maybe AgdaAny
d_epochInfoSlotToUTCTime_2594 v0
  = case coe v0 of
      C_constructor_2598 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v9
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.transVITime
d_transVITime_2596 ::
  T_AbstractFunctions_2556 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> AgdaAny
d_transVITime_2596 v0
  = case coe v0 of
      C_constructor_2598 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v10
      _ -> MAlonzo.RTE.mazUnreachableError
