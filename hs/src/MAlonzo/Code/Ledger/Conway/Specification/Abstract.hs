...
d_txPOSIXTimeVldt_2420 ::
  MAlonzo.Code.Ledger.Conway.Specification.Script.ScriptPurpose.T_TxInfo_2388 ->
  AgdaAny
d_txPOSIXTimeVldt_2420 v0
  = coe
...
d_indexOf_2430 a0 = ()
data T_indexOf_2430
  = C_constructor_2456 (MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1322 ->
                        [MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1322] ->
                        Maybe AgdaAny)
                       (MAlonzo.Code.Ledger.Core.Specification.Address.T_RewardAddress_104 ->
...
d_indexOfDCert_2444 ::
  ...
  [MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1322] ->
  Maybe AgdaAny
d_indexOfDCert_2444 v0
  = case coe v0 of
      C_constructor_2456 v1 v2 v3 v4 v5 v6 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfRewardAddress
d_indexOfRewardAddress_2446 ::
  T_indexOf_2430 ->
  MAlonzo.Code.Ledger.Core.Specification.Address.T_RewardAddress_104 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Maybe AgdaAny
d_indexOfRewardAddress_2446 v0
  = case coe v0 of
      C_constructor_2456 v1 v2 v3 v4 v5 v6 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfTxIn_2448 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> Maybe AgdaAny
d_indexOfTxIn_2448 v0
  = case coe v0 of
      C_constructor_2456 v1 v2 v3 v4 v5 v6 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfPolicyId
d_indexOfPolicyId_2450 ::
  T_indexOf_2430 -> AgdaAny -> [AgdaAny] -> Maybe AgdaAny
d_indexOfPolicyId_2450 v0
  = case coe v0 of
      C_constructor_2456 v1 v2 v3 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfVote_2452 ::
  ...
  [MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovVoter_966] ->
  Maybe AgdaAny
d_indexOfVote_2452 v0
  = case coe v0 of
      C_constructor_2456 v1 v2 v3 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfProposal
d_indexOfProposal_2454 ::
  T_indexOf_2430 ->
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovProposal_1070 ->
  [MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovProposal_1070] ->
  Maybe AgdaAny
d_indexOfProposal_2454 v0
  = case coe v0 of
      C_constructor_2456 v1 v2 v3 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.ValidityInterval
d_ValidityInterval_2458 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  ()
d_ValidityInterval_2458 = erased
-- Ledger.Conway.Specification.Abstract.AbstractFunctions
d_AbstractFunctions_2460 a0 = ()
data T_AbstractFunctions_2460
  = C_constructor_2506 MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
                       (AgdaAny -> AgdaAny -> Integer) (AgdaAny -> Integer) T_indexOf_2430
...
d_UTCTime_2484 :: T_AbstractFunctions_2460 -> ()
d_UTCTime_2484 = erased
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.DecEq-UTCTime
d_DecEq'45'UTCTime_2486 ::
  T_AbstractFunctions_2460 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'UTCTime_2486 v0
  = case coe v0 of
      C_constructor_2506 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.txscriptfee
d_txscriptfee_2488 ::
  T_AbstractFunctions_2460 -> AgdaAny -> AgdaAny -> Integer
d_txscriptfee_2488 v0
  = case coe v0 of
      C_constructor_2506 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.serSize
d_serSize_2490 :: T_AbstractFunctions_2460 -> AgdaAny -> Integer
d_serSize_2490 v0
  = case coe v0 of
      C_constructor_2506 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.indexOfImp
d_indexOfImp_2492 :: T_AbstractFunctions_2460 -> T_indexOf_2430
d_indexOfImp_2492 v0
  = case coe v0 of
      C_constructor_2506 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.runPLCScript
d_runPLCScript_2494 ::
  T_AbstractFunctions_2460 ->
  AgdaAny -> AgdaAny -> AgdaAny -> [AgdaAny] -> Bool
d_runPLCScript_2494 v0
  = case coe v0 of
      C_constructor_2506 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.scriptSize
d_scriptSize_2496 ::
  T_AbstractFunctions_2460 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Integer
d_scriptSize_2496 v0
  = case coe v0 of
      C_constructor_2506 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_valContext_2498 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Script.ScriptPurpose.T_ScriptPurpose_2374 ->
  AgdaAny
d_valContext_2498 v0
  = case coe v0 of
      C_constructor_2506 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.getLanguageView
d_getLanguageView_2500 ::
  T_AbstractFunctions_2460 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_272 ->
  AgdaAny -> AgdaAny
d_getLanguageView_2500 v0
  = case coe v0 of
      C_constructor_2506 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v9
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.epochInfoSlotToUTCTime
d_epochInfoSlotToUTCTime_2502 ::
  T_AbstractFunctions_2460 -> AgdaAny -> Maybe AgdaAny
d_epochInfoSlotToUTCTime_2502 v0
  = case coe v0 of
      C_constructor_2506 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v10
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.transVITime
d_transVITime_2504 ::
  T_AbstractFunctions_2460 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> AgdaAny
d_transVITime_2504 v0
  = case coe v0 of
      C_constructor_2506 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 -> coe v11
      _ -> MAlonzo.RTE.mazUnreachableError
