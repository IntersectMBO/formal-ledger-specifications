...
d_indexOf_2486 a0 = ()
data T_indexOf_2486
  = C_constructor_2512 (MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1358 ->
                        [MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1358] ->
                        Maybe AgdaAny)
                       (MAlonzo.Code.Ledger.Core.Specification.Address.T_RewardAddress_116 ->
...
d_indexOfDCert_2500 ::
  ...
  [MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DCert_1358] ->
  Maybe AgdaAny
d_indexOfDCert_2500 v0
  = case coe v0 of
      C_constructor_2512 v1 v2 v3 v4 v5 v6 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfRewardAddress
d_indexOfRewardAddress_2502 ::
  T_indexOf_2486 ->
  MAlonzo.Code.Ledger.Core.Specification.Address.T_RewardAddress_116 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Maybe AgdaAny
d_indexOfRewardAddress_2502 v0
  = case coe v0 of
      C_constructor_2512 v1 v2 v3 v4 v5 v6 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfTxIn_2504 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> Maybe AgdaAny
d_indexOfTxIn_2504 v0
  = case coe v0 of
      C_constructor_2512 v1 v2 v3 v4 v5 v6 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfPolicyId
d_indexOfPolicyId_2506 ::
  T_indexOf_2486 -> AgdaAny -> [AgdaAny] -> Maybe AgdaAny
d_indexOfPolicyId_2506 v0
  = case coe v0 of
      C_constructor_2512 v1 v2 v3 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfVote_2508 ::
  ...
  [MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovVoter_1002] ->
  Maybe AgdaAny
d_indexOfVote_2508 v0
  = case coe v0 of
      C_constructor_2512 v1 v2 v3 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.indexOf.indexOfProposal
d_indexOfProposal_2510 ::
  T_indexOf_2486 ->
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovProposal_1106 ->
  [MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.T_GovProposal_1106] ->
  Maybe AgdaAny
d_indexOfProposal_2510 v0
  = case coe v0 of
      C_constructor_2512 v1 v2 v3 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.ValidityInterval
d_ValidityInterval_2514 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  ()
d_ValidityInterval_2514 = erased
-- Ledger.Conway.Specification.Abstract.AbstractFunctions
d_AbstractFunctions_2516 a0 = ()
data T_AbstractFunctions_2516
  = C_constructor_2558 MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
                       (AgdaAny -> AgdaAny -> Integer) (AgdaAny -> Integer) T_indexOf_2486
...
d_UTCTime_2538 :: T_AbstractFunctions_2516 -> ()
d_UTCTime_2538 = erased
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.DecEq-UTCTime
d_DecEq'45'UTCTime_2540 ::
  T_AbstractFunctions_2516 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'UTCTime_2540 v0
  = case coe v0 of
      C_constructor_2558 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.txscriptfee
d_txscriptfee_2542 ::
  T_AbstractFunctions_2516 -> AgdaAny -> AgdaAny -> Integer
d_txscriptfee_2542 v0
  = case coe v0 of
      C_constructor_2558 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.serSize
d_serSize_2544 :: T_AbstractFunctions_2516 -> AgdaAny -> Integer
d_serSize_2544 v0
  = case coe v0 of
      C_constructor_2558 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.indexOfImp
d_indexOfImp_2546 :: T_AbstractFunctions_2516 -> T_indexOf_2486
d_indexOfImp_2546 v0
  = case coe v0 of
      C_constructor_2558 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.scriptSize
d_scriptSize_2548 ::
  T_AbstractFunctions_2516 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Integer
d_scriptSize_2548 v0
  = case coe v0 of
      C_constructor_2558 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_valContext_2550 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Script.ScriptPurpose.T_ScriptPurpose_2430 ->
  AgdaAny
d_valContext_2550 v0
  = case coe v0 of
      C_constructor_2558 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.getLanguageView
d_getLanguageView_2552 ::
  T_AbstractFunctions_2516 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_286 ->
  AgdaAny -> AgdaAny
d_getLanguageView_2552 v0
  = case coe v0 of
      C_constructor_2558 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.epochInfoSlotToUTCTime
d_epochInfoSlotToUTCTime_2554 ::
  T_AbstractFunctions_2516 -> AgdaAny -> Maybe AgdaAny
d_epochInfoSlotToUTCTime_2554 v0
  = case coe v0 of
      C_constructor_2558 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v9
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Abstract.AbstractFunctions.transVITime
d_transVITime_2556 ::
  T_AbstractFunctions_2516 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> AgdaAny
d_transVITime_2556 v0
  = case coe v0 of
      C_constructor_2558 v2 v3 v4 v5 v6 v7 v8 v9 v10 -> coe v10
      _ -> MAlonzo.RTE.mazUnreachableError
