...
d_DecEq'45'DepositPurpose_2266 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2516 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'DepositPurpose_2266 v0 ~v1
  = du_DecEq'45'DepositPurpose_2266 v0
du_DecEq'45'DepositPurpose_2266 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
du_DecEq'45'DepositPurpose_2266 v0
  = coe
...
d_DepositPurpose_2274 a0 a1 = ()
-- Ledger.Conway.Specification.PoolReap._.HasCast-DState
d_HasCast'45'DState_2306 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2516 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'DState_2306 ~v0 ~v1 = du_HasCast'45'DState_2306
du_HasCast'45'DState_2306 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'DState_2306
  = coe
...
d_PoolReapState_2622 a0 a1 = ()
data T_PoolReapState_2622
  = C_'10214'_'44'_'44'_'44'_'10215''7510'_2640 MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2510
                                                MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_188
                                                MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DState_1422
                                                MAlonzo.Code.Ledger.Conway.Specification.Certs.T_PState_1438
-- Ledger.Conway.Specification.PoolReap.PoolReapState.utxoSt
d_utxoSt_2632 ::
  T_PoolReapState_2622 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2510
d_utxoSt_2632 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2640 v1 v2 v3 v4 -> coe v1
...
d_acnt_2634 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2640 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_dState_2636 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2640 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pState_2638 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2640 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.PoolReap.HasCast-PoolReapState
d_HasCast'45'PoolReapState_2642 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2516 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'PoolReapState_2642 ~v0 ~v1
  = du_HasCast'45'PoolReapState_2642
du_HasCast'45'PoolReapState_2642 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'PoolReapState_2642
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (2622 :: Integer) (5811529314862483242 :: Integer)
                                 "Ledger.Conway.Specification.PoolReap.PoolReapState"
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (2066 :: Integer) (5811529314862483242 :: Integer)
                                 "Ledger.Conway.Specification.PoolReap._.UTxOState"
                                 (MAlonzo.RTE.Fixity MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                           (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
               (coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe
                                    (MAlonzo.RTE.QName
                                       (2258 :: Integer) (5811529314862483242 :: Integer)
                                       "Ledger.Conway.Specification.PoolReap._.DState"
                                       (MAlonzo.RTE.Fixity
                                          MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                 (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       (MAlonzo.RTE.QName
                                          (2392 :: Integer) (5811529314862483242 :: Integer)
                                          "Ledger.Conway.Specification.PoolReap._.PState"
                                          (MAlonzo.RTE.Fixity
                                             MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                    (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                        (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
         (coe C_'10214'_'44'_'44'_'44'_'10215''7510'_2640))
-- Ledger.Conway.Specification.PoolReap.HasDState-PoolReapState
d_HasDState'45'PoolReapState_2644 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2516 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_HasDState_1502
d_HasDState'45'PoolReapState_2644 ~v0 ~v1
  = du_HasDState'45'PoolReapState_2644
du_HasDState'45'PoolReapState_2644 ::
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_HasDState_1502
du_HasDState'45'PoolReapState_2644
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Certs.C_constructor_1512
      (coe (\ v0 -> d_dState_2636 (coe v0)))
-- Ledger.Conway.Specification.PoolReap.HasRewards-PoolReapState
d_HasRewards'45'PoolReapState_2646 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2516 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_HasRewards_1290
d_HasRewards'45'PoolReapState_2646 ~v0 ~v1
  = du_HasRewards'45'PoolReapState_2646
du_HasRewards'45'PoolReapState_2646 ::
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_HasRewards_1290
du_HasRewards'45'PoolReapState_2646
  = coe
      ...
      (coe
         (\ v0 ->
            coe
              ...
              (coe
                 MAlonzo.Code.Ledger.Conway.Specification.Certs.du_HasRewards'45'DState_1586)
              (d_dState_2636 (coe v0))))
-- Ledger.Conway.Specification.PoolReap._⊢_⇀⦇_,POOLREAP⦈_
d__'8866'_'8640''10631'_'44'POOLREAP'10632'__2654 a0 a1 a2 a3 a4 a5
  = ()
newtype T__'8866'_'8640''10631'_'44'POOLREAP'10632'__2654
  = C_POOLREAP_2688 T_PoolReapState_2622
...
d_acnt_2658 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_188
d_acnt_2658 ~v0 ~v1 v2 = du_acnt_2658 v2
du_acnt_2658 ::
  T_GeneralizeTel_12229 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_188
du_acnt_2658 v0
...
d_dState_2660 ::
  ...
  T_GeneralizeTel_12229 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DState_1422
d_dState_2660 ~v0 ~v1 v2 = du_dState_2660 v2
du_dState_2660 ::
  T_GeneralizeTel_12229 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DState_1422
du_dState_2660 v0
...
d_pState_2662 ::
  ...
  T_GeneralizeTel_12229 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_PState_1438
d_pState_2662 ~v0 ~v1 v2 = du_pState_2662 v2
du_pState_2662 ::
  T_GeneralizeTel_12229 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_PState_1438
du_pState_2662 v0
...
d_'46'generalizedField'45'poolReapState_12225 ::
  T_GeneralizeTel_12229 -> T_PoolReapState_2622
...
data T_GeneralizeTel_12229
  = C_mkGeneralizeTel_12231 T_PoolReapState_2622 AgdaAny
