...
du_acnt_2516 v0
  = coe
      d_acnt_2496
      (coe d_'46'generalizedField'45'poolReapState_11423 (coe v0))
-- Ledger.Conway.Specification.PoolReap._.dState
d_dState_2518 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2318 ->
...
d_'46'generalizedField'45'poolReapState_11423 ::
  T_GeneralizeTel_11427 -> T_PoolReapState_2484
d_'46'generalizedField'45'poolReapState_11423 v0
  = case coe v0 of
      C_mkGeneralizeTel_11429 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.PoolReap..generalizedField-e
d_'46'generalizedField'45'e_11425 ::
  T_GeneralizeTel_11427 -> AgdaAny
d_'46'generalizedField'45'e_11425 v0
  = case coe v0 of
      C_mkGeneralizeTel_11429 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.PoolReap.GeneralizeTel
d_GeneralizeTel_11427 a0 a1 = ()
data T_GeneralizeTel_11427
  = C_mkGeneralizeTel_11429 T_PoolReapState_2484 AgdaAny
