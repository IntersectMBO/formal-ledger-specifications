...
du_HasCast'45'DState_2160
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Certs.du_HasCast'45'DState_1566
...
d_PoolReapState_2490 a0 a1 = ()
data T_PoolReapState_2490
  = C_'10214'_'44'_'44'_'44'_'10215''7510'_2508 MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2426
                                                MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_168
                                                MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DState_1364
                                                MAlonzo.Code.Ledger.Conway.Specification.Certs.T_PState_1380
-- Ledger.Conway.Specification.PoolReap.PoolReapState.utxoSt
d_utxoSt_2500 ::
  T_PoolReapState_2490 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2426
d_utxoSt_2500 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2508 v1 v2 v3 v4 -> coe v1
...
d_acnt_2502 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2508 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_dState_2504 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2508 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pState_2506 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2508 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.PoolReap.HasCast-PoolReapState
d_HasCast'45'PoolReapState_2510 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2324 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'PoolReapState_2510 ~v0 ~v1
  = du_HasCast'45'PoolReapState_2510
du_HasCast'45'PoolReapState_2510 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'PoolReapState_2510
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (2490 :: Integer) (5811529314862483242 :: Integer)
                                 "Ledger.Conway.Specification.PoolReap.PoolReapState"
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe
                                    ...
                                    (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                        (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
         (coe C_'10214'_'44'_'44'_'44'_'10215''7510'_2508))
-- Ledger.Conway.Specification.PoolReap._⊢_⇀⦇_,POOLREAP⦈_
d__'8866'_'8640''10631'_'44'POOLREAP'10632'__2518 a0 a1 a2 a3 a4 a5
  = ()
newtype T__'8866'_'8640''10631'_'44'POOLREAP'10632'__2518
  = C_POOLREAP_2552 T_PoolReapState_2490
...
d_acnt_2522 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_168
d_acnt_2522 ~v0 ~v1 v2 = du_acnt_2522 v2
du_acnt_2522 ::
  T_GeneralizeTel_11429 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_168
du_acnt_2522 v0
...
d_'46'generalizedField'45'poolReapState_11425 ::
  T_GeneralizeTel_11429 -> T_PoolReapState_2490
...
data T_GeneralizeTel_11429
  = C_mkGeneralizeTel_11431 T_PoolReapState_2490 AgdaAny
