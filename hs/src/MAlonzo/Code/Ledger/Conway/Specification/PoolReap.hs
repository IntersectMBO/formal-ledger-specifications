...
du_HasCast'45'DState_1870
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Certs.du_HasCast'45'DState_1298
...
d_PoolReapState_2124 a0 a1 = ()
data T_PoolReapState_2124
  = C_'10214'_'44'_'44'_'44'_'10215''7510'_2142 MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2068
                                                MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_162
                                                MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DState_1110
                                                MAlonzo.Code.Ledger.Conway.Specification.Certs.T_PState_1166
-- Ledger.Conway.Specification.PoolReap.PoolReapState.utxoSt
d_utxoSt_2134 ::
  T_PoolReapState_2124 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2068
d_utxoSt_2134 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2142 v1 v2 v3 v4 -> coe v1
...
d_acnt_2136 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2142 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_dState_2138 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2142 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pState_2140 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2142 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.PoolReap.HasCast-PoolReapState
d_HasCast'45'PoolReapState_2144 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1964 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'PoolReapState_2144 ~v0 ~v1
  = du_HasCast'45'PoolReapState_2144
du_HasCast'45'PoolReapState_2144 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'PoolReapState_2144
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (2124 :: Integer) (5811529314862483242 :: Integer)
                                 "Ledger.Conway.Specification.PoolReap.PoolReapState"
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe
                                    ...
                                    (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                        (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
         (coe C_'10214'_'44'_'44'_'44'_'10215''7510'_2142))
-- Ledger.Conway.Specification.PoolReap._⊢_⇀⦇_,POOLREAP⦈_
d__'8866'_'8640''10631'_'44'POOLREAP'10632'__2152 a0 a1 a2 a3 a4 a5
  = ()
newtype T__'8866'_'8640''10631'_'44'POOLREAP'10632'__2152
  = C_POOLREAP_2186 T_PoolReapState_2124
-- Ledger.Conway.Specification.PoolReap._.acnt
d_acnt_2156 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1964 ->
  T_GeneralizeTel_10557 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_162
d_acnt_2156 ~v0 ~v1 v2 = du_acnt_2156 v2
du_acnt_2156 ::
  T_GeneralizeTel_10557 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_162
du_acnt_2156 v0
  = coe
      d_acnt_2136
      (coe d_'46'generalizedField'45'poolReapState_10553 (coe v0))
-- Ledger.Conway.Specification.PoolReap._.dState
d_dState_2158 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1964 ->
  T_GeneralizeTel_10557 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DState_1110
d_dState_2158 ~v0 ~v1 v2 = du_dState_2158 v2
du_dState_2158 ::
  T_GeneralizeTel_10557 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DState_1110
du_dState_2158 v0
...
d_pState_2160 ::
  ...
  T_GeneralizeTel_10557 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_PState_1166
d_pState_2160 ~v0 ~v1 v2 = du_pState_2160 v2
du_pState_2160 ::
  T_GeneralizeTel_10557 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_PState_1166
du_pState_2160 v0
...
d_utxoSt_2162 ::
  ...
  T_GeneralizeTel_10557 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2068
d_utxoSt_2162 ~v0 ~v1 v2 = du_utxoSt_2162 v2
du_utxoSt_2162 ::
  T_GeneralizeTel_10557 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2068
du_utxoSt_2162 v0
...
d_'46'generalizedField'45'poolReapState_10553 ::
  T_GeneralizeTel_10557 -> T_PoolReapState_2124
d_'46'generalizedField'45'poolReapState_10553 v0
  = case coe v0 of
      C_mkGeneralizeTel_10559 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.PoolReap..generalizedField-e
d_'46'generalizedField'45'e_10555 ::
  T_GeneralizeTel_10557 -> AgdaAny
d_'46'generalizedField'45'e_10555 v0
  = case coe v0 of
      C_mkGeneralizeTel_10559 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.PoolReap.GeneralizeTel
d_GeneralizeTel_10557 a0 a1 = ()
data T_GeneralizeTel_10557
  = C_mkGeneralizeTel_10559 T_PoolReapState_2124 AgdaAny
