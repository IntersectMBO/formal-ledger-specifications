...
d_HasCast'45'DState_2218 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2428 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'DState_2218 ~v0 ~v1 = du_HasCast'45'DState_2218
du_HasCast'45'DState_2218 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'DState_2218
  = coe
...
d_HasCast'45'PState_2224 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2428 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'PState_2224 ~v0 ~v1 = du_HasCast'45'PState_2224
du_HasCast'45'PState_2224 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'PState_2224
  = coe
...
d_PoolReapState_2538 a0 a1 = ()
data T_PoolReapState_2538
  = C_'10214'_'44'_'44'_'44'_'10215''7510'_2556 MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2420
                                                MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_170
                                                MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DState_1374
                                                MAlonzo.Code.Ledger.Conway.Specification.Certs.T_PState_1390
-- Ledger.Conway.Specification.PoolReap.PoolReapState.utxoSt
d_utxoSt_2548 ::
  T_PoolReapState_2538 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2420
d_utxoSt_2548 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2556 v1 v2 v3 v4 -> coe v1
...
d_acnt_2550 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2556 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_dState_2552 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2556 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pState_2554 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2556 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.PoolReap.HasCast-PoolReapState
d_HasCast'45'PoolReapState_2558 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2428 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'PoolReapState_2558 ~v0 ~v1
  = du_HasCast'45'PoolReapState_2558
du_HasCast'45'PoolReapState_2558 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'PoolReapState_2558
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (2538 :: Integer) (5811529314862483242 :: Integer)
                                 "Ledger.Conway.Specification.PoolReap.PoolReapState"
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (1978 :: Integer) (5811529314862483242 :: Integer)
                                 "Ledger.Conway.Specification.PoolReap._.UTxOState"
                                 (MAlonzo.RTE.Fixity MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                           (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
               (coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe
                                    (MAlonzo.RTE.QName
                                       (2174 :: Integer) (5811529314862483242 :: Integer)
                                       "Ledger.Conway.Specification.PoolReap._.DState"
                                       (MAlonzo.RTE.Fixity
                                          MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                 (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       (MAlonzo.RTE.QName
                                          (2304 :: Integer) (5811529314862483242 :: Integer)
                                          "Ledger.Conway.Specification.PoolReap._.PState"
                                          (MAlonzo.RTE.Fixity
                                             MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                    (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                        (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
         (coe C_'10214'_'44'_'44'_'44'_'10215''7510'_2556))
-- Ledger.Conway.Specification.PoolReap._⊢_⇀⦇_,POOLREAP⦈_
d__'8866'_'8640''10631'_'44'POOLREAP'10632'__2566 a0 a1 a2 a3 a4 a5
  = ()
newtype T__'8866'_'8640''10631'_'44'POOLREAP'10632'__2566
  = C_POOLREAP_2600 T_PoolReapState_2538
...
d_dState_2572 ::
  ...
  T_GeneralizeTel_11557 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DState_1374
d_dState_2572 ~v0 ~v1 v2 = du_dState_2572 v2
du_dState_2572 ::
  T_GeneralizeTel_11557 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DState_1374
du_dState_2572 v0
...
d_pState_2574 ::
  ...
  T_GeneralizeTel_11557 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_PState_1390
d_pState_2574 ~v0 ~v1 v2 = du_pState_2574 v2
du_pState_2574 ::
  T_GeneralizeTel_11557 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_PState_1390
du_pState_2574 v0
...
d_'46'generalizedField'45'poolReapState_11553 ::
  T_GeneralizeTel_11557 -> T_PoolReapState_2538
...
data T_GeneralizeTel_11557
  = C_mkGeneralizeTel_11559 T_PoolReapState_2538 AgdaAny
