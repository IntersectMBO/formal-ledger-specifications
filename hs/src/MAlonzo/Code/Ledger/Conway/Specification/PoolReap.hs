...
d_PoolReapState_2484 a0 a1 = ()
data T_PoolReapState_2484
  = C_'10214'_'44'_'44'_'44'_'10215''7510'_2502 MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2420
                                                MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_164
                                                MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DState_1346
                                                MAlonzo.Code.Ledger.Conway.Specification.Certs.T_PState_1362
-- Ledger.Conway.Specification.PoolReap.PoolReapState.utxoSt
d_utxoSt_2494 ::
  T_PoolReapState_2484 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2420
d_utxoSt_2494 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2502 v1 v2 v3 v4 -> coe v1
...
d_acnt_2496 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2502 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_dState_2498 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2502 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pState_2500 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2502 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.PoolReap.HasCast-PoolReapState
d_HasCast'45'PoolReapState_2504 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2318 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'PoolReapState_2504 ~v0 ~v1
  = du_HasCast'45'PoolReapState_2504
du_HasCast'45'PoolReapState_2504 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'PoolReapState_2504
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (2484 :: Integer) (5811529314862483242 :: Integer)
                                 "Ledger.Conway.Specification.PoolReap.PoolReapState"
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe
                                    ...
                                    (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                        (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
         (coe C_'10214'_'44'_'44'_'44'_'10215''7510'_2502))
-- Ledger.Conway.Specification.PoolReap._⊢_⇀⦇_,POOLREAP⦈_
d__'8866'_'8640''10631'_'44'POOLREAP'10632'__2512 a0 a1 a2 a3 a4 a5
  = ()
newtype T__'8866'_'8640''10631'_'44'POOLREAP'10632'__2512
  = C_POOLREAP_2546 T_PoolReapState_2484
-- Ledger.Conway.Specification.PoolReap._.acnt
d_acnt_2516 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2318 ->
  T_GeneralizeTel_11419 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_164
d_acnt_2516 ~v0 ~v1 v2 = du_acnt_2516 v2
du_acnt_2516 ::
  T_GeneralizeTel_11419 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_164
du_acnt_2516 v0
  = coe
      d_acnt_2496
      (coe d_'46'generalizedField'45'poolReapState_11415 (coe v0))
-- Ledger.Conway.Specification.PoolReap._.dState
d_dState_2518 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2318 ->
...
d_utxoSt_2522 ::
  ...
  T_GeneralizeTel_11419 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2420
d_utxoSt_2522 ~v0 ~v1 v2 = du_utxoSt_2522 v2
du_utxoSt_2522 ::
  T_GeneralizeTel_11419 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2420
du_utxoSt_2522 v0
...
d_'46'generalizedField'45'poolReapState_11415 ::
  T_GeneralizeTel_11419 -> T_PoolReapState_2484
d_'46'generalizedField'45'poolReapState_11415 v0
  = case coe v0 of
      C_mkGeneralizeTel_11421 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.PoolReap..generalizedField-e
d_'46'generalizedField'45'e_11417 ::
  T_GeneralizeTel_11419 -> AgdaAny
d_'46'generalizedField'45'e_11417 v0
  = case coe v0 of
      C_mkGeneralizeTel_11421 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.PoolReap.GeneralizeTel
d_GeneralizeTel_11419 a0 a1 = ()
data T_GeneralizeTel_11419
  = C_mkGeneralizeTel_11421 T_PoolReapState_2484 AgdaAny
