...
d_PoolReapState_2378 a0 a1 = ()
data T_PoolReapState_2378
  = C_'10214'_'44'_'44'_'44'_'10215''7510'_2396 MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2314
                                                MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_162
                                                MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DState_1280
                                                MAlonzo.Code.Ledger.Conway.Specification.Certs.T_PState_1296
-- Ledger.Conway.Specification.PoolReap.PoolReapState.utxoSt
d_utxoSt_2388 ::
  T_PoolReapState_2378 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2314
d_utxoSt_2388 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2396 v1 v2 v3 v4 -> coe v1
...
d_acnt_2390 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2396 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_dState_2392 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2396 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pState_2394 v0
  = case coe v0 of
      C_'10214'_'44'_'44'_'44'_'10215''7510'_2396 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.PoolReap.HasCast-PoolReapState
d_HasCast'45'PoolReapState_2398 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2212 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'PoolReapState_2398 ~v0 ~v1
  = du_HasCast'45'PoolReapState_2398
du_HasCast'45'PoolReapState_2398 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'PoolReapState_2398
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (2378 :: Integer) (5811529314862483242 :: Integer)
                                 "Ledger.Conway.Specification.PoolReap.PoolReapState"
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       (MAlonzo.RTE.QName
                                          (2156 :: Integer) (5811529314862483242 :: Integer)
                                          "Ledger.Conway.Specification.PoolReap._.PState"
                                          (MAlonzo.RTE.Fixity
                                             MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                    (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                        (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
         (coe C_'10214'_'44'_'44'_'44'_'10215''7510'_2396))
-- Ledger.Conway.Specification.PoolReap._⊢_⇀⦇_,POOLREAP⦈_
d__'8866'_'8640''10631'_'44'POOLREAP'10632'__2406 a0 a1 a2 a3 a4 a5
  = ()
newtype T__'8866'_'8640''10631'_'44'POOLREAP'10632'__2406
  = C_POOLREAP_2440 T_PoolReapState_2378
...
d_pState_2414 ::
  ...
  T_GeneralizeTel_10911 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_PState_1296
d_pState_2414 ~v0 ~v1 v2 = du_pState_2414 v2
du_pState_2414 ::
  T_GeneralizeTel_10911 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_PState_1296
du_pState_2414 v0
...
d_utxoSt_2416 ::
  ...
  T_GeneralizeTel_10911 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2314
d_utxoSt_2416 ~v0 ~v1 v2 = du_utxoSt_2416 v2
du_utxoSt_2416 ::
  T_GeneralizeTel_10911 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2314
du_utxoSt_2416 v0
...
d_'46'generalizedField'45'poolReapState_10907 ::
  T_GeneralizeTel_10911 -> T_PoolReapState_2378
...
data T_GeneralizeTel_10911
  = C_mkGeneralizeTel_10913 T_PoolReapState_2378 AgdaAny
