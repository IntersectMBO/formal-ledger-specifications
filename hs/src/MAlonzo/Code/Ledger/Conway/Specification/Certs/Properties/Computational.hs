...
d__'8866'_'8640''10631'_'44'CERTS'10632'__1168 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
...
d_Computational'45'DELEG_1782 v0
  = coe
      ...
      (\ v1 v2 v3 ->
         ...
         coe
           (case coe v3 of
              MAlonzo.Code.Ledger.Conway.Specification.Certs.C_delegate_1356 v5 v6 v7 v8
                -> let v9
                         = coe
                                         ...
                                         (let v12
                                          ...
                                          coe
                                            (case coe v12 of
                                               ...
                                               _ -> MAlonzo.RTE.mazUnreachableError)))
                        _ -> MAlonzo.RTE.mazUnreachableError)
              MAlonzo.Code.Ledger.Conway.Specification.Certs.C_dereg_1358 v5 v6
                -> let v7
                         = MAlonzo.Code.Class.Decidable.Core.d_dec_16
                             (coe
                                      ...
                                      (coe
                                         ...
                                         (coe
                                            ("\172\n(Class.IsSet.IsSet-Map (.Axiom.Set.Theory\7496.th List-Model\7496)\n Class.IsSet.IsSet.\8712 (c , 0))\n(.Ledger.Conway.Specification.Certs.DState.rewards st\7496)"
                                             ...
                                             Data.Text.Text)))
                        _ -> MAlonzo.RTE.mazUnreachableError)
              MAlonzo.Code.Ledger.Conway.Specification.Certs.C_reg_1370 v5 v6
                -> let v7
                         = coe
                             MAlonzo.Code.Relation.Nullary.Decidable.Core.du__'215''45'dec__84
                             (coe
...
d_Computational'45'POOL_1888 v0
  = coe
      ...
      (\ v1 v2 v3 ->
         ...
         coe
           (case coe v3 of
              MAlonzo.Code.Ledger.Conway.Specification.Certs.C_regpool_1360 v5 v6
                -> coe
                     MAlonzo.Code.Interface.ComputationalRelation.C_success_42
                     (coe
                        MAlonzo.Code.Data.Product.Base.du_'45''44'__92
              ...
              MAlonzo.Code.Ledger.Conway.Specification.Certs.C_retirepool_1362 v5 v6
                -> coe
                     MAlonzo.Code.Interface.ComputationalRelation.C_success_42
                     (coe
                        MAlonzo.Code.Data.Product.Base.du_'45''44'__92
...
d_Computational'45'GOVCERT_1902 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'GOVCERT_1902 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (\ v1 v2 v3 ->
         let v4
         ...
         coe
           (case coe v3 of
              MAlonzo.Code.Ledger.Conway.Specification.Certs.C_regdrep_1364 v5 v6 v7
                -> let v8
                         = coe
                             MAlonzo.Code.Relation.Nullary.Decidable.Core.du__'8846''45'dec__96
                             (coe
                                      ...
                                      (coe
                                         ...
                                         (coe
                                            ("\172\n(.Axiom.Set.Theory\7496.th List-Model\7496 Axiom.Set.Theory.\8712 c)\n(Class.IsSet.dom (.Axiom.Set.Theory\7496.th List-Model\7496)\n (.Ledger.Conway.Specification.Certs.GState.dreps\n  (.Ledger.Conway.Specification.Certs.CertState.gState cs)))"
                                             ...
                                             Data.Text.Text)))
                        _ -> MAlonzo.RTE.mazUnreachableError)
              MAlonzo.Code.Ledger.Conway.Specification.Certs.C_ccreghot_1368 v5 v6
                -> let v7
                         = coe
                             MAlonzo.Code.Relation.Nullary.Decidable.Core.du__'215''45'dec__84
                             (coe
      ...
      (\ v1 v2 v3 ->
         let v4
               = coe
                   ...
                   (MAlonzo.Code.Ledger.Conway.Specification.Certs.d_pp_1408 (coe v1))
                   (MAlonzo.Code.Ledger.Conway.Specification.Certs.d_pState_1472
                      (coe v2))
                   v3 in
         coe
           (let v5
                  = coe
                      MAlonzo.Code.Interface.ComputationalRelation.d_computeProof_272
                      (d_Computational'45'GOVCERT_1902 (coe v0)) v1 v2 v3 in
            coe
              (let v6
                     = coe
                         MAlonzo.Code.Ledger.Prelude.du_'10214'_'10215'_52
...
d_Computational'45'PRE'45'CERT_2498 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'PRE'45'CERT_2498 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (\ v1 v2 v3 ->
         let v4
...
d_Computational'45'CERTS_2636 ::
  MAlonzo.Code.Ledger.Conway.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'CERTS_2636 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.du_Computational'45'RunTraceAfter_1514
      (coe d_Computational'45'PRE'45'CERT_2498 (coe v0))
