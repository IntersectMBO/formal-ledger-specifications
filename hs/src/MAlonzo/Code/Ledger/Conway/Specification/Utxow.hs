...
d_UTxO_606 = erased
-- _.isBootstrapAddr
d_isBootstrapAddr_700 a0 a1 = ()
-- _.isBootstrapAddr?
d_isBootstrapAddr'63'_702 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  MAlonzo.Code.Class.Decidable.Core.T__'8263'_10
d_isBootstrapAddr'63'_702 ~v0 = du_isBootstrapAddr'63'_702
du_isBootstrapAddr'63'_702 ::
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  MAlonzo.Code.Class.Decidable.Core.T__'8263'_10
du_isBootstrapAddr'63'_702
  = coe
...
d_HasPParams'45'UTxOEnv_1970 ~v0 ~v1
  = du_HasPParams'45'UTxOEnv_1970
du_HasPParams'45'UTxOEnv_1970 ::
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_HasPParams_430
du_HasPParams'45'UTxOEnv_1970
  = coe
...
du_Dec'45'UsesV3Features_2666 v0
  = case coe v0 of
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.C_constructor_3408 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17 v18
        -> let v19
                 = case coe v12 of
                     []
                       -> coe
      ...
      (coe
         (\ v3 ->
            coe
              MAlonzo.Code.Class.ToBool.du_if_then_else__38
              (coe MAlonzo.Code.Class.ToBool.du_ToBool'45''8263'_106) erased
              (coe du_Dec'45'UsesV3Features_2666 (coe du_txb_2706 (coe v1)))
              (coe
                 (\ v4 ->
                    coe
...
d_hashScriptIntegrity_2752 v0 v1 v2 v3 v4 v5
  = let v6
          = coe
...
d__'8866'_'8640''10631'_'44'UTXOW'10632'__2790 a0 a1 a2 a3 a4 a5
  = ()
newtype T__'8866'_'8640''10631'_'44'UTXOW'10632'__2790
  = C_UTXOW'45'inductive_2894 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
-- Ledger.Conway.Specification.Utxow._.txAD
d_txAD_2796 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2428 ->
  T_GeneralizeTel_41113 -> Maybe AgdaAny
d_txAD_2796 ~v0 ~v1 v2 = du_txAD_2796 v2
du_txAD_2796 :: T_GeneralizeTel_41113 -> Maybe AgdaAny
du_txAD_2796 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txAD_3534
      (coe d_'46'generalizedField'45'tx_41105 (coe v0))
-- Ledger.Conway.Specification.Utxow._.body
d_body_2798 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2428 ->
  T_GeneralizeTel_41113 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TxBody_3334
...
d_refInputs_2812 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2428 ->
  T_GeneralizeTel_41113 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
...
d_reqSignerHashes_2814 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2428 ->
  T_GeneralizeTel_41113 -> [AgdaAny]
d_reqSignerHashes_2814 ~v0 ~v1 v2 = du_reqSignerHashes_2814 v2
du_reqSignerHashes_2814 :: T_GeneralizeTel_41113 -> [AgdaAny]
du_reqSignerHashes_2814 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_reqSignerHashes_3404
      (coe
         MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_body_3526
...
d_scriptIntegrityHash_2816 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2428 ->
  T_GeneralizeTel_41113 -> Maybe AgdaAny
d_scriptIntegrityHash_2816 ~v0 ~v1 v2
  = du_scriptIntegrityHash_2816 v2
du_scriptIntegrityHash_2816 ::
  T_GeneralizeTel_41113 -> Maybe AgdaAny
du_scriptIntegrityHash_2816 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_scriptIntegrityHash_3406
      (coe
         MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_body_3526
...
d_txADhash_2818 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2428 ->
  T_GeneralizeTel_41113 -> Maybe AgdaAny
d_txADhash_2818 ~v0 ~v1 v2 = du_txADhash_2818 v2
du_txADhash_2818 :: T_GeneralizeTel_41113 -> Maybe AgdaAny
du_txADhash_2818 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txADhash_3390
      (coe
...
d_txId_2830 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2428 ->
  T_GeneralizeTel_41113 -> AgdaAny
d_txId_2830 ~v0 ~v1 v2 = du_txId_2830 v2
du_txId_2830 :: T_GeneralizeTel_41113 -> AgdaAny
du_txId_2830 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txId_3380
      (coe
...
d_scripts_2844 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2428 ->
  T_GeneralizeTel_41113 -> [MAlonzo.Code.Data.Sum.Base.T__'8846'__30]
d_scripts_2844 ~v0 ~v1 v2 = du_scripts_2844 v2
du_scripts_2844 ::
  T_GeneralizeTel_41113 -> [MAlonzo.Code.Data.Sum.Base.T__'8846'__30]
du_scripts_2844 v0
  = coe
...
d_txdats_2848 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2428 ->
  T_GeneralizeTel_41113 -> [AgdaAny]
d_txdats_2848 ~v0 ~v1 v2 = du_txdats_2848 v2
du_txdats_2848 :: T_GeneralizeTel_41113 -> [AgdaAny]
du_txdats_2848 v0
  = coe
...
d_vkSigs_2852 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2428 ->
  T_GeneralizeTel_41113 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_vkSigs_2852 ~v0 ~v1 v2 = du_vkSigs_2852 v2
du_vkSigs_2852 ::
  T_GeneralizeTel_41113 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_vkSigs_2852 v0
  = coe
...
d_UTXOW'45'inductive'45'premises_2924 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2428 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3514 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2420 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOEnv_2404 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_UTXOW'45'inductive'45'premises_2924 v0 v1 v2 v3 v4
  = coe
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          ...
                                          (coe v2)))
                                    (coe
                                       d_hashScriptIntegrity_2752 (coe v0) (coe v1)
                                       (coe
                                          MAlonzo.Code.Ledger.Conway.Specification.Utxo.d_pparams_2414
                                          (coe v4))
                                       (coe
...
d_'46'generalizedField'45'tx_41105 ::
  T_GeneralizeTel_41113 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3514
d_'46'generalizedField'45'tx_41105 v0
  = case coe v0 of
      C_mkGeneralizeTel_41115 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Utxow..generalizedField-s
d_'46'generalizedField'45's_41107 ::
  T_GeneralizeTel_41113 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2420
d_'46'generalizedField'45's_41107 v0
  = case coe v0 of
      C_mkGeneralizeTel_41115 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Utxow..generalizedField-Γ
d_'46'generalizedField'45'Γ_41109 ::
  T_GeneralizeTel_41113 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOEnv_2404
d_'46'generalizedField'45'Γ_41109 v0
  = case coe v0 of
      C_mkGeneralizeTel_41115 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Utxow..generalizedField-s'
d_'46'generalizedField'45's''_41111 ::
  T_GeneralizeTel_41113 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2420
d_'46'generalizedField'45's''_41111 v0
  = case coe v0 of
      C_mkGeneralizeTel_41115 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Utxow.GeneralizeTel
d_GeneralizeTel_41113 a0 a1 = ()
data T_GeneralizeTel_41113
  = C_mkGeneralizeTel_41115 MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3514
                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2420
                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOEnv_2404
                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2420
