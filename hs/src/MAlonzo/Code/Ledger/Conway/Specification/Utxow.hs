...
d_txAD_2412 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1962 ->
  T_GeneralizeTel_30287 -> Maybe AgdaAny
d_txAD_2412 ~v0 ~v1 v2 = du_txAD_2412 v2
du_txAD_2412 :: T_GeneralizeTel_30287 -> Maybe AgdaAny
du_txAD_2412 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txAD_3160
      (coe d_'46'generalizedField'45'tx_30281 (coe v0))
-- Ledger.Conway.Specification.Utxow._.body
d_body_2414 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1962 ->
  T_GeneralizeTel_30287 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TxBody_2952
...
d_refInputs_2428 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1962 ->
  T_GeneralizeTel_30287 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
...
du_txADhash_2434 :: T_GeneralizeTel_30287 -> Maybe AgdaAny
du_txADhash_2434 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txADhash_3016
      (coe
...
d_txid_2444 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1962 ->
  T_GeneralizeTel_30287 -> AgdaAny
d_txid_2444 ~v0 ~v1 v2 = du_txid_2444 v2
du_txid_2444 :: T_GeneralizeTel_30287 -> AgdaAny
du_txid_2444 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txid_3022
      (coe
...
d_scripts_2462 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1962 ->
  T_GeneralizeTel_30287 -> [MAlonzo.Code.Data.Sum.Base.T__'8846'__30]
...
du_txdats_2466 :: T_GeneralizeTel_30287 -> [AgdaAny]
du_txdats_2466 v0
  = coe
...
d_'46'generalizedField'45's_30279 ::
  T_GeneralizeTel_30287 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2066
d_'46'generalizedField'45's_30279 v0
  = case coe v0 of
      C_mkGeneralizeTel_30289 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Utxow..generalizedField-tx
d_'46'generalizedField'45'tx_30281 ::
  T_GeneralizeTel_30287 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3140
d_'46'generalizedField'45'tx_30281 v0
  = case coe v0 of
      C_mkGeneralizeTel_30289 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Utxow..generalizedField-Γ
d_'46'generalizedField'45'Γ_30283 ::
  T_GeneralizeTel_30287 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOEnv_2048
d_'46'generalizedField'45'Γ_30283 v0
  = case coe v0 of
      C_mkGeneralizeTel_30289 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Utxow..generalizedField-s'
d_'46'generalizedField'45's''_30285 ::
  T_GeneralizeTel_30287 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2066
d_'46'generalizedField'45's''_30285 v0
  = case coe v0 of
      C_mkGeneralizeTel_30289 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Utxow.GeneralizeTel
d_GeneralizeTel_30287 a0 a1 = ()
data T_GeneralizeTel_30287
  = C_mkGeneralizeTel_30289 MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2066
                            MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3140
                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOEnv_2048
                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2066
