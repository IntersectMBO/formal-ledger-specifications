...
du_Dec'45'UsesV3Features_2660 v0
  = case coe v0 of
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.C_constructor_3326 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17 v18
        -> let v19
                 = case coe v12 of
                     []
                       -> coe
...
du_languages_2684 v0 v1 v2
  = coe
      ...
      (coe du_getLanguage_2694 (coe v0))
      (MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txscripts_3560
...
d_getLanguage_2694 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Maybe AgdaAny
d_getLanguage_2694 v0 ~v1 ~v2 ~v3 v4 = du_getLanguage_2694 v0 v4
du_getLanguage_2694 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Maybe AgdaAny
du_getLanguage_2694 v0 v1
  = case coe v1 of
...
d_allowedLanguages_2698 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2316 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3432 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> [AgdaAny]
d_allowedLanguages_2698 v0 ~v1 v2 v3
  = du_allowedLanguages_2698 v0 v2 v3
du_allowedLanguages_2698 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3432 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> [AgdaAny]
du_allowedLanguages_2698 v0 v1 v2
  = coe
      ...
      (coe
         ...
         (coe du_os_2748 (coe v0) (coe v1) (coe v2)))
      (coe
         (\ v3 ->
      ...
      (coe
         (\ v3 ->
            coe
              MAlonzo.Code.Class.ToBool.du_if_then_else__38
              (coe MAlonzo.Code.Class.ToBool.du_ToBool'45''8263'_106) erased
              (coe du_Dec'45'UsesV3Features_2660 (coe du_txb_2708 (coe v1)))
              (coe
                 (\ v4 ->
                    coe
...
d_txb_2708 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TxBody_3252
d_txb_2708 ~v0 ~v1 v2 ~v3 = du_txb_2708 v2
du_txb_2708 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3432 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TxBody_3252
du_txb_2708 v0
...
d_os_2748 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
d_os_2748 v0 ~v1 v2 v3 = du_os_2748 v0 v2 v3
du_os_2748 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3432 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
...
newtype T__'8866'_'8640''10631'_'44'UTXOW'10632'__2754
  = C_UTXOW'45'inductive_2858 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
-- Ledger.Conway.Specification.Utxow._.txAD
d_txAD_2770 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2316 ->
  T_GeneralizeTel_32791 -> Maybe AgdaAny
d_txAD_2770 ~v0 ~v1 v2 = du_txAD_2770 v2
du_txAD_2770 :: T_GeneralizeTel_32791 -> Maybe AgdaAny
du_txAD_2770 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txAD_3452
      (coe d_'46'generalizedField'45'tx_32785 (coe v0))
-- Ledger.Conway.Specification.Utxow._.body
d_body_2772 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2316 ->
  T_GeneralizeTel_32791 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TxBody_3252
...
d_refInputs_2786 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2316 ->
  T_GeneralizeTel_32791 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
...
du_txADhash_2792 :: T_GeneralizeTel_32791 -> Maybe AgdaAny
du_txADhash_2792 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txADhash_3308
      (coe
...
d_txId_2804 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2316 ->
  T_GeneralizeTel_32791 -> AgdaAny
d_txId_2804 ~v0 ~v1 v2 = du_txId_2804 v2
du_txId_2804 :: T_GeneralizeTel_32791 -> AgdaAny
du_txId_2804 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txId_3298
      (coe
...
d_scripts_2818 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2316 ->
  T_GeneralizeTel_32791 -> [MAlonzo.Code.Data.Sum.Base.T__'8846'__30]
...
du_txdats_2822 :: T_GeneralizeTel_32791 -> [AgdaAny]
du_txdats_2822 v0
  = coe
...
d_UTXOW'45'inductive'45'premises_2884 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2316 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2418 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3432 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_UTXOW'45'inductive'45'premises_2884 v0 ~v1 v2 v3
  = du_UTXOW'45'inductive'45'premises_2884 v0 v2 v3
du_UTXOW'45'inductive'45'premises_2884 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2418 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3432 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_UTXOW'45'inductive'45'premises_2884 v0 v1 v2
  = coe
               ...
               (coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe v0)
                        (coe
                           MAlonzo.Code.Ledger.Conway.Specification.Utxo.d_utxo_2428 (coe v1))
                        (coe
                           MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_body_3444
                           (coe v2)))))
               (coe
                              ...
                              (coe
                                 (\ v3 ->
                                    coe
                                      ...
                                      (coe v3)
                                      (coe
                                         du_allowedLanguages_2698 (coe v0) (coe v2)
                                         (coe
                                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.d_utxo_2428
                                            (coe v1)))))
                              (coe
                                 du_languages_2684 (coe v0) (coe v2)
                                 (coe
                                    MAlonzo.Code.Ledger.Conway.Specification.Utxo.d_utxo_2428
                                    (coe v1))))
                           (coe
...
d_'46'generalizedField'45's_32783 ::
  T_GeneralizeTel_32791 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2418
d_'46'generalizedField'45's_32783 v0
  = case coe v0 of
      C_mkGeneralizeTel_32793 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Utxow..generalizedField-tx
d_'46'generalizedField'45'tx_32785 ::
  T_GeneralizeTel_32791 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3432
d_'46'generalizedField'45'tx_32785 v0
  = case coe v0 of
      C_mkGeneralizeTel_32793 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Utxow..generalizedField-Γ
d_'46'generalizedField'45'Γ_32787 ::
  T_GeneralizeTel_32791 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOEnv_2402
d_'46'generalizedField'45'Γ_32787 v0
  = case coe v0 of
      C_mkGeneralizeTel_32793 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Utxow..generalizedField-s'
d_'46'generalizedField'45's''_32789 ::
  T_GeneralizeTel_32791 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2418
d_'46'generalizedField'45's''_32789 v0
  = case coe v0 of
      C_mkGeneralizeTel_32793 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Utxow.GeneralizeTel
d_GeneralizeTel_32791 a0 a1 = ()
data T_GeneralizeTel_32791
  = C_mkGeneralizeTel_32793 MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2418
                            MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3432
                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOEnv_2402
                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2418
