...
d_txAD_2772 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2318 ->
  T_GeneralizeTel_32811 -> Maybe AgdaAny
d_txAD_2772 ~v0 ~v1 v2 = du_txAD_2772 v2
du_txAD_2772 :: T_GeneralizeTel_32811 -> Maybe AgdaAny
du_txAD_2772 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txAD_3454
      (coe d_'46'generalizedField'45'tx_32805 (coe v0))
-- Ledger.Conway.Specification.Utxow._.body
d_body_2774 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2318 ->
  T_GeneralizeTel_32811 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TxBody_3254
...
d_refInputs_2788 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2318 ->
  T_GeneralizeTel_32811 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
...
du_txADhash_2794 :: T_GeneralizeTel_32811 -> Maybe AgdaAny
du_txADhash_2794 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txADhash_3310
      (coe
...
d_txId_2806 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2318 ->
  T_GeneralizeTel_32811 -> AgdaAny
d_txId_2806 ~v0 ~v1 v2 = du_txId_2806 v2
du_txId_2806 :: T_GeneralizeTel_32811 -> AgdaAny
du_txId_2806 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txId_3300
      (coe
...
d_scripts_2820 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2318 ->
  T_GeneralizeTel_32811 -> [MAlonzo.Code.Data.Sum.Base.T__'8846'__30]
...
du_txdats_2824 :: T_GeneralizeTel_32811 -> [AgdaAny]
du_txdats_2824 v0
  = coe
...
d_'46'generalizedField'45's_32803 ::
  T_GeneralizeTel_32811 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2420
d_'46'generalizedField'45's_32803 v0
  = case coe v0 of
      C_mkGeneralizeTel_32813 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Utxow..generalizedField-tx
d_'46'generalizedField'45'tx_32805 ::
  T_GeneralizeTel_32811 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3434
d_'46'generalizedField'45'tx_32805 v0
  = case coe v0 of
      C_mkGeneralizeTel_32813 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Utxow..generalizedField-Γ
d_'46'generalizedField'45'Γ_32807 ::
  T_GeneralizeTel_32811 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOEnv_2404
d_'46'generalizedField'45'Γ_32807 v0
  = case coe v0 of
      C_mkGeneralizeTel_32813 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Utxow..generalizedField-s'
d_'46'generalizedField'45's''_32809 ::
  T_GeneralizeTel_32811 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2420
d_'46'generalizedField'45's''_32809 v0
  = case coe v0 of
      C_mkGeneralizeTel_32813 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Utxow.GeneralizeTel
d_GeneralizeTel_32811 a0 a1 = ()
data T_GeneralizeTel_32811
  = C_mkGeneralizeTel_32813 MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2420
                            MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3434
                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOEnv_2404
                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2420
