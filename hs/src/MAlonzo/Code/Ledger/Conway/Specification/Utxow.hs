...
d__'8866'_'8640''10631'_'44'UTXOW'10632'__2762 a0 a1 a2 a3 a4 a5
  = ()
newtype T__'8866'_'8640''10631'_'44'UTXOW'10632'__2762
...
du_txAD_2768 :: T_GeneralizeTel_32791 -> Maybe AgdaAny
du_txAD_2768 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txAD_3452
      (coe d_'46'generalizedField'45'tx_32783 (coe v0))
...
du_txADhash_2790 :: T_GeneralizeTel_32791 -> Maybe AgdaAny
du_txADhash_2790 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txADhash_3308
      (coe
...
du_txId_2802 :: T_GeneralizeTel_32791 -> AgdaAny
du_txId_2802 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Transaction.d_txId_3298
      (coe
...
du_txdats_2820 :: T_GeneralizeTel_32791 -> [AgdaAny]
du_txdats_2820 v0
  = coe
                              ...
                              (coe
                                 (\ v3 ->
                                    coe
                                      ...
                                      (coe v3)
                                      (coe
                                         du_allowedLanguages_2698 (coe v0) (coe v1)
                                         (coe
                                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.d_utxo_2428
                                            (coe v2)))))
                              (coe
...
d_'46'generalizedField'45'tx_32783 ::
  T_GeneralizeTel_32791 ->
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3432
d_'46'generalizedField'45'tx_32783 v0
  = case coe v0 of
      C_mkGeneralizeTel_32793 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Specification.Utxow..generalizedField-s
d_'46'generalizedField'45's_32785 ::
  T_GeneralizeTel_32791 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2418
d_'46'generalizedField'45's_32785 v0
  = case coe v0 of
...
data T_GeneralizeTel_32791
  = C_mkGeneralizeTel_32793 MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3432
                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2418
                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOEnv_2402
                            MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2418
