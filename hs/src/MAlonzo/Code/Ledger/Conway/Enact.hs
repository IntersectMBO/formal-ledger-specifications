...
d_applyUpdate_298 v0
  = coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.Ledger.Conway.Types.GovStructure.d_govParams_1130
            (coe v0)))
-- _.ccMaxTermLengthOf
...
d_ccMaxTermLengthOf_494 ::
  MAlonzo.Code.Ledger.Conway.PParams.T_HasccMaxTermLength_464 ->
  AgdaAny -> Integer
d_ccMaxTermLengthOf_494 v0
  = coe
      MAlonzo.Code.Ledger.Conway.PParams.d_ccMaxTermLengthOf_472 (coe v0)
-- _.PParams.Emax
d_Emax_522 ::
...
d_EnactEnv_916 a0 = ()
data T_EnactEnv_916
  = C_EnactEnv'46'constructor_2327 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                                   Integer AgdaAny
-- Ledger.Conway.Enact.EnactEnv.gid
d_gid_924 ::
  T_EnactEnv_916 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_gid_924 v0
  = case coe v0 of
      C_EnactEnv'46'constructor_2327 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Enact.EnactEnv.treasury
d_treasury_926 :: T_EnactEnv_916 -> Integer
d_treasury_926 v0
  = case coe v0 of
      C_EnactEnv'46'constructor_2327 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Enact.EnactEnv.epoch
d_epoch_928 :: T_EnactEnv_916 -> AgdaAny
d_epoch_928 v0
  = case coe v0 of
      C_EnactEnv'46'constructor_2327 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Enact.EnactState
d_EnactState_930 a0 = ()
data T_EnactState_930
  = C_EnactState'46'constructor_2871 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                                     MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                                     MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                                     MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                                     MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_cc_942 ::
  T_EnactState_930 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_cc_942 v0
  = case coe v0 of
      C_EnactState'46'constructor_2871 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_constitution_944 v0
  = case coe v0 of
      C_EnactState'46'constructor_2871 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pv_946 v0
  = case coe v0 of
      C_EnactState'46'constructor_2871 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pparams_948 v0
  = case coe v0 of
      C_EnactState'46'constructor_2871 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_withdrawals_950 v0
  = case coe v0 of
      C_EnactState'46'constructor_2871 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Enact.HasEnactState
d_HasEnactState_956 a0 a1 a2 = ()
newtype T_HasEnactState_956
  = C_HasEnactState'46'constructor_3013 (AgdaAny -> T_EnactState_930)
-- Ledger.Conway.Enact.HasEnactState.EnactStateOf
d_EnactStateOf_964 ::
  T_HasEnactState_956 -> AgdaAny -> T_EnactState_930
d_EnactStateOf_964 v0
  = case coe v0 of
      C_HasEnactState'46'constructor_3013 v1 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Enact._.EnactStateOf
d_EnactStateOf_968 ::
  T_HasEnactState_956 -> AgdaAny -> T_EnactState_930
d_EnactStateOf_968 v0 = coe d_EnactStateOf_964 (coe v0)
-- Ledger.Conway.Enact.HasPParams-EnactState
d_HasPParams'45'EnactState_970 ::
  MAlonzo.Code.Ledger.Conway.Types.GovStructure.T_GovStructure_8 ->
  MAlonzo.Code.Ledger.Conway.PParams.T_HasPParams_428
d_HasPParams'45'EnactState_970 ~v0
  = du_HasPParams'45'EnactState_970
du_HasPParams'45'EnactState_970 ::
  MAlonzo.Code.Ledger.Conway.PParams.T_HasPParams_428
du_HasPParams'45'EnactState_970
  = coe
      ...
      (coe
         (\ v0 ->
            MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
              (coe d_pparams_948 (coe v0))))
-- Ledger.Conway.Enact.HasccMaxTermLength-EnactState
d_HasccMaxTermLength'45'EnactState_972 ::
  MAlonzo.Code.Ledger.Conway.Types.GovStructure.T_GovStructure_8 ->
  MAlonzo.Code.Ledger.Conway.PParams.T_HasccMaxTermLength_464
d_HasccMaxTermLength'45'EnactState_972 ~v0
  = du_HasccMaxTermLength'45'EnactState_972
du_HasccMaxTermLength'45'EnactState_972 ::
  MAlonzo.Code.Ledger.Conway.PParams.T_HasccMaxTermLength_464
du_HasccMaxTermLength'45'EnactState_972
  = coe
...
d_HasCast'45'EnactEnv_974 ::
  MAlonzo.Code.Ledger.Conway.Types.GovStructure.T_GovStructure_8 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'EnactEnv_974 ~v0 = du_HasCast'45'EnactEnv_974
du_HasCast'45'EnactEnv_974 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'EnactEnv_974
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (916 :: Integer) (3794707760481362711 :: Integer)
                                 "Ledger.Conway.Enact.EnactEnv"
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (762 :: Integer) (3794707760481362711 :: Integer)
                                 "Ledger.Conway.Enact._.GovActionID"
                                 (MAlonzo.RTE.Fixity MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                           (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
               (coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                     (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
         (coe C_EnactEnv'46'constructor_2327))
-- Ledger.Conway.Enact.ccCreds
d_ccCreds_976 ::
  MAlonzo.Code.Ledger.Conway.Types.GovStructure.T_GovStructure_8 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Ledger.Conway.Address.T_Credential_18]
d_ccCreds_976 ~v0 v1 = du_ccCreds_976 v1
du_ccCreds_976 ::
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Ledger.Conway.Address.T_Credential_18]
du_ccCreds_976 v0
...
d_getHash_982 ~v0 v1 v2 = du_getHash_982 v1 v2
du_getHash_982 ::
  MAlonzo.Code.Ledger.Conway.GovernanceActions.T_GovActionType_770 ->
  AgdaAny -> Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_getHash_982 v0 v1
  = case coe v0 of
...
d_getHashES_994 ~v0 v1 v2 = du_getHashES_994 v1 v2
du_getHashES_994 ::
  T_EnactState_930 ->
  MAlonzo.Code.Ledger.Conway.GovernanceActions.T_GovActionType_770 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_getHashES_994 v0 v1
  = case coe v1 of
      MAlonzo.Code.Ledger.Conway.GovernanceActions.C_NoConfidence_772
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
                MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe d_cc_942 (coe v0)))
      MAlonzo.Code.Ledger.Conway.GovernanceActions.C_UpdateCommittee_774
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
      ...
      MAlonzo.Code.Ledger.Conway.GovernanceActions.C_NewConstitution_776
        -> coe
             ...
             (coe
                ...
                (coe d_constitution_944 (coe v0)))
      MAlonzo.Code.Ledger.Conway.GovernanceActions.C_TriggerHF_778
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
                MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe d_pv_946 (coe v0)))
      MAlonzo.Code.Ledger.Conway.GovernanceActions.C_ChangePParams_780
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
...
d__'8866'_'8640''10631'_'44'ENACT'10632'__1010 a0 a1 a2 a3 a4 = ()
data T__'8866'_'8640''10631'_'44'ENACT'10632'__1010
  = C_Enact'45'NoConf_1038 |
    C_Enact'45'UpdComm_1046 (AgdaAny ->
                             MAlonzo.Code.Data.List.Relation.Unary.Any.T_Any_34 ->
                             MAlonzo.Code.Data.Sum.Base.T__'8846'__30) |
    C_Enact'45'NewConst_1048 | C_Enact'45'HF_1050 |
    C_Enact'45'PParams_1052 |
    C_Enact'45'Wdrl_1058 MAlonzo.Code.Data.Nat.Base.T__'8804'__22 |
    C_Enact'45'Info_1060
