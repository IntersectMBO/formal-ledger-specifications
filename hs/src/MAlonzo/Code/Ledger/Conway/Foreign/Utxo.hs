...
check_MkUTxOState_1155 ::
  ...
  Integer ->
  MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.T_HSMap_46
    MAlonzo.Code.Ledger.Conway.Foreign.Certs.T_DepositPurpose_2853
    Integer ->
...
utxoStep = coe d_utxo'45'step_4702
d_utxo'45'step_4702 ::
  MAlonzo.Code.Ledger.Core.Foreign.ExternalFunctions.T_ExternalFunctions_8 ->
  T_UTxOEnv_91 ->
  T_UTxOState_1153 ->
...
utxowStep ::
  ...
  MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.T_HSComputationResult_110
    MAlonzo.Code.Agda.Builtin.String.T_String_6 T_UTxOState_1153
utxowStep = coe d_utxow'45'step_4704
d_utxow'45'step_4704 ::
  MAlonzo.Code.Ledger.Core.Foreign.ExternalFunctions.T_ExternalFunctions_8 ->
  T_UTxOEnv_91 ->
  T_UTxOState_1153 ->
  MAlonzo.Code.Ledger.Conway.Foreign.Transaction.T_Tx_95389 ->
...
utxoDebug = coe d_utxo'45'debug_4706
d_utxo'45'debug_4706 ::
  MAlonzo.Code.Ledger.Core.Foreign.ExternalFunctions.T_ExternalFunctions_8 ->
  T_UTxOEnv_91 ->
  T_UTxOState_1153 ->
  MAlonzo.Code.Ledger.Conway.Foreign.Transaction.T_Tx_95389 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_utxo'45'debug_4706 ~v0 v1 v2 v3 = du_utxo'45'debug_4706 v1 v2 v3
du_utxo'45'debug_4706 ::
  T_UTxOEnv_91 ->
  T_UTxOState_1153 ->
  MAlonzo.Code.Ledger.Conway.Foreign.Transaction.T_Tx_95389 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
du_utxo'45'debug_4706 v0 v1 v2
  = coe
...
utxowDebug ::
  ...
  MAlonzo.Code.Ledger.Conway.Foreign.Transaction.T_Tx_95389 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
utxowDebug = coe d_utxow'45'debug_4782
d_utxow'45'debug_4782 ::
  MAlonzo.Code.Ledger.Core.Foreign.ExternalFunctions.T_ExternalFunctions_8 ->
  T_UTxOEnv_91 ->
  T_UTxOState_1153 ->
  MAlonzo.Code.Ledger.Conway.Foreign.Transaction.T_Tx_95389 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_utxow'45'debug_4782 v0 ~v1 v2 v3
  = du_utxow'45'debug_4782 v0 v2 v3
du_utxow'45'debug_4782 ::
  MAlonzo.Code.Ledger.Core.Foreign.ExternalFunctions.T_ExternalFunctions_8 ->
  T_UTxOState_1153 ->
  MAlonzo.Code.Ledger.Conway.Foreign.Transaction.T_Tx_95389 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
du_utxow'45'debug_4782 v0 v1 v2
  = coe
      MAlonzo.Code.Data.String.Base.d_unlines_36
      (coe
         MAlonzo.Code.Agda.Builtin.List.C__'8759'__22
