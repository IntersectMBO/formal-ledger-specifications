...
import qualified MAlonzo.Code.Ledger.Core.Specification.TokenAlgebra.Coin
...
d_tokenAlgebra_110
  = coe
      MAlonzo.Code.Ledger.Core.Specification.TokenAlgebra.Coin.du_Coin'45'TokenAlgebra_132
