...
d_Conv'45'Anchor_30
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_constructor_818 v1 v2
...
d_Conv'45'GovVotes_42
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_constructor_990 v1 v2 v3
                -> coe
                     C_GovVotes_1263
                     (coe
