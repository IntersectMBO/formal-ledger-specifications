...
d_Conv'45'Anchor_30
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.GovernanceActions.C_Anchor'46'constructor_2359 v1 v2
...
d_Conv'45'GovVote_42
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.GovernanceActions.C_GovVote'46'constructor_4455 v1 v2 v3 v4
                -> coe
                     C_GovVote_1533
                     (coe
         ...
         (\ v0 ->
            case coe v0 of
              C_GovVote_1533 v1 v2 v3 v4
                -> coe
                     MAlonzo.Code.Ledger.Conway.GovernanceActions.C_GovVote'46'constructor_4455
                     (coe
                        MAlonzo.Code.Data.Product.Base.du_map_128
                        (coe
                           MAlonzo.Code.Foreign.Convertible.d_from_20
