...
d_Conv'45'Anchor_30
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_constructor_830 v1 v2
...
d_Conv'45'GovVote_42
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Gov.Actions.C_constructor_904 v1 v2 v3 v4
                -> coe
                     C_GovVote_1605
                     (coe
