...
d_Conv'45'EnactState_104
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Enact.C_constructor_1116 v1 v2 v3 v4 v5
                -> coe
                     C_MkEnactState_161
                     (coe
...
d_Conv'45'EnactEnv_108
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Enact.C_constructor_1092 v1 v2 v3
                -> coe
                     C_MkEnactEnv_12159
                     (coe
                        MAlonzo.Code.Foreign.Haskell.Coerce.d_coerce_44 () erased () erased
