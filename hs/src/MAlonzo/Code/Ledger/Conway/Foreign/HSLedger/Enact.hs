...
d_Conv'45'EnactState_94
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Enact.C_EnactState'46'constructor_2855 v1 v2 v3 v4 v5
                -> coe
                     C_MkEnactState_141
                     (coe
...
d_Conv'45'EnactEnv_98
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Enact.C_EnactEnv'46'constructor_2315 v1 v2 v3
                -> coe
                     C_MkEnactEnv_11187
                     (coe
                        MAlonzo.Code.Foreign.Haskell.Coerce.d_coerce_44 () erased () erased
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              C_MkEnactEnv_11187 v1 v2 v3
                -> coe
                     MAlonzo.Code.Ledger.Conway.Specification.Enact.C_EnactEnv'46'constructor_2315
                     (coe
                        MAlonzo.Code.Data.Product.Base.du_map_128
                        (coe
                           MAlonzo.Code.Foreign.Convertible.d_from_20
...
enactStep ::
  T_EnactEnv_11185 ->
  T_EnactState_139 ->
  MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Gov.Actions.T_GovAction_1073 ->
...
d_EnactEnv_11185 = ()
type T_EnactEnv_11185 = EnactEnv
pattern C_MkEnactEnv_11187 a0 a1 a2 = MkEnactEnv a0 a1 a2
check_MkEnactEnv_11187 ::
  MAlonzo.Code.Foreign.Haskell.Pair.T_Pair_22
    () () Integer Integer ->
  Integer -> Integer -> T_EnactEnv_11185
check_MkEnactEnv_11187 = MkEnactEnv
cover_EnactEnv_11185 :: EnactEnv -> ()
cover_EnactEnv_11185 x
  = case x of
      MkEnactEnv _ _ _ -> ()
