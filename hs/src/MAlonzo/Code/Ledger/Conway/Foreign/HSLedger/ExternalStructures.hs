...
d_HSTransactionStructure_692 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Transaction.C_TransactionStructure'46'constructor_14611
      (coe
         MAlonzo.Code.Class.DecEq.Core.C_DecEq'46'constructor_31
         (coe MAlonzo.Code.Data.Nat.Properties.d__'8799'__2710))
      (coe
...
du_netId_1268 ::
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> Integer
du_netId_1268 = coe MAlonzo.Code.Ledger.Conway.Address.du_netId_158
...
d_indexOfImp_2652 ::
  ...
  MAlonzo.Code.Ledger.Conway.Abstract.T_indexOf_1958
d_indexOfImp_2652 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Abstract.d_indexOfImp_2000 (coe v0)
...
d_runPLCScript_2654 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Abstract.d_runPLCScript_2002 (coe v0)
...
d_scriptSize_2656 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Abstract.d_scriptSize_2004 (coe v0)
-- Ledger.Conway.Foreign.HSLedger.ExternalStructures._.AbstractFunctions.serSize
d_serSize_2658 ::
  MAlonzo.Code.Ledger.Conway.Abstract.T_AbstractFunctions_1984 ->
  Integer -> Integer
d_serSize_2658 v0
  = coe MAlonzo.Code.Ledger.Conway.Abstract.d_serSize_1998 (coe v0)
...
d_txscriptfee_2660 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Abstract.d_txscriptfee_1996 (coe v0)
...
du_HSAbstractFunctions_2676
  = coe
      MAlonzo.Code.Ledger.Conway.Abstract.C_AbstractFunctions'46'constructor_4589
      (coe (\ v0 v1 -> 0 :: Integer)) (coe (\ v0 -> 0 :: Integer))
      (coe
         MAlonzo.Code.Ledger.Conway.Abstract.C_indexOf'46'constructor_4297
