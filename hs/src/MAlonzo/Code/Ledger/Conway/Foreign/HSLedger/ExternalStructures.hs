...
d_indexOfImp_3078 ::
  ...
  MAlonzo.Code.Ledger.Core.Specification.Abstract.T_indexOf_2360
...
du_HSAbstractFunctions_3104
  = coe
      MAlonzo.Code.Ledger.Core.Specification.Abstract.C_constructor_2414
      (coe (\ v0 v1 -> 0 :: Integer)) (coe (\ v0 -> 0 :: Integer))
      (coe
         MAlonzo.Code.Ledger.Core.Specification.Abstract.C_constructor_2386
