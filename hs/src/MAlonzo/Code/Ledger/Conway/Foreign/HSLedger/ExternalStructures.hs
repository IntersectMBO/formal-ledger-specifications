...
d_indexOfImp_2706 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_indexOf_1932
...
du_HSAbstractFunctions_2730
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Abstract.C_AbstractFunctions'46'constructor_4533
      (coe (\ v0 v1 -> 0 :: Integer)) (coe (\ v0 -> 0 :: Integer))
      (coe
         MAlonzo.Code.Ledger.Conway.Specification.Abstract.C_indexOf'46'constructor_4241
