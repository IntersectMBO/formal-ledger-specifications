...
d_Conv'45'Snapshot_132
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Rewards.C_constructor_2980 v1 v2 v3
                -> coe
                     C_MkSnapshot_1443
                     (coe
...
d_Conv'45'Snapshots_136
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Rewards.C_constructor_3042 v1 v2 v3 v4
                -> coe
                     C_MkSnapshots_4279
                     (coe
                        C_MkSnapshot_1443
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (\ v5 ->
                                 case coe v5 of
                                   MAlonzo.Code.Ledger.Conway.Specification.Rewards.C_constructor_2980 v6 v7 v8
                                     -> coe
                                          C_MkSnapshot_1443
                                          (coe
                                             MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.C_MkHSMap_26
      ...
      (coe
         (\ v0 ->
            coe
              C_constructor_156
              (coe
                 MAlonzo.Code.Ledger.Conway.Specification.Rewards.d_Δt_2948
                 (coe v0))
              (coe
                 MAlonzo.Code.Ledger.Conway.Specification.Rewards.d_Δr_2950
                 (coe v0))
              (coe
                 MAlonzo.Code.Ledger.Conway.Specification.Rewards.d_Δf_2952
                 (coe v0))
              (coe
                 MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.C_MkHSMap_26
                 (coe
                    ...
                    (MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
                       (coe
                          MAlonzo.Code.Ledger.Conway.Specification.Rewards.d_rs_2954
                          (coe v0)))))))
                                                                   ...
                                                                   MAlonzo.Code.Agda.Builtin.Bool.C_true_10
                                                                     -> case coe v12 of
                                                                          MAlonzo.Code.Relation.Nullary.Reflects.C_of'696'_22 v13
                                                                            -> coe
                                                                                 MAlonzo.Code.Ledger.Conway.Specification.Rewards.C_constructor_2964
                                                                                 (d_Δt_148 (coe v0))
                                                                                 (d_Δr_150 (coe v0))
                                                                                 (d_Δf_152 (coe v0))
                                                                                 (coe
