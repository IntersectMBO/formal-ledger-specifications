...
d_nonZero'45'1'43'max0'45'x_44 ::
...
d_nonZero'45'1'47'n_46 ::
  Integer ->
  MAlonzo.Code.Data.Nat.Base.T_NonZero_112 ->
  MAlonzo.Code.Data.Nat.Base.T_NonZero_112
d_nonZero'45'1'47'n_46 v0 v1
  = coe
...
d_Δf'45'nonpositive_76 ::
  MAlonzo.Code.Ledger.Conway.Specification.Rewards.T_RewardUpdate_2686 ->
  MAlonzo.Code.Data.Integer.Base.T__'8804'__26
d_Δf'45'nonpositive_76 v0
  = coe
...
d_Δt'45'nonnegative_82 ::
  MAlonzo.Code.Ledger.Conway.Specification.Rewards.T_RewardUpdate_2686 ->
  MAlonzo.Code.Data.Integer.Base.T__'8804'__26
d_Δt'45'nonnegative_82 v0
  = coe
...
d_HsTy'45'Snapshot_102 ::
  MAlonzo.Code.Foreign.HaskellTypes.T_HasHsType_14
d_HsTy'45'Snapshot_102 = erased
-- Ledger.Conway.Foreign.HSLedger.Rewards.Conv-Snapshot
d_Conv'45'Snapshot_104 ::
...
d_Conv'45'Snapshot_104
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Rewards.C_constructor_2736 v1 v2 v3
                -> coe
                     C_MkSnapshot_131
                     (coe
...
d_HsTy'45'Snapshots_106 ::
  MAlonzo.Code.Foreign.HaskellTypes.T_HasHsType_14
d_HsTy'45'Snapshots_106 = erased
-- Ledger.Conway.Foreign.HSLedger.Rewards.Conv-Snapshots
d_Conv'45'Snapshots_108 ::
  MAlonzo.Code.Foreign.Convertible.T_Convertible_8
d_Conv'45'Snapshots_108
  = coe
      MAlonzo.Code.Foreign.Convertible.C_constructor_22
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Rewards.C_constructor_2798 v1 v2 v3 v4
                -> coe
                     C_MkSnapshots_2993
                     (coe
                        C_MkSnapshot_131
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (\ v5 ->
                                 case coe v5 of
                                   MAlonzo.Code.Ledger.Conway.Specification.Rewards.C_constructor_2736 v6 v7 v8
                                     -> coe
                                          C_MkSnapshot_131
                                          (coe
                                             MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.C_MkHSMap_26
...
d_HsRewardUpdate_110 = ()
type T_HsRewardUpdate_110 = HsRewardUpdate
pattern C_constructor_128 a0 a1 a2 a3 = MkRewardUpdate a0 a1 a2 a3
check_constructor_128 ::
  Integer ->
  Integer ->
  Integer ->
  MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.T_HSMap_16
    ...
    Integer ->
  T_HsRewardUpdate_110
check_constructor_128 = MkRewardUpdate
cover_HsRewardUpdate_110 :: HsRewardUpdate -> ()
cover_HsRewardUpdate_110 x
  = case x of
      MkRewardUpdate _ _ _ _ -> ()
-- Ledger.Conway.Foreign.HSLedger.Rewards.HsRewardUpdate.Δt
d_Δt_120 :: T_HsRewardUpdate_110 -> Integer
d_Δt_120 v0
  = case coe v0 of
      C_constructor_128 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Foreign.HSLedger.Rewards.HsRewardUpdate.Δr
d_Δr_122 :: T_HsRewardUpdate_110 -> Integer
d_Δr_122 v0
  = case coe v0 of
      C_constructor_128 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Foreign.HSLedger.Rewards.HsRewardUpdate.Δf
d_Δf_124 :: T_HsRewardUpdate_110 -> Integer
d_Δf_124 v0
  = case coe v0 of
      C_constructor_128 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_rs_126 v0
  = case coe v0 of
      C_constructor_128 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_HsTy'45'RewardUpdate_130 ::
  MAlonzo.Code.Foreign.HaskellTypes.T_HasHsType_14
d_HsTy'45'RewardUpdate_130 = erased
-- Ledger.Conway.Foreign.HSLedger.Rewards.Conv-RewardUpdate
d_Conv'45'RewardUpdate_132 ::
  MAlonzo.Code.Foreign.Convertible.T_Convertible_8
d_Conv'45'RewardUpdate_132
  = coe
      MAlonzo.Code.Foreign.Convertible.C_constructor_22
                 ...
                 (coe
                    ...
                    (MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
                       (coe
                          ...
                          (coe v0)))))))
      (coe (\ v0 -> d_HsRewardUpdate'8594'RewardUpdate_182 (coe v0)))
...
d_rs_166 ::
  ...
  MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.T_HSMap_16
    MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Address.T_Credential_589
    Integer
d_rs_166 v0 = coe d_rs_126 (coe v0)
-- Ledger.Conway.Foreign.HSLedger.Rewards._._.ru.Δf
d_Δf_168 :: T_HsRewardUpdate_110 -> Integer
d_Δf_168 v0 = coe d_Δf_124 (coe v0)
-- Ledger.Conway.Foreign.HSLedger.Rewards._._.ru.Δr
d_Δr_170 :: T_HsRewardUpdate_110 -> Integer
d_Δr_170 v0 = coe d_Δr_122 (coe v0)
-- Ledger.Conway.Foreign.HSLedger.Rewards._._.ru.Δt
d_Δt_172 :: T_HsRewardUpdate_110 -> Integer
d_Δt_172 v0 = coe d_Δt_120 (coe v0)
-- Ledger.Conway.Foreign.HSLedger.Rewards._._.HsRewardUpdate→RewardUpdate
d_HsRewardUpdate'8594'RewardUpdate_182 ::
  T_HsRewardUpdate_110 ->
  MAlonzo.Code.Ledger.Conway.Specification.Rewards.T_RewardUpdate_2686
d_HsRewardUpdate'8594'RewardUpdate_182 v0
  = let v1
              ...
              (coe
                 ...
                 (coe
                    ...
                    (coe
                       MAlonzo.Code.Data.Integer.Base.d__'43'__284
                       (coe
                          MAlonzo.Code.Data.Integer.Base.d__'43'__284 (coe d_Δt_120 (coe v0))
                          (coe d_Δr_122 (coe v0)))
                       (coe d_Δf_124 (coe v0)))
                    (coe
      ...
      (let v2
             = MAlonzo.Code.Class.Decidable.Core.d_dec_16
                 (coe
                    ...
                    MAlonzo.Code.Data.Integer.Base.d_0ℤ_12 (d_Δt_120 (coe v0))) in
       coe
         (let v3
                = MAlonzo.Code.Class.Decidable.Core.d_dec_16
                    (coe
                       MAlonzo.Code.Class.Decidable.Instances.d_ℤ'45'Dec'45''8804'_38
                       (d_Δf_124 (coe v0)) MAlonzo.Code.Data.Integer.Base.d_0ℤ_12) in
          coe
            (case coe v1 of
                                                                   ...
                                                                   MAlonzo.Code.Agda.Builtin.Bool.C_true_10
                                                                     -> case coe v12 of
                                                                          MAlonzo.Code.Relation.Nullary.Reflects.C_of'696'_22 v13
                                                                            -> coe
                                                                                 MAlonzo.Code.Ledger.Conway.Specification.Rewards.C_constructor_2720
                                                                                 (d_Δt_120 (coe v0))
                                                                                 (d_Δr_122 (coe v0))
                                                                                 (d_Δf_124 (coe v0))
                                                                                 (coe
