...
-- Ledger.Conway.Foreign.HSLedger.Rewards._.HasStake
d_HasStake_22 a0 a1 = ()
-- Ledger.Conway.Foreign.HSLedger.Rewards._.HasStake-Snapshot
d_HasStake'45'Snapshot_24 ::
  ...
  = let v0
    ...
    coe
      (coe
         ...
         (coe v0))
-- Ledger.Conway.Foreign.HSLedger.Rewards._.stakeOf
d_stakeOf_60 ::
  MAlonzo.Code.Ledger.Conway.Specification.Rewards.T_HasStake_2640 ->
...
d_uncurry'7504'_62 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_uncurry'7504'_62 v0 v1 v2 v3 v4 v5
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Rewards.du_uncurry'7504'_2484
      v3 v4 v5
-- Ledger.Conway.Foreign.HSLedger.Rewards._.HasStake.stakeOf
d_stakeOf_70 ::
  MAlonzo.Code.Ledger.Conway.Specification.Rewards.T_HasStake_2640 ->
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_stakeOf_70 v0
...
d_Δf'45'nonpositive_80 ::
  MAlonzo.Code.Ledger.Conway.Specification.Rewards.T_RewardUpdate_2588 ->
  MAlonzo.Code.Data.Integer.Base.T__'8804'__26
d_Δf'45'nonpositive_80 v0
  = coe
...
d_Δt'45'nonnegative_86 ::
  MAlonzo.Code.Ledger.Conway.Specification.Rewards.T_RewardUpdate_2588 ->
  MAlonzo.Code.Data.Integer.Base.T__'8804'__26
d_Δt'45'nonnegative_86 v0
  = coe
...
d_HsTy'45'Snapshot_106 ::
  MAlonzo.Code.Foreign.HaskellTypes.T_HasHsType_14
d_HsTy'45'Snapshot_106 = erased
-- Ledger.Conway.Foreign.HSLedger.Rewards.Conv-Snapshot
d_Conv'45'Snapshot_108 ::
...
d_Conv'45'Snapshot_108
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Rewards.C_Snapshot'46'constructor_45747 v1 v2 v3
                -> coe
                     C_MkSnapshot_201
                     (coe
...
d_HsTy'45'Snapshots_110 ::
  MAlonzo.Code.Foreign.HaskellTypes.T_HasHsType_14
d_HsTy'45'Snapshots_110 = erased
-- Ledger.Conway.Foreign.HSLedger.Rewards.Conv-Snapshots
d_Conv'45'Snapshots_112 ::
  MAlonzo.Code.Foreign.Convertible.T_Convertible_8
d_Conv'45'Snapshots_112
  = coe
      MAlonzo.Code.Foreign.Convertible.C_Convertible'46'constructor_21
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Rewards.C_Snapshots'46'constructor_52781 v1 v2 v3 v4
                -> coe
                     C_MkSnapshots_2709
                     (coe
                        C_MkSnapshot_201
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              C_MkSnapshots_2709 v1 v2 v3 v4
                -> coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (\ v5 ->
                                 case coe v5 of
                                   MAlonzo.Code.Ledger.Conway.Specification.Rewards.C_Snapshot'46'constructor_45747 v6 v7 v8
                                     -> coe
                                          C_MkSnapshot_201
                                          (coe
                                             MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.C_MkHSMap_26
...
d_HsRewardUpdate_114 = ()
type T_HsRewardUpdate_114 = HsRewardUpdate
pattern C_HsRewardUpdate'46'constructor_4459 a0 a1 a2 a3 = MkRewardUpdate a0 a1 a2 a3
check_HsRewardUpdate'46'constructor_4459 ::
  Integer ->
  Integer ->
  Integer ->
  MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.T_HSMap_16
    ...
    Integer ->
  T_HsRewardUpdate_114
check_HsRewardUpdate'46'constructor_4459 = MkRewardUpdate
cover_HsRewardUpdate_114 :: HsRewardUpdate -> ()
cover_HsRewardUpdate_114 x
  = case x of
      MkRewardUpdate _ _ _ _ -> ()
-- Ledger.Conway.Foreign.HSLedger.Rewards.HsRewardUpdate.Δt
d_Δt_124 :: T_HsRewardUpdate_114 -> Integer
d_Δt_124 v0
  = case coe v0 of
      C_HsRewardUpdate'46'constructor_4459 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Foreign.HSLedger.Rewards.HsRewardUpdate.Δr
d_Δr_126 :: T_HsRewardUpdate_114 -> Integer
d_Δr_126 v0
  = case coe v0 of
      C_HsRewardUpdate'46'constructor_4459 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Foreign.HSLedger.Rewards.HsRewardUpdate.Δf
d_Δf_128 :: T_HsRewardUpdate_114 -> Integer
d_Δf_128 v0
  = case coe v0 of
      C_HsRewardUpdate'46'constructor_4459 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_rs_130 v0
  = case coe v0 of
      C_HsRewardUpdate'46'constructor_4459 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_Conv'45'RewardUpdate_134
  = coe
      ...
      (coe
         (\ v0 ->
            coe
              C_HsRewardUpdate'46'constructor_4459
              (coe
...
d_rs_168 ::
  ...
  MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.T_HSMap_16
    MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Address.T_Credential_533
    Integer
d_rs_168 v0 = coe d_rs_130 (coe v0)
-- Ledger.Conway.Foreign.HSLedger.Rewards._._.ru.Δf
d_Δf_170 :: T_HsRewardUpdate_114 -> Integer
d_Δf_170 v0 = coe d_Δf_128 (coe v0)
-- Ledger.Conway.Foreign.HSLedger.Rewards._._.ru.Δr
d_Δr_172 :: T_HsRewardUpdate_114 -> Integer
d_Δr_172 v0 = coe d_Δr_126 (coe v0)
-- Ledger.Conway.Foreign.HSLedger.Rewards._._.ru.Δt
d_Δt_174 :: T_HsRewardUpdate_114 -> Integer
d_Δt_174 v0 = coe d_Δt_124 (coe v0)
              ...
              (coe
                 ...
                 (coe
                    ...
                    (coe
                       MAlonzo.Code.Data.Integer.Base.d__'43'__276
                       (coe
                          MAlonzo.Code.Data.Integer.Base.d__'43'__276 (coe d_Δt_124 (coe v0))
                          (coe d_Δr_126 (coe v0)))
                       (coe d_Δf_128 (coe v0)))
                    (coe
      ...
      (let v2
             = MAlonzo.Code.Class.Decidable.Core.d_dec_16
                 (coe
                    ...
                    MAlonzo.Code.Data.Integer.Base.d_0ℤ_12 (d_Δt_124 (coe v0))) in
       coe
         (let v3
                = MAlonzo.Code.Class.Decidable.Core.d_dec_16
                    (coe
                       MAlonzo.Code.Class.Decidable.Instances.d_ℤ'45'Dec'45''8804'_78
                       (d_Δf_128 (coe v0)) MAlonzo.Code.Data.Integer.Base.d_0ℤ_12) in
          coe
            (case coe v1 of
...
d_Snapshot_199 = ()
type T_Snapshot_199 = Snapshot
pattern C_MkSnapshot_201 a0 a1 a2 = MkSnapshot a0 a1 a2
check_MkSnapshot_201 ::
  MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.T_HSMap_16
    MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Address.T_Credential_533
    Integer ->
  MAlonzo.Code.Ledger.Prelude.Foreign.HSTypes.T_HSMap_16
  ...
  T_Snapshot_199
check_MkSnapshot_201 = MkSnapshot
cover_Snapshot_199 :: Snapshot -> ()
cover_Snapshot_199 x
  = case x of
      MkSnapshot _ _ _ -> ()
-- Ledger.Conway.Foreign.HSLedger.Rewards.Snapshots
d_Snapshots_2707 = ()
type T_Snapshots_2707 = Snapshots
pattern C_MkSnapshots_2709 a0 a1 a2 a3 = MkSnapshots a0 a1 a2 a3
check_MkSnapshots_2709 ::
  T_Snapshot_199 ->
  T_Snapshot_199 -> T_Snapshot_199 -> Integer -> T_Snapshots_2707
check_MkSnapshots_2709 = MkSnapshots
cover_Snapshots_2707 :: Snapshots -> ()
cover_Snapshots_2707 x
  = case x of
      MkSnapshots _ _ _ _ -> ()
