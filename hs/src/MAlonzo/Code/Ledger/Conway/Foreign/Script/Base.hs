...
module MAlonzo.Code.Ledger.Conway.Foreign.Script.Base where
...
-- Ledger.Conway.Foreign.Script.Base.HSLanguage
d_HSLanguage_10 = ()
...
cover_HSLanguage_15 x
  = case x of
      ...
      PV2 -> ()
      PV3 -> ()
-- Ledger.Conway.Foreign.Script.Base.HsType-HSLanguage
d_HsType'45'HSLanguage_18 ::
  MAlonzo.Code.Foreign.HaskellTypes.T_HasHsType_14
d_HsType'45'HSLanguage_18 = erased
-- Ledger.Conway.Foreign.Script.Base.Convert-HSLanguage
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              ...
              _ -> MAlonzo.RTE.mazUnreachableError))
-- Ledger.Conway.Foreign.Script.Base.DecEq-HSLanguage
                ...
                -> coe
                     (\ v1 ->
                        case coe v1 of
                          ...
                          _ -> MAlonzo.RTE.mazUnreachableError)
              _ -> MAlonzo.RTE.mazUnreachableError))
-- Ledger.Conway.Foreign.Script.Base.Show-HSLanguage
