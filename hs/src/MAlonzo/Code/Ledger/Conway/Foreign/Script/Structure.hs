...
data T_HSTimelock_302
  = C_constructor_316 MAlonzo.Code.Ledger.Conway.Specification.Script.Timelock.T_Timelock_152
                      Integer Integer
...
d_HSP1ScriptStructure_322 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Script.Base.C_constructor_174
      (\ v1 v2 v3 ->
         MAlonzo.Code.Ledger.Conway.Specification.Script.Timelock.d_Dec'45'evalTimelock_210
...
d_HSP2ScriptStructure_344 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Script.Base.C_constructor_326
...
d_HSScriptStructure_372 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Script.Base.C_constructor_500
