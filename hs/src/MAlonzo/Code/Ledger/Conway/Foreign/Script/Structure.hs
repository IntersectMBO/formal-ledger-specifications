...
data T_HSTimelock_302
  = C_constructor_316 MAlonzo.Code.Ledger.Conway.Specification.Script.Timelock.T_Timelock_108
                      Integer Integer
...
d_HSP1ScriptStructure_322 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Script.Base.C_constructor_130
      (\ v1 v2 v3 ->
         MAlonzo.Code.Ledger.Conway.Specification.Script.Timelock.d_Dec'45'evalTimelock_166
...
d_HSP2ScriptStructure_344 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Script.Base.C_constructor_282
