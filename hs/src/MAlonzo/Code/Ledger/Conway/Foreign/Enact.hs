...
d_Conv'45'EnactState_102
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Enact.C_constructor_1248 v1 v2 v3 v4 v5
                -> coe
                     C_MkEnactState_161
                     (coe
...
d_Conv'45'EnactEnv_106
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Specification.Enact.C_constructor_1224 v1 v2 v3
                -> coe
                     C_MkEnactEnv_12125
                     (coe
                        MAlonzo.Code.Foreign.Haskell.Coerce.d_coerce_44 () erased () erased
