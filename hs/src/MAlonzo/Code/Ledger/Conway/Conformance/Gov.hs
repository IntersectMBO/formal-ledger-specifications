...
d_GovEnv_2562 a0 a1 = ()
data T_GovEnv_2562
  = C_constructor_2592 AgdaAny AgdaAny
                       MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_310
                       (Maybe AgdaAny)
                       MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_996
                       MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1376
...
d_txid_2578 :: T_GovEnv_2562 -> AgdaAny
d_txid_2578 v0
  = case coe v0 of
      C_constructor_2592 v1 v2 v3 v4 v5 v6 v7 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.epoch
d_epoch_2580 :: T_GovEnv_2562 -> AgdaAny
d_epoch_2580 v0
  = case coe v0 of
      C_constructor_2592 v1 v2 v3 v4 v5 v6 v7 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pparams_2582 v0
  = case coe v0 of
      C_constructor_2592 v1 v2 v3 v4 v5 v6 v7 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.ppolicy
d_ppolicy_2584 :: T_GovEnv_2562 -> Maybe AgdaAny
d_ppolicy_2584 v0
  = case coe v0 of
      C_constructor_2592 v1 v2 v3 v4 v5 v6 v7 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_enactState_2586 v0
  = case coe v0 of
      C_constructor_2592 v1 v2 v3 v4 v5 v6 v7 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_certState_2588 v0
  = case coe v0 of
      C_constructor_2592 v1 v2 v3 v4 v5 v6 v7 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.rewardCreds
d_rewardCreds_2590 ::
  T_GovEnv_2562 ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
d_rewardCreds_2590 v0
  = case coe v0 of
      C_constructor_2592 v1 v2 v3 v4 v5 v6 v7 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.HasCast-GovEnv
d_HasCast'45'GovEnv_2594 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2090 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'GovEnv_2594 ~v0 ~v1 = du_HasCast'45'GovEnv_2594
du_HasCast'45'GovEnv_2594 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'GovEnv_2594
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (2562 :: Integer) (14950884968918448145 :: Integer)
                                 "Ledger.Conway.Conformance.Gov.GovEnv"
                              ...
                              (coe
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          (MAlonzo.RTE.QName
                                             (1740 :: Integer) (14950884968918448145 :: Integer)
                                             "Ledger.Conway.Conformance.Gov._.EnactState"
                                             (MAlonzo.RTE.Fixity
                                                MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                       (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          ...
                                          (coe
                                             (MAlonzo.RTE.QName
                                                (1914 :: Integer) (14950884968918448145 :: Integer)
                                                "Ledger.Conway.Conformance.Gov._.CertState"
                                                (MAlonzo.RTE.Fixity
                                                   MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                          (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                                          ...
                                          (coe
                                             ...
                                             (coe
                                                ...
                                                (coe
                                                   MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
                                 (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))))))
         (coe C_constructor_2592))
-- Ledger.Conway.Conformance.Gov._⊢_⇀⦇_,GOVS⦈_
d__'8866'_'8640''10631'_'44'GOVS'10632'__2596 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2090 ->
  T_GovEnv_2562 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> ()
d__'8866'_'8640''10631'_'44'GOVS'10632'__2596 = erased
...
d_certState_2612 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1376
d_certState_2612 v0 ~v1 ~v2 ~v3 = du_certState_2612 v0
du_certState_2612 ::
  T_GovEnv_2562 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1376
du_certState_2612 v0 = coe d_certState_2588 (coe v0)
...
d_enactState_2614 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_996
d_enactState_2614 v0 ~v1 ~v2 ~v3 = du_enactState_2614 v0
du_enactState_2614 ::
  T_GovEnv_2562 ->
  MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_996
du_enactState_2614 v0 = coe d_enactState_2586 (coe v0)
...
d_epoch_2616 v0 ~v1 ~v2 ~v3 = du_epoch_2616 v0
du_epoch_2616 :: T_GovEnv_2562 -> AgdaAny
du_epoch_2616 v0 = coe d_epoch_2580 (coe v0)
...
d_pparams_2618 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_310
d_pparams_2618 v0 ~v1 ~v2 ~v3 = du_pparams_2618 v0
du_pparams_2618 ::
  T_GovEnv_2562 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_310
du_pparams_2618 v0 = coe d_pparams_2582 (coe v0)
...
d_ppolicy_2620 v0 ~v1 ~v2 ~v3 = du_ppolicy_2620 v0
du_ppolicy_2620 :: T_GovEnv_2562 -> Maybe AgdaAny
du_ppolicy_2620 v0 = coe d_ppolicy_2584 (coe v0)
...
d_rewardCreds_2622 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
d_rewardCreds_2622 v0 ~v1 ~v2 ~v3 = du_rewardCreds_2622 v0
du_rewardCreds_2622 ::
  T_GovEnv_2562 ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
du_rewardCreds_2622 v0 = coe d_rewardCreds_2590 (coe v0)
...
d_txid_2624 ::
  ...
  [MAlonzo.Code.Data.Sum.Base.T__'8846'__30] ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> AgdaAny
d_txid_2624 v0 ~v1 ~v2 ~v3 = du_txid_2624 v0
du_txid_2624 :: T_GovEnv_2562 -> AgdaAny
du_txid_2624 v0 = coe d_txid_2578 (coe v0)
