...
d_GovEnv_2718 a0 a1 = ()
data T_GovEnv_2718
  = C_constructor_2748 AgdaAny AgdaAny
                       MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_270
                       (Maybe AgdaAny)
                       MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_1044
                       MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1476
...
d_txid_2734 :: T_GovEnv_2718 -> AgdaAny
d_txid_2734 v0
  = case coe v0 of
      C_constructor_2748 v1 v2 v3 v4 v5 v6 v7 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.epoch
d_epoch_2736 :: T_GovEnv_2718 -> AgdaAny
d_epoch_2736 v0
  = case coe v0 of
      C_constructor_2748 v1 v2 v3 v4 v5 v6 v7 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pparams_2738 v0
  = case coe v0 of
      C_constructor_2748 v1 v2 v3 v4 v5 v6 v7 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.ppolicy
d_ppolicy_2740 :: T_GovEnv_2718 -> Maybe AgdaAny
d_ppolicy_2740 v0
  = case coe v0 of
      C_constructor_2748 v1 v2 v3 v4 v5 v6 v7 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_enactState_2742 v0
  = case coe v0 of
      C_constructor_2748 v1 v2 v3 v4 v5 v6 v7 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_certState_2744 v0
  = case coe v0 of
      C_constructor_2748 v1 v2 v3 v4 v5 v6 v7 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_rewardCreds_2746 v0
  = case coe v0 of
      C_constructor_2748 v1 v2 v3 v4 v5 v6 v7 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (2718 :: Integer) (14950884968918448145 :: Integer)
                                 "Ledger.Conway.Conformance.Gov.GovEnv"
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          ...
                                          (coe
                                             (MAlonzo.RTE.QName
                                                (2016 :: Integer) (14950884968918448145 :: Integer)
                                                "Ledger.Conway.Conformance.Gov._.CertState"
                                                (MAlonzo.RTE.Fixity
                                                   MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                          (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                                          ...
                                          (coe
                                             ...
                                             (coe
                                                ...
                                                (coe
                                                   MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
                                 (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))))))
         (coe C_constructor_2748))
-- Ledger.Conway.Conformance.Gov._⊢_⇀⦇_,GOVS⦈_
d__'8866'_'8640''10631'_'44'GOVS'10632'__2752 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2224 ->
  T_GovEnv_2718 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> ()
d__'8866'_'8640''10631'_'44'GOVS'10632'__2752 = erased
...
d_certState_2768 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1476
d_certState_2768 v0 ~v1 ~v2 ~v3 = du_certState_2768 v0
du_certState_2768 ::
  T_GovEnv_2718 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1476
du_certState_2768 v0 = coe d_certState_2744 (coe v0)
...
d_enactState_2770 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_1044
d_enactState_2770 v0 ~v1 ~v2 ~v3 = du_enactState_2770 v0
du_enactState_2770 ::
  T_GovEnv_2718 ->
  MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_1044
du_enactState_2770 v0 = coe d_enactState_2742 (coe v0)
...
d_epoch_2772 v0 ~v1 ~v2 ~v3 = du_epoch_2772 v0
du_epoch_2772 :: T_GovEnv_2718 -> AgdaAny
du_epoch_2772 v0 = coe d_epoch_2736 (coe v0)
...
d_pparams_2774 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_270
d_pparams_2774 v0 ~v1 ~v2 ~v3 = du_pparams_2774 v0
du_pparams_2774 ::
  T_GovEnv_2718 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_270
du_pparams_2774 v0 = coe d_pparams_2738 (coe v0)
...
d_ppolicy_2776 v0 ~v1 ~v2 ~v3 = du_ppolicy_2776 v0
du_ppolicy_2776 :: T_GovEnv_2718 -> Maybe AgdaAny
du_ppolicy_2776 v0 = coe d_ppolicy_2740 (coe v0)
...
d_rewardCreds_2778 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
d_rewardCreds_2778 v0 ~v1 ~v2 ~v3 = du_rewardCreds_2778 v0
du_rewardCreds_2778 ::
  T_GovEnv_2718 ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
du_rewardCreds_2778 v0 = coe d_rewardCreds_2746 (coe v0)
...
d_txid_2780 ::
  ...
  [MAlonzo.Code.Data.Sum.Base.T__'8846'__30] ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> AgdaAny
d_txid_2780 v0 ~v1 ~v2 ~v3 = du_txid_2780 v0
du_txid_2780 :: T_GovEnv_2718 -> AgdaAny
du_txid_2780 v0 = coe d_txid_2734 (coe v0)
