...
d_GovState_2310 = erased
-- Ledger.Conway.Conformance.Gov.GovEnv
d_GovEnv_2444 a0 a1 = ()
data T_GovEnv_2444
  = C_GovEnv'46'constructor_7593 AgdaAny AgdaAny
                                 MAlonzo.Code.Ledger.Conway.PParams.T_PParams_264 (Maybe AgdaAny)
                                 MAlonzo.Code.Ledger.Conway.Enact.T_EnactState_922
                                 MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1274
                                 [MAlonzo.Code.Ledger.Conway.Address.T_Credential_18]
-- Ledger.Conway.Conformance.Gov.GovEnv.txid
d_txid_2460 :: T_GovEnv_2444 -> AgdaAny
d_txid_2460 v0
  = case coe v0 of
      C_GovEnv'46'constructor_7593 v1 v2 v3 v4 v5 v6 v7 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.epoch
d_epoch_2462 :: T_GovEnv_2444 -> AgdaAny
d_epoch_2462 v0
  = case coe v0 of
      C_GovEnv'46'constructor_7593 v1 v2 v3 v4 v5 v6 v7 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.pparams
d_pparams_2464 ::
  T_GovEnv_2444 -> MAlonzo.Code.Ledger.Conway.PParams.T_PParams_264
d_pparams_2464 v0
  = case coe v0 of
      C_GovEnv'46'constructor_7593 v1 v2 v3 v4 v5 v6 v7 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.ppolicy
d_ppolicy_2466 :: T_GovEnv_2444 -> Maybe AgdaAny
d_ppolicy_2466 v0
  = case coe v0 of
      C_GovEnv'46'constructor_7593 v1 v2 v3 v4 v5 v6 v7 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.enactState
d_enactState_2468 ::
  T_GovEnv_2444 -> MAlonzo.Code.Ledger.Conway.Enact.T_EnactState_922
d_enactState_2468 v0
  = case coe v0 of
      C_GovEnv'46'constructor_7593 v1 v2 v3 v4 v5 v6 v7 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_certState_2470 v0
  = case coe v0 of
      C_GovEnv'46'constructor_7593 v1 v2 v3 v4 v5 v6 v7 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.rewardCreds
d_rewardCreds_2472 ::
  T_GovEnv_2444 ->
  [MAlonzo.Code.Ledger.Conway.Address.T_Credential_18]
d_rewardCreds_2472 v0
  = case coe v0 of
      C_GovEnv'46'constructor_7593 v1 v2 v3 v4 v5 v6 v7 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_HasCast'45'GovEnv_2474 ~v0 ~v1 = du_HasCast'45'GovEnv_2474
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (2444 :: Integer) (14950884968918448145 :: Integer)
                                 "Ledger.Conway.Conformance.Gov.GovEnv"
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          ...
                                          (coe
                                             (MAlonzo.RTE.QName
                                                (1832 :: Integer) (14950884968918448145 :: Integer)
                                                "Ledger.Conway.Conformance.Gov._.CertState"
                                                (MAlonzo.RTE.Fixity
                                                   MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                          (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                                          ...
                                          (coe
                                             ...
                                             (coe
                                                ...
                                                (coe
                                                   MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
                                 (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))))))
         (coe C_GovEnv'46'constructor_7593))
-- Ledger.Conway.Conformance.Gov._⊢_⇀⦇_,GOVS⦈_
d__'8866'_'8640''10631'_'44'GOVS'10632'__2476 ::
  MAlonzo.Code.Ledger.Conway.Transaction.T_TransactionStructure_22 ->
  MAlonzo.Code.Ledger.Conway.Abstract.T_AbstractFunctions_1986 ->
  T_GovEnv_2444 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> ()
d__'8866'_'8640''10631'_'44'GOVS'10632'__2476 = erased
...
d_certState_2492 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1274
d_certState_2492 v0 ~v1 ~v2 ~v3 = du_certState_2492 v0
du_certState_2492 ::
  T_GovEnv_2444 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1274
du_certState_2492 v0 = coe d_certState_2470 (coe v0)
...
d_enactState_2494 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Enact.T_EnactState_922
d_enactState_2494 v0 ~v1 ~v2 ~v3 = du_enactState_2494 v0
du_enactState_2494 ::
  T_GovEnv_2444 -> MAlonzo.Code.Ledger.Conway.Enact.T_EnactState_922
du_enactState_2494 v0 = coe d_enactState_2468 (coe v0)
...
d_epoch_2496 v0 ~v1 ~v2 ~v3 = du_epoch_2496 v0
du_epoch_2496 :: T_GovEnv_2444 -> AgdaAny
du_epoch_2496 v0 = coe d_epoch_2462 (coe v0)
...
d_pparams_2498 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.PParams.T_PParams_264
d_pparams_2498 v0 ~v1 ~v2 ~v3 = du_pparams_2498 v0
du_pparams_2498 ::
  T_GovEnv_2444 -> MAlonzo.Code.Ledger.Conway.PParams.T_PParams_264
du_pparams_2498 v0 = coe d_pparams_2464 (coe v0)
...
d_ppolicy_2500 v0 ~v1 ~v2 ~v3 = du_ppolicy_2500 v0
du_ppolicy_2500 :: T_GovEnv_2444 -> Maybe AgdaAny
du_ppolicy_2500 v0 = coe d_ppolicy_2466 (coe v0)
...
d_rewardCreds_2502 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  [MAlonzo.Code.Ledger.Conway.Address.T_Credential_18]
d_rewardCreds_2502 v0 ~v1 ~v2 ~v3 = du_rewardCreds_2502 v0
du_rewardCreds_2502 ::
  T_GovEnv_2444 ->
  [MAlonzo.Code.Ledger.Conway.Address.T_Credential_18]
du_rewardCreds_2502 v0 = coe d_rewardCreds_2472 (coe v0)
...
d_txid_2504 ::
  ...
  [MAlonzo.Code.Data.Sum.Base.T__'8846'__30] ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> AgdaAny
d_txid_2504 v0 ~v1 ~v2 ~v3 = du_txid_2504 v0
du_txid_2504 :: T_GovEnv_2444 -> AgdaAny
du_txid_2504 v0 = coe d_txid_2460 (coe v0)
