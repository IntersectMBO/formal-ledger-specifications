...
d_GovState_2766 ::
  ...
  ()
d_GovState_2766 = erased
-- Ledger.Conway.Conformance.Gov.GovEnv
d_GovEnv_2910 a0 a1 = ()
data T_GovEnv_2910
  = C_constructor_2940 AgdaAny AgdaAny
                       MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_272
                       (Maybe AgdaAny)
                       MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_1150
                       MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1590
...
d_txid_2926 :: T_GovEnv_2910 -> AgdaAny
d_txid_2926 v0
  = case coe v0 of
      C_constructor_2940 v1 v2 v3 v4 v5 v6 v7 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.epoch
d_epoch_2928 :: T_GovEnv_2910 -> AgdaAny
d_epoch_2928 v0
  = case coe v0 of
      C_constructor_2940 v1 v2 v3 v4 v5 v6 v7 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pparams_2930 v0
  = case coe v0 of
      C_constructor_2940 v1 v2 v3 v4 v5 v6 v7 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.ppolicy
d_ppolicy_2932 :: T_GovEnv_2910 -> Maybe AgdaAny
d_ppolicy_2932 v0
  = case coe v0 of
      C_constructor_2940 v1 v2 v3 v4 v5 v6 v7 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_enactState_2934 v0
  = case coe v0 of
      C_constructor_2940 v1 v2 v3 v4 v5 v6 v7 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_certState_2936 v0
  = case coe v0 of
      C_constructor_2940 v1 v2 v3 v4 v5 v6 v7 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_rewardCreds_2938 v0
  = case coe v0 of
      C_constructor_2940 v1 v2 v3 v4 v5 v6 v7 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.HasCast-GovEnv
d_HasCast'45'GovEnv_2942 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2460 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'GovEnv_2942 ~v0 ~v1 = du_HasCast'45'GovEnv_2942
du_HasCast'45'GovEnv_2942 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'GovEnv_2942
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (2910 :: Integer) (14950884968918448145 :: Integer)
                                 "Ledger.Conway.Conformance.Gov.GovEnv"
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (1300 :: Integer) (4677747647620784524 :: Integer)
                              ...
                              (coe
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          (MAlonzo.RTE.QName
                                             (2002 :: Integer) (14950884968918448145 :: Integer)
                                             "Ledger.Conway.Conformance.Gov._.EnactState"
                                             (MAlonzo.RTE.Fixity
                                                MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                       (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          ...
                                          (coe
                                             (MAlonzo.RTE.QName
                                                (2206 :: Integer) (14950884968918448145 :: Integer)
                                                "Ledger.Conway.Conformance.Gov._.CertState"
                                                (MAlonzo.RTE.Fixity
                                                   MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                          (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                                          ...
                                          (coe
                                             ...
                                             (coe
                                                ...
                                                (coe
                                                   MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
                                 (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))))))
         (coe C_constructor_2940))
-- Ledger.Conway.Conformance.Gov._⊢_⇀⦇_,GOVS⦈_
d__'8866'_'8640''10631'_'44'GOVS'10632'__2944 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2460 ->
  T_GovEnv_2910 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> ()
d__'8866'_'8640''10631'_'44'GOVS'10632'__2944 = erased
...
d_certState_2960 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1590
d_certState_2960 v0 ~v1 ~v2 ~v3 = du_certState_2960 v0
du_certState_2960 ::
  T_GovEnv_2910 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1590
du_certState_2960 v0 = coe d_certState_2936 (coe v0)
...
d_enactState_2962 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_1150
d_enactState_2962 v0 ~v1 ~v2 ~v3 = du_enactState_2962 v0
du_enactState_2962 ::
  T_GovEnv_2910 ->
  MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_1150
du_enactState_2962 v0 = coe d_enactState_2934 (coe v0)
...
d_epoch_2964 v0 ~v1 ~v2 ~v3 = du_epoch_2964 v0
du_epoch_2964 :: T_GovEnv_2910 -> AgdaAny
du_epoch_2964 v0 = coe d_epoch_2928 (coe v0)
...
d_pparams_2966 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_272
d_pparams_2966 v0 ~v1 ~v2 ~v3 = du_pparams_2966 v0
du_pparams_2966 ::
  T_GovEnv_2910 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_272
du_pparams_2966 v0 = coe d_pparams_2930 (coe v0)
...
d_ppolicy_2968 v0 ~v1 ~v2 ~v3 = du_ppolicy_2968 v0
du_ppolicy_2968 :: T_GovEnv_2910 -> Maybe AgdaAny
du_ppolicy_2968 v0 = coe d_ppolicy_2932 (coe v0)
...
d_rewardCreds_2970 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
d_rewardCreds_2970 v0 ~v1 ~v2 ~v3 = du_rewardCreds_2970 v0
du_rewardCreds_2970 ::
  T_GovEnv_2910 ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
du_rewardCreds_2970 v0 = coe d_rewardCreds_2938 (coe v0)
...
d_txid_2972 ::
  ...
  [MAlonzo.Code.Data.Sum.Base.T__'8846'__30] ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> AgdaAny
d_txid_2972 v0 ~v1 ~v2 ~v3 = du_txid_2972 v0
du_txid_2972 :: T_GovEnv_2910 -> AgdaAny
du_txid_2972 v0 = coe d_txid_2926 (coe v0)
