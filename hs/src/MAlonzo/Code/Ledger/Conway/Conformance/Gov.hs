...
d_GovState_2054 = erased
-- Ledger.Conway.Conformance.Gov.GovEnv
d_GovEnv_2180 a0 a1 = ()
data T_GovEnv_2180
  = C_GovEnv'46'constructor_6049 AgdaAny AgdaAny
...
d_txid_2196 v0
  = case coe v0 of
      C_GovEnv'46'constructor_6049 v1 v2 v3 v4 v5 v6 v7 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.epoch
d_epoch_2198 :: T_GovEnv_2180 -> AgdaAny
d_epoch_2198 v0
  = case coe v0 of
      C_GovEnv'46'constructor_6049 v1 v2 v3 v4 v5 v6 v7 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.pparams
d_pparams_2200 ::
  T_GovEnv_2180 -> MAlonzo.Code.Ledger.PParams.T_PParams_244
d_pparams_2200 v0
  = case coe v0 of
      C_GovEnv'46'constructor_6049 v1 v2 v3 v4 v5 v6 v7 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.ppolicy
d_ppolicy_2202 :: T_GovEnv_2180 -> Maybe AgdaAny
d_ppolicy_2202 v0
  = case coe v0 of
      C_GovEnv'46'constructor_6049 v1 v2 v3 v4 v5 v6 v7 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.enactState
d_enactState_2204 ::
  T_GovEnv_2180 -> MAlonzo.Code.Ledger.Enact.T_EnactState_850
d_enactState_2204 v0
  = case coe v0 of
      C_GovEnv'46'constructor_6049 v1 v2 v3 v4 v5 v6 v7 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_certState_2206 v0
  = case coe v0 of
      C_GovEnv'46'constructor_6049 v1 v2 v3 v4 v5 v6 v7 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.rewardCreds
d_rewardCreds_2208 ::
  T_GovEnv_2180 -> [MAlonzo.Code.Ledger.Address.T_Credential_16]
d_rewardCreds_2208 v0
  = case coe v0 of
      C_GovEnv'46'constructor_6049 v1 v2 v3 v4 v5 v6 v7 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_To'45'GovEnv_2210 ~v0 ~v1 = du_To'45'GovEnv_2210
du_To'45'GovEnv_2210 :: MAlonzo.Code.Class.To.T_To_8
du_To'45'GovEnv_2210
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (2180 :: Integer) (14950884968918448145 :: Integer)
                                 "Ledger.Conway.Conformance.Gov.GovEnv"
                                          ...
                                          (coe
                                             ...
                                             (coe
                                                ...
                                                (coe
                                                   MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
                                 (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))))))
         (coe C_GovEnv'46'constructor_6049))
...
d_certState_2228 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1110
d_certState_2228 v0 ~v1 ~v2 ~v3 = du_certState_2228 v0
du_certState_2228 ::
  T_GovEnv_2180 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1110
du_certState_2228 v0 = coe d_certState_2206 (coe v0)
...
d_enactState_2230 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Enact.T_EnactState_850
d_enactState_2230 v0 ~v1 ~v2 ~v3 = du_enactState_2230 v0
du_enactState_2230 ::
  T_GovEnv_2180 -> MAlonzo.Code.Ledger.Enact.T_EnactState_850
du_enactState_2230 v0 = coe d_enactState_2204 (coe v0)
...
d_epoch_2232 v0 ~v1 ~v2 ~v3 = du_epoch_2232 v0
du_epoch_2232 :: T_GovEnv_2180 -> AgdaAny
du_epoch_2232 v0 = coe d_epoch_2198 (coe v0)
...
d_pparams_2234 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.PParams.T_PParams_244
d_pparams_2234 v0 ~v1 ~v2 ~v3 = du_pparams_2234 v0
du_pparams_2234 ::
  T_GovEnv_2180 -> MAlonzo.Code.Ledger.PParams.T_PParams_244
du_pparams_2234 v0 = coe d_pparams_2200 (coe v0)
...
d_ppolicy_2236 v0 ~v1 ~v2 ~v3 = du_ppolicy_2236 v0
du_ppolicy_2236 :: T_GovEnv_2180 -> Maybe AgdaAny
du_ppolicy_2236 v0 = coe d_ppolicy_2202 (coe v0)
...
d_rewardCreds_2238 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  [MAlonzo.Code.Ledger.Address.T_Credential_16]
d_rewardCreds_2238 v0 ~v1 ~v2 ~v3 = du_rewardCreds_2238 v0
du_rewardCreds_2238 ::
  T_GovEnv_2180 -> [MAlonzo.Code.Ledger.Address.T_Credential_16]
du_rewardCreds_2238 v0 = coe d_rewardCreds_2208 (coe v0)
...
d_txid_2240 ::
  ...
  [MAlonzo.Code.Data.Sum.Base.T__'8846'__30] ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> AgdaAny
d_txid_2240 v0 ~v1 ~v2 ~v3 = du_txid_2240 v0
du_txid_2240 :: T_GovEnv_2180 -> AgdaAny
du_txid_2240 v0 = coe d_txid_2196 (coe v0)
