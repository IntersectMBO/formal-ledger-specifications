...
d_GovState_2708 ::
  ...
  ()
d_GovState_2708 = erased
-- Ledger.Conway.Conformance.Gov.GovEnv
d_GovEnv_2852 a0 a1 = ()
data T_GovEnv_2852
  = C_constructor_2882 AgdaAny AgdaAny
                       MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_280
                       (Maybe AgdaAny)
                       MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_1120
                       MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1556
...
d_txid_2868 :: T_GovEnv_2852 -> AgdaAny
d_txid_2868 v0
  = case coe v0 of
      C_constructor_2882 v1 v2 v3 v4 v5 v6 v7 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.epoch
d_epoch_2870 :: T_GovEnv_2852 -> AgdaAny
d_epoch_2870 v0
  = case coe v0 of
      C_constructor_2882 v1 v2 v3 v4 v5 v6 v7 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pparams_2872 v0
  = case coe v0 of
      C_constructor_2882 v1 v2 v3 v4 v5 v6 v7 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.ppolicy
d_ppolicy_2874 :: T_GovEnv_2852 -> Maybe AgdaAny
d_ppolicy_2874 v0
  = case coe v0 of
      C_constructor_2882 v1 v2 v3 v4 v5 v6 v7 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.enactState
d_enactState_2876 ::
  T_GovEnv_2852 ->
  MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_1120
d_enactState_2876 v0
  = case coe v0 of
      C_constructor_2882 v1 v2 v3 v4 v5 v6 v7 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_certState_2878 v0
  = case coe v0 of
      C_constructor_2882 v1 v2 v3 v4 v5 v6 v7 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.rewardCreds
d_rewardCreds_2880 ::
  T_GovEnv_2852 ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
d_rewardCreds_2880 v0
  = case coe v0 of
      C_constructor_2882 v1 v2 v3 v4 v5 v6 v7 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.HasCast-GovEnv
d_HasCast'45'GovEnv_2884 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2406 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'GovEnv_2884 ~v0 ~v1 = du_HasCast'45'GovEnv_2884
du_HasCast'45'GovEnv_2884 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'GovEnv_2884
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (2852 :: Integer) (14950884968918448145 :: Integer)
                                 "Ledger.Conway.Conformance.Gov.GovEnv"
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe
                                    (MAlonzo.RTE.QName
                                       (420 :: Integer) (14950884968918448145 :: Integer)
                                       "_.PParams"
                                       (MAlonzo.RTE.Fixity
                                          MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                 (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                              ...
                              (coe
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          (MAlonzo.RTE.QName
                                             (1948 :: Integer) (14950884968918448145 :: Integer)
                                             "Ledger.Conway.Conformance.Gov._.EnactState"
                                             (MAlonzo.RTE.Fixity
                                                MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                       (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
...
d__'8866'_'8640''10631'_'44'GOVS'10632'__2886 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2406 ->
  T_GovEnv_2852 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> ()
d__'8866'_'8640''10631'_'44'GOVS'10632'__2886 = erased
...
d_certState_2902 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1556
d_certState_2902 v0 ~v1 ~v2 ~v3 = du_certState_2902 v0
du_certState_2902 ::
  T_GovEnv_2852 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1556
du_certState_2902 v0 = coe d_certState_2878 (coe v0)
...
d_enactState_2904 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_1120
d_enactState_2904 v0 ~v1 ~v2 ~v3 = du_enactState_2904 v0
du_enactState_2904 ::
  T_GovEnv_2852 ->
  MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_1120
du_enactState_2904 v0 = coe d_enactState_2876 (coe v0)
...
d_epoch_2906 v0 ~v1 ~v2 ~v3 = du_epoch_2906 v0
du_epoch_2906 :: T_GovEnv_2852 -> AgdaAny
du_epoch_2906 v0 = coe d_epoch_2870 (coe v0)
...
d_pparams_2908 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_280
d_pparams_2908 v0 ~v1 ~v2 ~v3 = du_pparams_2908 v0
du_pparams_2908 ::
  T_GovEnv_2852 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_280
du_pparams_2908 v0 = coe d_pparams_2872 (coe v0)
...
d_ppolicy_2910 v0 ~v1 ~v2 ~v3 = du_ppolicy_2910 v0
du_ppolicy_2910 :: T_GovEnv_2852 -> Maybe AgdaAny
du_ppolicy_2910 v0 = coe d_ppolicy_2874 (coe v0)
...
d_rewardCreds_2912 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
d_rewardCreds_2912 v0 ~v1 ~v2 ~v3 = du_rewardCreds_2912 v0
du_rewardCreds_2912 ::
  T_GovEnv_2852 ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
du_rewardCreds_2912 v0 = coe d_rewardCreds_2880 (coe v0)
...
d_txid_2914 ::
  ...
  [MAlonzo.Code.Data.Sum.Base.T__'8846'__30] ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> AgdaAny
d_txid_2914 v0 ~v1 ~v2 ~v3 = du_txid_2914 v0
du_txid_2914 :: T_GovEnv_2852 -> AgdaAny
du_txid_2914 v0 = coe d_txid_2868 (coe v0)
