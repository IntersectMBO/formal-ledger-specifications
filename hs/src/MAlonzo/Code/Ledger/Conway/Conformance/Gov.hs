...
d_GovState_2574 ::
  ...
  ()
d_GovState_2574 = erased
-- Ledger.Conway.Conformance.Gov.GovEnv
d_GovEnv_2814 a0 a1 = ()
data T_GovEnv_2814
  = C_constructor_2844 AgdaAny AgdaAny
                       MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_274
                       (Maybe AgdaAny)
                       MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_1110
                       MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1546
...
d_txid_2830 :: T_GovEnv_2814 -> AgdaAny
d_txid_2830 v0
  = case coe v0 of
      C_constructor_2844 v1 v2 v3 v4 v5 v6 v7 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.epoch
d_epoch_2832 :: T_GovEnv_2814 -> AgdaAny
d_epoch_2832 v0
  = case coe v0 of
      C_constructor_2844 v1 v2 v3 v4 v5 v6 v7 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pparams_2834 v0
  = case coe v0 of
      C_constructor_2844 v1 v2 v3 v4 v5 v6 v7 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.ppolicy
d_ppolicy_2836 :: T_GovEnv_2814 -> Maybe AgdaAny
d_ppolicy_2836 v0
  = case coe v0 of
      C_constructor_2844 v1 v2 v3 v4 v5 v6 v7 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_enactState_2838 v0
  = case coe v0 of
      C_constructor_2844 v1 v2 v3 v4 v5 v6 v7 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_certState_2840 v0
  = case coe v0 of
      C_constructor_2844 v1 v2 v3 v4 v5 v6 v7 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.rewardCreds
d_rewardCreds_2842 ::
  T_GovEnv_2814 ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
d_rewardCreds_2842 v0
  = case coe v0 of
      C_constructor_2844 v1 v2 v3 v4 v5 v6 v7 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.HasCast-GovEnv
d_HasCast'45'GovEnv_2846 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Core.Specification.Abstract.T_AbstractFunctions_2388 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'GovEnv_2846 ~v0 ~v1 = du_HasCast'45'GovEnv_2846
du_HasCast'45'GovEnv_2846 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'GovEnv_2846
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (2814 :: Integer) (14950884968918448145 :: Integer)
                                 "Ledger.Conway.Conformance.Gov.GovEnv"
                              ...
                              (coe
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          (MAlonzo.RTE.QName
                                             (2508 :: Integer) (14950884968918448145 :: Integer)
                                             "Ledger.Conway.Conformance.Gov._.EnactState"
                                             (MAlonzo.RTE.Fixity
                                                MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                       (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                                          ...
                                          (coe
                                             ...
                                             (coe
                                                ...
                                                (coe
                                                   MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
                                 (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))))))
         (coe C_constructor_2844))
-- Ledger.Conway.Conformance.Gov._⊢_⇀⦇_,GOVS⦈_
d__'8866'_'8640''10631'_'44'GOVS'10632'__2848 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Core.Specification.Abstract.T_AbstractFunctions_2388 ->
  T_GovEnv_2814 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> ()
d__'8866'_'8640''10631'_'44'GOVS'10632'__2848 = erased
...
d_certState_2864 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1546
d_certState_2864 v0 ~v1 ~v2 ~v3 = du_certState_2864 v0
du_certState_2864 ::
  T_GovEnv_2814 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1546
du_certState_2864 v0 = coe d_certState_2840 (coe v0)
...
d_enactState_2866 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_1110
d_enactState_2866 v0 ~v1 ~v2 ~v3 = du_enactState_2866 v0
du_enactState_2866 ::
  T_GovEnv_2814 ->
  MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_1110
du_enactState_2866 v0 = coe d_enactState_2838 (coe v0)
...
d_epoch_2868 v0 ~v1 ~v2 ~v3 = du_epoch_2868 v0
du_epoch_2868 :: T_GovEnv_2814 -> AgdaAny
du_epoch_2868 v0 = coe d_epoch_2832 (coe v0)
...
d_pparams_2870 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_274
d_pparams_2870 v0 ~v1 ~v2 ~v3 = du_pparams_2870 v0
du_pparams_2870 ::
  T_GovEnv_2814 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_PParams_274
du_pparams_2870 v0 = coe d_pparams_2834 (coe v0)
...
d_ppolicy_2872 v0 ~v1 ~v2 ~v3 = du_ppolicy_2872 v0
du_ppolicy_2872 :: T_GovEnv_2814 -> Maybe AgdaAny
du_ppolicy_2872 v0 = coe d_ppolicy_2836 (coe v0)
...
d_rewardCreds_2874 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
d_rewardCreds_2874 v0 ~v1 ~v2 ~v3 = du_rewardCreds_2874 v0
du_rewardCreds_2874 ::
  T_GovEnv_2814 ->
  [MAlonzo.Code.Ledger.Core.Specification.Address.T_Credential_20]
du_rewardCreds_2874 v0 = coe d_rewardCreds_2842 (coe v0)
...
d_txid_2876 ::
  ...
  [MAlonzo.Code.Data.Sum.Base.T__'8846'__30] ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> AgdaAny
d_txid_2876 v0 ~v1 ~v2 ~v3 = du_txid_2876 v0
du_txid_2876 :: T_GovEnv_2814 -> AgdaAny
du_txid_2876 v0 = coe d_txid_2830 (coe v0)
