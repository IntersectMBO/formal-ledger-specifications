...
d_HasCast'45'PState_2182 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1962 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'PState_2182 ~v0 ~v1 = du_HasCast'45'PState_2182
du_HasCast'45'PState_2182 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'PState_2182
  = coe
...
data T_Snapshot_2466
  = C_Snapshot'46'constructor_6531 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                                   MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_stake_2472 v0
  = case coe v0 of
      C_Snapshot'46'constructor_6531 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_NewEpochState_2518
  = C_NewEpochState'46'constructor_6973 AgdaAny T_EpochState_2494
...
d_lastEpoch_2526 v0
  = case coe v0 of
      C_NewEpochState'46'constructor_6973 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe
                                    ...
                                    (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))))
                  (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))
         (coe C_Snapshot'46'constructor_6531))
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe
                                    ...
                                    (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                        (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
         (coe C_Snapshots'46'constructor_6615))
                              ...
                              (coe
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))))
                     (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
         (coe C_NewEpochState'46'constructor_6973))
...
du_certState_2710 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Ledger.d_certState_2212
      (coe d_'46'generalizedField'45'lstate_30053 (coe v0))
...
d_fees_2722 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1962 ->
  T_GeneralizeTel_30063 -> Integer
d_fees_2722 ~v0 ~v1 v2 = du_fees_2722 v2
du_fees_2722 :: T_GeneralizeTel_30063 -> Integer
du_fees_2722 v0
  = coe
...
d_utxo_2724 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1962 ->
  T_GeneralizeTel_30063 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
du_certState_2742 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Ledger.d_certState_2212
      (coe d_'46'generalizedField'45'ls_43021 (coe v0))
-- Ledger.Conway.Conformance.Epoch._.govSt
d_govSt_2744 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1962 ->
  T_GeneralizeTel_43037 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
...
du_es_2760 v0
  = coe
      ...
      (coe d_'46'generalizedField'45'fut_43023 (coe v0))
...
d_'46'generalizedField'45'lstate_30053 ::
  T_GeneralizeTel_30063 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2200
d_'46'generalizedField'45'lstate_30053 v0
  = case coe v0 of
      C_mkGeneralizeTel_30065 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-mark
d_'46'generalizedField'45'mark_30055 ::
  T_GeneralizeTel_30063 -> T_Snapshot_2466
d_'46'generalizedField'45'mark_30055 v0
  = case coe v0 of
      C_mkGeneralizeTel_30065 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-set
d_'46'generalizedField'45'set_30057 ::
  T_GeneralizeTel_30063 -> T_Snapshot_2466
d_'46'generalizedField'45'set_30057 v0
  = case coe v0 of
      C_mkGeneralizeTel_30065 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-go
d_'46'generalizedField'45'go_30059 ::
  T_GeneralizeTel_30063 -> T_Snapshot_2466
d_'46'generalizedField'45'go_30059 v0
  = case coe v0 of
      C_mkGeneralizeTel_30065 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-feeSS
d_'46'generalizedField'45'feeSS_30061 ::
  T_GeneralizeTel_30063 -> Integer
d_'46'generalizedField'45'feeSS_30061 v0
  = case coe v0 of
      C_mkGeneralizeTel_30065 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch.GeneralizeTel
d_GeneralizeTel_30063 a0 a1 = ()
data T_GeneralizeTel_30063
  = C_mkGeneralizeTel_30065 MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2200
                            T_Snapshot_2466 T_Snapshot_2466 T_Snapshot_2466 Integer
-- Ledger.Conway.Conformance.Epoch..generalizedField-ls
d_'46'generalizedField'45'ls_43021 ::
  T_GeneralizeTel_43037 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2200
d_'46'generalizedField'45'ls_43021 v0
  = case coe v0 of
      C_mkGeneralizeTel_43039 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-fut
d_'46'generalizedField'45'fut_43023 ::
  T_GeneralizeTel_43037 ->
  MAlonzo.Code.Ledger.Conway.Specification.Ratify.T_RatifyState_2258
d_'46'generalizedField'45'fut_43023 v0
  = case coe v0 of
      C_mkGeneralizeTel_43039 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-e
d_'46'generalizedField'45'e_43025 ::
  T_GeneralizeTel_43037 -> AgdaAny
d_'46'generalizedField'45'e_43025 v0
  = case coe v0 of
      C_mkGeneralizeTel_43039 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-acnt
d_'46'generalizedField'45'acnt_43027 ::
  T_GeneralizeTel_43037 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_162
d_'46'generalizedField'45'acnt_43027 v0
  = case coe v0 of
      C_mkGeneralizeTel_43039 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-ss'
d_'46'generalizedField'45'ss''_43029 ::
  T_GeneralizeTel_43037 -> T_Snapshots_2476
d_'46'generalizedField'45'ss''_43029 v0
  = case coe v0 of
      C_mkGeneralizeTel_43039 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-fut'
d_'46'generalizedField'45'fut''_43031 ::
  T_GeneralizeTel_43037 ->
  MAlonzo.Code.Ledger.Conway.Specification.Ratify.T_RatifyState_2258
d_'46'generalizedField'45'fut''_43031 v0
  = case coe v0 of
      C_mkGeneralizeTel_43039 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-ss
d_'46'generalizedField'45'ss_43033 ::
  T_GeneralizeTel_43037 -> T_Snapshots_2476
d_'46'generalizedField'45'ss_43033 v0
  = case coe v0 of
      C_mkGeneralizeTel_43039 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch..generalizedField-es₀
d_'46'generalizedField'45'es'8320'_43035 ::
  T_GeneralizeTel_43037 ->
  MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_948
d_'46'generalizedField'45'es'8320'_43035 v0
  = case coe v0 of
      C_mkGeneralizeTel_43039 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Epoch.GeneralizeTel
d_GeneralizeTel_43037 a0 a1 = ()
data T_GeneralizeTel_43037
  = C_mkGeneralizeTel_43039 MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2200
                            MAlonzo.Code.Ledger.Conway.Specification.Ratify.T_RatifyState_2258
