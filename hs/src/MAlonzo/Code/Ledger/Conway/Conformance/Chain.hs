...
d__'8866'_'8640''10631'_'44'LEDGERS'10632'__1994 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  ...
  [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3444] ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2586 -> ()
d__'8866'_'8640''10631'_'44'LEDGERS'10632'__1994 = erased
-- Ledger.Conway.Conformance.Chain._.HasCast-LEnv
d_HasCast'45'LEnv_1998 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2334 ->
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
d_HasCast'45'LEnv_1998 ~v0 ~v1 = du_HasCast'45'LEnv_1998
du_HasCast'45'LEnv_1998 ::
  MAlonzo.Code.QstdlibZ45Zclasses.Class.HasCast.Base.T_HasCast_16
du_HasCast'45'LEnv_1998
  = coe
...
d__'8866'_'8640''10631'_'44'NEWEPOCH'10632'__2302 a0 a1 a2 a3 a4 a5
  = ()
...
d_DecEq'45'DepositPurpose_2442 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2334 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'DepositPurpose_2442 v0 ~v1
  = du_DecEq'45'DepositPurpose_2442 v0
du_DecEq'45'DepositPurpose_2442 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
du_DecEq'45'DepositPurpose_2442 v0
  = let v1
...
d_DepositPurpose_2448 a0 a1 = ()
-- Ledger.Conway.Conformance.Chain.ChainState
d_ChainState_2820 a0 a1 = ()
newtype T_ChainState_2820
  = C_constructor_2826 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2890
-- Ledger.Conway.Conformance.Chain.ChainState.newEpochState
d_newEpochState_2824 ::
  T_ChainState_2820 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2890
d_newEpochState_2824 v0
  = case coe v0 of
...
d_Block_2828 a0 a1 = ()
data T_Block_2828
  = C_constructor_2838 [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3444]
                       AgdaAny
...
d_ts_2834 v0
  = case coe v0 of
      C_constructor_2838 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.Block.slot
d_slot_2836 :: T_Block_2828 -> AgdaAny
d_slot_2836 v0
  = case coe v0 of
      C_constructor_2838 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_maybePurpose_2850 v0 ~v1 v2 v3 v4
  = du_maybePurpose_2850 v0 v2 v3 v4
du_maybePurpose_2850 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DepositPurpose_1114 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Integer -> Maybe Integer
du_maybePurpose_2850 v0 v1 v2 v3
  = case coe v2 of
...
d_maybePurpose'45'prop_2882 = erased
-- Ledger.Conway.Conformance.Chain.filterPurpose
d_filterPurpose_2924 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2334 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DepositPurpose_1114 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_filterPurpose_2924 v0 ~v1 v2 v3 = du_filterPurpose_2924 v0 v2 v3
du_filterPurpose_2924 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DepositPurpose_1114 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_filterPurpose_2924 v0 v1 v2
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.QabstractZ45ZsetZ45Ztheory.FiniteSetTheory.d_List'45'Model'7496'_8))
         (coe du_maybePurpose_2850 (coe v0) (coe v1)) (coe v2))
-- Ledger.Conway.Conformance.Chain.govActionDeposits
d_govActionDeposits_2938 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2334 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2586 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_govActionDeposits_2938 v0 ~v1 v2
  = du_govActionDeposits_2938 v0 v2
du_govActionDeposits_2938 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2586 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_govActionDeposits_2938 v0 v1
  = coe
...
d__'8866'_'8640''10631'_'44'CHAIN'10632'__2996 a0 a1 a2 a3 a4 a5
  = ()
data T__'8866'_'8640''10631'_'44'CHAIN'10632'__2996
  = C_CHAIN_3040 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2890
                 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T__'8866'_'8640''10631'_'44'NEWEPOCH'10632'__3136
                 MAlonzo.Code.Interface.STS.T__'8866'_'8640''10214'_'10215''42'__80
-- Ledger.Conway.Conformance.Chain._.newEpochState
d_newEpochState_3000 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2334 ->
  T_GeneralizeTel_45977 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2890
d_newEpochState_3000 ~v0 ~v1 v2 = du_newEpochState_3000 v2
du_newEpochState_3000 ::
  T_GeneralizeTel_45977 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2890
du_newEpochState_3000 v0
  = coe
      d_newEpochState_2824
      (coe d_'46'generalizedField'45's_45969 (coe v0))
-- Ledger.Conway.Conformance.Chain._.slot
d_slot_3004 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2334 ->
  T_GeneralizeTel_45977 -> AgdaAny
d_slot_3004 ~v0 ~v1 v2 = du_slot_3004 v2
du_slot_3004 :: T_GeneralizeTel_45977 -> AgdaAny
du_slot_3004 v0
  = coe d_slot_2836 (coe d_'46'generalizedField'45'b_45971 (coe v0))
...
d_ts_3006 ::
  ...
  T_GeneralizeTel_45977 ->
  [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3444]
d_ts_3006 ~v0 ~v1 v2 = du_ts_3006 v2
du_ts_3006 ::
  T_GeneralizeTel_45977 ->
  [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3444]
du_ts_3006 v0
  = coe d_ts_2834 (coe d_'46'generalizedField'45'b_45971 (coe v0))
...
d_epochState_3010 ::
  ...
  T_GeneralizeTel_45977 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_EpochState_2866
d_epochState_3010 ~v0 ~v1 v2 = du_epochState_3010 v2
du_epochState_3010 ::
  T_GeneralizeTel_45977 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_EpochState_2866
du_epochState_3010 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Epoch.d_epochState_2900
      (coe d_'46'generalizedField'45'nes_45973 (coe v0))
...
d_acnt_3018 ~v0 ~v1 v2 = du_acnt_3018 v2
du_acnt_3018 ::
  T_GeneralizeTel_45977 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_168
du_acnt_3018 v0
...
d_ls_3024 ::
  ...
  T_GeneralizeTel_45977 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2586
d_ls_3024 ~v0 ~v1 v2 = du_ls_3024 v2
du_ls_3024 ::
  T_GeneralizeTel_45977 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2586
du_ls_3024 v0
...
d_constitution_3032 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2334 ->
  T_GeneralizeTel_45977 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_constitution_3032 ~v0 ~v1 v2 = du_constitution_3032 v2
du_constitution_3032 ::
  T_GeneralizeTel_45977 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_constitution_3032 v0
  = coe
...
d_pparams_3034 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2334 ->
  T_GeneralizeTel_45977 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_pparams_3034 ~v0 ~v1 v2 = du_pparams_3034 v2
du_pparams_3034 ::
  T_GeneralizeTel_45977 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_pparams_3034 v0
  = coe
...
d_'46'generalizedField'45's_45969 ::
  T_GeneralizeTel_45977 -> T_ChainState_2820
d_'46'generalizedField'45's_45969 v0
  = case coe v0 of
      C_mkGeneralizeTel_45979 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-b
d_'46'generalizedField'45'b_45971 ::
  T_GeneralizeTel_45977 -> T_Block_2828
d_'46'generalizedField'45'b_45971 v0
  = case coe v0 of
      C_mkGeneralizeTel_45979 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-nes
d_'46'generalizedField'45'nes_45973 ::
  T_GeneralizeTel_45977 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2890
d_'46'generalizedField'45'nes_45973 v0
  = case coe v0 of
      C_mkGeneralizeTel_45979 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-ls'
d_'46'generalizedField'45'ls''_45975 ::
  T_GeneralizeTel_45977 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2586
d_'46'generalizedField'45'ls''_45975 v0
  = case coe v0 of
      C_mkGeneralizeTel_45979 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.GeneralizeTel
d_GeneralizeTel_45977 a0 a1 = ()
data T_GeneralizeTel_45977
  = C_mkGeneralizeTel_45979 T_ChainState_2820 T_Block_2828
                            MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2890
                            MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2586
