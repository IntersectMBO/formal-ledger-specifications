...
d_ChainState_2470 a0 a1 = ()
newtype T_ChainState_2470
  = C_ChainState'46'constructor_6301 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2558
-- Ledger.Conway.Conformance.Chain.ChainState.newEpochState
d_newEpochState_2474 ::
  T_ChainState_2470 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2558
d_newEpochState_2474 v0
  = case coe v0 of
...
d_Block_2476 a0 a1 = ()
data T_Block_2476
  = C_Block'46'constructor_6359 [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3180]
                                AgdaAny
...
d_slot_2484 :: T_Block_2476 -> AgdaAny
d_slot_2484 v0
  = case coe v0 of
...
d_maybePurpose_2496 v0 ~v1 v2 v3 v4
  = du_maybePurpose_2496 v0 v2 v3 v4
du_maybePurpose_2496 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DepositPurpose_934 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Integer -> Maybe Integer
du_maybePurpose_2496 v0 v1 v2 v3
  = case coe v2 of
...
d_maybePurpose'45'prop_2528 = erased
-- Ledger.Conway.Conformance.Chain.filterPurpose
d_filterPurpose_2570 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2002 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DepositPurpose_934 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_filterPurpose_2570 v0 ~v1 v2 v3 = du_filterPurpose_2570 v0 v2 v3
du_filterPurpose_2570 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DepositPurpose_934 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_filterPurpose_2570 v0 v1 v2
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.QabstractZ45ZsetZ45Ztheory.FiniteSetTheory.d_List'45'Model'7496'_8))
         (coe du_maybePurpose_2496 (coe v0) (coe v1)) (coe v2))
-- Ledger.Conway.Conformance.Chain.govActionDeposits
d_govActionDeposits_2584 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2002 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2240 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_govActionDeposits_2584 v0 ~v1 v2
  = du_govActionDeposits_2584 v0 v2
du_govActionDeposits_2584 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2240 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_govActionDeposits_2584 v0 v1
  = coe
...
d_calculateStakeDistrs_2640 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2002 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2240 ->
  MAlonzo.Code.Ledger.Conway.Specification.Ratify.T_StakeDistrs_2262
d_calculateStakeDistrs_2640 v0 ~v1 v2
  = du_calculateStakeDistrs_2640 v0 v2
du_calculateStakeDistrs_2640 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2240 ->
  MAlonzo.Code.Ledger.Conway.Specification.Ratify.T_StakeDistrs_2262
du_calculateStakeDistrs_2640 v0 v1
  = coe
      MAlonzo.Code.Ledger.Conway.Specification.Ratify.C_StakeDistrs'46'constructor_15729
      (coe du_govActionDeposits_2584 (coe v0) (coe v1))
-- Ledger.Conway.Conformance.Chain._⊢_⇀⦇_,CHAIN⦈_
d__'8866'_'8640''10631'_'44'CHAIN'10632'__2690 a0 a1 a2 a3 a4 a5
  = ()
data T__'8866'_'8640''10631'_'44'CHAIN'10632'__2690
  = C_CHAIN_2734 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2558
...
-- Ledger.Conway.Conformance.Chain._.newEpochState
d_newEpochState_2694 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2002 ->
  T_GeneralizeTel_43407 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2558
d_newEpochState_2694 ~v0 ~v1 v2 = du_newEpochState_2694 v2
du_newEpochState_2694 ::
  T_GeneralizeTel_43407 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2558
du_newEpochState_2694 v0
  = coe
      d_newEpochState_2474
...
du_slot_2698 :: T_GeneralizeTel_43407 -> AgdaAny
du_slot_2698 v0
  = coe d_slot_2484 (coe d_'46'generalizedField'45'b_43401 (coe v0))
...
d_ts_2700 ::
  ...
  T_GeneralizeTel_43407 ->
  [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3180]
d_ts_2700 ~v0 ~v1 v2 = du_ts_2700 v2
du_ts_2700 ::
  T_GeneralizeTel_43407 ->
  [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3180]
du_ts_2700 v0
  = coe d_ts_2482 (coe d_'46'generalizedField'45'b_43401 (coe v0))
...
d_epochState_2704 ::
  ...
  T_GeneralizeTel_43407 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_EpochState_2534
d_epochState_2704 ~v0 ~v1 v2 = du_epochState_2704 v2
du_epochState_2704 ::
  T_GeneralizeTel_43407 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_EpochState_2534
du_epochState_2704 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Epoch.d_epochState_2568
...
d_acnt_2712 ~v0 ~v1 v2 = du_acnt_2712 v2
du_acnt_2712 ::
  T_GeneralizeTel_43407 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_162
du_acnt_2712 v0
...
d_es_2714 ~v0 ~v1 v2 = du_es_2714 v2
du_es_2714 ::
  T_GeneralizeTel_43407 ->
  MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_948
du_es_2714 v0
...
d_ls_2718 ::
  ...
  T_GeneralizeTel_43407 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2240
d_ls_2718 ~v0 ~v1 v2 = du_ls_2718 v2
du_ls_2718 ::
  T_GeneralizeTel_43407 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2240
du_ls_2718 v0
...
d_constitution_2726 ~v0 ~v1 v2 = du_constitution_2726 v2
du_constitution_2726 ::
  T_GeneralizeTel_43407 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_constitution_2726 v0
  = coe
...
d_pparams_2728 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2002 ->
  T_GeneralizeTel_43407 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_pparams_2728 ~v0 ~v1 v2 = du_pparams_2728 v2
du_pparams_2728 ::
  T_GeneralizeTel_43407 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_pparams_2728 v0
  = coe
...
d_'46'generalizedField'45's_43399 ::
  T_GeneralizeTel_43407 -> T_ChainState_2470
...
d_'46'generalizedField'45'b_43401 ::
  T_GeneralizeTel_43407 -> T_Block_2476
...
data T_GeneralizeTel_43407
  = C_mkGeneralizeTel_43409 T_ChainState_2470 T_Block_2476
                            MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2558
                            MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2240
