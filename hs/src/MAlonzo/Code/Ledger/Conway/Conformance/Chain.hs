...
d__'8866'_'8640''10631'_'44'NEWEPOCH'10632'__2310 a0 a1 a2 a3 a4 a5
  = ()
...
d_DecEq'45'DepositPurpose_2468 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2388 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'DepositPurpose_2468 v0 ~v1
  = du_DecEq'45'DepositPurpose_2468 v0
du_DecEq'45'DepositPurpose_2468 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
du_DecEq'45'DepositPurpose_2468 v0
  = let v1
...
d_DepositPurpose_2474 a0 a1 = ()
-- Ledger.Conway.Conformance.Chain.ChainState
d_ChainState_2846 a0 a1 = ()
newtype T_ChainState_2846
  = C_constructor_2852 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_4768
-- Ledger.Conway.Conformance.Chain.ChainState.newEpochState
d_newEpochState_2850 ::
  T_ChainState_2846 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_4768
d_newEpochState_2850 v0
  = case coe v0 of
      C_constructor_2852 v1 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.Block
d_Block_2854 a0 a1 = ()
data T_Block_2854
  = C_constructor_2864 [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3434]
                       AgdaAny
...
d_ts_2860 v0
  = case coe v0 of
      C_constructor_2864 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.Block.slot
d_slot_2862 :: T_Block_2854 -> AgdaAny
d_slot_2862 v0
  = case coe v0 of
      C_constructor_2864 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_maybePurpose_2876 v0 ~v1 v2 v3 v4
  = du_maybePurpose_2876 v0 v2 v3 v4
du_maybePurpose_2876 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DepositPurpose_1114 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Integer -> Maybe Integer
du_maybePurpose_2876 v0 v1 v2 v3
  = case coe v2 of
...
d_maybePurpose'45'prop_2908 = erased
-- Ledger.Conway.Conformance.Chain.filterPurpose
d_filterPurpose_2950 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2388 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DepositPurpose_1114 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_filterPurpose_2950 v0 ~v1 v2 v3 = du_filterPurpose_2950 v0 v2 v3
du_filterPurpose_2950 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DepositPurpose_1114 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_filterPurpose_2950 v0 v1 v2
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.QabstractZ45ZsetZ45Ztheory.FiniteSetTheory.d_List'45'Model'7496'_8))
         (coe du_maybePurpose_2876 (coe v0) (coe v1)) (coe v2))
-- Ledger.Conway.Conformance.Chain.govActionDeposits
d_govActionDeposits_2964 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2388 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2584 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_govActionDeposits_2964 v0 ~v1 v2
  = du_govActionDeposits_2964 v0 v2
du_govActionDeposits_2964 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2584 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_govActionDeposits_2964 v0 v1
  = coe
...
d__'8866'_'8640''10631'_'44'CHAIN'10632'__3022 a0 a1 a2 a3 a4 a5
  = ()
data T__'8866'_'8640''10631'_'44'CHAIN'10632'__3022
  = C_CHAIN_3072 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_4768
                 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T__'8866'_'8640''10631'_'44'NEWEPOCH'10632'__5110
                 MAlonzo.Code.Interface.STS.T__'8866'_'8640''10214'_'10215''42'__80
-- Ledger.Conway.Conformance.Chain._.newEpochState
d_newEpochState_3026 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2388 ->
  T_GeneralizeTel_46111 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_4768
d_newEpochState_3026 ~v0 ~v1 v2 = du_newEpochState_3026 v2
du_newEpochState_3026 ::
  T_GeneralizeTel_46111 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_4768
du_newEpochState_3026 v0
  = coe
      d_newEpochState_2850
      (coe d_'46'generalizedField'45's_46103 (coe v0))
-- Ledger.Conway.Conformance.Chain._.slot
d_slot_3030 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2388 ->
  T_GeneralizeTel_46111 -> AgdaAny
d_slot_3030 ~v0 ~v1 v2 = du_slot_3030 v2
du_slot_3030 :: T_GeneralizeTel_46111 -> AgdaAny
du_slot_3030 v0
  = coe d_slot_2862 (coe d_'46'generalizedField'45'b_46105 (coe v0))
...
d_ts_3032 ::
  ...
  T_GeneralizeTel_46111 ->
  [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3434]
d_ts_3032 ~v0 ~v1 v2 = du_ts_3032 v2
du_ts_3032 ::
  T_GeneralizeTel_46111 ->
  [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3434]
du_ts_3032 v0
  = coe d_ts_2860 (coe d_'46'generalizedField'45'b_46105 (coe v0))
...
d_epochState_3040 ::
  ...
  T_GeneralizeTel_46111 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_EpochState_4742
d_epochState_3040 ~v0 ~v1 v2 = du_epochState_3040 v2
du_epochState_3040 ::
  T_GeneralizeTel_46111 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_EpochState_4742
du_epochState_3040 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Epoch.d_epochState_4788
      (coe d_'46'generalizedField'45'nes_46107 (coe v0))
...
d_acnt_3050 ~v0 ~v1 v2 = du_acnt_3050 v2
du_acnt_3050 ::
  T_GeneralizeTel_46111 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_166
du_acnt_3050 v0
...
d_es_3052 ~v0 ~v1 v2 = du_es_3052 v2
du_es_3052 ::
  T_GeneralizeTel_46111 ->
  MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_1110
du_es_3052 v0
...
d_ls_3056 ::
  ...
  T_GeneralizeTel_46111 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2584
d_ls_3056 ~v0 ~v1 v2 = du_ls_3056 v2
du_ls_3056 ::
  T_GeneralizeTel_46111 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2584
du_ls_3056 v0
...
d_constitution_3064 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2388 ->
  T_GeneralizeTel_46111 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_constitution_3064 ~v0 ~v1 v2 = du_constitution_3064 v2
du_constitution_3064 ::
  T_GeneralizeTel_46111 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_constitution_3064 v0
  = coe
...
d_pparams_3066 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2388 ->
  T_GeneralizeTel_46111 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_pparams_3066 ~v0 ~v1 v2 = du_pparams_3066 v2
du_pparams_3066 ::
  T_GeneralizeTel_46111 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_pparams_3066 v0
  = coe
...
d_'46'generalizedField'45's_46103 ::
  T_GeneralizeTel_46111 -> T_ChainState_2846
d_'46'generalizedField'45's_46103 v0
  = case coe v0 of
      C_mkGeneralizeTel_46113 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-b
d_'46'generalizedField'45'b_46105 ::
  T_GeneralizeTel_46111 -> T_Block_2854
d_'46'generalizedField'45'b_46105 v0
  = case coe v0 of
      C_mkGeneralizeTel_46113 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-nes
d_'46'generalizedField'45'nes_46107 ::
  T_GeneralizeTel_46111 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_4768
d_'46'generalizedField'45'nes_46107 v0
  = case coe v0 of
      C_mkGeneralizeTel_46113 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-ls'
d_'46'generalizedField'45'ls''_46109 ::
  T_GeneralizeTel_46111 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2584
d_'46'generalizedField'45'ls''_46109 v0
  = case coe v0 of
      C_mkGeneralizeTel_46113 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.GeneralizeTel
d_GeneralizeTel_46111 a0 a1 = ()
data T_GeneralizeTel_46111
  = C_mkGeneralizeTel_46113 T_ChainState_2846 T_Block_2854
                            MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_4768
                            MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2584
