...
newtype T_ChainState_2430
  = C_ChainState'46'constructor_6093 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2518
...
d_newEpochState_2434 v0
  = case coe v0 of
      C_ChainState'46'constructor_6093 v1 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.Block
d_Block_2436 a0 a1 = ()
data T_Block_2436
  = C_Block'46'constructor_6151 [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3140]
                                AgdaAny
...
d_ts_2442 v0
  = case coe v0 of
      C_Block'46'constructor_6151 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.Block.slot
d_slot_2444 :: T_Block_2436 -> AgdaAny
d_slot_2444 v0
  = case coe v0 of
      C_Block'46'constructor_6151 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_newEpochState_2654 v0
  = coe
      d_newEpochState_2434
      (coe d_'46'generalizedField'45's_43191 (coe v0))
-- Ledger.Conway.Conformance.Chain._.slot
d_slot_2658 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1962 ->
  T_GeneralizeTel_43199 -> AgdaAny
d_slot_2658 ~v0 ~v1 v2 = du_slot_2658 v2
du_slot_2658 :: T_GeneralizeTel_43199 -> AgdaAny
du_slot_2658 v0
  = coe d_slot_2444 (coe d_'46'generalizedField'45'b_43193 (coe v0))
...
du_ts_2660 ::
  ...
  [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3140]
du_ts_2660 v0
  = coe d_ts_2442 (coe d_'46'generalizedField'45'b_43193 (coe v0))
...
du_epochState_2664 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Epoch.d_epochState_2528
      (coe d_'46'generalizedField'45'nes_43195 (coe v0))
...
d_constitution_2686 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1962 ->
  T_GeneralizeTel_43199 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_'46'generalizedField'45's_43191 ::
  T_GeneralizeTel_43199 -> T_ChainState_2430
d_'46'generalizedField'45's_43191 v0
  = case coe v0 of
      C_mkGeneralizeTel_43201 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-b
d_'46'generalizedField'45'b_43193 ::
  T_GeneralizeTel_43199 -> T_Block_2436
d_'46'generalizedField'45'b_43193 v0
  = case coe v0 of
      C_mkGeneralizeTel_43201 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-nes
d_'46'generalizedField'45'nes_43195 ::
  T_GeneralizeTel_43199 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2518
d_'46'generalizedField'45'nes_43195 v0
  = case coe v0 of
      C_mkGeneralizeTel_43201 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-ls'
d_'46'generalizedField'45'ls''_43197 ::
  T_GeneralizeTel_43199 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2200
d_'46'generalizedField'45'ls''_43197 v0
  = case coe v0 of
      C_mkGeneralizeTel_43201 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.GeneralizeTel
d_GeneralizeTel_43199 a0 a1 = ()
data T_GeneralizeTel_43199
  = C_mkGeneralizeTel_43201 T_ChainState_2430 T_Block_2436
                            MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2518
                            MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2200
