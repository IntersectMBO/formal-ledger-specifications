...
d_ChainState_2654 a0 a1 = ()
newtype T_ChainState_2654
  = C_constructor_2660 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2712
-- Ledger.Conway.Conformance.Chain.ChainState.newEpochState
d_newEpochState_2658 ::
  T_ChainState_2654 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2712
d_newEpochState_2658 v0
  = case coe v0 of
...
d_Block_2662 a0 a1 = ()
data T_Block_2662
  = C_constructor_2672 [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3364]
                       AgdaAny
...
d_ts_2668 v0
  = case coe v0 of
      C_constructor_2672 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.Block.slot
d_slot_2670 :: T_Block_2662 -> AgdaAny
d_slot_2670 v0
  = case coe v0 of
      C_constructor_2672 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_maybePurpose_2684 v0 ~v1 v2 v3 v4
  = du_maybePurpose_2684 v0 v2 v3 v4
du_maybePurpose_2684 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DepositPurpose_1052 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Integer -> Maybe Integer
du_maybePurpose_2684 v0 v1 v2 v3
  = case coe v2 of
...
d_maybePurpose'45'prop_2716 = erased
-- Ledger.Conway.Conformance.Chain.filterPurpose
d_filterPurpose_2758 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2224 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DepositPurpose_1052 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_filterPurpose_2758 v0 ~v1 v2 v3 = du_filterPurpose_2758 v0 v2 v3
du_filterPurpose_2758 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DepositPurpose_1052 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_filterPurpose_2758 v0 v1 v2
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.QabstractZ45ZsetZ45Ztheory.FiniteSetTheory.d_List'45'Model'7496'_8))
         (coe du_maybePurpose_2684 (coe v0) (coe v1)) (coe v2))
-- Ledger.Conway.Conformance.Chain.govActionDeposits
d_govActionDeposits_2772 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2224 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2476 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_govActionDeposits_2772 v0 ~v1 v2
  = du_govActionDeposits_2772 v0 v2
du_govActionDeposits_2772 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2476 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_govActionDeposits_2772 v0 v1
  = coe
...
d__'8866'_'8640''10631'_'44'CHAIN'10632'__2828 a0 a1 a2 a3 a4 a5
  = ()
data T__'8866'_'8640''10631'_'44'CHAIN'10632'__2828
  = C_CHAIN_2872 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2712
...
-- Ledger.Conway.Conformance.Chain._.newEpochState
d_newEpochState_2832 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2224 ->
  T_GeneralizeTel_43331 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2712
d_newEpochState_2832 ~v0 ~v1 v2 = du_newEpochState_2832 v2
du_newEpochState_2832 ::
  T_GeneralizeTel_43331 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2712
du_newEpochState_2832 v0
  = coe
      d_newEpochState_2658
      (coe d_'46'generalizedField'45's_43323 (coe v0))
...
du_slot_2836 :: T_GeneralizeTel_43331 -> AgdaAny
du_slot_2836 v0
  = coe d_slot_2670 (coe d_'46'generalizedField'45'b_43325 (coe v0))
...
d_ts_2838 ::
  ...
  T_GeneralizeTel_43331 ->
  [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3364]
d_ts_2838 ~v0 ~v1 v2 = du_ts_2838 v2
du_ts_2838 ::
  T_GeneralizeTel_43331 ->
  [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3364]
du_ts_2838 v0
  = coe d_ts_2668 (coe d_'46'generalizedField'45'b_43325 (coe v0))
...
du_epochState_2842 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Epoch.d_epochState_2722
      (coe d_'46'generalizedField'45'nes_43327 (coe v0))
...
d_acnt_2850 ~v0 ~v1 v2 = du_acnt_2850 v2
du_acnt_2850 ::
  T_GeneralizeTel_43331 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_162
du_acnt_2850 v0
...
d_es_2852 ~v0 ~v1 v2 = du_es_2852 v2
du_es_2852 ::
  T_GeneralizeTel_43331 ->
  MAlonzo.Code.Ledger.Conway.Specification.Enact.T_EnactState_1044
du_es_2852 v0
...
d_ls_2856 ::
  ...
  T_GeneralizeTel_43331 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2476
d_ls_2856 ~v0 ~v1 v2 = du_ls_2856 v2
du_ls_2856 ::
  T_GeneralizeTel_43331 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2476
du_ls_2856 v0
...
d_constitution_2864 ~v0 ~v1 v2 = du_constitution_2864 v2
du_constitution_2864 ::
  T_GeneralizeTel_43331 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_constitution_2864 v0
  = coe
...
d_pparams_2866 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2224 ->
  T_GeneralizeTel_43331 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_pparams_2866 ~v0 ~v1 v2 = du_pparams_2866 v2
du_pparams_2866 ::
  T_GeneralizeTel_43331 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_pparams_2866 v0
  = coe
...
d_'46'generalizedField'45's_43323 ::
  T_GeneralizeTel_43331 -> T_ChainState_2654
d_'46'generalizedField'45's_43323 v0
  = case coe v0 of
      C_mkGeneralizeTel_43333 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-b
d_'46'generalizedField'45'b_43325 ::
  T_GeneralizeTel_43331 -> T_Block_2662
d_'46'generalizedField'45'b_43325 v0
  = case coe v0 of
      C_mkGeneralizeTel_43333 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-nes
d_'46'generalizedField'45'nes_43327 ::
  T_GeneralizeTel_43331 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2712
d_'46'generalizedField'45'nes_43327 v0
  = case coe v0 of
      C_mkGeneralizeTel_43333 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-ls'
d_'46'generalizedField'45'ls''_43329 ::
  T_GeneralizeTel_43331 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2476
d_'46'generalizedField'45'ls''_43329 v0
  = case coe v0 of
      C_mkGeneralizeTel_43333 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.GeneralizeTel
d_GeneralizeTel_43331 a0 a1 = ()
data T_GeneralizeTel_43331
  = C_mkGeneralizeTel_43333 T_ChainState_2654 T_Block_2662
                            MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2712
                            MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2476
