...
d_ChainState_2212 a0 a1 = ()
newtype T_ChainState_2212
  = C_ChainState'46'constructor_4669 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2292
-- Ledger.Conway.Conformance.Chain.ChainState.newEpochState
d_newEpochState_2216 ::
  T_ChainState_2212 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2292
d_newEpochState_2216 v0
  = case coe v0 of
      C_ChainState'46'constructor_4669 v1 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.Block
d_Block_2218 a0 a1 = ()
data T_Block_2218
  = C_Block'46'constructor_4727 [MAlonzo.Code.Ledger.Transaction.T_Tx_2652]
                                AgdaAny
-- Ledger.Conway.Conformance.Chain.Block.ts
d_ts_2224 ::
  T_Block_2218 -> [MAlonzo.Code.Ledger.Transaction.T_Tx_2652]
d_ts_2224 v0
  = case coe v0 of
      C_Block'46'constructor_4727 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.Block.slot
d_slot_2226 :: T_Block_2218 -> AgdaAny
d_slot_2226 v0
  = case coe v0 of
      C_Block'46'constructor_4727 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_maybePurpose_2238 v0 ~v1 v2 v3 v4
  = du_maybePurpose_2238 v0 v2 v3 v4
du_maybePurpose_2238 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Certs.T_DepositPurpose_836 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Integer -> Maybe Integer
du_maybePurpose_2238 v0 v1 v2 v3
  = case coe v2 of
...
d_maybePurpose'45'prop_2270 = erased
-- Ledger.Conway.Conformance.Chain.filterPurpose
d_filterPurpose_2312 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1760 ->
  MAlonzo.Code.Ledger.Certs.T_DepositPurpose_836 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_filterPurpose_2312 v0 ~v1 v2 v3 = du_filterPurpose_2312 v0 v2 v3
du_filterPurpose_2312 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Certs.T_DepositPurpose_836 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_filterPurpose_2312 v0 v1 v2
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.QabstractZ45ZsetZ45Ztheory.FiniteSetTheory.d_List'45'Model'7496'_8))
         (coe du_maybePurpose_2238 (coe v0) (coe v1)) (coe v2))
-- Ledger.Conway.Conformance.Chain.govActionDeposits
d_govActionDeposits_2326 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1760 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_1994 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_govActionDeposits_2326 v0 ~v1 v2
  = du_govActionDeposits_2326 v0 v2
du_govActionDeposits_2326 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_1994 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_govActionDeposits_2326 v0 v1
  = coe
...
d_calculateStakeDistrs_2382 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1760 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_1994 ->
  MAlonzo.Code.Ledger.Ratify.T_StakeDistrs_2006
d_calculateStakeDistrs_2382 v0 ~v1 v2
  = du_calculateStakeDistrs_2382 v0 v2
du_calculateStakeDistrs_2382 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_1994 ->
  MAlonzo.Code.Ledger.Ratify.T_StakeDistrs_2006
du_calculateStakeDistrs_2382 v0 v1
  = coe
      MAlonzo.Code.Ledger.Ratify.C_StakeDistrs'46'constructor_12391
      (coe du_govActionDeposits_2326 (coe v0) (coe v1))
-- Ledger.Conway.Conformance.Chain._⊢_⇀⦇_,CHAIN⦈_
d__'8866'_'8640''10631'_'44'CHAIN'10632'__2432 a0 a1 a2 a3 a4 a5
  = ()
data T__'8866'_'8640''10631'_'44'CHAIN'10632'__2432
  = C_CHAIN_2476 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2292
                 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T__'8866'_'8640''10631'_'44'NEWEPOCH'10632'__2604
                 MAlonzo.Code.Interface.STS.T__'8866'_'8640''10214'_'10215''42'__68
-- Ledger.Conway.Conformance.Chain._.newEpochState
d_newEpochState_2436 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1760 ->
  T_GeneralizeTel_41927 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2292
d_newEpochState_2436 ~v0 ~v1 v2 = du_newEpochState_2436 v2
du_newEpochState_2436 ::
  T_GeneralizeTel_41927 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2292
du_newEpochState_2436 v0
  = coe
      d_newEpochState_2216
      (coe d_'46'generalizedField'45's_41919 (coe v0))
-- Ledger.Conway.Conformance.Chain._.slot
d_slot_2440 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1760 ->
  T_GeneralizeTel_41927 -> AgdaAny
d_slot_2440 ~v0 ~v1 v2 = du_slot_2440 v2
du_slot_2440 :: T_GeneralizeTel_41927 -> AgdaAny
du_slot_2440 v0
  = coe d_slot_2226 (coe d_'46'generalizedField'45'b_41921 (coe v0))
...
d_ts_2442 ::
  ...
  T_GeneralizeTel_41927 ->
  [MAlonzo.Code.Ledger.Transaction.T_Tx_2652]
d_ts_2442 ~v0 ~v1 v2 = du_ts_2442 v2
du_ts_2442 ::
  T_GeneralizeTel_41927 ->
  [MAlonzo.Code.Ledger.Transaction.T_Tx_2652]
du_ts_2442 v0
  = coe d_ts_2224 (coe d_'46'generalizedField'45'b_41921 (coe v0))
...
d_epochState_2446 ::
  ...
  T_GeneralizeTel_41927 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_EpochState_2268
d_epochState_2446 ~v0 ~v1 v2 = du_epochState_2446 v2
du_epochState_2446 ::
  T_GeneralizeTel_41927 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_EpochState_2268
du_epochState_2446 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Epoch.d_epochState_2302
      (coe d_'46'generalizedField'45'nes_41923 (coe v0))
-- Ledger.Conway.Conformance.Chain._.acnt
d_acnt_2454 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1760 ->
  T_GeneralizeTel_41927 -> MAlonzo.Code.Ledger.PParams.T_Acnt_144
d_acnt_2454 ~v0 ~v1 v2 = du_acnt_2454 v2
du_acnt_2454 ::
  T_GeneralizeTel_41927 -> MAlonzo.Code.Ledger.PParams.T_Acnt_144
du_acnt_2454 v0
  = coe
...
d_es_2456 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1760 ->
  T_GeneralizeTel_41927 -> MAlonzo.Code.Ledger.Enact.T_EnactState_850
d_es_2456 ~v0 ~v1 v2 = du_es_2456 v2
du_es_2456 ::
  T_GeneralizeTel_41927 -> MAlonzo.Code.Ledger.Enact.T_EnactState_850
du_es_2456 v0
  = coe
...
d_ls_2460 ::
  ...
  T_GeneralizeTel_41927 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_1994
d_ls_2460 ~v0 ~v1 v2 = du_ls_2460 v2
du_ls_2460 ::
  T_GeneralizeTel_41927 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_1994
du_ls_2460 v0
...
d_constitution_2468 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1760 ->
  T_GeneralizeTel_41927 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_constitution_2468 ~v0 ~v1 v2 = du_constitution_2468 v2
du_constitution_2468 ::
  T_GeneralizeTel_41927 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_constitution_2468 v0
  = coe
...
d_'46'generalizedField'45's_41919 ::
  T_GeneralizeTel_41927 -> T_ChainState_2212
d_'46'generalizedField'45's_41919 v0
  = case coe v0 of
      C_mkGeneralizeTel_41929 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-b
d_'46'generalizedField'45'b_41921 ::
  T_GeneralizeTel_41927 -> T_Block_2218
d_'46'generalizedField'45'b_41921 v0
  = case coe v0 of
      C_mkGeneralizeTel_41929 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-nes
d_'46'generalizedField'45'nes_41923 ::
  T_GeneralizeTel_41927 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2292
d_'46'generalizedField'45'nes_41923 v0
  = case coe v0 of
      C_mkGeneralizeTel_41929 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-ls'
d_'46'generalizedField'45'ls''_41925 ::
  T_GeneralizeTel_41927 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_1994
d_'46'generalizedField'45'ls''_41925 v0
  = case coe v0 of
      C_mkGeneralizeTel_41929 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.GeneralizeTel
d_GeneralizeTel_41927 a0 a1 = ()
data T_GeneralizeTel_41927
  = C_mkGeneralizeTel_41929 T_ChainState_2212 T_Block_2218
                            MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2292
                            MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_1994
