...
d__'8866'_'8640''10631'_'44'NEWEPOCH'10632'__2286 a0 a1 a2 a3 a4 a5
  = ()
-- Ledger.Conway.Conformance.Chain._.NewEpochState
d_NewEpochState_2304 a0 a1 = ()
...
d_DecEq'45'DepositPurpose_2430 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2322 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'DepositPurpose_2430 v0 ~v1
  = du_DecEq'45'DepositPurpose_2430 v0
du_DecEq'45'DepositPurpose_2430 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
du_DecEq'45'DepositPurpose_2430 v0
  = let v1
...
d_ChainState_2816 a0 a1 = ()
newtype T_ChainState_2816
  = C_constructor_2822 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2886
-- Ledger.Conway.Conformance.Chain.ChainState.newEpochState
d_newEpochState_2820 ::
  T_ChainState_2816 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2886
d_newEpochState_2820 v0
  = case coe v0 of
      C_constructor_2822 v1 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.Block
d_Block_2824 a0 a1 = ()
data T_Block_2824
  = C_constructor_2834 [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3442]
                       AgdaAny
...
d_ts_2830 v0
  = case coe v0 of
      C_constructor_2834 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.Block.slot
d_slot_2832 :: T_Block_2824 -> AgdaAny
d_slot_2832 v0
  = case coe v0 of
      C_constructor_2834 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_maybePurpose_2846 v0 ~v1 v2 v3 v4
  = du_maybePurpose_2846 v0 v2 v3 v4
du_maybePurpose_2846 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DepositPurpose_1100 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Integer -> Maybe Integer
du_maybePurpose_2846 v0 v1 v2 v3
  = case coe v2 of
...
d_maybePurpose'45'prop_2878 = erased
-- Ledger.Conway.Conformance.Chain.filterPurpose
d_filterPurpose_2920 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2322 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DepositPurpose_1100 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_filterPurpose_2920 v0 ~v1 v2 v3 = du_filterPurpose_2920 v0 v2 v3
du_filterPurpose_2920 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Certs.T_DepositPurpose_1100 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_filterPurpose_2920 v0 v1 v2
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.QabstractZ45ZsetZ45Ztheory.FiniteSetTheory.d_List'45'Model'7496'_8))
         (coe du_maybePurpose_2846 (coe v0) (coe v1)) (coe v2))
-- Ledger.Conway.Conformance.Chain.govActionDeposits
d_govActionDeposits_2934 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2322 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2572 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_govActionDeposits_2934 v0 ~v1 v2
  = du_govActionDeposits_2934 v0 v2
du_govActionDeposits_2934 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2572 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_govActionDeposits_2934 v0 v1
  = coe
...
d__'8866'_'8640''10631'_'44'CHAIN'10632'__2992 a0 a1 a2 a3 a4 a5
  = ()
data T__'8866'_'8640''10631'_'44'CHAIN'10632'__2992
  = C_CHAIN_3036 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2886
                 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T__'8866'_'8640''10631'_'44'NEWEPOCH'10632'__3132
                 MAlonzo.Code.Interface.STS.T__'8866'_'8640''10214'_'10215''42'__80
-- Ledger.Conway.Conformance.Chain._.newEpochState
d_newEpochState_2996 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2322 ->
  T_GeneralizeTel_45979 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2886
d_newEpochState_2996 ~v0 ~v1 v2 = du_newEpochState_2996 v2
du_newEpochState_2996 ::
  T_GeneralizeTel_45979 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2886
du_newEpochState_2996 v0
  = coe
      d_newEpochState_2820
      (coe d_'46'generalizedField'45's_45971 (coe v0))
-- Ledger.Conway.Conformance.Chain._.slot
d_slot_3000 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2322 ->
  T_GeneralizeTel_45979 -> AgdaAny
d_slot_3000 ~v0 ~v1 v2 = du_slot_3000 v2
du_slot_3000 :: T_GeneralizeTel_45979 -> AgdaAny
du_slot_3000 v0
  = coe d_slot_2832 (coe d_'46'generalizedField'45'b_45973 (coe v0))
...
d_ts_3002 ::
  ...
  T_GeneralizeTel_45979 ->
  [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3442]
d_ts_3002 ~v0 ~v1 v2 = du_ts_3002 v2
du_ts_3002 ::
  T_GeneralizeTel_45979 ->
  [MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3442]
du_ts_3002 v0
  = coe d_ts_2830 (coe d_'46'generalizedField'45'b_45973 (coe v0))
...
d_epochState_3006 ::
  ...
  T_GeneralizeTel_45979 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_EpochState_2862
d_epochState_3006 ~v0 ~v1 v2 = du_epochState_3006 v2
du_epochState_3006 ::
  T_GeneralizeTel_45979 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_EpochState_2862
du_epochState_3006 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Epoch.d_epochState_2896
      (coe d_'46'generalizedField'45'nes_45975 (coe v0))
...
d_acnt_3014 ~v0 ~v1 v2 = du_acnt_3014 v2
du_acnt_3014 ::
  T_GeneralizeTel_45979 ->
  MAlonzo.Code.Ledger.Conway.Specification.PParams.T_Acnt_168
du_acnt_3014 v0
...
d_ls_3020 ::
  ...
  T_GeneralizeTel_45979 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2572
d_ls_3020 ~v0 ~v1 v2 = du_ls_3020 v2
du_ls_3020 ::
  T_GeneralizeTel_45979 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2572
du_ls_3020 v0
...
d_constitution_3028 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2322 ->
  T_GeneralizeTel_45979 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_constitution_3028 ~v0 ~v1 v2 = du_constitution_3028 v2
du_constitution_3028 ::
  T_GeneralizeTel_45979 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_constitution_3028 v0
  = coe
...
d_pparams_3030 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2322 ->
  T_GeneralizeTel_45979 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_pparams_3030 ~v0 ~v1 v2 = du_pparams_3030 v2
du_pparams_3030 ::
  T_GeneralizeTel_45979 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_pparams_3030 v0
  = coe
...
d_'46'generalizedField'45's_45971 ::
  T_GeneralizeTel_45979 -> T_ChainState_2816
d_'46'generalizedField'45's_45971 v0
  = case coe v0 of
      C_mkGeneralizeTel_45981 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-b
d_'46'generalizedField'45'b_45973 ::
  T_GeneralizeTel_45979 -> T_Block_2824
d_'46'generalizedField'45'b_45973 v0
  = case coe v0 of
      C_mkGeneralizeTel_45981 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-nes
d_'46'generalizedField'45'nes_45975 ::
  T_GeneralizeTel_45979 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2886
d_'46'generalizedField'45'nes_45975 v0
  = case coe v0 of
      C_mkGeneralizeTel_45981 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-ls'
d_'46'generalizedField'45'ls''_45977 ::
  T_GeneralizeTel_45979 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2572
d_'46'generalizedField'45'ls''_45977 v0
  = case coe v0 of
      C_mkGeneralizeTel_45981 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.GeneralizeTel
d_GeneralizeTel_45979 a0 a1 = ()
data T_GeneralizeTel_45979
  = C_mkGeneralizeTel_45981 T_ChainState_2816 T_Block_2824
                            MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2886
                            MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2572
