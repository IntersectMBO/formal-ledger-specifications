...
d__'8866'_'8640''10631'_'44'CERTS'10632'__1098 ::
  MAlonzo.Code.Ledger.Core.Specification.Gov.Base.T_GovStructure_10 ->
  ...
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1546 -> ()
d__'8866'_'8640''10631'_'44'CERTS'10632'__1098 = erased
-- Ledger.Conway.Conformance.Certs.Properties._._⊢_⇀⦇_,CERT⦈_
d__'8866'_'8640''10631'_'44'CERT'10632'__1100 a0 a1 a2 a3 a4 = ()
-- Ledger.Conway.Conformance.Certs.Properties._._⊢_⇀⦇_,DELEG⦈_
d__'8866'_'8640''10631'_'44'DELEG'10632'__1102 a0 a1 a2 a3 a4 = ()
-- Ledger.Conway.Conformance.Certs.Properties._._⊢_⇀⦇_,GOVCERT⦈_
d__'8866'_'8640''10631'_'44'GOVCERT'10632'__1104 a0 a1 a2 a3 a4
  = ()
-- Ledger.Conway.Conformance.Certs.Properties._._⊢_⇀⦇_,POST-CERT⦈_
d__'8866'_'8640''10631'_'44'POST'45'CERT'10632'__1108 a0 a1 a2 a3
                                                      a4
  = ()
-- Ledger.Conway.Conformance.Certs.Properties._._⊢_⇀⦇_,PRE-CERT⦈_
d__'8866'_'8640''10631'_'44'PRE'45'CERT'10632'__1110 a0 a1 a2 a3 a4
  = ()
-- Ledger.Conway.Conformance.Certs.Properties._.CertState
d_CertState_1140 a0 = ()
-- Ledger.Conway.Conformance.Certs.Properties._.DecEq-DepositPurpose
d_DecEq'45'DepositPurpose_1170 ::
  MAlonzo.Code.Ledger.Core.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'DepositPurpose_1170 v0
  = coe
...
d_Computational'45'DELEG_1584 ::
  MAlonzo.Code.Ledger.Core.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'DELEG_1584 v0
  = coe
                                        ...
                                        -> coe
                                             ...
                                             (coe
                                                ...
                                                (coe
                                                   ...
                                                   (coe
                                                      MAlonzo.Code.Ledger.Conway.Conformance.Certs.du_HasCast'45'DState_1562)
                                                   (coe
...
d_Computational'45'GOVCERT_1786 ::
  MAlonzo.Code.Ledger.Core.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'GOVCERT_1786 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (\ v1 v2 v3 ->
         let v4
...
d_Computational'45'CERT_2062 ::
  MAlonzo.Code.Ledger.Core.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'CERT_2062 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (\ v1 v2 v3 ->
         let v4
         ...
         coe
           (let v5
                  = coe
                      MAlonzo.Code.Interface.ComputationalRelation.d_computeProof_272
                      (d_Computational'45'GOVCERT_1786 (coe v0)) v1
                                                           ...
                                                           -> coe
                                                                ...
                                                                (coe
                                                                   ...
                                                                   (coe
                                                                      MAlonzo.Code.Ledger.Prelude.du_'10214'_'10215'_72
                                                                      (coe
                                                                         MAlonzo.Code.Ledger.Conway.Conformance.Certs.du_HasCast'45'CertState_1566)
                                                                      (coe
                                                                         MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                                                                         (coe v17)
                                                                         (coe
...
d_Computational'45'PRE'45'CERT_2370 ::
  MAlonzo.Code.Ledger.Core.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'PRE'45'CERT_2370 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (\ v1 v2 v3 ->
         let v4
                                                        ...
                                                        (coe
                                                           ...
                                                           (let v9
                                                                  = coe
                                                                      ...
                                                                      (let v9
                                                                             = coe
                                                                                 MAlonzo.Code.Ledger.Conway.Conformance.Certs.C_mkGeneralizeTel_86517
                                                                                 (coe
                                                                                    MAlonzo.Code.Ledger.Core.Specification.Certs.d_pp_1332
                                                                                    (coe v1))
                                                                                 (coe
                                                                       ...
                                                                       coe
                                                                         (MAlonzo.Code.Ledger.Conway.Specification.PParams.d_drepActivity_414
                                                                            (coe
                                                                               MAlonzo.Code.Ledger.Conway.Conformance.Certs.d_'46'generalizedField'45'pp_86489
                                                                               (coe v9)))) in
                                                            coe (coe (\ v10 -> v9)))
                                                           (coe
                                                              MAlonzo.Code.Ledger.Conway.Conformance.Certs.d_dreps_1538
                                                     ...
                                                     (coe
                                                        ...
                                                        (coe
                                                           ...
                                                           (coe
                                                              ...
                                                              (coe v2)))))))))
                                      (coe
                                         MAlonzo.Code.Ledger.Conway.Conformance.Certs.C_CERT'45'pre_2034
                                         v7))
                            _ -> MAlonzo.RTE.mazUnreachableError
                     else coe
                            seq (coe v6)
...
d_Computational'45'POST'45'CERT_2512 ::
  MAlonzo.Code.Ledger.Core.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'POST'45'CERT_2512 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (\ v1 v2 v3 ->
         seq
...
d_dreps_2522 ::
  ...
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1546 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_dreps_2522 ~v0 ~v1 v2 = du_dreps_2522 v2
du_dreps_2522 ::
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1546 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_dreps_2522 v0
...
d_validVoteDelegs_2524 ::
  MAlonzo.Code.Ledger.Core.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Ledger.Core.Specification.Certs.T_CertEnv_1318 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1546 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_validVoteDelegs_2524 v0 ~v1 v2 = du_validVoteDelegs_2524 v0 v2
du_validVoteDelegs_2524 ::
  MAlonzo.Code.Ledger.Core.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1546 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_validVoteDelegs_2524 v0 v1
  = coe
...
d_cs''_2526 ::
  ...
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1546 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1546
d_cs''_2526 v0 ~v1 v2 = du_cs''_2526 v0 v2
du_cs''_2526 ::
  MAlonzo.Code.Ledger.Core.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1546 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1546
  ...
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
               (coe du_validVoteDelegs_2524 (coe v0) (coe v1))
               (coe
                  MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                  (coe
                     MAlonzo.Code.Ledger.Conway.Conformance.Certs.d_stakeDelegs_1522
...
d_Computational'45'CERTS_2534 ::
  MAlonzo.Code.Ledger.Core.Specification.Gov.Base.T_GovStructure_10 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'CERTS_2534 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.du_Computational'45'RunTraceAfterAndThen_1366
      (coe d_Computational'45'PRE'45'CERT_2370 (coe v0))
      (coe d_Computational'45'CERT_2062 (coe v0))
      (coe d_Computational'45'POST'45'CERT_2512 (coe v0))
      (coe
