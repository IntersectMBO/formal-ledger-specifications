...
du_certState_2572 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Ledger.d_certState_2580
      (coe d_'46'generalizedField'45'lstate_6929 (coe v0))
...
d_fees_2584 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2318 ->
  T_GeneralizeTel_6939 -> Integer
d_fees_2584 ~v0 ~v1 v2 = du_fees_2584 v2
du_fees_2584 :: T_GeneralizeTel_6939 -> Integer
du_fees_2584 v0
  = coe
...
d_utxo_2586 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_2318 ->
  T_GeneralizeTel_6939 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d__'8866'_'8640''10631'_'44'SNAP'10632'__5451 a0 a1 a2 a3 a4 a5
  = ()
-- Ledger.Conway.Conformance.Rewards..generalizedField-lstate
d_'46'generalizedField'45'lstate_6929 ::
  T_GeneralizeTel_6939 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2568
d_'46'generalizedField'45'lstate_6929 v0
  = case coe v0 of
      C_mkGeneralizeTel_6941 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Rewards..generalizedField-mark
d_'46'generalizedField'45'mark_6931 ::
  T_GeneralizeTel_6939 ->
  MAlonzo.Code.Ledger.Conway.Specification.Rewards.T_Snapshot_2914
d_'46'generalizedField'45'mark_6931 v0
  = case coe v0 of
      C_mkGeneralizeTel_6941 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Rewards..generalizedField-set
d_'46'generalizedField'45'set_6933 ::
  T_GeneralizeTel_6939 ->
  MAlonzo.Code.Ledger.Conway.Specification.Rewards.T_Snapshot_2914
d_'46'generalizedField'45'set_6933 v0
  = case coe v0 of
      C_mkGeneralizeTel_6941 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Rewards..generalizedField-go
d_'46'generalizedField'45'go_6935 ::
  T_GeneralizeTel_6939 ->
  MAlonzo.Code.Ledger.Conway.Specification.Rewards.T_Snapshot_2914
d_'46'generalizedField'45'go_6935 v0
  = case coe v0 of
      C_mkGeneralizeTel_6941 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Rewards..generalizedField-feeSS
d_'46'generalizedField'45'feeSS_6937 ::
  T_GeneralizeTel_6939 -> Integer
d_'46'generalizedField'45'feeSS_6937 v0
  = case coe v0 of
      C_mkGeneralizeTel_6941 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Rewards.GeneralizeTel
d_GeneralizeTel_6939 a0 a1 = ()
data T_GeneralizeTel_6939
  = C_mkGeneralizeTel_6941 MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2568
                           MAlonzo.Code.Ledger.Conway.Specification.Rewards.T_Snapshot_2914
                           MAlonzo.Code.Ledger.Conway.Specification.Rewards.T_Snapshot_2914
                           MAlonzo.Code.Ledger.Conway.Specification.Rewards.T_Snapshot_2914
                           Integer
