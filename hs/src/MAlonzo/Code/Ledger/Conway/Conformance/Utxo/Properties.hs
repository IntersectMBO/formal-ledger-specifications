...
d_Computational'45'UTXOS_2326 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1960 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'UTXOS_2326 v0 v1
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (d_computeProof_2420 (coe v0) (coe v1))
...
d_computeProof_2420 v0 v1 v2 v3 v4
  = let v5
          = coe
                                                                ...
                                                                (coe
                                                                   ...
                                                                   (coe
                                                                      ...
                                                                      (coe
                                                                         ...
                                                                         (coe v3))))
                                                                (coe
                                                                   MAlonzo.Code.Ledger.Conway.Conformance.Utxo.C_Scripts'45'Yes_2340
                                                                   v11))
                                                      _ -> coe v10
                                               _ -> coe v10
                                                              ...
                                                              (coe
                                                                 ...
                                                                 (coe
                                                                    ...
                                                                    (coe
                                                                       ...
                                                                       (coe v3)))
                                                                 (coe
                                                                    MAlonzo.Code.Ledger.Conway.Conformance.Utxo.C_Scripts'45'No_2420
                                                                    v14))
                                                       _ -> coe v10
                                                _ -> coe v10
                                         _ -> MAlonzo.RTE.mazUnreachableError
...
d_completeness_2430 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3134 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2064 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Utxo.T__'8866'_'8640''10631'_'44'UTXOS'10632'__2260 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_completeness_2430 = erased
-- Ledger.Conway.Conformance.Utxo.Properties.Computational-UTXO
d_Computational'45'UTXO_2460 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1960 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'UTXO_2460 v0 v1
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (d_computeProof_2540 (coe v0) (coe v1))
-- Ledger.Conway.Conformance.Utxo.Properties._.Go.computeProofH
d_computeProofH_2500 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1960 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOEnv_2046 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2064 ->
  ...
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_computeProofH_2500 v0 v1 v2 v3 v4 v5
  = case coe v5 of
                                                                                                                                           ...
                                                                                                                                           (coe
                                                                                                                                              ...
                                                                                                                                              (coe
                                                                                                                                                 (\ v41
                                                                                                                                                    v42 ->
                                                                                                                                                    coe
                                                                                                                                                      MAlonzo.Code.Ledger.Conway.Conformance.Utxo.C_UTXO'45'inductive_2534
                                                                                                                                                      (coe
                                                                                                                                                         MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                                                                                                                                                         (coe
                                                                                                                                                            v9)
...
d_computeProof_2540 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3134 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_computeProof_2540 v0 v1 v2 v3 v4
  = coe
      d_computeProofH_2500 (coe v0) (coe v1) (coe v2) (coe v3) (coe v4)
      (coe
         MAlonzo.Code.Class.Decidable.Core.d_dec_16
         (coe
            MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
...
d_completeness_2544 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3134 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2064 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Utxo.T__'8866'_'8640''10631'_'44'UTXO'10632'__2426 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
...
d_UTXO'45'step_2752 ::
  ...
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_Tx_3134 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_UTXO'45'step_2752 v0 v1
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.du_compute_274
      (coe d_Computational'45'UTXO_2460 (coe v0) (coe v1))
-- Ledger.Conway.Conformance.Utxo.Properties.UTXO-step-computes-UTXO
d_UTXO'45'step'45'computes'45'UTXO_2754 ::
  MAlonzo.Code.Ledger.Conway.Specification.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Specification.Abstract.T_AbstractFunctions_1960 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOEnv_2046 ->
  MAlonzo.Code.Ledger.Conway.Specification.Utxo.T_UTxOState_2064 ->
...
d_UTXO'45'step'45'computes'45'UTXO_2754 v0 v1 v2 v3 v4 v5
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.du_'8801''45'success'8660'STS_300
      (coe d_Computational'45'UTXO_2460 (coe v0) (coe v1)) (coe v2)
