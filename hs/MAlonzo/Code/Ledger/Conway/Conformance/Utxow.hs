...
d_slot_1548 :: MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2010 -> AgdaAny
d_slot_1548 v0 = coe MAlonzo.Code.Ledger.Utxo.d_slot_2018 (coe v0)
...
d_fees_1558 :: MAlonzo.Code.Ledger.Utxo.T_UTxOState_2024 -> Integer
d_fees_1558 v0 = coe MAlonzo.Code.Ledger.Utxo.d_fees_2036 (coe v0)
-- Ledger.Conway.Conformance.Utxow._.UTxOState.utxo
d_utxo_1560 ::
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_2024 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_utxo_1560 v0 = coe MAlonzo.Code.Ledger.Utxo.d_utxo_2034 (coe v0)
...
du_allowedLanguages_1926 v0
  = coe MAlonzo.Code.Ledger.Utxow.du_allowedLanguages_2142 (coe v0)
...
du_languages_1936 v0
  = coe MAlonzo.Code.Ledger.Utxow.du_languages_2126 (coe v0)
...
d_getDataHashes_2026 ::
  ...
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1724 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> [AgdaAny]
d_getDataHashes_2026 ~v0 ~v1 = du_getDataHashes_2026
...
d_getInputHashes_2028 ::
  ...
  MAlonzo.Code.Ledger.Transaction.T_Tx_2638 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> [AgdaAny]
d_getInputHashes_2028 v0 ~v1 = du_getInputHashes_2028 v0
du_getInputHashes_2028 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2638 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> [AgdaAny]
du_getInputHashes_2028 v0
  = coe MAlonzo.Code.Ledger.Utxo.du_getInputHashes_1936 (coe v0)
-- Ledger.Conway.Conformance.Utxow._⊢_⇀⦇_,UTXOW⦈_
d__'8866'_'8640''10631'_'44'UTXOW'10632'__2146 a0 a1 a2 a3 a4 a5
  = ()
newtype T__'8866'_'8640''10631'_'44'UTXOW'10632'__2146
  = C_UTXOW'45'inductive_2254 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
-- Ledger.Conway.Conformance.Utxow._.txAD
d_txAD_2160 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1724 ->
  T_GeneralizeTel_7505 -> Maybe AgdaAny
d_txAD_2160 ~v0 ~v1 v2 = du_txAD_2160 v2
du_txAD_2160 :: T_GeneralizeTel_7505 -> Maybe AgdaAny
du_txAD_2160 v0
  = coe
...
d_body_2162 ::
  ...
  MAlonzo.Code.Ledger.Transaction.T_TxBody_2536
d_body_2162 ~v0 ~v1 v2 = du_body_2162 v2
du_body_2162 ::
  T_GeneralizeTel_7505 ->
  MAlonzo.Code.Ledger.Transaction.T_TxBody_2536
du_body_2162 v0
...
d_wits_2164 ::
  ...
  T_GeneralizeTel_7505 ->
  MAlonzo.Code.Ledger.Transaction.T_TxWitnesses_2618
d_wits_2164 ~v0 ~v1 v2 = du_wits_2164 v2
du_wits_2164 ::
  T_GeneralizeTel_7505 ->
  MAlonzo.Code.Ledger.Transaction.T_TxWitnesses_2618
du_wits_2164 v0
...
d_refInputs_2174 ~v0 ~v1 v2 = du_refInputs_2174 v2
du_refInputs_2174 ::
  T_GeneralizeTel_7505 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
du_refInputs_2174 v0
  = coe
...
d_txADhash_2180 ::
  ...
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1724 ->
  T_GeneralizeTel_7505 -> Maybe AgdaAny
d_txADhash_2180 ~v0 ~v1 v2 = du_txADhash_2180 v2
du_txADhash_2180 :: T_GeneralizeTel_7505 -> Maybe AgdaAny
du_txADhash_2180 v0
  = coe
...
d_txid_2190 ~v0 ~v1 v2 = du_txid_2190 v2
du_txid_2190 :: T_GeneralizeTel_7505 -> AgdaAny
du_txid_2190 v0
  = coe
...
d_txouts_2194 ::
  ...
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1724 ->
  T_GeneralizeTel_7505 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_txouts_2194 ~v0 ~v1 v2 = du_txouts_2194 v2
du_txouts_2194 ::
  T_GeneralizeTel_7505 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_txouts_2194 v0
  = coe
...
d_txvldt_2202 ::
  ...
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1724 ->
  T_GeneralizeTel_7505 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_txvldt_2202 ~v0 ~v1 v2 = du_txvldt_2202 v2
du_txvldt_2202 ::
  T_GeneralizeTel_7505 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_txvldt_2202 v0
  = coe
...
d_scripts_2210 ~v0 ~v1 v2 = du_scripts_2210 v2
du_scripts_2210 ::
  T_GeneralizeTel_7505 -> [MAlonzo.Code.Data.Sum.Base.T__'8846'__30]
du_scripts_2210 v0
  = coe
...
d_txdats_2214 ::
  ...
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1724 ->
  T_GeneralizeTel_7505 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_txdats_2214 ~v0 ~v1 v2 = du_txdats_2214 v2
du_txdats_2214 ::
  T_GeneralizeTel_7505 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_txdats_2214 v0
  = coe
...
d_vkSigs_2218 ::
  ...
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1724 ->
  T_GeneralizeTel_7505 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_vkSigs_2218 ~v0 ~v1 v2 = du_vkSigs_2218 v2
du_vkSigs_2218 ::
  T_GeneralizeTel_7505 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_vkSigs_2218 v0
  = coe
...
d_utxo_2228 ::
  ...
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1724 ->
  T_GeneralizeTel_7505 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_utxo_2228 ~v0 ~v1 v2 = du_utxo_2228 v2
du_utxo_2228 ::
  T_GeneralizeTel_7505 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_utxo_2228 v0
  = coe
...
d_UTXOW'45'inductive'45'premises_2280 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1724 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2638 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_2024 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_UTXOW'45'inductive'45'premises_2280 v0 ~v1 v2 v3
  = du_UTXOW'45'inductive'45'premises_2280 v0 v2 v3
du_UTXOW'45'inductive'45'premises_2280 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2638 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_2024 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_UTXOW'45'inductive'45'premises_2280 v0 v1 v2
  = coe
            ...
            (coe
                     ...
                     coe
                       ...
                       (coe
                          ...
                          (coe
                             ...
                             (MAlonzo.Code.Ledger.Utxo.d_utxo_2034 (coe v2))
                             (MAlonzo.Code.Ledger.Transaction.d_body_2648 (coe v1))))
                       (coe
               ...
               (coe
                  ...
                  (MAlonzo.Code.Ledger.Transaction.d_txscripts_2748
                     (coe v0) (coe v1)
                     (coe MAlonzo.Code.Ledger.Utxo.d_utxo_2034 (coe v2)))))
            (coe
               MAlonzo.Code.Class.Decidable.Instances.du_Dec'45''215'_24
               (coe
                  MAlonzo.Code.Axiom.Set.du_Dec'45'All'738'_1634
                              ...
                              coe
                                ...
                                (coe
                                   ...
                                   (coe
                                      ...
                                      (coe MAlonzo.Code.Ledger.Transaction.d_wits_2650 (coe v1))))))
                        (coe
                           MAlonzo.Code.Ledger.Utxo.du_getInputHashes_1936 (coe v0) (coe v1)
                           (coe MAlonzo.Code.Ledger.Utxo.d_utxo_2034 (coe v2))))
                     (coe
                        MAlonzo.Code.Class.Decidable.Instances.du_Dec'45''215'_24
                        (coe
                              ...
                              (coe
                                 (\ v3 ->
                                    coe
                                      ...
                                      (coe v3)
                                      (coe
                                         MAlonzo.Code.Ledger.Utxow.du_allowedLanguages_2142 (coe v0)
                                         (coe v1)
                                         (coe MAlonzo.Code.Ledger.Utxo.d_utxo_2034 (coe v2)))))
                              (coe
                                 MAlonzo.Code.Ledger.Utxow.du_languages_2126 (coe v0) (coe v1)
                                 (coe MAlonzo.Code.Ledger.Utxo.d_utxo_2034 (coe v2))))
                           (coe
                                 ...
                                 (MAlonzo.Code.Interface.Hashable.d_hash_16
                                    (coe
                                       ...
                                       (coe
                                          MAlonzo.Code.Ledger.Transaction.d_adHashingScheme_1194
                                          (coe v0))))
                                 (MAlonzo.Code.Ledger.Transaction.d_txAD_2654 (coe v1)))))))))))
-- Ledger.Conway.Conformance.Utxow..generalizedField-tx
d_'46'generalizedField'45'tx_7497 ::
  T_GeneralizeTel_7505 -> MAlonzo.Code.Ledger.Transaction.T_Tx_2638
...
d_'46'generalizedField'45's_7499 ::
  T_GeneralizeTel_7505 -> MAlonzo.Code.Ledger.Utxo.T_UTxOState_2024
...
d_'46'generalizedField'45'Γ_7501 ::
  T_GeneralizeTel_7505 -> MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2010
...
data T_GeneralizeTel_7505
  = C_mkGeneralizeTel_7507 MAlonzo.Code.Ledger.Transaction.T_Tx_2638
                           MAlonzo.Code.Ledger.Utxo.T_UTxOState_2024
                           MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2010
                           MAlonzo.Code.Ledger.Utxo.T_UTxOState_2024
