...
d_UTxO_368 = erased
-- _.isBootstrapAddr
d_isBootstrapAddr_458 a0 a1 = ()
-- _.isBootstrapAddr?
d_isBootstrapAddr'63'_460 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  MAlonzo.Code.Class.Decidable.Core.T__'8263'_10
d_isBootstrapAddr'63'_460 ~v0 = du_isBootstrapAddr'63'_460
du_isBootstrapAddr'63'_460 ::
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  MAlonzo.Code.Class.Decidable.Core.T__'8263'_10
du_isBootstrapAddr'63'_460
...
d_slot_1622 :: MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2008 -> AgdaAny
d_slot_1622 v0 = coe MAlonzo.Code.Ledger.Utxo.d_slot_2016 (coe v0)
...
d_fees_1632 :: MAlonzo.Code.Ledger.Utxo.T_UTxOState_2022 -> Integer
d_fees_1632 v0 = coe MAlonzo.Code.Ledger.Utxo.d_fees_2034 (coe v0)
-- Ledger.Utxow._.UTxOState.utxo
d_utxo_1634 ::
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_2022 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_utxo_1634 v0 = coe MAlonzo.Code.Ledger.Utxo.d_utxo_2032 (coe v0)
    ...
    coe
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.Ledger.Utxo.du_outs_2056 (coe du_txb_2150 (coe v1))))
         (coe
            MAlonzo.Code.Class.IsSet.du_range_550
            (coe
               MAlonzo.Code.Axiom.Set.d_th_1470
      ...
      (coe
         ...
         (\ v3 ->
            coe
              ...
              (coe
                 MAlonzo.Code.Ledger.ScriptValidation.C_Spend_1734
                 (coe MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28 (coe v3)))
              (coe
            ...
            (coe
               ...
               (coe
                  ...
                  (coe
                     ...
                     (coe
                        MAlonzo.Code.QabstractZ45ZsetZ45Ztheory.FiniteSetTheory.d_List'45'Model'7496'_8))
                  (coe MAlonzo.Code.Ledger.Transaction.d_txins_2574 (coe v2))
                  (coe
                     MAlonzo.Code.Ledger.Transaction.d_collateral_2608 (coe v2))))))
      (coe
         MAlonzo.Code.Axiom.Set.du__'8746'__680
         (coe
            MAlonzo.Code.Axiom.Set.d_th_1470
         ...
         (coe
            ...
            (\ v3 ->
               coe
                 MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                 (coe MAlonzo.Code.Ledger.ScriptValidation.C_Rwrd_1730 (coe v3))
               ...
               (\ v3 ->
                  coe
                    ...
                    (\ v4 ->
                       coe
                         MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                         (coe MAlonzo.Code.Ledger.ScriptValidation.C_Cert_1728 (coe v3))
                         (coe v4))
                    (coe MAlonzo.Code.Ledger.Certs.du_cwitness_856 (coe v3)))
               (coe
                  MAlonzo.Code.Axiom.Set.du_fromList_428
                  (coe
                     MAlonzo.Code.Axiom.Set.d_th_1470
            ...
            (coe
               ...
               (coe
                  ...
                  (\ v3 ->
                     coe
                       MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                       (coe MAlonzo.Code.Ledger.ScriptValidation.C_Mint_1732 (coe v3))
               ...
               (coe
                  ...
                  (coe
                     ...
                     (\ v3 ->
                        coe
                          MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                          (coe MAlonzo.Code.Ledger.ScriptValidation.C_Vote_1736 (coe v3))
                          (coe MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe v3)))
                     (coe
                        MAlonzo.Code.Axiom.Set.du_fromList_428
                        (coe
                        ...
                        (coe
                           ...
                           () erased
                           (\ v3 ->
                              MAlonzo.Code.Ledger.GovernanceActions.d_voter_738 (coe v3))
                  ...
                  (coe
                     ...
                     (\ v3 ->
                        let v4
                              = MAlonzo.Code.Ledger.GovernanceActions.d_policy_762 (coe v3) in
                        coe
                          (case coe v4 of
                             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 v5
                               -> coe
                                    ...
                                    (coe
                                       MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                                       (coe
                                          MAlonzo.Code.Ledger.ScriptValidation.C_Propose_1738
                                          (coe v3))
...
d_txAD_2296 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1722 ->
  T_GeneralizeTel_34825 -> Maybe AgdaAny
d_txAD_2296 ~v0 ~v1 v2 = du_txAD_2296 v2
du_txAD_2296 :: T_GeneralizeTel_34825 -> Maybe AgdaAny
du_txAD_2296 v0
  = coe
      MAlonzo.Code.Ledger.Transaction.d_txAD_2650
      (coe d_'46'generalizedField'45'tx_34819 (coe v0))
-- Ledger.Utxow._.body
d_body_2298 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1722 ->
  T_GeneralizeTel_34825 ->
  MAlonzo.Code.Ledger.Transaction.T_TxBody_2532
...
d_wits_2300 ::
  ...
  T_GeneralizeTel_34825 ->
  MAlonzo.Code.Ledger.Transaction.T_TxWitnesses_2614
d_wits_2300 ~v0 ~v1 v2 = du_wits_2300 v2
du_wits_2300 ::
  T_GeneralizeTel_34825 ->
  MAlonzo.Code.Ledger.Transaction.T_TxWitnesses_2614
du_wits_2300 v0
...
d_refInputs_2310 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1722 ->
  T_GeneralizeTel_34825 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
d_refInputs_2310 ~v0 ~v1 v2 = du_refInputs_2310 v2
du_refInputs_2310 ::
  T_GeneralizeTel_34825 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
du_refInputs_2310 v0
  = coe
      MAlonzo.Code.Ledger.Transaction.d_refInputs_2576
      (coe
         MAlonzo.Code.Ledger.Transaction.d_body_2644
...
d_txADhash_2316 ::
  ...
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1722 ->
  T_GeneralizeTel_34825 -> Maybe AgdaAny
d_txADhash_2316 ~v0 ~v1 v2 = du_txADhash_2316 v2
du_txADhash_2316 :: T_GeneralizeTel_34825 -> Maybe AgdaAny
du_txADhash_2316 v0
  = coe
...
d_txid_2326 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1722 ->
  T_GeneralizeTel_34825 -> AgdaAny
d_txid_2326 ~v0 ~v1 v2 = du_txid_2326 v2
du_txid_2326 :: T_GeneralizeTel_34825 -> AgdaAny
du_txid_2326 v0
  = coe
...
d_scripts_2346 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1722 ->
  T_GeneralizeTel_34825 -> [MAlonzo.Code.Data.Sum.Base.T__'8846'__30]
d_scripts_2346 ~v0 ~v1 v2 = du_scripts_2346 v2
du_scripts_2346 ::
  T_GeneralizeTel_34825 -> [MAlonzo.Code.Data.Sum.Base.T__'8846'__30]
du_scripts_2346 v0
  = coe
...
d_txdats_2350 ::
  ...
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1722 ->
  T_GeneralizeTel_34825 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_txdats_2350 ~v0 ~v1 v2 = du_txdats_2350 v2
du_txdats_2350 ::
  T_GeneralizeTel_34825 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_txdats_2350 v0
  = coe
...
d_vkSigs_2354 ::
  ...
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1722 ->
  T_GeneralizeTel_34825 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_vkSigs_2354 ~v0 ~v1 v2 = du_vkSigs_2354 v2
du_vkSigs_2354 ::
  T_GeneralizeTel_34825 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_vkSigs_2354 v0
  = coe
         ...
         (coe
            ...
            (coe
                  ...
                  (\ v3 ->
                     coe
                       ...
                       (coe
                          ...
                          (coe
                             du_scriptsNeeded_2278 v0
                             (MAlonzo.Code.Ledger.Utxo.d_utxo_2032 (coe v1))
                             (MAlonzo.Code.Ledger.Transaction.d_body_2644 (coe v2))))
                       (coe
               ...
               (coe
                  ...
                  (MAlonzo.Code.Ledger.Transaction.d_txscripts_2744
                     (coe v0) (coe v2)
                     (coe MAlonzo.Code.Ledger.Utxo.d_utxo_2032 (coe v1)))))
            (coe
               MAlonzo.Code.Class.Decidable.Instances.du_Dec'45''215'_24
               (coe
                  MAlonzo.Code.Axiom.Set.du_Dec'45'All'738'_1634
                              ...
                              coe
                                ...
                                (coe
                                   ...
                                   (coe
                                      ...
                                      (coe MAlonzo.Code.Ledger.Transaction.d_wits_2646 (coe v2))))))
                        (coe
                           MAlonzo.Code.Ledger.Utxo.du_getInputHashes_1934 (coe v0) (coe v2)
                           (coe MAlonzo.Code.Ledger.Utxo.d_utxo_2032 (coe v1))))
                     (coe
                        MAlonzo.Code.Class.Decidable.Instances.du_Dec'45''215'_24
                        (coe
                              ...
                              (coe
                                 (\ v3 ->
                                    coe
                                      ...
                                      (coe v3)
                                      (coe
                                         du_allowedLanguages_2140 (coe v0) (coe v2)
                                         (coe MAlonzo.Code.Ledger.Utxo.d_utxo_2032 (coe v1)))))
                              (coe
                                 du_languages_2124 (coe v0) (coe v2)
                                 (coe MAlonzo.Code.Ledger.Utxo.d_utxo_2032 (coe v1))))
                           (coe
                                 ...
                                 (MAlonzo.Code.Interface.Hashable.d_hash_16
                                    (coe
                                       ...
                                       (coe
                                          MAlonzo.Code.Ledger.Transaction.d_adHashingScheme_1192
                                          (coe v0))))
                                 (MAlonzo.Code.Ledger.Transaction.d_txAD_2650 (coe v2)))))))))))
-- Ledger.Utxow..generalizedField-s
d_'46'generalizedField'45's_34817 ::
  T_GeneralizeTel_34825 -> MAlonzo.Code.Ledger.Utxo.T_UTxOState_2022
d_'46'generalizedField'45's_34817 v0
  = case coe v0 of
      C_mkGeneralizeTel_34827 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow..generalizedField-tx
d_'46'generalizedField'45'tx_34819 ::
  T_GeneralizeTel_34825 -> MAlonzo.Code.Ledger.Transaction.T_Tx_2634
d_'46'generalizedField'45'tx_34819 v0
  = case coe v0 of
      C_mkGeneralizeTel_34827 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow..generalizedField-Γ
d_'46'generalizedField'45'Γ_34821 ::
  T_GeneralizeTel_34825 -> MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2008
d_'46'generalizedField'45'Γ_34821 v0
  = case coe v0 of
      C_mkGeneralizeTel_34827 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow..generalizedField-s'
d_'46'generalizedField'45's''_34823 ::
  T_GeneralizeTel_34825 -> MAlonzo.Code.Ledger.Utxo.T_UTxOState_2022
d_'46'generalizedField'45's''_34823 v0
  = case coe v0 of
      C_mkGeneralizeTel_34827 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow.GeneralizeTel
d_GeneralizeTel_34825 a0 a1 = ()
data T_GeneralizeTel_34825
  = C_mkGeneralizeTel_34827 MAlonzo.Code.Ledger.Utxo.T_UTxOState_2022
                            MAlonzo.Code.Ledger.Transaction.T_Tx_2634
                            MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2008
                            MAlonzo.Code.Ledger.Utxo.T_UTxOState_2022
