...
d_getDataHashes_1544 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> [AgdaAny]
d_getDataHashes_1544 ~v0 ~v1 = du_getDataHashes_1544
du_getDataHashes_1544 ::
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> [AgdaAny]
du_getDataHashes_1544
  = coe MAlonzo.Code.Ledger.Utxo.du_getDataHashes_1924
-- Ledger.Utxow._.getInputHashes
d_getInputHashes_1546 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2622 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> [AgdaAny]
d_getInputHashes_1546 v0 ~v1 = du_getInputHashes_1546 v0
du_getInputHashes_1546 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2622 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> [AgdaAny]
du_getInputHashes_1546 v0
...
d_slot_1616 :: MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2002 -> AgdaAny
d_slot_1616 v0 = coe MAlonzo.Code.Ledger.Utxo.d_slot_2010 (coe v0)
...
d_fees_1626 :: MAlonzo.Code.Ledger.Utxo.T_UTxOState_2016 -> Integer
d_fees_1626 v0 = coe MAlonzo.Code.Ledger.Utxo.d_fees_2028 (coe v0)
-- Ledger.Utxow._.UTxOState.utxo
d_utxo_1628 ::
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_2016 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_utxo_1628 v0 = coe MAlonzo.Code.Ledger.Utxo.d_utxo_2026 (coe v0)
...
du_Dec'45'UsesV3Features_2094 v0
  = case coe v0 of
      MAlonzo.Code.Ledger.Transaction.C_TxBody'46'constructor_17687 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17 v18 v19 v20
        -> case coe v9 of
             []
               -> case coe v10 of
                    []
    ...
    coe
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.Ledger.Utxo.du_outs_2050 (coe du_txb_2144 (coe v1))))
         (coe
            MAlonzo.Code.Class.IsSet.du_range_550
            (coe
               MAlonzo.Code.Axiom.Set.d_th_1470
            ...
            (coe
               ...
               (coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           () erased
                           (\ v3 ->
                              MAlonzo.Code.Ledger.GovernanceActions.d_voter_732 (coe v3))
                  ...
                  (coe
                     ...
                     (\ v3 ->
                        let v4
                              = MAlonzo.Code.Ledger.GovernanceActions.d_policy_756 (coe v3) in
                        coe
                          (case coe v4 of
...
d_witsVKeyNeeded_2270 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Transaction.T_TxBody_2520 -> [AgdaAny]
d_witsVKeyNeeded_2270 v0 ~v1 = du_witsVKeyNeeded_2270 v0
du_witsVKeyNeeded_2270 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Transaction.T_TxBody_2520 -> [AgdaAny]
du_witsVKeyNeeded_2270 v0
  = coe
...
d_scriptsNeeded_2272 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Transaction.T_TxBody_2520 -> [AgdaAny]
d_scriptsNeeded_2272 v0 ~v1 = du_scriptsNeeded_2272 v0
du_scriptsNeeded_2272 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Transaction.T_TxBody_2520 -> [AgdaAny]
du_scriptsNeeded_2272 v0
  = coe
      MAlonzo.Code.Function.Base.du__'8728''8322'__92
...
d__'8866'_'8640''10631'_'44'UTXOW'10632'__2274 a0 a1 a2 a3 a4 a5
  = ()
newtype T__'8866'_'8640''10631'_'44'UTXOW'10632'__2274
  = C_UTXOW'45'inductive_2374 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
-- Ledger.Utxow._.txAD
d_txAD_2290 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_GeneralizeTel_34809 -> Maybe AgdaAny
d_txAD_2290 ~v0 ~v1 v2 = du_txAD_2290 v2
du_txAD_2290 :: T_GeneralizeTel_34809 -> Maybe AgdaAny
du_txAD_2290 v0
  = coe
      MAlonzo.Code.Ledger.Transaction.d_txAD_2638
      (coe d_'46'generalizedField'45'tx_34803 (coe v0))
-- Ledger.Utxow._.body
d_body_2292 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_GeneralizeTel_34809 ->
  MAlonzo.Code.Ledger.Transaction.T_TxBody_2520
...
d_refInputs_2304 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_GeneralizeTel_34809 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
...
du_txADhash_2310 :: T_GeneralizeTel_34809 -> Maybe AgdaAny
du_txADhash_2310 v0
  = coe
...
d_txid_2320 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_GeneralizeTel_34809 -> AgdaAny
d_txid_2320 ~v0 ~v1 v2 = du_txid_2320 v2
du_txid_2320 :: T_GeneralizeTel_34809 -> AgdaAny
du_txid_2320 v0
  = coe
...
d_scripts_2340 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_GeneralizeTel_34809 -> [MAlonzo.Code.Data.Sum.Base.T__'8846'__30]
         ...
         (coe
            ...
            (coe
                  ...
                  (\ v3 ->
                     coe
                       ...
                       (coe
                          ...
                          (coe
                             du_scriptsNeeded_2272 v0
                             (MAlonzo.Code.Ledger.Utxo.d_utxo_2026 (coe v1))
                             (MAlonzo.Code.Ledger.Transaction.d_body_2632 (coe v2))))
                       (coe
               ...
               (coe
                  ...
                  (MAlonzo.Code.Ledger.Transaction.d_txscripts_2732
                     (coe v0) (coe v2)
                     (coe MAlonzo.Code.Ledger.Utxo.d_utxo_2026 (coe v1)))))
            (coe
               MAlonzo.Code.Class.Decidable.Instances.du_Dec'45''215'_24
               (coe
                  MAlonzo.Code.Axiom.Set.du_Dec'45'All'738'_1634
                              ...
                              coe
                                ...
                                (coe
                                   ...
                                   (coe
                                      ...
                                      (coe MAlonzo.Code.Ledger.Transaction.d_wits_2634 (coe v2))))))
                        (coe
                           MAlonzo.Code.Ledger.Utxo.du_getInputHashes_1928 (coe v0) (coe v2)
                           (coe MAlonzo.Code.Ledger.Utxo.d_utxo_2026 (coe v1))))
                     (coe
                        MAlonzo.Code.Class.Decidable.Instances.du_Dec'45''215'_24
                        (coe
                              ...
                              (coe
                                 (\ v3 ->
                                    coe
                                      ...
                                      (coe v3)
                                      (coe
                                         du_allowedLanguages_2134 (coe v0) (coe v2)
                                         (coe MAlonzo.Code.Ledger.Utxo.d_utxo_2026 (coe v1)))))
                              (coe
                                 du_languages_2118 (coe v0) (coe v2)
                                 (coe MAlonzo.Code.Ledger.Utxo.d_utxo_2026 (coe v1))))
                           (coe
                                 ...
                                 (MAlonzo.Code.Interface.Hashable.d_hash_16
                                    (coe
                                       ...
                                       (coe
                                          MAlonzo.Code.Ledger.Transaction.d_adHashingScheme_1186
                                          (coe v0))))
                                 (MAlonzo.Code.Ledger.Transaction.d_txAD_2638 (coe v2)))))))))))
-- Ledger.Utxow..generalizedField-s
d_'46'generalizedField'45's_34801 ::
  T_GeneralizeTel_34809 -> MAlonzo.Code.Ledger.Utxo.T_UTxOState_2016
d_'46'generalizedField'45's_34801 v0
  = case coe v0 of
      C_mkGeneralizeTel_34811 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow..generalizedField-tx
d_'46'generalizedField'45'tx_34803 ::
  T_GeneralizeTel_34809 -> MAlonzo.Code.Ledger.Transaction.T_Tx_2622
d_'46'generalizedField'45'tx_34803 v0
  = case coe v0 of
      C_mkGeneralizeTel_34811 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow..generalizedField-Γ
d_'46'generalizedField'45'Γ_34805 ::
  T_GeneralizeTel_34809 -> MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2002
d_'46'generalizedField'45'Γ_34805 v0
  = case coe v0 of
      C_mkGeneralizeTel_34811 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow..generalizedField-s'
d_'46'generalizedField'45's''_34807 ::
  T_GeneralizeTel_34809 -> MAlonzo.Code.Ledger.Utxo.T_UTxOState_2016
d_'46'generalizedField'45's''_34807 v0
  = case coe v0 of
      C_mkGeneralizeTel_34811 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow.GeneralizeTel
d_GeneralizeTel_34809 a0 a1 = ()
data T_GeneralizeTel_34809
  = C_mkGeneralizeTel_34811 MAlonzo.Code.Ledger.Utxo.T_UTxOState_2016
                            MAlonzo.Code.Ledger.Transaction.T_Tx_2622
                            MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2002
                            MAlonzo.Code.Ledger.Utxo.T_UTxOState_2016
