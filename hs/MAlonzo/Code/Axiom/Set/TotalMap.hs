...
d_Map_10 :: MAlonzo.Code.Axiom.Set.T_Theory_94 -> () -> () -> ()
d_Map_10 = erased
...
d_Rel_20 :: MAlonzo.Code.Axiom.Set.T_Theory_94 -> () -> () -> ()
d_Rel_20 = erased
...
data T_TotalMap_168
  = C_TotalMap'46'constructor_937 AgdaAny (AgdaAny -> AgdaAny)
-- Axiom.Set.TotalMap.TotalMap.rel
d_rel_180 :: T_TotalMap_168 -> AgdaAny
d_rel_180 v0
  = case coe v0 of
      C_TotalMap'46'constructor_937 v1 v3 -> coe v1
...
d_total'45'rel_184 v0
  = case coe v0 of
      C_TotalMap'46'constructor_937 v1 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_updateFn_208 ~v0 ~v1 v2 ~v3 v4 v5 v6
  = du_updateFn_208 v2 v4 v5 v6
du_updateFn_208 ::
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  AgdaAny -> AgdaAny -> AgdaAny
du_updateFn_208 v0 v1 v2 v3
  = case coe v1 of
...
d_mapWithKey_260 v0 ~v1 ~v2 ~v3 ~v4 v5 v6
  = du_mapWithKey_260 v0 v5 v6
du_mapWithKey_260 ::
  MAlonzo.Code.Axiom.Set.T_Theory_94 ->
  (AgdaAny -> AgdaAny -> AgdaAny) -> T_TotalMap_168 -> T_TotalMap_168
du_mapWithKey_260 v0 v1 v2
  = coe
      C_TotalMap'46'constructor_937
      (coe
      ...
      (\ v3 ->
         coe
           MAlonzo.Code.Axiom.Set.du_'8712''45'map'8242'_412 (coe v0)
           (coe
              MAlonzo.Code.Axiom.Set.du_map_398 v0
              (\ v4 ->
                 case coe v4 of
...
d_update_276 v0 ~v1 v2 ~v3 v4 v5 = du_update_276 v0 v2 v4 v5
du_update_276 ::
  MAlonzo.Code.Axiom.Set.T_Theory_94 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  AgdaAny -> AgdaAny -> T_TotalMap_168 -> T_TotalMap_168
du_update_276 v0 v1 v2 v3
  = coe
      du_mapWithKey_260 (coe v0)
      (coe
         du_updateFn_208 (coe v1)
         (coe
            MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 (coe v2) (coe v3)))
-- Axiom.Set.TotalMap.LookupUpdate.∈-rel-update
d_'8712''45'rel'45'update_300 ::
  MAlonzo.Code.Axiom.Set.T_Theory_94 ->
  () ->
  () ->
  AgdaAny ->
...
d_'8712''45'rel'45'update_300 v0 ~v1 ~v2 ~v3 v4 v5 ~v6 v7 v8
  = du_'8712''45'rel'45'update_300 v0 v4 v5 v7 v8
du_'8712''45'rel'45'update_300 ::
  MAlonzo.Code.Axiom.Set.T_Theory_94 ->
  AgdaAny ->
  AgdaAny ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
...
d_lookup'45'update'45'id_306 = erased
...
d_Fun'8658'Map_322 v0 ~v1 ~v2 ~v3 ~v4 v5 v6
  = du_Fun'8658'Map_322 v0 v5 v6
du_Fun'8658'Map_322 ::
  MAlonzo.Code.Axiom.Set.T_Theory_94 ->
  (AgdaAny -> AgdaAny) ->
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_Fun'8658'Map_322 v0 v1 v2
  = coe
      MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
      (coe
         MAlonzo.Code.Axiom.Set.du_map_398 v0
...
d_Fun'8658'TotalMap_332 ::
  MAlonzo.Code.Axiom.Set.T_Theory_94 ->
  () ->
  AgdaAny ->
  (AgdaAny -> AgdaAny) ->
  () -> (AgdaAny -> AgdaAny) -> T_TotalMap_168
d_Fun'8658'TotalMap_332 v0 ~v1 v2 v3 ~v4 v5
  = du_Fun'8658'TotalMap_332 v0 v2 v3 v5
du_Fun'8658'TotalMap_332 ::
  MAlonzo.Code.Axiom.Set.T_Theory_94 ->
  AgdaAny ->
  (AgdaAny -> AgdaAny) -> (AgdaAny -> AgdaAny) -> T_TotalMap_168
du_Fun'8658'TotalMap_332 v0 v1 v2 v3
  = coe
      C_TotalMap'46'constructor_937
      (coe
         MAlonzo.Code.Axiom.Set.du_map_398 v0
      ...
      (\ v4 ->
         coe
           ...
           (coe
              MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 (coe v4) (coe v3 v4))
           (coe
              MAlonzo.Code.Axiom.Set.du_'8712''45'map'8242'_412 (coe v0) (coe v1)
              (coe
                 (\ v5 ->
                    coe
                      MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 (coe v5) (coe v3 v5)))
              (coe v4) (coe v2 v4)))
-- Axiom.Set.TotalMap.FunTot.Fun∈TotalMap
d_Fun'8712'TotalMap_342 ::
  MAlonzo.Code.Axiom.Set.T_Theory_94 ->
  () ->
  AgdaAny ->
  (AgdaAny -> AgdaAny) ->
  () -> (AgdaAny -> AgdaAny) -> AgdaAny -> AgdaAny -> AgdaAny
d_Fun'8712'TotalMap_342 v0 ~v1 v2 ~v3 ~v4 v5 v6 v7
  = du_Fun'8712'TotalMap_342 v0 v2 v5 v6 v7
du_Fun'8712'TotalMap_342 ::
  MAlonzo.Code.Axiom.Set.T_Theory_94 ->
  AgdaAny -> (AgdaAny -> AgdaAny) -> AgdaAny -> AgdaAny -> AgdaAny
du_Fun'8712'TotalMap_342 v0 v1 v2 v3 v4
  = coe
      MAlonzo.Code.Axiom.Set.du_'8712''45'map'8242'_412 (coe v0) (coe v1)
      (coe
         (\ v5 ->
...
d_lookup'8728'Fun'8658'TotalMap'45'id_350 ::
  MAlonzo.Code.Axiom.Set.T_Theory_94 ->
  () ->
  AgdaAny ->
  (AgdaAny -> AgdaAny) ->
  ...
  (AgdaAny -> AgdaAny) ->
  AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_lookup'8728'Fun'8658'TotalMap'45'id_350 = erased
