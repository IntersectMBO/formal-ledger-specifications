...
```agda
  ...
  instance
    ...
    HasTopLevelGuards-TxBody : HasTopLevelGuards (TxBody txLevel)
    HasTopLevelGuards-TxBody .TopLevelGuardsOf = TxBody.txRequiredTopLevelGuards
    HasTopLevelGuards-Tx : HasTopLevelGuards (Tx txLevel)
    HasTopLevelGuards-Tx .TopLevelGuardsOf = TopLevelGuardsOf ∘ TxBodyOf
