...
module _
  ...
  ≤updateCertDeps (delegate _ _ _ _ ∷ cs) (_ All.∷ nrf) = {!≤updateCertDeps cs nrf!}
  ≤updateCertDeps (regpool _ _      ∷ cs) (_ All.∷ nrf) = {!!}
  ≤updateCertDeps (retirepool _ _   ∷ cs) (_ All.∷ nrf) = {!!}
  ≤updateCertDeps (regdrep _ _ _    ∷ cs) (_ All.∷ nrf) = {!!}
  ≤updateCertDeps (ccreghot _ _     ∷ cs) (_ All.∷ nrf) = {!!}
