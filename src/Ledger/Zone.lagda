...
\begin{code}
  ZONE-V :
    ...
    ∙ noCycles ltx -- chkLinear ltx -- TODO which one?
    -- TODO maxTxExUnits - we should add these up and check they're not exceeded, but currently this is not done in UTXO rule
