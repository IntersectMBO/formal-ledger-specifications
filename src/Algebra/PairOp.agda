...
module Algebra.PairOp (X : Set) (ε : X) (_≈_ : BRel X zeroˡ) (_∙_ : Op₂ X) where
...
pairOpIdentityˡ idˡ (a , b) =
  ×-refl {zeroˡ} {zeroˡ} {zeroˡ} {zeroˡ} {X} {X} {_} {_} (idˡ a) (idˡ b) {ε , ε}

pairOpIdentityʳ :
  Algebra.RightIdentity _≈_ ε _∙_ → Algebra.RightIdentity _≈ᵖ_ (ε , ε) _∙ᵖ_
pairOpIdentityʳ idʳ (a , b) =
  ×-refl {zeroˡ} {zeroˡ} {zeroˡ} {zeroˡ} {X} {X} {_} {_} (idʳ a) (idʳ b) {ε , ε}
...
pairOpAssoc assoc (a , b) (c , d) (e , f) =
  ×-refl {zeroˡ} {zeroˡ} {zeroˡ} {zeroˡ} {X} {X}
         {λ _ _ → ((a ∙ c) ∙ e) ≈ (a ∙ (c ∙ e))}
         {λ _ _ → ((b ∙ d) ∙ f) ≈ (b ∙ (d ∙ f))}
