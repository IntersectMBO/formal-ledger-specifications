...
open import Prelude.Generics using (TypeView; mapVars; viewTy; mapVariables; viewTy′; argTys; _◇; _◇⟦_⟧; _◇⟦_∣_⟧; _∙; _∙⟦_⟧; _∙⟦_∣_⟧; _∙⟦_∣_∣_⟧; _◆; _◆⟦_⟧; `λ∅; `λ⟦_∣_∣_⇒_⟧; `λ⟦_⇒_⟧; hArg?; vArg?; iArg?; `λ_⇒_; ♯; `_) public
