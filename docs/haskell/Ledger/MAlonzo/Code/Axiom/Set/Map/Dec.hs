...
d_dom_146 v0 v1 v2
  = coe
      MAlonzo.Code.Axiom.Set.Rel.du_dom_300
...
d_left'45'unique_186 ::
  MAlonzo.Code.Axiom.Set.T_Theory'7496'_1266 ->
  () -> () -> AgdaAny -> ()
d_left'45'unique_186 = erased
...
d_unionThese_322 v0 ~v1 ~v2 ~v3 ~v4 v5 v6 v7 v8 v9
  = du_unionThese_322 v0 v5 v6 v7 v8 v9
du_unionThese_322 ::
  MAlonzo.Code.Axiom.Set.T_Theory'7496'_1266 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  AgdaAny -> AgdaAny -> MAlonzo.Code.Data.These.Base.T_These_38
du_unionThese_322 v0 v1 v2 v3 v4 v5
  = let v6
          = coe
              ...
              (coe
                 ...
                 (coe MAlonzo.Code.Axiom.Set.Map.du__'738'_468 (coe v2))) in
    coe
      (let v7
             = coe
                 MAlonzo.Code.Axiom.Set.d__'8712''63'__1542 v0 erased v1 v4
                 (coe
                    MAlonzo.Code.Axiom.Set.Rel.du_dom_300
                    (MAlonzo.Code.Axiom.Set.d_th_1414 (coe v0))
                    (coe MAlonzo.Code.Axiom.Set.Map.du__'738'_468 (coe v3))) in
       coe
         (case coe v6 of
...
d_unionWith_384 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_unionWith_384 v0 ~v1 ~v2 ~v3 ~v4 ~v5 v6 v7 v8 v9
  = du_unionWith_384 v0 v6 v7 v8 v9
du_unionWith_384 ::
  MAlonzo.Code.Axiom.Set.T_Theory'7496'_1266 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  (MAlonzo.Code.Data.These.Base.T_These_38 -> AgdaAny) ->
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_unionWith_384 v0 v1 v2 v3 v4
  = case coe v3 of
        ...
        -> case coe v4 of
             MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v7 v8
               -> coe
                    ...
                    (coe
                       du_m''''_406 (coe v0) (coe v1) (coe v2) (coe v5) erased (coe v7)
                       erased)
                    erased
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_d_404 ::
  ...
  (AgdaAny ->
   ...
   AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12) ->
  AgdaAny
d_d_404 v0 ~v1 ~v2 ~v3 ~v4 ~v5 ~v6 ~v7 v8 ~v9 v10 ~v11
  = du_d_404 v0 v8 v10
du_d_404 ::
  MAlonzo.Code.Axiom.Set.T_Theory'7496'_1266 ->
  AgdaAny -> AgdaAny -> AgdaAny
...
d_m''''_406 ::
  ...
  (AgdaAny ->
   ...
   AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12) ->
  AgdaAny
d_m''''_406 v0 ~v1 ~v2 ~v3 ~v4 ~v5 v6 v7 v8 v9 v10 v11
  = du_m''''_406 v0 v6 v7 v8 v9 v10 v11
du_m''''_406 ::
  MAlonzo.Code.Axiom.Set.T_Theory'7496'_1266 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  (MAlonzo.Code.Data.These.Base.T_These_38 -> AgdaAny) ->
  ...
  (AgdaAny ->
   ...
   AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12) ->
  AgdaAny
du_m''''_406 v0 v1 v2 v3 v4 v5 v6
  = coe
      ...
      (\ v7 ->
         coe
           ...
           (coe
              v2
              (coe
                 du_unionThese_322 (coe v0) (coe v1)
                 (coe MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 (coe v3) (coe v4))
                 (coe MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 (coe v5) (coe v6))
                 (coe MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28 (coe v7))
                 (coe MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe v7)))))
      (coe
         MAlonzo.Code.Axiom.Set.du_incl'45'set_1646 (coe v0) (coe v1)
         (coe du_d_404 (coe v0) (coe v3) (coe v5)))
...
d__'8746''8314'__522 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d__'8746''8314'__522 v0 ~v1 ~v2 v3 v4
  = du__'8746''8314'__522 v0 v3 v4
du__'8746''8314'__522 ::
  MAlonzo.Code.Axiom.Set.T_Theory'7496'_1266 ->
  MAlonzo.Code.Algebra.Bundles.T_Monoid_740 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du__'8746''8314'__522 v0 v1 v2
  = coe
      du_unionWith_384 (coe v0) (coe v2)
      (coe
...
d_aggregate'8330'_524 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_aggregate'8330'_524 v0 ~v1 ~v2 v3 v4 v5
  = du_aggregate'8330'_524 v0 v3 v4 v5
du_aggregate'8330'_524 ::
  MAlonzo.Code.Axiom.Set.T_Theory'7496'_1266 ->
  MAlonzo.Code.Algebra.Bundles.T_Monoid_740 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_aggregate'8330'_524 v0 v1 v2 v3
  = case coe v3 of
             ...
             MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v6 v7
               -> coe
                    ...
                    (coe
                       (\ v8 v9 ->
                          coe
                            du__'8746''8314'__522 v0 v1 v2 v8
                            (coe
