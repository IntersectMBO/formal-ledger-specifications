...
du__'215'__244 v0
  = coe
      ...
      (coe MAlonzo.Code.Algebra.Bundles.du_rawMonoid_954 (coe v0))
...
d_'215''45'homo'45'0_274 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Algebra.Bundles.T_Monoid_882 -> AgdaAny -> AgdaAny
  ...
  = case coe v2 of
      0 -> coe
             ...
             (coe
                ...
                (MAlonzo.Code.Algebra.Bundles.d_isMonoid_906 (coe v0))
                (coe
                   MAlonzo.Code.Algebra.Definitions.RawMonoid.du__'215'__60
                   (coe MAlonzo.Code.Algebra.Bundles.du_rawMonoid_954 (coe v0))
                   (coe v3) (coe v1)))
      _ -> let v4 = subInt (coe v2) (coe (1 :: Integer)) in
           coe
             (coe
                ...
                (coe
                   MAlonzo.Code.Algebra.Bundles.d__'8729'__902 v0 v1
                   (coe
                      MAlonzo.Code.Algebra.Definitions.RawMonoid.du__'215'__60
                      (coe MAlonzo.Code.Algebra.Bundles.du_rawMonoid_954 (coe v0))
                      ...
                      (let v5
                             = MAlonzo.Code.Relation.Binary.Structures.d_refl_34
                                 (coe
                                    MAlonzo.Code.Relation.Binary.Bundles.d_isEquivalence_60
                                    (let v5
                                           = MAlonzo.Code.Algebra.Bundles.d_isMonoid_906 (coe v0) in
                                     coe
                                       (let v6
                                              = MAlonzo.Code.Algebra.Structures.d_isSemigroup_696
                                                  (coe v5) in
...
du_'215''45'idem_306 v0 v1 v2 v3
  = case coe v3 of
      1 -> coe
             MAlonzo.Code.Algebra.Structures.du_identity'691'_728
             (MAlonzo.Code.Algebra.Bundles.d_isMonoid_906 (coe v0)) v1
      _ -> coe
             MAlonzo.Code.Relation.Binary.Reasoning.Syntax.du_begin__46
             (\ v4 v5 v6 ->
                coe
             ...
             (coe
                ...
                (coe
                   ...
                   (coe
                      ...
                      (coe MAlonzo.Code.Algebra.Bundles.du_rawMonoid_954 (coe v0))
                      (coe subInt (coe v3) (coe (1 :: Integer))) (coe v1)))
                (coe MAlonzo.Code.Algebra.Bundles.d__'8729'__902 v0 v1 v1) v1
                (coe
                   MAlonzo.Code.Relation.Binary.Reasoning.Syntax.du_step'45''8776''45''10217'_368
                   (coe
                      MAlonzo.Code.Relation.Binary.Reasoning.Base.Single.du_'8764''45'go_40
                                ...
                                coe
                                  (coe
                                     ...
                                     (coe
                                        MAlonzo.Code.Algebra.Structures.d_isMagma_480
                                        (coe v5))))))))
                   (coe MAlonzo.Code.Algebra.Bundles.d__'8729'__902 v0 v1 v1) v1 v1
                   (let v4
                          = MAlonzo.Code.Relation.Binary.Structures.d_refl_34
                              (coe
                                 MAlonzo.Code.Relation.Binary.Bundles.d_isEquivalence_60
