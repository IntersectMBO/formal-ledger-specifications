...
d_getDataHashes_1546 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1714 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> [AgdaAny]
d_getDataHashes_1546 ~v0 ~v1 = du_getDataHashes_1546
du_getDataHashes_1546 ::
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> [AgdaAny]
du_getDataHashes_1546
  = coe MAlonzo.Code.Ledger.Utxo.du_getDataHashes_1928
-- Ledger.Utxow._.getInputHashes
d_getInputHashes_1548 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1714 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2622 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> [AgdaAny]
d_getInputHashes_1548 v0 ~v1 = du_getInputHashes_1548 v0
du_getInputHashes_1548 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2622 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> [AgdaAny]
du_getInputHashes_1548 v0
...
d_slot_1630 :: MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2006 -> AgdaAny
d_slot_1630 v0 = coe MAlonzo.Code.Ledger.Utxo.d_slot_2014 (coe v0)
...
d_fees_1640 :: MAlonzo.Code.Ledger.Utxo.T_UTxOState_2020 -> Integer
d_fees_1640 v0 = coe MAlonzo.Code.Ledger.Utxo.d_fees_2032 (coe v0)
-- Ledger.Utxow._.UTxOState.utxo
d_utxo_1642 ::
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_2020 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_utxo_1642 v0 = coe MAlonzo.Code.Ledger.Utxo.d_utxo_2030 (coe v0)
-- Ledger.Utxow._.ScriptPurpose
d_ScriptPurpose_1692 a0 a1 = ()
-- Ledger.Utxow._.d
d_d_2018 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1714 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
...
du_Dec'45'UsesV3Features_2106 v0
  = case coe v0 of
      MAlonzo.Code.Ledger.Transaction.C_TxBody'46'constructor_17621 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17 v18 v19 v20
        -> case coe v9 of
             []
               -> case coe v10 of
                    []
            ...
            (coe
               ...
               (coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           () erased
                           (\ v3 ->
                              MAlonzo.Code.Ledger.GovernanceActions.d_voter_736 (coe v3))
                  ...
                  (coe
                     ...
                     (\ v3 ->
                        let v4
                              = MAlonzo.Code.Ledger.GovernanceActions.d_policy_760 (coe v3) in
                        coe
                          (case coe v4 of
...
d_txAD_2300 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1714 ->
  T_GeneralizeTel_34727 -> Maybe AgdaAny
d_txAD_2300 ~v0 ~v1 v2 = du_txAD_2300 v2
du_txAD_2300 :: T_GeneralizeTel_34727 -> Maybe AgdaAny
du_txAD_2300 v0
  = coe
      MAlonzo.Code.Ledger.Transaction.d_txAD_2638
      (coe d_'46'generalizedField'45'tx_34719 (coe v0))
-- Ledger.Utxow._.body
d_body_2302 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1714 ->
  T_GeneralizeTel_34727 ->
  MAlonzo.Code.Ledger.Transaction.T_TxBody_2520
...
d_refInputs_2314 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1714 ->
  T_GeneralizeTel_34727 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
...
d_txADhash_2320 ::
  ...
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1714 ->
  T_GeneralizeTel_34727 -> Maybe AgdaAny
d_txADhash_2320 ~v0 ~v1 v2 = du_txADhash_2320 v2
du_txADhash_2320 :: T_GeneralizeTel_34727 -> Maybe AgdaAny
du_txADhash_2320 v0
  = coe
...
d_txid_2330 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1714 ->
  T_GeneralizeTel_34727 -> AgdaAny
d_txid_2330 ~v0 ~v1 v2 = du_txid_2330 v2
du_txid_2330 :: T_GeneralizeTel_34727 -> AgdaAny
du_txid_2330 v0
  = coe
...
d_scripts_2350 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1714 ->
  T_GeneralizeTel_34727 -> [MAlonzo.Code.Data.Sum.Base.T__'8846'__30]
d_scripts_2350 ~v0 ~v1 v2 = du_scripts_2350 v2
du_scripts_2350 ::
  T_GeneralizeTel_34727 -> [MAlonzo.Code.Data.Sum.Base.T__'8846'__30]
du_scripts_2350 v0
  = coe
...
d_txdats_2354 ::
  ...
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1714 ->
  T_GeneralizeTel_34727 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_txdats_2354 ~v0 ~v1 v2 = du_txdats_2354 v2
du_txdats_2354 ::
  T_GeneralizeTel_34727 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_txdats_2354 v0
  = coe
...
d_vkSigs_2358 ::
  ...
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1714 ->
  T_GeneralizeTel_34727 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_vkSigs_2358 ~v0 ~v1 v2 = du_vkSigs_2358 v2
du_vkSigs_2358 ::
  T_GeneralizeTel_34727 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_vkSigs_2358 v0
  = coe
...
d_'46'generalizedField'45'tx_34719 ::
  T_GeneralizeTel_34727 -> MAlonzo.Code.Ledger.Transaction.T_Tx_2622
d_'46'generalizedField'45'tx_34719 v0
  = case coe v0 of
      C_mkGeneralizeTel_34729 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow..generalizedField-s
d_'46'generalizedField'45's_34721 ::
  T_GeneralizeTel_34727 -> MAlonzo.Code.Ledger.Utxo.T_UTxOState_2020
d_'46'generalizedField'45's_34721 v0
  = case coe v0 of
      C_mkGeneralizeTel_34729 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow..generalizedField-Γ
d_'46'generalizedField'45'Γ_34723 ::
  T_GeneralizeTel_34727 -> MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2006
d_'46'generalizedField'45'Γ_34723 v0
  = case coe v0 of
      C_mkGeneralizeTel_34729 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow..generalizedField-s'
d_'46'generalizedField'45's''_34725 ::
  T_GeneralizeTel_34727 -> MAlonzo.Code.Ledger.Utxo.T_UTxOState_2020
d_'46'generalizedField'45's''_34725 v0
  = case coe v0 of
      C_mkGeneralizeTel_34729 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow.GeneralizeTel
d_GeneralizeTel_34727 a0 a1 = ()
data T_GeneralizeTel_34727
  = C_mkGeneralizeTel_34729 MAlonzo.Code.Ledger.Transaction.T_Tx_2622
                            MAlonzo.Code.Ledger.Utxo.T_UTxOState_2020
                            MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2006
                            MAlonzo.Code.Ledger.Utxo.T_UTxOState_2020
