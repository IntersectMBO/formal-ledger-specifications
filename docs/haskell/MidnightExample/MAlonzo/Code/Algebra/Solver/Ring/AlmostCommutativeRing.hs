...
data T_IsAlmostCommutativeRing_26
  = C_IsAlmostCommutativeRing'46'constructor_1027 MAlonzo.Code.Algebra.Structures.T_IsCommutativeSemiring_1526
...
d_'42''45'comm_82 v0
  = coe
      MAlonzo.Code.Algebra.Structures.d_'42''45'comm_1542
      (coe d_isCommutativeSemiring_62 (coe v0))
  ...
  = let v1 = d_isCommutativeSemiring_62 (coe v0) in
    coe
      (let v2
       ...
       coe
         (coe
            MAlonzo.Code.Algebra.Structures.du_'42''45'isMagma_1394
            (coe
               MAlonzo.Code.Algebra.Structures.d_isSemiringWithoutAnnihilatingZero_1432
               (coe v2))))
  ...
  = let v1 = d_isCommutativeSemiring_62 (coe v0) in
    coe
      (let v2
       ...
       coe
         (coe
            MAlonzo.Code.Algebra.Structures.du_'42''45'isSemigroup_1396
            (coe
               MAlonzo.Code.Algebra.Structures.d_isSemiringWithoutAnnihilatingZero_1432
               (coe v2))))
-- Algebra.Solver.Ring.AlmostCommutativeRing.IsAlmostCommutativeRing._.assoc
          ...
          coe
            (let v4
             ...
             coe
               (coe
                  MAlonzo.Code.Algebra.Structures.du_identity'691'_646
                  (coe MAlonzo.Code.Algebra.Structures.d_isMonoid_664 (coe v4))))))
-- Algebra.Solver.Ring.AlmostCommutativeRing.IsAlmostCommutativeRing._.identityˡ
d_identity'737'_122 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
...
du_isSemiringWithoutOne_156 v0
  = let v1 = d_isCommutativeSemiring_62 (coe v0) in
    coe
      (coe
         MAlonzo.Code.Algebra.Structures.du_isSemiringWithoutOne_1508
         (coe MAlonzo.Code.Algebra.Structures.d_isSemiring_1540 (coe v1)))
...
data T_AlmostCommutativeRing_178
  = C_AlmostCommutativeRing'46'constructor_5961 (AgdaAny ->
                                                 AgdaAny -> AgdaAny)
                                                (AgdaAny -> AgdaAny -> AgdaAny) (AgdaAny -> AgdaAny)
...
d__'43'__204 v0
  = case coe v0 of
      C_AlmostCommutativeRing'46'constructor_5961 v3 v4 v5 v6 v7 v8
        -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Solver.Ring.AlmostCommutativeRing.AlmostCommutativeRing._*_
d__'42'__206 ::
  ...
  = let v1 = d_isAlmostCommutativeRing_214 (coe v0) in
    coe
      (let v2 = d_isCommutativeSemiring_62 (coe v1) in
       coe
         (let v3
                = MAlonzo.Code.Algebra.Structures.d_isSemiring_1540 (coe v2) in
          coe
            (let v4
                   = MAlonzo.Code.Algebra.Structures.d_isSemiringWithoutAnnihilatingZero_1432
                       (coe v3) in
            ...
            (let v4
             ...
             coe
               (let v5
                ...
                coe
                  (let v6
                         = MAlonzo.Code.Algebra.Structures.d_isMonoid_664 (coe v5) in
                   coe
                     (let v7
             ...
             coe
               (let v5
                ...
                coe
                  (coe
                     MAlonzo.Code.Algebra.Structures.du_identity'691'_646
                     (coe MAlonzo.Code.Algebra.Structures.d_isMonoid_664 (coe v5)))))))
-- Algebra.Solver.Ring.AlmostCommutativeRing.AlmostCommutativeRing._.identityˡ
d_identity'737'_260 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
    ...
    coe
      (let v2 = d_isCommutativeSemiring_62 (coe v1) in
       coe
         (coe
            MAlonzo.Code.Algebra.Structures.du_isSemiringWithoutOne_1508
            (coe MAlonzo.Code.Algebra.Structures.d_isSemiring_1540 (coe v2))))
...
du_'42''45'commutativeMonoid_324 v0
  = coe
      MAlonzo.Code.Algebra.Bundles.du_'42''45'commutativeMonoid_2360
...
du_magma_328 v0
  = let v1 = coe du_commutativeSemiring_320 (coe v0) in
    coe
      (let v2
             = coe MAlonzo.Code.Algebra.Bundles.du_semiring_2318 (coe v1) in
       coe
         (let v3
                = coe
          ...
          coe
            (let v4
                   = coe
                       MAlonzo.Code.Algebra.Bundles.du_'42''45'monoid_2006 (coe v3) in
             coe
               (coe
         ...
         (let v3
          ...
          coe
            (coe
               ...
               (coe
                  MAlonzo.Code.Algebra.Bundles.du_'42''45'monoid_2006 (coe v3)))))
-- Algebra.Solver.Ring.AlmostCommutativeRing.AlmostCommutativeRing._.+-commutativeMonoid
  ...
  = let v1 = coe du_commutativeSemiring_320 (coe v0) in
    coe
      (let v2
       ...
       coe
         (coe
            MAlonzo.Code.Algebra.Bundles.du_'43''45'commutativeMonoid_1984
            (coe
               MAlonzo.Code.Algebra.Bundles.du_semiringWithoutAnnihilatingZero_2140
               (coe v2))))
-- Algebra.Solver.Ring.AlmostCommutativeRing.AlmostCommutativeRing._.magma
         ...
         (let v3
          ...
          coe
            (let v4
             ...
             coe
               (let v5
                      = coe MAlonzo.Code.Algebra.Bundles.du_monoid_890 (coe v4) in
                coe
                  (coe
                     MAlonzo.Code.Algebra.Bundles.du_magma_524
...
data T__'45'Raw'45'AlmostCommutative'10230'__358
  = C__'45'Raw'45'AlmostCommutative'10230'_'46'constructor_9407 (AgdaAny ->
                                                                 AgdaAny)
                                                                (AgdaAny -> AgdaAny -> AgdaAny)
                                                                (AgdaAny -> AgdaAny -> AgdaAny)
                                                                (AgdaAny -> AgdaAny) AgdaAny AgdaAny
...
d_'10214'_'10215'_756 v0
  = case coe v0 of
      C__'45'Raw'45'AlmostCommutative'10230'_'46'constructor_9407 v1 v2 v3 v4 v5 v6
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_'45'raw'45'almostCommutative'10230'_774 v0
  = coe
      C__'45'Raw'45'AlmostCommutative'10230'_'46'constructor_9407
      (coe (\ v1 -> v1))
      (coe
         (\ v1 v2 ->
            coe
              ...
              (let v3 = coe du_rawRing_344 (coe v0) in
               coe (coe MAlonzo.Code.Algebra.Bundles.Raw.d__'43'__266 v3 v1 v2))))
      (coe
         (\ v1 v2 ->
            coe
              MAlonzo.Code.Relation.Binary.Structures.d_refl_34
                             ...
                             (coe
                                ...
                                (coe
                                   ...
                                   (coe
                                      ...
                                      (coe d_isAlmostCommutativeRing_214 (coe v0))))))))))
              (let v3 = coe du_rawRing_344 (coe v0) in
               coe (coe MAlonzo.Code.Algebra.Bundles.Raw.d__'42'__268 v3 v1 v2))))
      (coe
         (\ v1 ->
            coe
              MAlonzo.Code.Relation.Binary.Structures.d_refl_34
              ...
              (let v2 = coe du_rawRing_344 (coe v0) in
               coe (coe MAlonzo.Code.Algebra.Bundles.Raw.d_'45'__270 v2 v1))))
      (coe
         MAlonzo.Code.Relation.Binary.Structures.d_refl_34
         (MAlonzo.Code.Algebra.Structures.d_isEquivalence_152
            (coe
...
d_isCommutativeMagma_990 ::
  ...
  T__'45'Raw'45'AlmostCommutative'10230'__358 ->
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Algebra.Structures.T_IsCommutativeMagma_180
...
d_'42''45'isMagma_996 ::
  ...
  T_AlmostCommutativeRing_178 ->
  T__'45'Raw'45'AlmostCommutative'10230'__358 ->
  AgdaAny -> AgdaAny -> MAlonzo.Code.Algebra.Structures.T_IsMagma_144
...
d_'42''45'isMonoid_998 ::
  ...
  T__'45'Raw'45'AlmostCommutative'10230'__358 ->
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Algebra.Structures.T_IsMonoid_604
...
d_'42''45'isSemigroup_1000 ::
  ...
  T__'45'Raw'45'AlmostCommutative'10230'__358 ->
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Algebra.Structures.T_IsSemigroup_440
...
d_isUnitalMagma_1038 ::
  ...
  T__'45'Raw'45'AlmostCommutative'10230'__358 ->
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Algebra.Structures.T_IsUnitalMagma_560
...
d_commutativeSemiring_1060 ::
  ...
  T__'45'Raw'45'AlmostCommutative'10230'__358 ->
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Algebra.Bundles.T_CommutativeSemiring_2188
...
d_isNearSemiring_1076 ::
  ...
  T__'45'Raw'45'AlmostCommutative'10230'__358 ->
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Algebra.Structures.T_IsNearSemiring_1066
...
d_isSemiring_1080 ::
  ...
  T__'45'Raw'45'AlmostCommutative'10230'__358 ->
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Algebra.Structures.T_IsSemiring_1418
...
d_semiring_1092 ::
  ...
  T_AlmostCommutativeRing_178 ->
  T__'45'Raw'45'AlmostCommutative'10230'__358 ->
  AgdaAny -> AgdaAny -> MAlonzo.Code.Algebra.Bundles.T_Semiring_2022
...
du_fromCommutativeRing_1124 v0
  = coe
      C_AlmostCommutativeRing'46'constructor_5961
      (MAlonzo.Code.Algebra.Bundles.d__'43'__3742 (coe v0))
      (MAlonzo.Code.Algebra.Bundles.d__'42'__3744 (coe v0))
      (MAlonzo.Code.Algebra.Bundles.d_'45'__3746 (coe v0))
      (MAlonzo.Code.Algebra.Bundles.d_0'35'_3748 (coe v0))
      (MAlonzo.Code.Algebra.Bundles.d_1'35'_3750 (coe v0))
      (coe
         C_IsAlmostCommutativeRing'46'constructor_1027
         (coe
            MAlonzo.Code.Algebra.Structures.du_isCommutativeSemiring_2754
            (coe
               MAlonzo.Code.Algebra.Bundles.d_isCommutativeRing_3752 (coe v0)))
         (coe
                             ...
                             (coe
                                ...
                                (coe
                                   ...
                                   (coe
                                      MAlonzo.Code.Algebra.Structures.d_isRing_2642
                                      (coe
                                         MAlonzo.Code.Algebra.Bundles.d_isCommutativeRing_3752
                                         (coe v0)))))))))
                 (coe
                    MAlonzo.Code.Algebra.Bundles.d_'45'__3746 v0
                    (coe MAlonzo.Code.Algebra.Bundles.d__'42'__3744 v0 v1 v2))
                 (coe
                    MAlonzo.Code.Algebra.Bundles.d__'42'__3744 v0
                    (coe MAlonzo.Code.Algebra.Bundles.d_'45'__3746 v0 v1) v2)
                 (coe
                    MAlonzo.Code.Algebra.Properties.Ring.du_'45''8255'distrib'737''45''42'_388
                    (coe MAlonzo.Code.Algebra.Bundles.du_ring_3876 (coe v0)) (coe v1)
                    (coe v2))))
         (coe
            ...
            (coe
               ...
               (coe MAlonzo.Code.Algebra.Bundles.du_ring_3876 (coe v0)))))
-- Algebra.Solver.Ring.AlmostCommutativeRing.fromCommutativeSemiring
d_fromCommutativeSemiring_1410 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Algebra.Bundles.T_CommutativeSemiring_2188 ->
  T_AlmostCommutativeRing_178
d_fromCommutativeSemiring_1410 ~v0 ~v1 v2
  = du_fromCommutativeSemiring_1410 v2
du_fromCommutativeSemiring_1410 ::
  MAlonzo.Code.Algebra.Bundles.T_CommutativeSemiring_2188 ->
  T_AlmostCommutativeRing_178
du_fromCommutativeSemiring_1410 v0
  = coe
      C_AlmostCommutativeRing'46'constructor_5961
      (MAlonzo.Code.Algebra.Bundles.d__'43'__2212 (coe v0))
      (MAlonzo.Code.Algebra.Bundles.d__'42'__2214 (coe v0)) (\ v1 -> v1)
      (MAlonzo.Code.Algebra.Bundles.d_0'35'_2216 (coe v0))
      (MAlonzo.Code.Algebra.Bundles.d_1'35'_2218 (coe v0))
      (coe
         C_IsAlmostCommutativeRing'46'constructor_1027
         (coe
            MAlonzo.Code.Algebra.Bundles.d_isCommutativeSemiring_2220 (coe v0))
         (coe (\ v1 v2 v3 -> v3))
         (coe
            (\ v1 v2 ->
               coe
                             ...
                             (coe
                                ...
                                (coe
                                   ...
                                   (coe
                                      MAlonzo.Code.Algebra.Structures.d_isSemiring_1540
                                      (coe
                                         MAlonzo.Code.Algebra.Bundles.d_isCommutativeSemiring_2220
                                         (coe v0)))))))))
                 (coe MAlonzo.Code.Algebra.Bundles.d__'42'__2214 v0 v1 v2)))
         (coe
            (\ v1 v2 ->
               coe
                 MAlonzo.Code.Relation.Binary.Structures.d_refl_34
                                ...
                                (coe
                                   ...
                                   (coe
                                      ...
                                      (coe
                                         MAlonzo.Code.Algebra.Bundles.d_isCommutativeSemiring_2220
                                         (coe v0)))))))))
                 (coe MAlonzo.Code.Algebra.Bundles.d__'43'__2212 v0 v1 v2))))
