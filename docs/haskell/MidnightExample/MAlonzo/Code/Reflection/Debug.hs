...
d_Filter'45'Alg_70
  = coe
      ...
      (coe
         MAlonzo.Code.Data.Bool.Properties.d_'8744''45''8743''45'booleanAlgebra_3392)
...
d_lattice_98 :: MAlonzo.Code.Algebra.Lattice.Bundles.T_Lattice_500
d_lattice_98
  = let v0 = d_Filter'45'Alg_70 in
    coe
      (coe
...
data T_DebugOptions_234
  = C_DebugOptions'46'constructor_1907 [MAlonzo.Code.Agda.Builtin.String.T_String_6]
                                       T_DebugSelection_56
                                       ([MAlonzo.Code.Agda.Builtin.String.T_String_6] -> Bool)
...
d_path_246 v0
  = case coe v0 of
      C_DebugOptions'46'constructor_1907 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Reflection.Debug.DebugOptions.selection
d_selection_248 :: T_DebugOptions_234 -> T_DebugSelection_56
d_selection_248 v0
  = case coe v0 of
      C_DebugOptions'46'constructor_1907 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_filter_250 v0
  = case coe v0 of
      C_DebugOptions'46'constructor_1907 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Reflection.Debug.DebugOptions.level
d_level_252 :: T_DebugOptions_234 -> Integer
d_level_252 v0
  = case coe v0 of
      C_DebugOptions'46'constructor_1907 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_specializeDebugOptions_258 v0 v1
  = case coe v0 of
      C_DebugOptions'46'constructor_1907 v2 v3 v4 v5 v6
        -> case coe v1 of
             C_DebugOptions'46'constructor_1907 v7 v8 v9 v10 v11
               -> coe
                    C_DebugOptions'46'constructor_1907
                    (coe
...
d_debugOptionsPath_266 v0
  = case coe v0 of
      C_DebugOptions'46'constructor_1907 v1 v2 v3 v4 v5
        -> case coe v2 of
             C_FullPath_58
               -> coe
...
d_debugPrintPrefix_288 v0
  = coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.Data.List.Base.du_length_284 (d_path_246 (coe v0)))
