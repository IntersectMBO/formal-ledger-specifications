...
d_Convertible'45'Point_144
  = coe
      ...
      (coe
         (\ v0 ->
            coe
              MAlonzo.Code.MidnightExample.Ledger.C_Point'46'constructor_2297
...
d_Convertible'45'Header_168
  = coe
      ...
      (coe
         (\ v0 ->
            coe
              MAlonzo.Code.MidnightExample.Ledger.C_Header'46'constructor_7243
...
d_Convertible'45'Block_200
  = coe
      ...
      (coe
         (\ v0 ->
            coe
              MAlonzo.Code.MidnightExample.Ledger.C_Block'46'constructor_7569
              (coe
...
d_Convertible'45'LedgerState_230
  = coe
      ...
      (coe
         (\ v0 ->
            coe
              MAlonzo.Code.MidnightExample.Ledger.C_LedgerState'46'constructor_10913
              (coe
                 MAlonzo.Code.Foreign.Convertible.d_from_20
                 (coe
                    MAlonzo.Code.Foreign.Convertible.C_Convertible'46'constructor_21
