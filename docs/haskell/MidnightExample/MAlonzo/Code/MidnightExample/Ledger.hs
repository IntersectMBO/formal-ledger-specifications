...
du___14 :: MAlonzo.Code.Algebra.Bundles.T_CommutativeMonoid_962
du___14
  = coe
      MAlonzo.Code.Data.Integer.Properties.d_'43''45'0'45'commutativeMonoid_4446
...
du_addBlockHash_150 v0 v1 v2 v3
  = coe
      C_Block'46'constructor_7569
      (coe
         C_Header'46'constructor_7243
         (coe d_slotNo_70 (coe d_header_86 (coe v3)))
         (coe d_blockNo_72 (coe d_header_86 (coe v3)))
...
du_tickLedgerState_192 v0 v1
  = coe
      ...
      (coe
         (\ v2 ->
            coe
              C_LedgerState'46'constructor_10913 (coe d_tip_184 (coe v1))
      ...
      (coe
         ...
         (coe
            ...
            (coe
               ...
               (coe
                  MAlonzo.Code.Axiom.Set.Sum.du_indexedSumL_764 (coe du___14)
                       ...
                       MAlonzo.Code.Relation.Nullary.Reflects.C_of'696'_22 v9
                         -> coe
                              ...
                              (coe
                                 ...
                                 (coe
                                    C_LedgerState'46'constructor_10913
                                    (coe
                                       du_blockPoint_102
                                       (coe
                                          C_Block'46'constructor_7569
                                          (coe
                                             C_Header'46'constructor_7243
                                             (coe d_slotNo_70 (coe d_header_86 (coe v5)))
                                             (coe d_blockNo_72 (coe d_header_86 (coe v5)))
                                             (coe d_blockHash_74 (coe d_header_86 (coe v5)))
                                             (coe d_prev_76 (coe d_header_86 (coe v5)))
                                             (coe d_nodeId_78 (coe d_header_86 (coe v5))))
                                          (coe d_body_88 (coe v5))))
                                    (coe
                                       ...
                                       (let v10 = coe du___14 in
                                        coe
                                          (coe
                                             MAlonzo.Code.Axiom.Set.Sum.du_indexedSumL_764 v10
      ...
      (coe
         ...
         (coe
            ...
            (coe
               ...
               (coe MAlonzo.Code.Class.DecEq.Instances.d_DecEq'45'ℤ_28)
               (coe
                  MAlonzo.Code.Axiom.Set.Sum.du_indexedSumL_764
                  MAlonzo.Code.Data.Integer.Properties.d_'43''45'0'45'commutativeMonoid_4446
                  (coe du_txDelta_52) (d_body_88 (coe v4)))
               (coe MAlonzo.Code.Data.Integer.Base.d_0ℤ_12))
            (coe MAlonzo.Code.Class.Decidable.Instances.d_Dec'45''8869'_18))
      ...
      (coe
         (\ v6 ->
            coe
              MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
              (coe
                 C_LedgerState'46'constructor_10913 (coe du_blockPoint_102 (coe v4))
                 (coe
                    MAlonzo.Code.Data.Integer.Base.d__'43'__276
...
d_LEDGER'45'property'8321'_400 ::
  () ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  MAlonzo.Code.Interface.Hashable.T_Hashable_8 ->
  (() ->
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  MAlonzo.Code.Data.Irrelevant.T_Irrelevant_20
d_LEDGER'45'property'8321'_400 = erased
-- MidnightExample.Ledger.LEDGER-property₂
d_LEDGER'45'property'8322'_404 ::
  () ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  MAlonzo.Code.Interface.Hashable.T_Hashable_8 ->
  (() ->
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  MAlonzo.Code.Data.Irrelevant.T_Irrelevant_20
d_LEDGER'45'property'8322'_404 = erased
-- MidnightExample.Ledger.LEDGER-property₃
d_LEDGER'45'property'8323'_412 ::
  () ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  MAlonzo.Code.Interface.Hashable.T_Hashable_8 ->
  (() ->
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  MAlonzo.Code.Data.Irrelevant.T_Irrelevant_20
d_LEDGER'45'property'8323'_412 = erased
