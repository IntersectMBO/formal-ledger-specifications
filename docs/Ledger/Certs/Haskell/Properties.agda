...
open import Ledger.Certs gs
  using ( Deposits ; PState ; PoolParams ; DCert ; DepositPurpose
        ; _⊢_⇀⦇_,POOL⦈_ ; DecEq-DepositPurpose ; PoolEnv)
...
open DCert ; open DepositPurpose ; open PState ; open _⊢_⇀⦇_,POOL⦈_
