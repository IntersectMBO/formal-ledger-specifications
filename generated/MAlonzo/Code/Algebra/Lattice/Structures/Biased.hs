...
du_isPartialEquivalence_440 v0
  = let v1
          = MAlonzo.Code.Algebra.Lattice.Structures.d_isBand_2538 (coe v0) in
    coe
      (let v2
...
data T_IsLattice'8322'_582
  = C_IsLattice'8322''46'constructor_3999 MAlonzo.Code.Algebra.Lattice.Structures.T_IsSemilattice_2530
                                          MAlonzo.Code.Algebra.Lattice.Structures.T_IsSemilattice_2530
...
d_comm_604 v0
  = coe
      MAlonzo.Code.Algebra.Lattice.Structures.d_comm_2540
      (coe d_isMeetSemilattice_596 (coe v0))
...
data T_IsDistributiveLattice'691''690''7504'_674
  = C_IsDistributiveLattice'691''690''7504''46'constructor_7033 MAlonzo.Code.Algebra.Lattice.Structures.T_IsLattice_2830
                                                                (AgdaAny ->
                                                                 AgdaAny -> AgdaAny -> AgdaAny)
...
data T_IsBooleanAlgebra'691'_748
  = C_IsBooleanAlgebra'691''46'constructor_11051 MAlonzo.Code.Algebra.Lattice.Structures.T_IsDistributiveLattice_2904
                                                 (AgdaAny -> AgdaAny) (AgdaAny -> AgdaAny)
                                                 (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
  ...
  = let v1 = d_isDistributiveLattice_768 (coe v0) in
    coe
      (coe
         MAlonzo.Code.Algebra.Lattice.Structures.du_'8743''45'absorbs'45''8744'_2882
         (coe
            MAlonzo.Code.Algebra.Lattice.Structures.d_isLattice_2916 (coe v1)))
