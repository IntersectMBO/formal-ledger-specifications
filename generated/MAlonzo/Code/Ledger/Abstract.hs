...
d_indexOf_1624 a0 = ()
data T_indexOf_1624
  = C_indexOf'46'constructor_2285 (MAlonzo.Code.Ledger.Certs.T_DCert_834 ->
...
d_indexOfDCert_1638 v0
  = case coe v0 of
      C_indexOf'46'constructor_2285 v1 v2 v3 v4 v5 v6 -> coe v1
...
d_indexOfRwdAddr_1640 v0
  = case coe v0 of
      C_indexOf'46'constructor_2285 v1 v2 v3 v4 v5 v6 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfTxIn_1642 v0
  = case coe v0 of
      C_indexOf'46'constructor_2285 v1 v2 v3 v4 v5 v6 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfPolicyId_1644 v0
  = case coe v0 of
      C_indexOf'46'constructor_2285 v1 v2 v3 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfVote_1646 v0
  = case coe v0 of
      C_indexOf'46'constructor_2285 v1 v2 v3 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfProposal_1648 v0
  = case coe v0 of
      C_indexOf'46'constructor_2285 v1 v2 v3 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Abstract.AbstractFunctions
d_AbstractFunctions_1650 a0 = ()
data T_AbstractFunctions_1650
  = C_AbstractFunctions'46'constructor_2547 (AgdaAny ->
                                             AgdaAny -> Integer)
...
d_txscriptfee_1662 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_2547 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Abstract.AbstractFunctions.serSize
d_serSize_1664 :: T_AbstractFunctions_1650 -> AgdaAny -> Integer
d_serSize_1664 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_2547 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfImp_1666 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_2547 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_runPLCScript_1668 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_2547 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_scriptSize_1670 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_2547 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
