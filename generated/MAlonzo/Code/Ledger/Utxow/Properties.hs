...
d__'8866'_'8640''10631'_'44'UTXOW'10632'__1636 a0 a1 a2 a3 a4 a5
  = ()
-- Ledger.Utxow.Properties.Computational-UTXOW
d_Computational'45'UTXOW_1932 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1644 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'UTXOW_1932 v0 v1
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (d_computeProof_2018 (coe v0) (coe v1))
...
d_genErr_1970 v0 ~v1 ~v2 v3 v4 ~v5 = du_genErr_1970 v0 v3 v4
du_genErr_1970 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_1858 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2826 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
du_genErr_1970 v0 v1 v2
  = let v3
          = coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (MAlonzo.Code.Ledger.Transaction.d_txscripts_2936
                                 (coe v0) (coe v2)
                                 (coe MAlonzo.Code.Ledger.Utxo.d_utxo_1868 (coe v1)))))
                        erased in
              coe
                (case coe v5 of
                                                ...
                                                (coe
                                                   ...
                                                   (coe
                                                      ...
                                                      (coe
                                                         ...
                                                         (coe v2)))))))
                                     (coe
                                        MAlonzo.Code.Ledger.Utxow.du_witsVKeyNeeded_2158 v0
                                        (MAlonzo.Code.Ledger.Utxo.d_utxo_1868 (coe v1))
                                        (MAlonzo.Code.Ledger.Transaction.d_body_2836 (coe v2))))
                                  erased in
                        coe
                          (case coe v7 of
                                                     ...
                                                     (coe
                                                        ...
                                                        (MAlonzo.Code.Ledger.Crypto.d_DecEq'45'ScriptHash_204
                                                           (coe
                                                              ...
                                                              (coe v0))))
                                                     (coe
                                                        MAlonzo.Code.Ledger.Utxow.du_scriptsNeeded_2160
                                                        v0
                                                                             ...
                                                                             (coe
                                                                                (\ v15 ->
                                                                                   coe
                                                                                     ...
                                                                                     (coe v15)
                                                                                     (coe
                                                                                        MAlonzo.Code.Ledger.Utxow.du_allowedLanguages_2024
                                                                                        (coe v0)
                                                                                        (coe v2)
                                                                                        (coe
                                                                                           MAlonzo.Code.Ledger.Utxo.d_utxo_1868
                                                                                           (coe
                                                                                              v1)))))
                                                                             (coe
                                                                                MAlonzo.Code.Ledger.Utxow.du_languages_2008
                                                                                (coe v0) (coe v2)
                                                                                (coe
                                                                                   MAlonzo.Code.Ledger.Utxo.d_utxo_1868
                                                                                   (coe v1))))
...
d_computeProof_2018 v0 v1 v2 v3 v4
  = let v5
          = MAlonzo.Code.Class.Decidable.Core.d_dec_16
              (coe
                 MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
                 (coe
                    MAlonzo.Code.Ledger.Utxow.du_UTXOW'45'inductive'45'premises_2294
           ...
           -> if coe v6
                then case coe v7 of
                                                                          ...
                                                                          -> coe
                                                                               ...
                                                                               (coe
                                                                                  ...
                                                                                  (coe
                                                                                     (\ v23 v24 ->
                                                                                        coe
                                                                                          MAlonzo.Code.Ledger.Utxow.C_UTXOW'45'inductive_2268
                                                                                          (coe
                                                                               ...
                                                                               (coe
                                                                                  ...
                                                                                  (MAlonzo.Code.Ledger.Utxo.Properties.d_Computational'45'UTXO_2358
                                                                                     (coe v0)
                                                                                     (coe v1))
                                                                                  v2 v3 v4)
                                                                        _ -> MAlonzo.RTE.mazUnreachableError
                       ...
                       (coe
                          ...
                          (coe du_genErr_1970 (coe v0) (coe v3) (coe v4)))
         _ -> MAlonzo.RTE.mazUnreachableError)
...
d_completeness_2042 ::
  ...
  MAlonzo.Code.Ledger.Transaction.T_Tx_2826 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_1858 ->
  MAlonzo.Code.Ledger.Utxow.T__'8866'_'8640''10631'_'44'UTXOW'10632'__2162 ->
