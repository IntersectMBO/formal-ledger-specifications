...
data T__'8866'_'8640''10631'_'44'GOV'''10632'__990
  = C_GOV'45'Vote_1494 MAlonzo.Code.Ledger.GovernanceActions.T_GovActionState_738
    ...
    C_GOV'45'Propose_1588 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
-- Ledger.Gov._⊢_⇀⦇_,GOV⦈_
...
d_enactState_1500 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_GeneralizeTel_36937 ->
  MAlonzo.Code.Ledger.GovernanceActions.T_Anchor_642 ->
  MAlonzo.Code.Ledger.Enact.T_EnactState_788
d_enactState_1500 ~v0 v1 ~v2 = du_enactState_1500 v1
du_enactState_1500 ::
  T_GeneralizeTel_36937 -> MAlonzo.Code.Ledger.Enact.T_EnactState_788
du_enactState_1500 v0
  = coe d_enactState_986 (coe d_'46'generalizedField'45'Γ_36921 v0)
-- Ledger.Gov._.epoch
d_epoch_1502 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_GeneralizeTel_36937 ->
...
du_epoch_1502 :: T_GeneralizeTel_36937 -> AgdaAny
du_epoch_1502 v0
  = coe d_epoch_980 (coe d_'46'generalizedField'45'Γ_36921 v0)
-- Ledger.Gov._.pparams
d_pparams_1504 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_GeneralizeTel_36937 ->
...
du_pparams_1504 ::
  T_GeneralizeTel_36937 -> MAlonzo.Code.Ledger.PParams.T_PParams_228
du_pparams_1504 v0
  = coe d_pparams_982 (coe d_'46'generalizedField'45'Γ_36921 v0)
-- Ledger.Gov._.ppolicy
d_ppolicy_1506 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_GeneralizeTel_36937 ->
...
du_ppolicy_1506 :: T_GeneralizeTel_36937 -> Maybe AgdaAny
du_ppolicy_1506 v0
  = coe d_ppolicy_984 (coe d_'46'generalizedField'45'Γ_36921 v0)
-- Ledger.Gov._.txid
d_txid_1508 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_GeneralizeTel_36937 ->
...
du_txid_1508 :: T_GeneralizeTel_36937 -> AgdaAny
du_txid_1508 v0
  = coe d_txid_978 (coe d_'46'generalizedField'45'Γ_36921 v0)
...
du_govActionDeposit_1534 :: T_GeneralizeTel_36937 -> Integer
...
du_govActionLifetime_1536 :: T_GeneralizeTel_36937 -> Integer
...
-- Ledger.Gov..generalizedField-Γ
d_'46'generalizedField'45'Γ_36921 ::
  T_GeneralizeTel_36937 -> T_GovEnv_966
d_'46'generalizedField'45'Γ_36921 = MAlonzo.RTE.mazUnreachableError
-- Ledger.Gov..generalizedField-addr
d_'46'generalizedField'45'addr_36923 ::
  T_GeneralizeTel_36937 -> MAlonzo.Code.Ledger.Address.T_RwdAddr_76
d_'46'generalizedField'45'addr_36923
  = MAlonzo.RTE.mazUnreachableError
-- Ledger.Gov..generalizedField-a
d_'46'generalizedField'45'a_36925 ::
  T_GeneralizeTel_36937 ->
  MAlonzo.Code.Ledger.GovernanceActions.T_GovAction_652
d_'46'generalizedField'45'a_36925 = MAlonzo.RTE.mazUnreachableError
-- Ledger.Gov..generalizedField-p
d_'46'generalizedField'45'p_36927 ::
  T_GeneralizeTel_36937 -> Maybe AgdaAny
d_'46'generalizedField'45'p_36927 = MAlonzo.RTE.mazUnreachableError
-- Ledger.Gov..generalizedField-d
d_'46'generalizedField'45'd_36929 ::
  T_GeneralizeTel_36937 -> Integer
d_'46'generalizedField'45'd_36929 = MAlonzo.RTE.mazUnreachableError
-- Ledger.Gov..generalizedField-prev
d_'46'generalizedField'45'prev_36931 ::
  T_GeneralizeTel_36937 -> AgdaAny
d_'46'generalizedField'45'prev_36931
  = MAlonzo.RTE.mazUnreachableError
-- Ledger.Gov..generalizedField-s
d_'46'generalizedField'45's_36933 ::
  T_GeneralizeTel_36937 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
d_'46'generalizedField'45's_36933 = MAlonzo.RTE.mazUnreachableError
-- Ledger.Gov..generalizedField-k
d_'46'generalizedField'45'k_36935 ::
  T_GeneralizeTel_36937 -> Integer
d_'46'generalizedField'45'k_36935 = MAlonzo.RTE.mazUnreachableError
-- Ledger.Gov.GeneralizeTel
d_GeneralizeTel_36937 a0 = ()
data T_GeneralizeTel_36937
  = C_mkGeneralizeTel_36939 T_GovEnv_966
                            MAlonzo.Code.Ledger.Address.T_RwdAddr_76
                            MAlonzo.Code.Ledger.GovernanceActions.T_GovAction_652
