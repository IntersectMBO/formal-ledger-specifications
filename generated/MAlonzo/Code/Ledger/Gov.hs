...
du__'8764''63'__1962 v0 v1
  = coe
      ...
      (coe
         ...
         (coe du_govActionPriority_1948 (coe v0))
         (coe du_govActionPriority_1948 (coe v1)))
      (coe
         MAlonzo.Code.Relation.Nullary.Decidable.Core.du__'8846''45'dec__86
         (coe
            ...
            (coe
               MAlonzo.Code.Data.Nat.Properties.d__'8799'__2688
               (coe du_govActionPriority_1948 (coe v0)) (coe (0 :: Integer)))
            (coe
               MAlonzo.Code.Data.Nat.Properties.d__'8799'__2688
               (coe du_govActionPriority_1948 (coe v1)) (coe (1 :: Integer))))
         (coe
            MAlonzo.Code.Relation.Nullary.Decidable.Core.du__'215''45'dec__76
            (coe
               MAlonzo.Code.Data.Nat.Properties.d__'8799'__2688
               (coe du_govActionPriority_1948 (coe v0)) (coe (1 :: Integer)))
            (coe
