...
d_HashProtected_684 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 -> () -> ()
d_HashProtected_684 = erased
-- Ledger.Enact._.NeedsHash
d_NeedsHash_688 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 ->
  MAlonzo.Code.Ledger.GovernanceActions.T_GovAction_690 -> ()
d_NeedsHash_688 = erased
-- Ledger.Enact.EnactEnv
d_EnactEnv_812 a0 = ()
data T_EnactEnv_812
  = C_EnactEnv'46'constructor_1629 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                                   Integer AgdaAny
...
d_gid_820 v0
  = case coe v0 of
      C_EnactEnv'46'constructor_1629 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Enact.EnactEnv.treasury
d_treasury_822 :: T_EnactEnv_812 -> Integer
d_treasury_822 v0
  = case coe v0 of
      C_EnactEnv'46'constructor_1629 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Enact.EnactEnv.epoch
d_epoch_824 :: T_EnactEnv_812 -> AgdaAny
d_epoch_824 v0
  = case coe v0 of
      C_EnactEnv'46'constructor_1629 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Enact.EnactState
d_EnactState_826 a0 = ()
data T_EnactState_826
  = C_EnactState'46'constructor_2173 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                                     MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                                     MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                                     MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                                     MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_cc_838 ::
  T_EnactState_826 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_cc_838 v0
  = case coe v0 of
      C_EnactState'46'constructor_2173 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Enact.EnactState.constitution
d_constitution_840 ::
  T_EnactState_826 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_constitution_840 v0
  = case coe v0 of
      C_EnactState'46'constructor_2173 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pv_842 v0
  = case coe v0 of
      C_EnactState'46'constructor_2173 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_pparams_844 v0
  = case coe v0 of
      C_EnactState'46'constructor_2173 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Enact.EnactState.withdrawals
d_withdrawals_846 ::
  T_EnactState_826 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_withdrawals_846 v0
  = case coe v0 of
      C_EnactState'46'constructor_2173 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Enact.ToRecord-EnactEnv
d_ToRecord'45'EnactEnv_848 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 ->
  MAlonzo.Code.ToRecord.T_ToRecord_6
d_ToRecord'45'EnactEnv_848 ~v0 = du_ToRecord'45'EnactEnv_848
du_ToRecord'45'EnactEnv_848 :: MAlonzo.Code.ToRecord.T_ToRecord_6
du_ToRecord'45'EnactEnv_848
  = coe
      ...
      (coe
         ...
         (coe
            (\ v0 v1 v2 ->
               coe C_EnactEnv'46'constructor_1629 (coe v0) (coe v1) (coe v2))))
-- Ledger.Enact.ccCreds
d_ccCreds_856 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Ledger.Address.T_Credential_16]
d_ccCreds_856 ~v0 v1 = du_ccCreds_856 v1
du_ccCreds_856 ::
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  [MAlonzo.Code.Ledger.Address.T_Credential_16]
du_ccCreds_856 v0
...
d_getHash_862 ~v0 v1 v2 = du_getHash_862 v1 v2
du_getHash_862 ::
  MAlonzo.Code.Ledger.GovernanceActions.T_GovAction_690 ->
  AgdaAny -> Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_getHash_862 v0 v1
  = case coe v0 of
      MAlonzo.Code.Ledger.GovernanceActions.C_NoConfidence_692
        -> coe MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 (coe v1)
      MAlonzo.Code.Ledger.GovernanceActions.C_UpdateCommittee_694 v2 v3 v4
        -> coe MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 (coe v1)
      MAlonzo.Code.Ledger.GovernanceActions.C_NewConstitution_696 v2 v3
        -> coe MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 (coe v1)
      MAlonzo.Code.Ledger.GovernanceActions.C_TriggerHF_698 v2
        -> coe MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 (coe v1)
      MAlonzo.Code.Ledger.GovernanceActions.C_ChangePParams_700 v2
        -> coe MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 (coe v1)
      MAlonzo.Code.Ledger.GovernanceActions.C_TreasuryWdrl_702 v2
...
d_getHashES_874 ~v0 v1 v2 = du_getHashES_874 v1 v2
du_getHashES_874 ::
  T_EnactState_826 ->
  MAlonzo.Code.Ledger.GovernanceActions.T_GovAction_690 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_getHashES_874 v0 v1
  = case coe v1 of
      MAlonzo.Code.Ledger.GovernanceActions.C_NoConfidence_692
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
                MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe d_cc_838 (coe v0)))
      MAlonzo.Code.Ledger.GovernanceActions.C_UpdateCommittee_694 v2 v3 v4
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
      ...
      MAlonzo.Code.Ledger.GovernanceActions.C_NewConstitution_696 v2 v3
        -> coe
             ...
             (coe
                ...
                (coe d_constitution_840 (coe v0)))
      MAlonzo.Code.Ledger.GovernanceActions.C_TriggerHF_698 v2
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
                MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe d_pv_842 (coe v0)))
      MAlonzo.Code.Ledger.GovernanceActions.C_ChangePParams_700 v2
        -> coe
             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
             (coe
                MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
                (coe d_pparams_844 (coe v0)))
      MAlonzo.Code.Ledger.GovernanceActions.C_TreasuryWdrl_702 v2
        -> coe MAlonzo.Code.Agda.Builtin.Maybe.C_nothing_18
      MAlonzo.Code.Ledger.GovernanceActions.C_Info_704
        -> coe MAlonzo.Code.Agda.Builtin.Maybe.C_nothing_18
...
d__'8866'_'8640''10631'_'44'ENACT'10632'__890 a0 a1 a2 a3 a4 = ()
data T__'8866'_'8640''10631'_'44'ENACT'10632'__890
  = C_Enact'45'NoConf_918 |
    C_Enact'45'NewComm_926 (AgdaAny ->
                            MAlonzo.Code.Data.List.Relation.Unary.Any.T_Any_34 ->
                            MAlonzo.Code.Data.Sum.Base.T__'8846'__30) |
    C_Enact'45'NewConst_928 | C_Enact'45'HF_930 |
    C_Enact'45'PParams_932 |
    C_Enact'45'Wdrl_938 MAlonzo.Code.Data.Nat.Base.T__'8804'__22 |
    C_Enact'45'Info_940
