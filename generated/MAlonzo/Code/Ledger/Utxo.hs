...
data T_UTxOEnv_2008
  = C_UTxOEnv'46'constructor_16333 AgdaAny
                                   MAlonzo.Code.Ledger.PParams.T_PParams_242 Integer
-- Ledger.Utxo.UTxOEnv.slot
d_slot_2016 :: T_UTxOEnv_2008 -> AgdaAny
d_slot_2016 v0
  = case coe v0 of
      C_UTxOEnv'46'constructor_16333 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxo.UTxOEnv.pparams
d_pparams_2018 ::
  T_UTxOEnv_2008 -> MAlonzo.Code.Ledger.PParams.T_PParams_242
d_pparams_2018 v0
  = case coe v0 of
      C_UTxOEnv'46'constructor_16333 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxo.UTxOEnv.treasury
d_treasury_2020 :: T_UTxOEnv_2008 -> Integer
d_treasury_2020 v0
  = case coe v0 of
      C_UTxOEnv'46'constructor_16333 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
  ...
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.Ledger.Fees.du_scriptsCost_1476 (coe v2)
         ...
         (\ v1 ->
            addInt
              (coe
                 addInt
                 (coe
                    addInt (coe du_cbalance_2064 (coe v0) (coe d_utxo_2032 (coe v1)))
...
d_txdonation_2940 ::
  ...
  T_UTxOState_2022 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2622 -> Integer
d_txdonation_2940 ~v0 ~v1 ~v2 v3 = du_txdonation_2940 v3
du_txdonation_2940 ::
  MAlonzo.Code.Ledger.Transaction.T_Tx_2622 -> Integer
...
d_txfee_2942 ::
  ...
  T_UTxOState_2022 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2622 -> Integer
d_txfee_2942 ~v0 ~v1 ~v2 v3 = du_txfee_2942 v3
du_txfee_2942 ::
  MAlonzo.Code.Ledger.Transaction.T_Tx_2622 -> Integer
du_txfee_2942 v0
  = coe
...
du_pparams_2964 ::
  T_UTxOEnv_2008 -> MAlonzo.Code.Ledger.PParams.T_PParams_242
du_pparams_2964 v0 = coe d_pparams_2018 (coe v0)
-- Ledger.Utxo._.slot
d_slot_2966 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_UTxOEnv_2008 ->
...
du_slot_2966 :: T_UTxOEnv_2008 -> AgdaAny
du_slot_2966 v0 = coe d_slot_2016 (coe v0)
...
du_treasury_2968 :: T_UTxOEnv_2008 -> Integer
du_treasury_2968 v0 = coe d_treasury_2020 (coe v0)
-- Ledger.Utxo._.deposits
d_deposits_2972 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_UTxOEnv_2008 ->
...
du_deposits_2972 ::
  T_UTxOState_2022 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_deposits_2972 v0 = coe d_deposits_2036 (coe v0)
...
du_donations_2974 :: T_UTxOState_2022 -> Integer
du_donations_2974 v0 = coe d_donations_2038 (coe v0)
-- Ledger.Utxo._.fees
d_fees_2976 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_UTxOEnv_2008 ->
...
du_fees_2976 :: T_UTxOState_2022 -> Integer
du_fees_2976 v0 = coe d_fees_2034 (coe v0)
-- Ledger.Utxo._.utxo
d_utxo_2978 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_UTxOEnv_2008 ->
...
du_utxo_2978 ::
  T_UTxOState_2022 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_utxo_2978 v0 = coe d_utxo_2032 (coe v0)
...
du_pparams_3044 ::
  T_UTxOEnv_2008 -> MAlonzo.Code.Ledger.PParams.T_PParams_242
du_pparams_3044 v0 = coe d_pparams_2018 (coe v0)
-- Ledger.Utxo._.slot
d_slot_3046 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_UTxOEnv_2008 ->
...
du_slot_3046 :: T_UTxOEnv_2008 -> AgdaAny
du_slot_3046 v0 = coe d_slot_2016 (coe v0)
-- Ledger.Utxo._.treasury
d_treasury_3048 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_UTxOEnv_2008 ->
...
du_treasury_3048 :: T_UTxOEnv_2008 -> Integer
du_treasury_3048 v0 = coe d_treasury_2020 (coe v0)
-- Ledger.Utxo._.deposits
d_deposits_3052 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_UTxOEnv_2008 ->
...
du_deposits_3052 ::
  T_UTxOState_2022 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_deposits_3052 v0 = coe d_deposits_2036 (coe v0)
-- Ledger.Utxo._.donations
d_donations_3054 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_UTxOEnv_2008 ->
...
du_donations_3054 :: T_UTxOState_2022 -> Integer
du_donations_3054 v0 = coe d_donations_2038 (coe v0)
-- Ledger.Utxo._.fees
d_fees_3056 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_UTxOEnv_2008 ->
...
du_fees_3056 :: T_UTxOState_2022 -> Integer
du_fees_3056 v0 = coe d_fees_2034 (coe v0)
-- Ledger.Utxo._.utxo
d_utxo_3058 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_UTxOEnv_2008 ->
...
du_utxo_3058 ::
  T_UTxOState_2022 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_utxo_3058 v0 = coe d_utxo_2032 (coe v0)
...
du_body_3124 v0
  = coe
      ...
      (coe d_'46'generalizedField'45'tx_202197 (coe v0))
-- Ledger.Utxo._.curTreasury
d_curTreasury_3132 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_GeneralizeTel_202205 -> Maybe Integer
d_curTreasury_3132 ~v0 ~v1 v2 = du_curTreasury_3132 v2
du_curTreasury_3132 :: T_GeneralizeTel_202205 -> Maybe Integer
...
d_mint_3134 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_GeneralizeTel_202205 -> AgdaAny
d_mint_3134 ~v0 ~v1 v2 = du_mint_3134 v2
du_mint_3134 :: T_GeneralizeTel_202205 -> AgdaAny
du_mint_3134 v0
  = coe
...
d_refInputs_3136 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_GeneralizeTel_202205 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
...
d_txNetworkId_3144 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_GeneralizeTel_202205 -> Maybe AgdaAny
d_txNetworkId_3144 ~v0 ~v1 v2 = du_txNetworkId_3144 v2
du_txNetworkId_3144 :: T_GeneralizeTel_202205 -> Maybe AgdaAny
...
d_txsize_3160 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_GeneralizeTel_202205 -> Integer
d_txsize_3160 ~v0 ~v1 v2 = du_txsize_3160 v2
du_txsize_3160 :: T_GeneralizeTel_202205 -> Integer
du_txsize_3160 v0
  = coe
      MAlonzo.Code.Ledger.Transaction.d_txsize_2592
      (coe
...
d_pparams_3172 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_GeneralizeTel_202205 -> MAlonzo.Code.Ledger.PParams.T_PParams_242
d_pparams_3172 ~v0 ~v1 v2 = du_pparams_3172 v2
du_pparams_3172 ::
  T_GeneralizeTel_202205 -> MAlonzo.Code.Ledger.PParams.T_PParams_242
du_pparams_3172 v0
  = coe
      d_pparams_2018 (coe d_'46'generalizedField'45'Γ_202199 (coe v0))
-- Ledger.Utxo._.slot
d_slot_3174 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
...
du_slot_3174 :: T_GeneralizeTel_202205 -> AgdaAny
du_slot_3174 v0
  = coe d_slot_2016 (coe d_'46'generalizedField'45'Γ_202199 (coe v0))
-- Ledger.Utxo._.treasury
d_treasury_3176 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
...
du_treasury_3176 :: T_GeneralizeTel_202205 -> Integer
du_treasury_3176 v0
  = coe
      d_treasury_2020 (coe d_'46'generalizedField'45'Γ_202199 (coe v0))
-- Ledger.Utxo._.deposits
d_deposits_3180 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
...
du_deposits_3180 v0
  = coe
      d_deposits_2036 (coe d_'46'generalizedField'45's_202201 (coe v0))
-- Ledger.Utxo._.donations
d_donations_3182 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
...
du_donations_3182 :: T_GeneralizeTel_202205 -> Integer
du_donations_3182 v0
  = coe
      d_donations_2038 (coe d_'46'generalizedField'45's_202201 (coe v0))
-- Ledger.Utxo._.fees
d_fees_3184 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
...
du_fees_3184 :: T_GeneralizeTel_202205 -> Integer
du_fees_3184 v0
  = coe d_fees_2034 (coe d_'46'generalizedField'45's_202201 (coe v0))
-- Ledger.Utxo._.utxo
d_utxo_3186 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
...
du_utxo_3186 ::
  T_GeneralizeTel_202205 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_utxo_3186 v0
  = coe d_utxo_2032 (coe d_'46'generalizedField'45's_202201 (coe v0))
         ...
         (coe
            ...
            (coe
               ...
               (coe
                  MAlonzo.Code.Class.Decidable.Instances.du_Dec'45''215'_24
                  (coe
                     du_Dec'45'inInterval_2598 (coe v0) (coe d_slot_2016 (coe v3))
                     (coe
                        MAlonzo.Code.Ledger.Transaction.d_txvldt_2572
                        (coe MAlonzo.Code.Ledger.Transaction.d_body_2632 (coe v2))))
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe MAlonzo.Code.Ledger.Transaction.d_tokenAlgebra_2212 (coe v0)))
                           (coe
                              du_consumed_2886 (coe v0) (coe d_pparams_2018 (coe v3)) (coe v4)
                              (coe MAlonzo.Code.Ledger.Transaction.d_body_2632 (coe v2)))
                           (coe
                              du_produced_2894 (coe v0) (coe d_pparams_2018 (coe v3)) (coe v4)
                              (coe MAlonzo.Code.Ledger.Transaction.d_body_2632 (coe v2))))
                        (coe
                           MAlonzo.Code.Class.Decidable.Instances.du_Dec'45''215'_24
                           (coe
...
d_'46'generalizedField'45'tx_202197 ::
  T_GeneralizeTel_202205 -> MAlonzo.Code.Ledger.Transaction.T_Tx_2622
d_'46'generalizedField'45'tx_202197 v0
  = case coe v0 of
      C_mkGeneralizeTel_202207 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxo..generalizedField-Γ
d_'46'generalizedField'45'Γ_202199 ::
  T_GeneralizeTel_202205 -> T_UTxOEnv_2008
d_'46'generalizedField'45'Γ_202199 v0
  = case coe v0 of
      C_mkGeneralizeTel_202207 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxo..generalizedField-s
d_'46'generalizedField'45's_202201 ::
  T_GeneralizeTel_202205 -> T_UTxOState_2022
d_'46'generalizedField'45's_202201 v0
  = case coe v0 of
      C_mkGeneralizeTel_202207 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxo..generalizedField-s'
d_'46'generalizedField'45's''_202203 ::
  T_GeneralizeTel_202205 -> T_UTxOState_2022
d_'46'generalizedField'45's''_202203 v0
  = case coe v0 of
      C_mkGeneralizeTel_202207 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxo.GeneralizeTel
d_GeneralizeTel_202205 a0 a1 = ()
data T_GeneralizeTel_202205
  = C_mkGeneralizeTel_202207 MAlonzo.Code.Ledger.Transaction.T_Tx_2622
