...
du_body_3016 v0
  = coe
      ...
      (coe d_'46'generalizedField'45'tx_159473 (coe v0))
-- Ledger.Utxo._.curTreasury
d_curTreasury_3024 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
  T_GeneralizeTel_159481 -> Maybe Integer
d_curTreasury_3024 ~v0 ~v1 v2 = du_curTreasury_3024 v2
du_curTreasury_3024 :: T_GeneralizeTel_159481 -> Maybe Integer
...
d_mint_3026 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
  T_GeneralizeTel_159481 -> AgdaAny
d_mint_3026 ~v0 ~v1 v2 = du_mint_3026 v2
du_mint_3026 :: T_GeneralizeTel_159481 -> AgdaAny
du_mint_3026 v0
  = coe
...
d_refInputs_3028 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
  T_GeneralizeTel_159481 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
...
d_txNetworkId_3036 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
  T_GeneralizeTel_159481 -> Maybe AgdaAny
d_txNetworkId_3036 ~v0 ~v1 v2 = du_txNetworkId_3036 v2
du_txNetworkId_3036 :: T_GeneralizeTel_159481 -> Maybe AgdaAny
...
d_txsize_3052 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
  T_GeneralizeTel_159481 -> Integer
d_txsize_3052 ~v0 ~v1 v2 = du_txsize_3052 v2
du_txsize_3052 :: T_GeneralizeTel_159481 -> Integer
du_txsize_3052 v0
  = coe
      MAlonzo.Code.Ledger.Transaction.d_txsize_2594
      (coe
...
d_pparams_3064 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
  T_GeneralizeTel_159481 -> MAlonzo.Code.Ledger.PParams.T_PParams_244
d_pparams_3064 ~v0 ~v1 v2 = du_pparams_3064 v2
du_pparams_3064 ::
  T_GeneralizeTel_159481 -> MAlonzo.Code.Ledger.PParams.T_PParams_244
du_pparams_3064 v0
  = coe
      d_pparams_1920 (coe d_'46'generalizedField'45'Γ_159475 (coe v0))
-- Ledger.Utxo._.slot
d_slot_3066 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
...
du_slot_3066 :: T_GeneralizeTel_159481 -> AgdaAny
du_slot_3066 v0
  = coe d_slot_1918 (coe d_'46'generalizedField'45'Γ_159475 (coe v0))
-- Ledger.Utxo._.treasury
d_treasury_3068 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
...
du_treasury_3068 :: T_GeneralizeTel_159481 -> Integer
du_treasury_3068 v0
  = coe
      d_treasury_1922 (coe d_'46'generalizedField'45'Γ_159475 (coe v0))
-- Ledger.Utxo._.deposits
d_deposits_3072 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
...
du_deposits_3072 v0
  = coe
      d_deposits_1938 (coe d_'46'generalizedField'45's_159477 (coe v0))
-- Ledger.Utxo._.donations
d_donations_3074 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
...
du_donations_3074 :: T_GeneralizeTel_159481 -> Integer
du_donations_3074 v0
  = coe
      d_donations_1940 (coe d_'46'generalizedField'45's_159477 (coe v0))
-- Ledger.Utxo._.fees
d_fees_3076 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
...
du_fees_3076 :: T_GeneralizeTel_159481 -> Integer
du_fees_3076 v0
  = coe d_fees_1936 (coe d_'46'generalizedField'45's_159477 (coe v0))
-- Ledger.Utxo._.utxo
d_utxo_3078 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
...
du_utxo_3078 ::
  T_GeneralizeTel_159481 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_utxo_3078 v0
  = coe d_utxo_1934 (coe d_'46'generalizedField'45's_159477 (coe v0))
...
d_'46'generalizedField'45'tx_159473 ::
  T_GeneralizeTel_159481 -> MAlonzo.Code.Ledger.Transaction.T_Tx_2624
d_'46'generalizedField'45'tx_159473 v0
  = case coe v0 of
      C_mkGeneralizeTel_159483 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxo..generalizedField-Γ
d_'46'generalizedField'45'Γ_159475 ::
  T_GeneralizeTel_159481 -> T_UTxOEnv_1910
d_'46'generalizedField'45'Γ_159475 v0
  = case coe v0 of
      C_mkGeneralizeTel_159483 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxo..generalizedField-s
d_'46'generalizedField'45's_159477 ::
  T_GeneralizeTel_159481 -> T_UTxOState_1924
d_'46'generalizedField'45's_159477 v0
  = case coe v0 of
      C_mkGeneralizeTel_159483 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxo..generalizedField-s'
d_'46'generalizedField'45's''_159479 ::
  T_GeneralizeTel_159481 -> T_UTxOState_1924
d_'46'generalizedField'45's''_159479 v0
  = case coe v0 of
      C_mkGeneralizeTel_159483 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxo.GeneralizeTel
d_GeneralizeTel_159481 a0 a1 = ()
data T_GeneralizeTel_159481
  = C_mkGeneralizeTel_159483 MAlonzo.Code.Ledger.Transaction.T_Tx_2624
