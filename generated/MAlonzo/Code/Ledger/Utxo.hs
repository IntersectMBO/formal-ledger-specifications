...
du_pparams_2856 ::
  T_UTxOEnv_1912 -> MAlonzo.Code.Ledger.PParams.T_PParams_242
du_pparams_2856 v0 = coe d_pparams_1922 (coe v0)
-- Ledger.Utxo._.slot
d_slot_2858 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  T_UTxOEnv_1912 ->
...
du_slot_2858 :: T_UTxOEnv_1912 -> AgdaAny
du_slot_2858 v0 = coe d_slot_1920 (coe v0)
...
du_treasury_2860 :: T_UTxOEnv_1912 -> Integer
du_treasury_2860 v0 = coe d_treasury_1924 (coe v0)
-- Ledger.Utxo._.deposits
d_deposits_2864 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  T_UTxOEnv_1912 ->
...
du_deposits_2864 ::
  T_UTxOState_1926 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_deposits_2864 v0 = coe d_deposits_1940 (coe v0)
...
du_donations_2866 :: T_UTxOState_1926 -> Integer
du_donations_2866 v0 = coe d_donations_1942 (coe v0)
-- Ledger.Utxo._.fees
d_fees_2868 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  T_UTxOEnv_1912 ->
...
du_fees_2868 :: T_UTxOState_1926 -> Integer
du_fees_2868 v0 = coe d_fees_1938 (coe v0)
-- Ledger.Utxo._.utxo
d_utxo_2870 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  T_UTxOEnv_1912 ->
...
du_utxo_2870 ::
  T_UTxOState_1926 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_utxo_2870 v0 = coe d_utxo_1936 (coe v0)
...
du_pparams_2936 ::
  T_UTxOEnv_1912 -> MAlonzo.Code.Ledger.PParams.T_PParams_242
du_pparams_2936 v0 = coe d_pparams_1922 (coe v0)
-- Ledger.Utxo._.slot
d_slot_2938 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  T_UTxOEnv_1912 ->
...
du_slot_2938 :: T_UTxOEnv_1912 -> AgdaAny
du_slot_2938 v0 = coe d_slot_1920 (coe v0)
-- Ledger.Utxo._.treasury
d_treasury_2940 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  T_UTxOEnv_1912 ->
...
du_treasury_2940 :: T_UTxOEnv_1912 -> Integer
du_treasury_2940 v0 = coe d_treasury_1924 (coe v0)
-- Ledger.Utxo._.deposits
d_deposits_2944 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  T_UTxOEnv_1912 ->
...
du_deposits_2944 ::
  T_UTxOState_1926 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_deposits_2944 v0 = coe d_deposits_1940 (coe v0)
-- Ledger.Utxo._.donations
d_donations_2946 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  T_UTxOEnv_1912 ->
...
du_donations_2946 :: T_UTxOState_1926 -> Integer
du_donations_2946 v0 = coe d_donations_1942 (coe v0)
-- Ledger.Utxo._.fees
d_fees_2948 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  T_UTxOEnv_1912 ->
...
du_fees_2948 :: T_UTxOState_1926 -> Integer
du_fees_2948 v0 = coe d_fees_1938 (coe v0)
-- Ledger.Utxo._.utxo
d_utxo_2950 ::
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  T_UTxOEnv_1912 ->
...
du_utxo_2950 ::
  T_UTxOState_1926 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_utxo_2950 v0 = coe d_utxo_1936 (coe v0)
...
du_body_3016 v0
  = coe
      ...
      (coe d_'46'generalizedField'45'tx_159393 (coe v0))
-- Ledger.Utxo._.curTreasury
d_curTreasury_3024 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  T_GeneralizeTel_159401 -> Maybe Integer
d_curTreasury_3024 ~v0 ~v1 v2 = du_curTreasury_3024 v2
du_curTreasury_3024 :: T_GeneralizeTel_159401 -> Maybe Integer
...
d_mint_3026 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  T_GeneralizeTel_159401 -> AgdaAny
d_mint_3026 ~v0 ~v1 v2 = du_mint_3026 v2
du_mint_3026 :: T_GeneralizeTel_159401 -> AgdaAny
du_mint_3026 v0
  = coe
...
d_refInputs_3028 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  T_GeneralizeTel_159401 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
...
d_txNetworkId_3036 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  T_GeneralizeTel_159401 -> Maybe AgdaAny
d_txNetworkId_3036 ~v0 ~v1 v2 = du_txNetworkId_3036 v2
du_txNetworkId_3036 :: T_GeneralizeTel_159401 -> Maybe AgdaAny
...
d_txsize_3052 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  T_GeneralizeTel_159401 -> Integer
d_txsize_3052 ~v0 ~v1 v2 = du_txsize_3052 v2
du_txsize_3052 :: T_GeneralizeTel_159401 -> Integer
du_txsize_3052 v0
  = coe
      MAlonzo.Code.Ledger.Transaction.d_txsize_2588
      (coe
...
d_pparams_3064 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  T_GeneralizeTel_159401 -> MAlonzo.Code.Ledger.PParams.T_PParams_242
d_pparams_3064 ~v0 ~v1 v2 = du_pparams_3064 v2
du_pparams_3064 ::
  T_GeneralizeTel_159401 -> MAlonzo.Code.Ledger.PParams.T_PParams_242
du_pparams_3064 v0
  = coe
      d_pparams_1922 (coe d_'46'generalizedField'45'Γ_159395 (coe v0))
-- Ledger.Utxo._.slot
d_slot_3066 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
...
du_slot_3066 :: T_GeneralizeTel_159401 -> AgdaAny
du_slot_3066 v0
  = coe d_slot_1920 (coe d_'46'generalizedField'45'Γ_159395 (coe v0))
-- Ledger.Utxo._.treasury
d_treasury_3068 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
...
du_treasury_3068 :: T_GeneralizeTel_159401 -> Integer
du_treasury_3068 v0
  = coe
      d_treasury_1924 (coe d_'46'generalizedField'45'Γ_159395 (coe v0))
-- Ledger.Utxo._.deposits
d_deposits_3072 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
...
du_deposits_3072 v0
  = coe
      d_deposits_1940 (coe d_'46'generalizedField'45's_159397 (coe v0))
-- Ledger.Utxo._.donations
d_donations_3074 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
...
du_donations_3074 :: T_GeneralizeTel_159401 -> Integer
du_donations_3074 v0
  = coe
      d_donations_1942 (coe d_'46'generalizedField'45's_159397 (coe v0))
-- Ledger.Utxo._.fees
d_fees_3076 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
...
du_fees_3076 :: T_GeneralizeTel_159401 -> Integer
du_fees_3076 v0
  = coe d_fees_1938 (coe d_'46'generalizedField'45's_159397 (coe v0))
-- Ledger.Utxo._.utxo
d_utxo_3078 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
...
du_utxo_3078 ::
  T_GeneralizeTel_159401 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_utxo_3078 v0
  = coe d_utxo_1936 (coe d_'46'generalizedField'45's_159397 (coe v0))
         ...
         (coe
            ...
            (coe
               ...
               (coe
                  MAlonzo.Code.Class.Decidable.Instances.du_Dec'45''215'_24
                  (coe
                     du_Dec'45'inInterval_2466 (coe v0) (coe d_slot_1920 (coe v3))
                     (coe
                        MAlonzo.Code.Ledger.Transaction.d_txvldt_2568
                        (coe MAlonzo.Code.Ledger.Transaction.d_body_2628 (coe v2))))
                  (coe
                     ...
                     (coe
                        ...
                        (coe MAlonzo.Code.Class.DecEq.Instances.d_DecEq'45'Bool_16)
                        (coe
                           d_feesOK_2602 (coe v0) (coe v1) (coe d_pparams_1922 (coe v3))
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe MAlonzo.Code.Ledger.Transaction.d_tokenAlgebra_2208 (coe v0)))
                           (coe
                              du_consumed_2778 (coe v0) (coe d_pparams_1922 (coe v3)) (coe v4)
                              (coe MAlonzo.Code.Ledger.Transaction.d_body_2628 (coe v2)))
                           (coe
                              du_produced_2786 (coe v0) (coe d_pparams_1922 (coe v3)) (coe v4)
                              (coe MAlonzo.Code.Ledger.Transaction.d_body_2628 (coe v2))))
                        (coe
                           MAlonzo.Code.Class.Decidable.Instances.du_Dec'45''215'_24
                           (coe
...
d_'46'generalizedField'45'tx_159393 ::
  T_GeneralizeTel_159401 -> MAlonzo.Code.Ledger.Transaction.T_Tx_2618
d_'46'generalizedField'45'tx_159393 v0
  = case coe v0 of
      C_mkGeneralizeTel_159403 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxo..generalizedField-Γ
d_'46'generalizedField'45'Γ_159395 ::
  T_GeneralizeTel_159401 -> T_UTxOEnv_1912
d_'46'generalizedField'45'Γ_159395 v0
  = case coe v0 of
      C_mkGeneralizeTel_159403 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxo..generalizedField-s
d_'46'generalizedField'45's_159397 ::
  T_GeneralizeTel_159401 -> T_UTxOState_1926
d_'46'generalizedField'45's_159397 v0
  = case coe v0 of
      C_mkGeneralizeTel_159403 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxo..generalizedField-s'
d_'46'generalizedField'45's''_159399 ::
  T_GeneralizeTel_159401 -> T_UTxOState_1926
d_'46'generalizedField'45's''_159399 v0
  = case coe v0 of
      C_mkGeneralizeTel_159403 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxo.GeneralizeTel
d_GeneralizeTel_159401 a0 a1 = ()
data T_GeneralizeTel_159401
  = C_mkGeneralizeTel_159403 MAlonzo.Code.Ledger.Transaction.T_Tx_2618
