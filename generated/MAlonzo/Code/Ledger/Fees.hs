...
d__'8593'ℚ_1472 ~v0 v1 = du__'8593'ℚ_1472 v1
du__'8593'ℚ_1472 ::
  Integer -> MAlonzo.Code.Data.Rational.Base.T_ℚ_6
du__'8593'ℚ_1472 v0
  = coe
...
d_scriptsCost_1478 ~v0 v1 v2 = du_scriptsCost_1478 v1 v2
du_scriptsCost_1478 ::
  MAlonzo.Code.Ledger.PParams.T_PParams_244 -> Integer -> Integer
du_scriptsCost_1478 v0 v1
  = let v2
    ...
    coe
      (case coe v2 of
         ...
         _ -> let v3 = subInt (coe v2) (coe (1 :: Integer)) in
              coe
                (coe
                   du_scriptsCostAux_1578 (coe v0) (coe v3)
...
d_multiplier_1570 ~v0 v1 ~v2 ~v3 = du_multiplier_1570 v1
du_multiplier_1570 ::
  MAlonzo.Code.Ledger.PParams.T_PParams_244 ->
  MAlonzo.Code.Data.Rational.Base.T_ℚ_6
du_multiplier_1570 v0
  = coe
      MAlonzo.Code.Ledger.PParams.d_refScriptCostMultiplier_348 (coe v0)
-- Ledger.Fees._.sizeIncrement
d_sizeIncrement_1572 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.PParams.T_PParams_244 ->
  Integer -> Integer -> Integer
d_sizeIncrement_1572 ~v0 ~v1 v2 ~v3 = du_sizeIncrement_1572 v2
du_sizeIncrement_1572 :: Integer -> Integer
du_sizeIncrement_1572 v0 = coe addInt (coe (1 :: Integer)) (coe v0)
-- Ledger.Fees._.sizeIncrementRational
d_sizeIncrementRational_1574 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.PParams.T_PParams_244 ->
  Integer -> Integer -> MAlonzo.Code.Data.Rational.Base.T_ℚ_6
d_sizeIncrementRational_1574 ~v0 ~v1 v2 ~v3
  = du_sizeIncrementRational_1574 v2
du_sizeIncrementRational_1574 ::
  Integer -> MAlonzo.Code.Data.Rational.Base.T_ℚ_6
du_sizeIncrementRational_1574 v0
  = coe du__'8593'ℚ_1472 (coe du_sizeIncrement_1572 (coe v0))
...
d_scriptsCostAux_1578 ~v0 v1 v2 ~v3 v4 v5 v6 ~v7
  = du_scriptsCostAux_1578 v1 v2 v4 v5 v6
du_scriptsCostAux_1578 ::
  MAlonzo.Code.Ledger.PParams.T_PParams_244 ->
  Integer ->
  MAlonzo.Code.Data.Rational.Base.T_ℚ_6 ->
  MAlonzo.Code.Data.Rational.Base.T_ℚ_6 -> Integer -> Integer
du_scriptsCostAux_1578 v0 v1 v2 v3 v4
  = let v5
          = coe
              ...
              (coe
                 ...
                 (coe
                    ...
                    (coe du_sizeIncrement_1572 (coe v1)))) in
    coe
      (case coe v5 of
                          ...
                          (coe
                             ...
                             (coe
                                ...
                                (coe
                                   ...
                                   (coe du__'8593'ℚ_1472 (coe v4)) (coe v3)))))
                else coe
                       seq (coe v7)
                       (coe
                          du_scriptsCostAux_1578 (coe v0) (coe v1)
                          (coe
                             MAlonzo.Code.Data.Rational.Base.d__'43'__270 (coe v2)
                             (coe
                                MAlonzo.Code.Data.Rational.Base.d__'42'__276
                                (coe du_sizeIncrementRational_1574 (coe v1)) (coe v3)))
                          (coe
                             MAlonzo.Code.Data.Rational.Base.d__'42'__276
                             (coe du_multiplier_1570 (coe v0)) (coe v3))
                          (coe
                             MAlonzo.Code.Agda.Builtin.Nat.d__'45'__22 v4
                             (coe du_sizeIncrement_1572 (coe v1))))
         _ -> MAlonzo.RTE.mazUnreachableError)
-- Ledger.Fees._._.>′-trans
d_'62''8242''45'trans_1620 ::
  Integer ->
  Integer ->
  ...
  MAlonzo.Code.Data.Nat.Base.T__'8804''8242'__338 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804''8242'__338
d_'62''8242''45'trans_1620 ~v0 ~v1 ~v2 ~v3 ~v4 ~v5 ~v6 ~v7 ~v8 ~v9
                           ~v10 ~v11 v12 v13
  = du_'62''8242''45'trans_1620 v12 v13
du_'62''8242''45'trans_1620 ::
  MAlonzo.Code.Data.Nat.Base.T__'8804''8242'__338 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804''8242'__338 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804''8242'__338
du_'62''8242''45'trans_1620 v0 v1
  = case coe v0 of
      ...
      MAlonzo.Code.Data.Nat.Base.C_'8804''8242''45'step_348 v3
        -> coe
             ...
             (coe du_'62''8242''45'trans_1620 (coe v3) (coe v1))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Fees._._.suc∸≤′
d_suc'8760''8804''8242'_1640 ::
  Integer ->
  Integer ->
  (MAlonzo.Code.Data.Nat.Base.T__'8804'__22 ->
   MAlonzo.Code.Data.Irrelevant.T_Irrelevant_20) ->
  ...
  MAlonzo.Code.Data.Nat.Base.T__'8804''8242'__338 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804''8242'__338
d_suc'8760''8804''8242'_1640 ~v0 ~v1 ~v2 ~v3 ~v4 ~v5 ~v6 ~v7 ~v8
                             ~v9 v10 v11 v12
  = du_suc'8760''8804''8242'_1640 v10 v11 v12
du_suc'8760''8804''8242'_1640 ::
  Integer ->
  MAlonzo.Code.Data.Nat.Base.T__'8804''8242'__338 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804''8242'__338 ->
  MAlonzo.Code.Data.Nat.Base.T__'8804''8242'__338
du_suc'8760''8804''8242'_1640 v0 v1 v2
                 ...
                 MAlonzo.Code.Data.Nat.Base.C_'8804''8242''45'step_348 v5
                   -> case coe v2 of
                        ...
                        MAlonzo.Code.Data.Nat.Base.C_'8804''8242''45'step_348 v7
                          -> coe
                               MAlonzo.Code.Data.Nat.Base.C_'8804''8242''45'step_348
                               (coe du_suc'8760''8804''8242'_1640 (coe v3) (coe v5) (coe v7))
                        _ -> MAlonzo.RTE.mazUnreachableError
                   ...
                   MAlonzo.Code.Data.Nat.Base.C_'8804''8242''45'step_348 v6
                     -> case coe v2 of
                          ...
                          MAlonzo.Code.Data.Nat.Base.C_'8804''8242''45'step_348 v8
                            -> coe
                                 MAlonzo.Code.Data.Nat.Base.C_'8804''8242''45'step_348
                                 (coe du_suc'8760''8804''8242'_1640 (coe v3) (coe v6) (coe v8))
                          _ -> MAlonzo.RTE.mazUnreachableError
                   _ -> MAlonzo.RTE.mazUnreachableError
