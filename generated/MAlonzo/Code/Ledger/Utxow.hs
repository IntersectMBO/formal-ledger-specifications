...
d_txAD_2286 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1706 ->
  T_GeneralizeTel_34341 -> Maybe AgdaAny
d_txAD_2286 ~v0 ~v1 v2 = du_txAD_2286 v2
du_txAD_2286 :: T_GeneralizeTel_34341 -> Maybe AgdaAny
du_txAD_2286 v0
  = coe
      MAlonzo.Code.Ledger.Transaction.d_txAD_2632
      (coe d_'46'generalizedField'45'tx_34333 (coe v0))
-- Ledger.Utxow._.body
d_body_2288 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1706 ->
  T_GeneralizeTel_34341 ->
  MAlonzo.Code.Ledger.Transaction.T_TxBody_2514
...
d_refInputs_2300 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1706 ->
  T_GeneralizeTel_34341 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
...
du_txADhash_2306 :: T_GeneralizeTel_34341 -> Maybe AgdaAny
du_txADhash_2306 v0
  = coe
...
d_txid_2316 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1706 ->
  T_GeneralizeTel_34341 -> AgdaAny
d_txid_2316 ~v0 ~v1 v2 = du_txid_2316 v2
du_txid_2316 :: T_GeneralizeTel_34341 -> AgdaAny
du_txid_2316 v0
  = coe
...
d_scripts_2336 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1706 ->
  T_GeneralizeTel_34341 -> [MAlonzo.Code.Data.Sum.Base.T__'8846'__30]
...
du_utxo_2354 v0
  = coe
      ...
      (coe d_'46'generalizedField'45's_34335 (coe v0))
...
d_'46'generalizedField'45'tx_34333 ::
  T_GeneralizeTel_34341 -> MAlonzo.Code.Ledger.Transaction.T_Tx_2616
d_'46'generalizedField'45'tx_34333 v0
  = case coe v0 of
      C_mkGeneralizeTel_34343 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow..generalizedField-s
d_'46'generalizedField'45's_34335 ::
  T_GeneralizeTel_34341 -> MAlonzo.Code.Ledger.Utxo.T_UTxOState_1920
d_'46'generalizedField'45's_34335 v0
  = case coe v0 of
      C_mkGeneralizeTel_34343 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow..generalizedField-Γ
d_'46'generalizedField'45'Γ_34337 ::
  T_GeneralizeTel_34341 -> MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_1906
d_'46'generalizedField'45'Γ_34337 v0
  = case coe v0 of
      C_mkGeneralizeTel_34343 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow..generalizedField-s'
d_'46'generalizedField'45's''_34339 ::
  T_GeneralizeTel_34341 -> MAlonzo.Code.Ledger.Utxo.T_UTxOState_1920
d_'46'generalizedField'45's''_34339 v0
  = case coe v0 of
      C_mkGeneralizeTel_34343 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow.GeneralizeTel
d_GeneralizeTel_34341 a0 a1 = ()
data T_GeneralizeTel_34341
  = C_mkGeneralizeTel_34343 MAlonzo.Code.Ledger.Transaction.T_Tx_2616
                            MAlonzo.Code.Ledger.Utxo.T_UTxOState_1920
                            MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_1906
                            MAlonzo.Code.Ledger.Utxo.T_UTxOState_1920
