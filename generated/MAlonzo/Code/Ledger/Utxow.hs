...
d_UTxO_366 = erased
-- _.isBootstrapAddr
d_isBootstrapAddr_456 a0 a1 = ()
-- _.isBootstrapAddr?
d_isBootstrapAddr'63'_458 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  MAlonzo.Code.Class.Decidable.Core.T__'8263'_10
d_isBootstrapAddr'63'_458 ~v0 = du_isBootstrapAddr'63'_458
du_isBootstrapAddr'63'_458 ::
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30 ->
  MAlonzo.Code.Class.Decidable.Core.T__'8263'_10
du_isBootstrapAddr'63'_458
...
d_getDataHashes_1542 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1708 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> [AgdaAny]
d_getDataHashes_1542 ~v0 ~v1 = du_getDataHashes_1542
du_getDataHashes_1542 ::
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> [AgdaAny]
du_getDataHashes_1542
  = coe MAlonzo.Code.Ledger.Utxo.du_getDataHashes_1922
-- Ledger.Utxow._.getInputHashes
d_getInputHashes_1544 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1708 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2618 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> [AgdaAny]
d_getInputHashes_1544 v0 ~v1 = du_getInputHashes_1544 v0
du_getInputHashes_1544 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2618 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> [AgdaAny]
du_getInputHashes_1544 v0
...
d_slot_1626 :: MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2000 -> AgdaAny
d_slot_1626 v0 = coe MAlonzo.Code.Ledger.Utxo.d_slot_2008 (coe v0)
...
d_fees_1636 :: MAlonzo.Code.Ledger.Utxo.T_UTxOState_2014 -> Integer
d_fees_1636 v0 = coe MAlonzo.Code.Ledger.Utxo.d_fees_2026 (coe v0)
-- Ledger.Utxow._.UTxOState.utxo
d_utxo_1638 ::
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_2014 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_utxo_1638 v0 = coe MAlonzo.Code.Ledger.Utxo.d_utxo_2024 (coe v0)
...
du_Dec'45'UsesV3Features_2098 v0
  = case coe v0 of
      MAlonzo.Code.Ledger.Transaction.C_TxBody'46'constructor_17585 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17 v18 v19 v20
        -> case coe v9 of
             []
               -> case coe v10 of
                    []
    ...
    coe
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.Ledger.Utxo.du_outs_2044 (coe du_txb_2148 (coe v1))))
         (coe
            MAlonzo.Code.Class.IsSet.du_range_550
            (coe
               MAlonzo.Code.Axiom.Set.d_th_1470
      ...
      (coe
         ...
         (\ v3 ->
            coe
              ...
              (coe
                 MAlonzo.Code.Ledger.ScriptValidation.C_Spend_1720
                 (coe MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28 (coe v3)))
              (coe
      ...
      (coe
         ...
         (coe
            ...
            (\ v3 ->
               coe
                 MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                 (coe MAlonzo.Code.Ledger.ScriptValidation.C_Rwrd_1716 (coe v3))
               ...
               (\ v3 ->
                  coe
                    ...
                    (\ v4 ->
                       coe
                         MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                         (coe MAlonzo.Code.Ledger.ScriptValidation.C_Cert_1714 (coe v3))
                         (coe v4))
            ...
            (coe
               ...
               (coe
                  ...
                  (\ v3 ->
                     coe
                       MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                       (coe MAlonzo.Code.Ledger.ScriptValidation.C_Mint_1718 (coe v3))
               ...
               (coe
                  ...
                  (coe
                     ...
                     (\ v3 ->
                        coe
                          MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                          (coe MAlonzo.Code.Ledger.ScriptValidation.C_Vote_1722 (coe v3))
                          (coe MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe v3)))
                     (coe
                        MAlonzo.Code.Axiom.Set.du_fromList_428
                        (coe
                        ...
                        (coe
                           ...
                           () erased
                           (\ v3 ->
                              MAlonzo.Code.Ledger.GovernanceActions.d_voter_734 (coe v3))
                  ...
                  (coe
                     ...
                     (\ v3 ->
                        let v4
                              = MAlonzo.Code.Ledger.GovernanceActions.d_policy_758 (coe v3) in
                        coe
                          (case coe v4 of
                             MAlonzo.Code.Agda.Builtin.Maybe.C_just_16 v5
                               -> coe
                                    ...
                                    (coe
                                       MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                                       (coe
                                          MAlonzo.Code.Ledger.ScriptValidation.C_Propose_1724
                                          (coe v3))
...
newtype T__'8866'_'8640''10631'_'44'UTXOW'10632'__2278
  = C_UTXOW'45'inductive_2408 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
-- Ledger.Utxow._.txAD
d_txAD_2308 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1708 ->
...
du_txAD_2308 :: T_GeneralizeTel_34859 -> Maybe AgdaAny
du_txAD_2308 v0
  = coe
      MAlonzo.Code.Ledger.Transaction.d_txAD_2634
      (coe d_'46'generalizedField'45'tx_34851 (coe v0))
-- Ledger.Utxow._.body
d_body_2310 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1708 ->
...
du_txADhash_2328 :: T_GeneralizeTel_34859 -> Maybe AgdaAny
du_txADhash_2328 v0
  = coe
...
du_txid_2338 :: T_GeneralizeTel_34859 -> AgdaAny
du_txid_2338 v0
  = coe
...
d_UTXOW'45'inductive'45'premises_2434 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1708 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2618 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_2014 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_UTXOW'45'inductive'45'premises_2434 v0 ~v1 v2 v3
  = du_UTXOW'45'inductive'45'premises_2434 v0 v2 v3
du_UTXOW'45'inductive'45'premises_2434 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2618 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_2014 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_UTXOW'45'inductive'45'premises_2434 v0 v1 v2
  = coe
...
d_'46'generalizedField'45'tx_34851 ::
  T_GeneralizeTel_34859 -> MAlonzo.Code.Ledger.Transaction.T_Tx_2618
d_'46'generalizedField'45'tx_34851 v0
  = case coe v0 of
      C_mkGeneralizeTel_34861 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow..generalizedField-s
d_'46'generalizedField'45's_34853 ::
  T_GeneralizeTel_34859 -> MAlonzo.Code.Ledger.Utxo.T_UTxOState_2014
d_'46'generalizedField'45's_34853 v0
  = case coe v0 of
      C_mkGeneralizeTel_34861 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow..generalizedField-s'
d_'46'generalizedField'45's''_34855 ::
  T_GeneralizeTel_34859 -> MAlonzo.Code.Ledger.Utxo.T_UTxOState_2014
d_'46'generalizedField'45's''_34855 v0
  = case coe v0 of
      C_mkGeneralizeTel_34861 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxow..generalizedField-Γ
d_'46'generalizedField'45'Γ_34857 ::
  T_GeneralizeTel_34859 -> MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2000
d_'46'generalizedField'45'Γ_34857 v0
  = case coe v0 of
...
data T_GeneralizeTel_34859
  = C_mkGeneralizeTel_34861 MAlonzo.Code.Ledger.Transaction.T_Tx_2618
                            MAlonzo.Code.Ledger.Utxo.T_UTxOState_2014
                            MAlonzo.Code.Ledger.Utxo.T_UTxOState_2014
                            MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2000
