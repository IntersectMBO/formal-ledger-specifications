...
data T__'8866'_'8640''10631'_'44'LEDGER'10632'__2294
  = C_LEDGER'45'V_2342 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 |
    C_LEDGER'45'I_2344 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
-- Ledger.Ledger._.txcerts
d_txcerts_2316 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_GeneralizeTel_15359 -> [MAlonzo.Code.Ledger.Certs.T_DCert_832]
...
du_txcerts_2316 v0
  = coe
      ...
      (coe
         ...
         (coe d_'46'generalizedField'45'tx_15335 (coe v0)))
-- Ledger.Ledger._.txid
d_txid_2322 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_GeneralizeTel_15359 -> AgdaAny
d_txid_2322 ~v0 ~v1 v2 = du_txid_2322 v2
du_txid_2322 :: T_GeneralizeTel_15359 -> AgdaAny
du_txid_2322 v0
  = coe
...
d_txwdrls_2338 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_GeneralizeTel_15359 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d__'8866'_'8640''10631'_'44'LEDGERS'10632'__2362 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1716 ->
  T_LEnv_2140 ->
  T_LState_2162 ->
  [MAlonzo.Code.Ledger.Transaction.T_Tx_2622] -> T_LState_2162 -> ()
d__'8866'_'8640''10631'_'44'LEDGERS'10632'__2362 = erased
-- Ledger.Ledger..generalizedField-tx
d_'46'generalizedField'45'tx_15335 ::
  T_GeneralizeTel_15359 -> MAlonzo.Code.Ledger.Transaction.T_Tx_2622
d_'46'generalizedField'45'tx_15335 v0
  = case coe v0 of
      C_mkGeneralizeTel_15361 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Ledger..generalizedField-certState
d_'46'generalizedField'45'certState_15337 ::
  T_GeneralizeTel_15359 -> MAlonzo.Code.Ledger.Certs.T_CertState_928
d_'46'generalizedField'45'certState_15337 v0
  = case coe v0 of
      C_mkGeneralizeTel_15361 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Ledger..generalizedField-slot
d_'46'generalizedField'45'slot_15339 ::
  T_GeneralizeTel_15359 -> AgdaAny
d_'46'generalizedField'45'slot_15339 v0
  = case coe v0 of
      C_mkGeneralizeTel_15361 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Ledger..generalizedField-pp
d_'46'generalizedField'45'pp_15341 ::
  T_GeneralizeTel_15359 -> MAlonzo.Code.Ledger.PParams.T_PParams_244
d_'46'generalizedField'45'pp_15341 v0
  = case coe v0 of
      C_mkGeneralizeTel_15361 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Ledger..generalizedField-treasury
d_'46'generalizedField'45'treasury_15343 ::
  T_GeneralizeTel_15359 -> Integer
d_'46'generalizedField'45'treasury_15343 v0
  = case coe v0 of
      C_mkGeneralizeTel_15361 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Ledger..generalizedField-utxoSt
d_'46'generalizedField'45'utxoSt_15345 ::
  T_GeneralizeTel_15359 -> MAlonzo.Code.Ledger.Utxo.T_UTxOState_2016
d_'46'generalizedField'45'utxoSt_15345 v0
  = case coe v0 of
      C_mkGeneralizeTel_15361 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Ledger..generalizedField-utxoSt'
d_'46'generalizedField'45'utxoSt''_15347 ::
  T_GeneralizeTel_15359 -> MAlonzo.Code.Ledger.Utxo.T_UTxOState_2016
d_'46'generalizedField'45'utxoSt''_15347 v0
  = case coe v0 of
      C_mkGeneralizeTel_15361 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Ledger..generalizedField-govSt
d_'46'generalizedField'45'govSt_15349 ::
  T_GeneralizeTel_15359 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
d_'46'generalizedField'45'govSt_15349 v0
  = case coe v0 of
      C_mkGeneralizeTel_15361 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Ledger..generalizedField-enactState
d_'46'generalizedField'45'enactState_15351 ::
  T_GeneralizeTel_15359 -> MAlonzo.Code.Ledger.Enact.T_EnactState_826
d_'46'generalizedField'45'enactState_15351 v0
  = case coe v0 of
      C_mkGeneralizeTel_15361 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v9
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Ledger..generalizedField-certState'
d_'46'generalizedField'45'certState''_15353 ::
  T_GeneralizeTel_15359 -> MAlonzo.Code.Ledger.Certs.T_CertState_928
d_'46'generalizedField'45'certState''_15353 v0
  = case coe v0 of
      C_mkGeneralizeTel_15361 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v10
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Ledger..generalizedField-ppolicy
d_'46'generalizedField'45'ppolicy_15355 ::
  T_GeneralizeTel_15359 -> Maybe AgdaAny
d_'46'generalizedField'45'ppolicy_15355 v0
  = case coe v0 of
      C_mkGeneralizeTel_15361 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v11
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Ledger..generalizedField-govSt'
d_'46'generalizedField'45'govSt''_15357 ::
  T_GeneralizeTel_15359 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
d_'46'generalizedField'45'govSt''_15357 v0
  = case coe v0 of
      C_mkGeneralizeTel_15361 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12
        -> coe v12
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Ledger.GeneralizeTel
d_GeneralizeTel_15359 a0 a1 = ()
data T_GeneralizeTel_15359
  = C_mkGeneralizeTel_15361 MAlonzo.Code.Ledger.Transaction.T_Tx_2622
