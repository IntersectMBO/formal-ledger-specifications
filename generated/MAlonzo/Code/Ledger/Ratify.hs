...
d_epoch_1672 :: MAlonzo.Code.Ledger.Enact.T_EnactEnv_814 -> AgdaAny
d_epoch_1672 v0
...
d_gid_1674 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_gid_1674 v0 = coe MAlonzo.Code.Ledger.Enact.d_gid_822 (coe v0)
...
d_cc_1680 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_cc_1680 v0 = coe MAlonzo.Code.Ledger.Enact.d_cc_842 (coe v0)
...
d_pv_1686 ::
  MAlonzo.Code.Ledger.Enact.T_EnactState_830 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_pv_1686 v0 = coe MAlonzo.Code.Ledger.Enact.d_pv_846 (coe v0)
...
du___1704 :: MAlonzo.Code.Algebra.Bundles.T_CommutativeMonoid_962
du___1704
  = coe
...
du_maxThreshold_1734 v0
  = coe
      MAlonzo.Code.Data.List.Base.du_foldl_230 (coe du_comb_1742)
...
newtype T_StakeDistrs_1884
  = C_StakeDistrs'46'constructor_11247 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
-- Ledger.Ratify.StakeDistrs.stakeDistr
d_stakeDistr_1888 ::
  T_StakeDistrs_1884 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_stakeDistr_1888 v0
  = case coe v0 of
      C_StakeDistrs'46'constructor_11247 v1 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Ratify.RatifyEnv
d_RatifyEnv_1890 a0 = ()
data T_RatifyEnv_1890
  = C_RatifyEnv'46'constructor_11333 T_StakeDistrs_1884 AgdaAny
                                     MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_stakeDistrs_1902 v0
  = case coe v0 of
      C_RatifyEnv'46'constructor_11333 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Ratify.RatifyEnv.currentEpoch
d_currentEpoch_1904 :: T_RatifyEnv_1890 -> AgdaAny
d_currentEpoch_1904 v0
  = case coe v0 of
      C_RatifyEnv'46'constructor_11333 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_dreps_1906 v0
  = case coe v0 of
      C_RatifyEnv'46'constructor_11333 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_ccHotKeys_1908 v0
  = case coe v0 of
      C_RatifyEnv'46'constructor_11333 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Ratify.RatifyEnv.treasury
d_treasury_1910 :: T_RatifyEnv_1890 -> Integer
d_treasury_1910 v0
  = case coe v0 of
      C_RatifyEnv'46'constructor_11333 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_ccHotKeys_2410 ::
  T_RatifyEnv_1890 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_ccHotKeys_2410 v0 = coe d_ccHotKeys_1908 (coe v0)
...
du_currentEpoch_2412 :: T_RatifyEnv_1890 -> AgdaAny
du_currentEpoch_2412 v0 = coe d_currentEpoch_1904 (coe v0)
...
du_dreps_2414 ::
  T_RatifyEnv_1890 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_dreps_2414 v0 = coe d_dreps_1906 (coe v0)
...
du_stakeDistrs_2416 :: T_RatifyEnv_1890 -> T_StakeDistrs_1884
du_stakeDistrs_2416 v0 = coe d_stakeDistrs_1902 (coe v0)
...
du_treasury_2418 :: T_RatifyEnv_1890 -> Integer
du_treasury_2418 v0 = coe d_treasury_1910 (coe v0)
-- Ledger.Ratify.verifyPrev?
...
du_ccHotKeys_2586 ::
  T_RatifyEnv_1890 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_ccHotKeys_2586 v0 = coe d_ccHotKeys_1908 (coe v0)
-- Ledger.Ratify._.currentEpoch
d_currentEpoch_2588 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_RatifyEnv_1890 ->
...
du_currentEpoch_2588 :: T_RatifyEnv_1890 -> AgdaAny
du_currentEpoch_2588 v0 = coe d_currentEpoch_1904 (coe v0)
-- Ledger.Ratify._.dreps
d_dreps_2590 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_RatifyEnv_1890 ->
...
du_dreps_2590 ::
  T_RatifyEnv_1890 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_dreps_2590 v0 = coe d_dreps_1906 (coe v0)
-- Ledger.Ratify._.stakeDistrs
d_stakeDistrs_2592 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_RatifyEnv_1890 ->
...
du_stakeDistrs_2592 :: T_RatifyEnv_1890 -> T_StakeDistrs_1884
du_stakeDistrs_2592 v0 = coe d_stakeDistrs_1902 (coe v0)
-- Ledger.Ratify._.treasury
d_treasury_2594 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_RatifyEnv_1890 ->
...
du_treasury_2594 :: T_RatifyEnv_1890 -> Integer
du_treasury_2594 v0 = coe d_treasury_1910 (coe v0)
...
du_ccHotKeys_2624 ::
  T_RatifyEnv_1890 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_ccHotKeys_2624 v0 = coe d_ccHotKeys_1908 (coe v0)
-- Ledger.Ratify._.currentEpoch
d_currentEpoch_2626 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_RatifyEnv_1890 ->
...
du_currentEpoch_2626 :: T_RatifyEnv_1890 -> AgdaAny
du_currentEpoch_2626 v0 = coe d_currentEpoch_1904 (coe v0)
-- Ledger.Ratify._.dreps
d_dreps_2628 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_RatifyEnv_1890 ->
...
du_dreps_2628 ::
  T_RatifyEnv_1890 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_dreps_2628 v0 = coe d_dreps_1906 (coe v0)
-- Ledger.Ratify._.stakeDistrs
d_stakeDistrs_2630 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_RatifyEnv_1890 ->
...
du_stakeDistrs_2630 :: T_RatifyEnv_1890 -> T_StakeDistrs_1884
du_stakeDistrs_2630 v0 = coe d_stakeDistrs_1902 (coe v0)
-- Ledger.Ratify._.treasury
d_treasury_2632 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_RatifyEnv_1890 ->
...
du_treasury_2632 :: T_RatifyEnv_1890 -> Integer
du_treasury_2632 v0 = coe d_treasury_1910 (coe v0)
-- Ledger.Ratify._.ccHotKeys
d_ccHotKeys_2650 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_RatifyEnv_1890 ->
...
du_ccHotKeys_2650 ::
  T_RatifyEnv_1890 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_ccHotKeys_2650 v0 = coe d_ccHotKeys_1908 (coe v0)
-- Ledger.Ratify._.currentEpoch
d_currentEpoch_2652 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_RatifyEnv_1890 ->
...
du_currentEpoch_2652 :: T_RatifyEnv_1890 -> AgdaAny
du_currentEpoch_2652 v0 = coe d_currentEpoch_1904 (coe v0)
-- Ledger.Ratify._.dreps
d_dreps_2654 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_RatifyEnv_1890 ->
...
du_dreps_2654 ::
  T_RatifyEnv_1890 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_dreps_2654 v0 = coe d_dreps_1906 (coe v0)
-- Ledger.Ratify._.stakeDistrs
d_stakeDistrs_2656 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_RatifyEnv_1890 ->
...
du_stakeDistrs_2656 :: T_RatifyEnv_1890 -> T_StakeDistrs_1884
du_stakeDistrs_2656 v0 = coe d_stakeDistrs_1902 (coe v0)
-- Ledger.Ratify._.treasury
d_treasury_2658 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_RatifyEnv_1890 ->
...
du_treasury_2658 :: T_RatifyEnv_1890 -> Integer
du_treasury_2658 v0 = coe d_treasury_1910 (coe v0)
-- Ledger.Ratify._⊢_⇀⦇_,RATIFY⦈_
