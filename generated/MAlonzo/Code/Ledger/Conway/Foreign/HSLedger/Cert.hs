...
d_epoch_198 :: MAlonzo.Code.Ledger.Certs.T_CertEnv_868 -> Integer
d_epoch_198 v0 = coe MAlonzo.Code.Ledger.Certs.d_epoch_880 (coe v0)
...
d_votes_202 v0 = coe MAlonzo.Code.Ledger.Certs.d_votes_884 (coe v0)
-- Ledger.Conway.Foreign.HSLedger.Cert._.CertEnv.wdrls
d_wdrls_204 ::
  MAlonzo.Code.Ledger.Certs.T_CertEnv_868 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_wdrls_204 v0 = coe MAlonzo.Code.Ledger.Certs.d_wdrls_886 (coe v0)
...
d_HsTy'45'CertState_278 ::
  MAlonzo.Code.Foreign.HaskellTypes.T_HasHsType_14
d_HsTy'45'CertState_278 = erased
-- Ledger.Conway.Foreign.HSLedger.Cert.Conv-CertState
d_Conv'45'CertState_280 ::
...
certsStep ::
  ...
  MAlonzo.Code.Ledger.Conway.Foreign.HSTypes.T_ComputationResult_46
    MAlonzo.Code.Agda.Builtin.String.T_String_6 T_CertState_315
certsStep = coe d_certs'45'step_282
d_certs'45'step_282 ::
  MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Certs.T_CertEnv_4789 ->
  T_CertState_315 ->
  [MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Certs.T_DCert_13051] ->
  MAlonzo.Code.Ledger.Conway.Foreign.HSTypes.T_ComputationResult_46
    MAlonzo.Code.Agda.Builtin.String.T_String_6 T_CertState_315
d_certs'45'step_282 v0
  = coe
      MAlonzo.Code.Foreign.Convertible.d_to_18
      (coe
         MAlonzo.Code.Foreign.Convertible.du_Convertible'45'Fun_130
         (coe d_Conv'45'CertState_280)
         (coe
            MAlonzo.Code.Foreign.Convertible.du_Convertible'45'Fun_130
            (coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.Ledger.Conway.Conformance.Certs.Properties.d_Computational'45'CERTS_2204
            (coe
               MAlonzo.Code.Ledger.Transaction.d_govStructure_2322
               (coe
                  MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.ExternalStructures.d_HSTransactionStructure_656
...
certStep ::
  ...
  MAlonzo.Code.Ledger.Conway.Foreign.HSTypes.T_ComputationResult_46
    MAlonzo.Code.Agda.Builtin.String.T_String_6 T_CertState_315
certStep = coe d_cert'45'step_284
d_cert'45'step_284 ::
  MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Certs.T_CertEnv_4789 ->
  T_CertState_315 ->
  MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Certs.T_DCert_13051 ->
...
d_CertState_315 = ()
type T_CertState_315 = CertState
pattern C_MkCertState_317 a0 a1 a2 = MkCertState a0 a1 a2
check_MkCertState_317 ::
  ...
  T_CertState_315
check_MkCertState_317 = MkCertState
cover_CertState_315 :: CertState -> ()
cover_CertState_315 x
  = case x of
      MkCertState _ _ _ -> ()
