...
d_HsTy'45'UTxOEnv_156 ::
  MAlonzo.Code.Foreign.HaskellTypes.T_HasHsType_14
d_HsTy'45'UTxOEnv_156 = erased
-- Ledger.Conway.Foreign.HSLedger.Utxo.Conv-UTxOEnv
d_Conv'45'UTxOEnv_158 ::
...
d_Conv'45'UTxOEnv_158
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Conformance.Utxo.C_UTxOEnv'46'constructor_10369 v1 v2 v3
                -> coe
...
d_HsTy'45'UTxOState_160 ::
  MAlonzo.Code.Foreign.HaskellTypes.T_HasHsType_14
d_HsTy'45'UTxOState_160 = erased
-- Ledger.Conway.Foreign.HSLedger.Utxo.Conv-UTxOState
d_Conv'45'UTxOState_162 ::
  MAlonzo.Code.Foreign.Convertible.T_Convertible_8
d_Conv'45'UTxOState_162
  = coe
      MAlonzo.Code.Foreign.Convertible.C_Convertible'46'constructor_21
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Conway.Conformance.Utxo.C_'10214'_'44'_'44'_'44'_'10215''7512'_2046 v1 v2 v3 v4
                -> coe
                     C_MkUTxOState_1151
                     (coe
...
utxoStep = coe d_utxo'45'step_1864
d_utxo'45'step_1864 ::
  MAlonzo.Code.Ledger.Conway.Foreign.ExternalFunctions.T_ExternalFunctions_8 ->
  T_UTxOEnv_159 ->
  T_UTxOState_1149 ->
  ...
  MAlonzo.Code.Ledger.Conway.Foreign.HSTypes.T_ComputationResult_46
    MAlonzo.Code.Agda.Builtin.String.T_String_6 T_UTxOState_1149
d_utxo'45'step_1864 v0 v1
  = coe
      MAlonzo.Code.Foreign.Convertible.d_to_18
      (coe
         MAlonzo.Code.Foreign.Convertible.du_Convertible'45'Fun_130
         (coe d_Conv'45'UTxOState_162)
         (coe
            MAlonzo.Code.Foreign.Convertible.du_Convertible'45'Fun_130
            (coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.Ledger.Conway.Conformance.Utxo.Properties.d_Computational'45'UTXO_2164
               (coe
                  MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Core.d_HSTransactionStructure_894
                  (coe v0))
               (coe
         ...
         (coe
            MAlonzo.Code.Foreign.Convertible.d_from_20 d_Conv'45'UTxOEnv_158
            v1))
...
utxowStep ::
  ...
  MAlonzo.Code.Ledger.Conway.Foreign.HSTypes.T_ComputationResult_46
    MAlonzo.Code.Agda.Builtin.String.T_String_6 T_UTxOState_1149
utxowStep = coe d_utxow'45'step_1866
d_utxow'45'step_1866 ::
  MAlonzo.Code.Ledger.Conway.Foreign.ExternalFunctions.T_ExternalFunctions_8 ->
  T_UTxOEnv_159 ->
  T_UTxOState_1149 ->
  MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Transaction.T_Tx_112835 ->
...
utxoDebug = coe d_utxo'45'debug_1868
d_utxo'45'debug_1868 ::
  MAlonzo.Code.Ledger.Conway.Foreign.ExternalFunctions.T_ExternalFunctions_8 ->
  T_UTxOEnv_159 ->
  T_UTxOState_1149 ->
  MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Transaction.T_Tx_112835 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_utxo'45'debug_1868 ~v0 v1 v2 v3 = du_utxo'45'debug_1868 v1 v2 v3
du_utxo'45'debug_1868 ::
  T_UTxOEnv_159 ->
  T_UTxOState_1149 ->
  MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Transaction.T_Tx_112835 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
du_utxo'45'debug_1868 v0 v1 v2
  = coe
         ...
         (coe
            ...
            (coe
               ...
               (coe
                  ...
                  (coe
                     MAlonzo.Code.Ledger.Conway.Conformance.Utxo.du_balance_2160
                     (coe
                        MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Core.d_HSTransactionStructure_894
                        (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              MAlonzo.Code.Foreign.Convertible.d_from_20 d_Conv'45'UTxOState_162
                              v1))
                        (coe
                        ...
                        (let v3
                         ...
                         coe
                           (coe
                              ...
                              (MAlonzo.Code.Ledger.Transaction.d_tokenAlgebra_2300 (coe v3))
                              (coe
                                 MAlonzo.Code.Ledger.Conway.Conformance.Utxo.du_depositRefunds_2682
                                 (coe
                                    MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Core.d_HSTransactionStructure_894
                                    (coe
                                       MAlonzo.Code.Ledger.Conway.Foreign.ExternalFunctions.d_dummyExternalFunctions_14))
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          (\ v4 ->
                                             case coe v4 of
                                               MAlonzo.Code.Ledger.Conway.Conformance.Utxo.C_'10214'_'44'_'44'_'44'_'10215''7512'_2046 v5 v6 v7 v8
                                                 -> coe
                                                      C_MkUTxOState_1151
                                                      (coe
                                                         MAlonzo.Code.Ledger.Conway.Foreign.HSTypes.C_MkHSMap_28
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          (\ v3 ->
                                             case coe v3 of
                                               MAlonzo.Code.Ledger.Conway.Conformance.Utxo.C_'10214'_'44'_'44'_'44'_'10215''7512'_2046 v4 v5 v6 v7
                                                 -> coe
                                                      C_MkUTxOState_1151
                                                      (coe
                                                         MAlonzo.Code.Ledger.Conway.Foreign.HSTypes.C_MkHSMap_28
                                           ...
                                           coe
                                             (coe
                                                ...
                                                (MAlonzo.Code.Ledger.Transaction.d_tokenAlgebra_2300
                                                   (coe v3))
                                                (coe
                                                   MAlonzo.Code.Ledger.Conway.Conformance.Utxo.du_newDeposits_2690
                                                   (coe
                                                      MAlonzo.Code.Ledger.Conway.Foreign.HSLedger.Core.d_HSTransactionStructure_894
                                                      (coe
                                                         MAlonzo.Code.Ledger.Conway.Foreign.ExternalFunctions.d_dummyExternalFunctions_14))
