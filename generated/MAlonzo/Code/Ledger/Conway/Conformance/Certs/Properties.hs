...
d_Computational'45'DELEG_1090 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'DELEG_1090 v0
  = coe
...
d_Computational'45'POOL_1194 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'POOL_1194 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (\ v1 v2 v3 ->
         let v4
...
d_Computational'45'GOVCERT_1220 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'GOVCERT_1220 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (\ v1 ->
         case coe v1 of
...
d_Computational'45'CERT_1448 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'CERT_1448 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (\ v1 ->
         case coe v1 of
                         ...
                         -> coe
                              (\ v11 ->
                                 let v12
                                       = coe
                                           MAlonzo.Code.Interface.ComputationalRelation.d_computeProof_272
                                           (d_Computational'45'POOL_1194 (coe v0)) v3 v9 v11 in
                                 coe
                                   (let v13
                                          = coe
                                              MAlonzo.Code.Interface.ComputationalRelation.d_computeProof_272
                                              (d_Computational'45'GOVCERT_1220 (coe v0)) v1 v10
                                              v11 in
                                    coe
...
d_Computational'45'CERTBASE_1882 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'CERTBASE_1882 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (\ v1 ->
         case coe v1 of
           MAlonzo.Code.Ledger.Certs.C_'10214'_'44'_'44'_'44'_'44'_'10215''7580'_890 v2 v3 v4 v5 v6
             -> coe
                  (\ v7 v8 ->
                     coe
                       du_goal_2008 (coe v0) (coe v2) (coe v3) (coe v4) (coe v5) (coe v6)
                       (coe v7))
           _ -> MAlonzo.RTE.mazUnreachableError)
...
d_rewards_1988 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_rewards_1988 ~v0 ~v1 ~v2 ~v3 ~v4 ~v5 v6 ~v7 = du_rewards_1988 v6
du_rewards_1988 ::
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1072 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_rewards_1988 v0
...
d_voteDelegs_1992 ::
  ...
  MAlonzo.Code.Agda.Builtin.Unit.T_'8868'_6 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_voteDelegs_1992 ~v0 ~v1 ~v2 ~v3 ~v4 ~v5 v6 ~v7
  = du_voteDelegs_1992 v6
du_voteDelegs_1992 ::
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1072 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_voteDelegs_1992 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Certs.d_voteDelegs_1046
      (coe
         MAlonzo.Code.Ledger.Conway.Conformance.Certs.d_dState_1080
...
d_sep_1994 ~v0 ~v1 ~v2 ~v3 ~v4 ~v5 ~v6 ~v7 = du_sep_1994
du_sep_1994 :: MAlonzo.Code.Agda.Builtin.String.T_String_6
du_sep_1994 = coe (" | " :: Data.Text.Text)
...
d_genErr_1998 ::
  ...
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_genErr_1998 v0 ~v1 ~v2 ~v3 v4 ~v5 v6 ~v7 ~v8
  = du_genErr_1998 v0 v4 v6
du_genErr_1998 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1072 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
du_genErr_1998 v0 v1 v2
  = let v3
          = coe
              MAlonzo.Code.Ledger.Prelude.du_dec'45'de'45'morgan_8
              (coe
...
d_goal_2008 ::
  ...
  MAlonzo.Code.Agda.Builtin.Unit.T_'8868'_6 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_goal_2008 v0 v1 v2 v3 v4 v5 v6 ~v7
  = du_goal_2008 v0 v1 v2 v3 v4 v5 v6
du_goal_2008 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 ->
  AgdaAny ->
  MAlonzo.Code.Ledger.PParams.T_PParams_242 ->
         ...
         MAlonzo.Code.Relation.Nullary.Decidable.Core.C__because__32 v8 v9
           -> if coe v8
                then case coe v9 of
                                          ...
                                          (coe
                                             ...
                                             (let v12
                                                    = coe
                                                        ...
                                                        (let v12
                                                               = coe
                                                                   MAlonzo.Code.Ledger.Conway.Conformance.Certs.C_mkGeneralizeTel_42165
                                                         ...
                                                         coe
                                                           (MAlonzo.Code.Ledger.PParams.d_drepActivity_374
                                                              (coe
                                                                 MAlonzo.Code.Ledger.Conway.Conformance.Certs.d_'46'generalizedField'45'pp_42137
                                                                 (coe v12)))) in
                                              coe (coe (\ v13 -> v12)))
                                             (coe
                                                MAlonzo.Code.Ledger.Conway.Conformance.Certs.d_dreps_1064
                       ...
                       (coe
                          MAlonzo.Code.Interface.ComputationalRelation.C_failure_44
                          (coe du_genErr_1998 (coe v0) (coe v4) (coe v6)))
         _ -> MAlonzo.RTE.mazUnreachableError)
-- Ledger.Conway.Conformance.Certs.Properties.Computational-CERTS
d_Computational'45'CERTS_2046 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'CERTS_2046 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.du_Computational'45'ReflexiveTransitiveClosure'7495'''_1138
      (coe d_Computational'45'CERTBASE_1882 (coe v0))
      (coe d_Computational'45'CERT_1448 (coe v0))
      (coe
