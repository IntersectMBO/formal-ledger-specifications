         ...
         coe
           ...
           (coe
              ...
              (coe
                 ...
                 (coe
                    MAlonzo.Code.Ledger.Conway.Conformance.Epoch.Properties.du_NEWEPOCH'45'total_2208
                    (coe v0)
                    (coe
                       MAlonzo.Code.Ledger.Types.Epoch.d_epoch_68
                       (MAlonzo.Code.Ledger.Transaction.d_epochStructure_1532 (coe v0))
                       (MAlonzo.Code.Ledger.Conway.Conformance.Chain.d_slot_2362
                          (coe v4)))
                    (coe
                  ...
                  -> coe
                       ...
                       (coe
                          ...
                          (coe
                             ...
                             (coe
                                MAlonzo.Code.Ledger.Conway.Conformance.Chain.d_slot_2362 (coe v4))
                             (coe
                          ...
                          (MAlonzo.Code.Ledger.Conway.Conformance.Epoch.d_ls_2422
                             (coe
                                MAlonzo.Code.Ledger.Conway.Conformance.Epoch.d_epochState_2440
                                (coe v6)))
                          (MAlonzo.Code.Ledger.Conway.Conformance.Chain.d_ts_2360 (coe v4)))
                       (\ v8 ->
                          case coe v8 of
                                         ...
                                         (coe
                                            ...
                                            (coe
                                               ...
                                               (coe
                                                  ...
                                                  (let v11
                                                         = coe
                                                             MAlonzo.Code.Ledger.Conway.Conformance.Chain.C_mkGeneralizeTel_41847
                                                             (coe v3) (coe v4) (coe v6) (coe v9) in
                                                   coe
                                                     (coe
                                                        MAlonzo.Code.Ledger.Conway.Conformance.Epoch.d_epochState_2440
                                                        (coe
                                                           MAlonzo.Code.Ledger.Conway.Conformance.Chain.d_'46'generalizedField'45'nes_41841
                                                           (coe v11)))))
                                               (coe
                                                   ...
                                                   coe
                                                     (coe
                                                        ...
                                                        (coe
                                                           ...
                                                           (coe v11))))))
                                            (coe
                                               MAlonzo.Code.Ledger.Conway.Conformance.Epoch.d_ru_2442
                                               (coe v6))))
                                      (coe
                                         MAlonzo.Code.Ledger.Conway.Conformance.Chain.C_CHAIN_2612
                                         v6 v7 v10))
