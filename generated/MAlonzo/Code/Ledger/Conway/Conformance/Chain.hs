...
d_slot_1590 :: MAlonzo.Code.Ledger.Ledger.T_LEnv_2132 -> AgdaAny
d_slot_1590 v0
...
d_ChainState_2314 a0 a1 = ()
newtype T_ChainState_2314
  = C_ChainState'46'constructor_4363 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2322
-- Ledger.Conway.Conformance.Chain.ChainState.newEpochState
d_newEpochState_2318 ::
  T_ChainState_2314 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2322
d_newEpochState_2318 v0
  = case coe v0 of
      C_ChainState'46'constructor_4363 v1 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.Block
d_Block_2320 a0 a1 = ()
data T_Block_2320
  = C_Block'46'constructor_4421 [MAlonzo.Code.Ledger.Transaction.T_Tx_2624]
                                AgdaAny
-- Ledger.Conway.Conformance.Chain.Block.ts
d_ts_2326 ::
  T_Block_2320 -> [MAlonzo.Code.Ledger.Transaction.T_Tx_2624]
d_ts_2326 v0
  = case coe v0 of
      C_Block'46'constructor_4421 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.Block.slot
d_slot_2328 :: T_Block_2320 -> AgdaAny
d_slot_2328 v0
  = case coe v0 of
      C_Block'46'constructor_4421 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_maybePurpose_2340 v0 ~v1 v2 v3 v4
  = du_maybePurpose_2340 v0 v2 v3 v4
du_maybePurpose_2340 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Certs.T_DepositPurpose_812 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Integer -> Maybe Integer
du_maybePurpose_2340 v0 v1 v2 v3
  = case coe v2 of
...
d_maybePurpose'45'prop_2372 = erased
-- Ledger.Conway.Conformance.Chain.filterPurpose
d_filterPurpose_2414 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
  MAlonzo.Code.Ledger.Certs.T_DepositPurpose_812 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_filterPurpose_2414 v0 ~v1 v2 v3 = du_filterPurpose_2414 v0 v2 v3
du_filterPurpose_2414 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Certs.T_DepositPurpose_812 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_filterPurpose_2414 v0 v1 v2
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.QabstractZ45ZsetZ45Ztheory.FiniteSetTheory.d_List'45'Model'7496'_8))
         (coe du_maybePurpose_2340 (coe v0) (coe v1)) (coe v2))
-- Ledger.Conway.Conformance.Chain.govActionDeposits
d_govActionDeposits_2428 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2180 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_govActionDeposits_2428 v0 ~v1 v2
  = du_govActionDeposits_2428 v0 v2
du_govActionDeposits_2428 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2180 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_govActionDeposits_2428 v0 v1
  = coe
...
d_calculateStakeDistrs_2484 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2180 ->
  MAlonzo.Code.Ledger.Ratify.T_StakeDistrs_1952
d_calculateStakeDistrs_2484 v0 ~v1 v2
  = du_calculateStakeDistrs_2484 v0 v2
du_calculateStakeDistrs_2484 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2180 ->
  MAlonzo.Code.Ledger.Ratify.T_StakeDistrs_1952
du_calculateStakeDistrs_2484 v0 v1
  = coe
      MAlonzo.Code.Ledger.Ratify.C_StakeDistrs'46'constructor_11367
      (coe du_govActionDeposits_2428 (coe v0) (coe v1))
-- Ledger.Conway.Conformance.Chain._⊢_⇀⦇_,CHAIN⦈_
d__'8866'_'8640''10631'_'44'CHAIN'10632'__2534 a0 a1 a2 a3 a4 a5
  = ()
data T__'8866'_'8640''10631'_'44'CHAIN'10632'__2534
  = C_CHAIN_2578 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2322
...
d_newEpochState_2538 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
  T_GeneralizeTel_41429 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2322
d_newEpochState_2538 ~v0 ~v1 v2 = du_newEpochState_2538 v2
du_newEpochState_2538 ::
  T_GeneralizeTel_41429 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2322
du_newEpochState_2538 v0
  = coe
      d_newEpochState_2318
      (coe d_'46'generalizedField'45's_41421 (coe v0))
-- Ledger.Conway.Conformance.Chain._.slot
d_slot_2542 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
  T_GeneralizeTel_41429 -> AgdaAny
d_slot_2542 ~v0 ~v1 v2 = du_slot_2542 v2
du_slot_2542 :: T_GeneralizeTel_41429 -> AgdaAny
du_slot_2542 v0
  = coe d_slot_2328 (coe d_'46'generalizedField'45'b_41423 (coe v0))
...
d_ts_2544 ::
  ...
  T_GeneralizeTel_41429 ->
  [MAlonzo.Code.Ledger.Transaction.T_Tx_2624]
d_ts_2544 ~v0 ~v1 v2 = du_ts_2544 v2
du_ts_2544 ::
  T_GeneralizeTel_41429 ->
  [MAlonzo.Code.Ledger.Transaction.T_Tx_2624]
du_ts_2544 v0
  = coe d_ts_2326 (coe d_'46'generalizedField'45'b_41423 (coe v0))
...
d_epochState_2548 ::
  ...
  T_GeneralizeTel_41429 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_EpochState_2298
d_epochState_2548 ~v0 ~v1 v2 = du_epochState_2548 v2
du_epochState_2548 ::
  T_GeneralizeTel_41429 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_EpochState_2298
du_epochState_2548 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Epoch.d_epochState_2332
      (coe d_'46'generalizedField'45'nes_41425 (coe v0))
-- Ledger.Conway.Conformance.Chain._.acnt
d_acnt_2556 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
  T_GeneralizeTel_41429 -> MAlonzo.Code.Ledger.PParams.T_Acnt_146
d_acnt_2556 ~v0 ~v1 v2 = du_acnt_2556 v2
du_acnt_2556 ::
  T_GeneralizeTel_41429 -> MAlonzo.Code.Ledger.PParams.T_Acnt_146
du_acnt_2556 v0
  = coe
...
d_es_2558 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
  T_GeneralizeTel_41429 -> MAlonzo.Code.Ledger.Enact.T_EnactState_828
d_es_2558 ~v0 ~v1 v2 = du_es_2558 v2
du_es_2558 ::
  T_GeneralizeTel_41429 -> MAlonzo.Code.Ledger.Enact.T_EnactState_828
du_es_2558 v0
  = coe
...
d_ls_2562 ::
  ...
  T_GeneralizeTel_41429 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2180
d_ls_2562 ~v0 ~v1 v2 = du_ls_2562 v2
du_ls_2562 ::
  T_GeneralizeTel_41429 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2180
du_ls_2562 v0
...
d_constitution_2570 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1710 ->
  T_GeneralizeTel_41429 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_constitution_2570 ~v0 ~v1 v2 = du_constitution_2570 v2
du_constitution_2570 ::
  T_GeneralizeTel_41429 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_constitution_2570 v0
  = coe
...
d_'46'generalizedField'45's_41421 ::
  T_GeneralizeTel_41429 -> T_ChainState_2314
d_'46'generalizedField'45's_41421 v0
  = case coe v0 of
      C_mkGeneralizeTel_41431 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-b
d_'46'generalizedField'45'b_41423 ::
  T_GeneralizeTel_41429 -> T_Block_2320
d_'46'generalizedField'45'b_41423 v0
  = case coe v0 of
      C_mkGeneralizeTel_41431 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-nes
d_'46'generalizedField'45'nes_41425 ::
  T_GeneralizeTel_41429 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2322
d_'46'generalizedField'45'nes_41425 v0
  = case coe v0 of
      C_mkGeneralizeTel_41431 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain..generalizedField-ls'
d_'46'generalizedField'45'ls''_41427 ::
  T_GeneralizeTel_41429 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2180
d_'46'generalizedField'45'ls''_41427 v0
  = case coe v0 of
      C_mkGeneralizeTel_41431 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Chain.GeneralizeTel
d_GeneralizeTel_41429 a0 a1 = ()
data T_GeneralizeTel_41429
  = C_mkGeneralizeTel_41431 T_ChainState_2314 T_Block_2320
                            MAlonzo.Code.Ledger.Conway.Conformance.Epoch.T_NewEpochState_2322
                            MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2180
