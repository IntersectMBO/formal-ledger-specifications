...
du_mostStakeDRepDist_2060 v0 v1
  = coe
      MAlonzo.Code.Ledger.Set.Theory.du__'8739''94'''__1176 (coe v0)
      (coe
         (\ v2 ->
            coe
              ...
              (coe
                 ...
                 (coe
                    ...
                    (coe
                       MAlonzo.Code.Axiom.Set.d_th_1458
                       (coe MAlonzo.Code.Ledger.Set.Theory.d_List'45'Model'7496'_10))
                    (coe MAlonzo.Code.Axiom.Set.Map.du__'738'_540 (coe v0))
                    (coe
            ...
            coe
              ...
              (coe
                 ...
                 (coe
                    ...
                    (\ v3 v4 -> v4) (coe MAlonzo.Code.Axiom.Set.Map.du__'738'_540)
                                                       ...
                                                       (\ v5 ->
                                                          MAlonzo.Code.Data.Nat.Properties.d__'8805''63'__2808
                                                            (coe
                                                               ...
                                                               (coe
                                                                  MAlonzo.Code.Interface.IsSet.du_IsSet'45'Set_556)
                                                               (coe
                                                                  MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
                                                                  (coe
                                                                     MAlonzo.Code.Axiom.Set.d_specification_174
  ...
  = coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.Ledger.Conway.Conformance.GovernanceActions.C_credVoter_704))
      (coe
         MAlonzo.Code.Ledger.Set.Theory.du_filter'7504'_1160
         (\ v2 ->
            coe
                    ...
                    (coe
                       ...
                       (coe
                          ...
                          (coe
                             ...
                             (coe MAlonzo.Code.Axiom.Set.Map.du__'738'_540 (coe v6)))))
                    (coe
                       (\ v8 ->
                          coe
                          ...
                          coe
                            ...
                            (coe
                               ...
                               (coe
                                  MAlonzo.Code.Axiom.Set.d_th_1458
                                  (coe MAlonzo.Code.Ledger.Set.Theory.d_List'45'Model'7496'_10))
                               (coe MAlonzo.Code.Interface.IsSet.du_IsSet'45'Map_560) (coe v6))
                            (coe
                               MAlonzo.Code.Ledger.Conway.Conformance.GovernanceActions.C_no_758)))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Agda.Builtin.Maybe.C_nothing_18
...
du_getStakeDist_2332 v0 v1 v2
  = case coe v0 of
      ...
      MAlonzo.Code.Ledger.Conway.Conformance.GovernanceActions.C_DRep_694
        -> coe
             MAlonzo.Code.Ledger.Set.Theory.du_filterKeys_1168
             (\ v3 ->
                coe
                  MAlonzo.Code.Class.Decidable.Core.du_'8263''178'__138
                  (coe
