  ...
  = coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.Axiom.Set.d_th_1458
            (coe MAlonzo.Code.Ledger.Set.Theory.d_List'45'Model'7496'_10))
         (coe MAlonzo.Code.Interface.IsSet.du_IsSet'45'Map_560) (coe v2))
                ...
                (coe
                   ...
                   (coe
                      ...
                      (coe
                         ...
                         (coe v0))))
                (coe
                   MAlonzo.Code.Ledger.Set.Theory.du__'7584''738'_1144
         ...
         (\ v4 ->
            coe
              ...
              (coe
                 ...
                 (coe v0)
                 (coe
                    MAlonzo.Code.Ledger.Set.Theory.du__'8739''94'''__1176 (coe v1)
                    (coe
                       (\ v5 ->
                          coe
...
du_gaDepositStake_2468 v0 v1 v2
  = coe
      MAlonzo.Code.Ledger.Set.Theory.du_aggregateBy_1202
      (coe
                    ...
                    (let v4
                     ...
                     coe
                       (coe
                          ...
                          (coe MAlonzo.Code.Axiom.Set.Map.du__'738'_540 (coe v2)))))))
         (coe du_govSt''_2478 (coe v1)))
