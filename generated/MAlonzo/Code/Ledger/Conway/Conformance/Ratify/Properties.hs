...
du_exp'63'_1878 v0 v1 v2
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Ratify.d_expired'63'_2584
      (coe v0)
      (coe
...
du_acceptConds'63'_1884 v0 v1 v2 v3
  = coe
      ...
      (coe
         MAlonzo.Code.Ledger.Conway.Conformance.Ratify.d_accepted'63'_2568
         (coe v0) (coe v1)
         (coe
            MAlonzo.Code.Ledger.Conway.Conformance.Ratify.d_es_2034 (coe v2))
      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.Ledger.Conway.Conformance.Ratify.d_delayed'63'_2524
               (coe v0)
               (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.Ledger.Enact.C_'10214'_'44'_'44'_'10215''7497'_868
            ...
            (coe
               ...
               (coe MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe v3)))
            (coe
               MAlonzo.Code.Ledger.GovernanceActions.Properties.d_Computational'45'ENACT_940
               (coe
                                                          ...
                                                          coe
                                                            (coe
                                                               ...
                                                               (coe
                                                                  ...
                                                                  (coe v2))))
                                                         (coe
                                                            MAlonzo.Code.Ledger.Conway.Conformance.Ratify.du_delayingAction_2406
                                                            (coe
                                                               MAlonzo.Code.Ledger.GovernanceActions.d_action_838
                                                               (coe
                                                                  ...
                                                                  (coe v3)))))
                                                      (coe
                                                         MAlonzo.Code.Ledger.Conway.Conformance.Ratify.C_RATIFY'45'Accept_2644
                                                         (coe
                               ...
                               -> if coe v8
                                    then case coe v9 of
                                             ...
                                             -> coe
                                                  ...
                                                  (coe
                                                     ...
                                                     (coe
                                                        ...
                                                        (coe v2)))
                                                  (coe
                                                     MAlonzo.Code.Ledger.Conway.Conformance.Ratify.C_RATIFY'45'Reject_2674
                                                     (coe
                                                        MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                                                        erased (coe v10)))
                                           _ -> MAlonzo.RTE.mazUnreachableError
                                           ...
                                           (coe
                                              ...
                                              (coe v2)
                                              (coe
                                                 MAlonzo.Code.Ledger.Conway.Conformance.Ratify.C_RATIFY'45'Continue_2704
                                                 (coe
                                                    MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                                                    erased erased)))
                             _ -> MAlonzo.RTE.mazUnreachableError)
...
d_RATIFY'''45'completeness_1910 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ratify.T_RatifyState_2026 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ratify.T__'8866'_'8640''10631'_'44'RATIFY'''10632'__2600 ->
...
d_Computational'45'RATIFY''_1970 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'RATIFY''_1970 v0
  = coe
...
d_Computational'45'RATIFY_1972 v0
  = coe
      ...
      (coe d_Computational'45'RATIFY''_1970 (coe v0))
      (coe
         MAlonzo.Code.Interface.ComputationalRelation.du_InjectError'45''8869'_726)
      (coe
         MAlonzo.Code.Interface.ComputationalRelation.du_InjectError'45''8869'_726)
-- Ledger.Conway.Conformance.Ratify.Properties.RATIFY-total
d_RATIFY'45'total_1982 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ratify.T_RatifyEnv_1996 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ratify.T_RatifyState_2026 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_RATIFY'45'total_1982 v0 v1 v2 v3
  = coe
...
d_RATIFY'45'complete_1992 ::
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_RATIFY'45'complete_1992 = erased
-- Ledger.Conway.Conformance.Ratify.Properties.RATIFY-total'
d_RATIFY'45'total''_2002 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ratify.T_RatifyEnv_1996 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ratify.T_RatifyState_2026 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_RATIFY'45'total''_2002 v0 v1 v2 v3
  = coe d_RATIFY'45'total_1982 (coe v0) (coe v1) (coe v2) (coe v3)
-- Ledger.Conway.Conformance.Ratify.Properties.RATIFY-complete'
d_RATIFY'45'complete''_2012 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ratify.T_RatifyEnv_1996 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ratify.T_RatifyState_2026 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  ...
  MAlonzo.Code.Interface.STS.T__'8866'_'8640''10214'_'10215''42'__68 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_RATIFY'45'complete''_2012 = erased
