...
du_Computational'45'CERT_2134 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Certs.Properties.d_Computational'45'CERT_1448
...
du_Computational'45'CERTBASE_2136 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Certs.Properties.d_Computational'45'CERTBASE_1882
      (coe MAlonzo.Code.Ledger.Transaction.d_govStructure_2322 (coe v0))
...
d_slot_2234 :: MAlonzo.Code.Ledger.Ledger.T_LEnv_2132 -> AgdaAny
d_slot_2234 v0
...
d_slot_2398 :: MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_1912 -> AgdaAny
d_slot_2398 v0 = coe MAlonzo.Code.Ledger.Utxo.d_slot_1920 (coe v0)
...
d_Computational'45'LEDGER_2694 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'LEDGER_2694 v0 v1
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (d_computeProof_2828 (coe v0) (coe v1))
...
d_computeUtxow_2720 ~v0 ~v1 ~v2 v3 = du_computeUtxow_2720 v3
du_computeUtxow_2720 ::
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_1912 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_1926 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2618 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
du_computeUtxow_2720 v0
  = coe
...
d_computeCerts_2722 ::
  ...
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_computeCerts_2722 ~v0 ~v1 ~v2 v3 = du_computeCerts_2722 v3
du_computeCerts_2722 ::
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232 ->
  MAlonzo.Code.Ledger.Certs.T_CertEnv_868 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1072 ->
  [MAlonzo.Code.Ledger.Certs.T_DCert_832] ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
du_computeCerts_2722 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.d_computeProof_272
      (coe v0)
...
d_computeGov_2724 ::
  ...
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_computeGov_2724 ~v0 ~v1 ~v2 v3 = du_computeGov_2724 v3
du_computeGov_2724 ::
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Gov.T_GovEnv_2034 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
...
d_utxoΓ_2804 ::
  ...
  MAlonzo.Code.Ledger.Transaction.T_Tx_2618 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_1912
d_utxoΓ_2804 ~v0 ~v1 v2 ~v3 ~v4 = du_utxoΓ_2804 v2
du_utxoΓ_2804 ::
  MAlonzo.Code.Ledger.Ledger.T_LEnv_2132 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_1912
du_utxoΓ_2804 v0
...
d_certΓ_2820 ::
  ...
  MAlonzo.Code.Ledger.Transaction.T_Tx_2618 ->
  MAlonzo.Code.Ledger.Certs.T_CertEnv_868
d_certΓ_2820 v0 ~v1 v2 v3 v4 = du_certΓ_2820 v0 v2 v3 v4
du_certΓ_2820 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Ledger.T_LEnv_2132 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2180 ->
...
d_govΓ_2822 ::
  ...
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1072 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Gov.T_GovEnv_2034
d_govΓ_2822 v0 ~v1 v2 ~v3 v4 v5 = du_govΓ_2822 v0 v2 v4 v5
du_govΓ_2822 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Ledger.T_LEnv_2132 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2618 ->
...
d_computeProof_2828 ::
  ...
  MAlonzo.Code.Ledger.Transaction.T_Tx_2618 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_computeProof_2828 v0 v1 v2 v3 v4
  = let v5
                                     ...
                                     -> coe
                                          ...
                                          (coe
                                             ...
                                             (coe
                                                ...
                                                (coe
                                                   MAlonzo.Code.Interface.ComputationalRelation.du_InjectError'45'Id_730))
                                             (coe du_certΓ_2820 (coe v0) (coe v2) (coe v3) (coe v4))
                                             (MAlonzo.Code.Ledger.Conway.Conformance.Ledger.d_certState_2192
                                                (coe v3))
                                                      ...
                                                      (coe
                                                         ...
                                                         (coe
                                                            ...
                                                            (coe
                                                               MAlonzo.Code.Interface.ComputationalRelation.du_InjectError'45'Id_730))
                                                         (coe
                                                            du_govΓ_2822 (coe v0) (coe v2) (coe v4)
                                                            (coe v13))
                                                         (coe
...
d_completeness_2862 = erased
-- Ledger.Conway.Conformance.Ledger.Properties.Computational-LEDGERS
d_Computational'45'LEDGERS_3032 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1712 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'LEDGERS_3032 v0 v1
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.du_Computational'45'ReflexiveTransitiveClosure'7495'_774
      (coe
         MAlonzo.Code.Interface.ComputationalRelation.du_Computational'45'Id_738)
      (coe d_Computational'45'LEDGER_2694 (coe v0) (coe v1))
      (coe
         MAlonzo.Code.Interface.ComputationalRelation.du_InjectError'45''8869'_726)
      (coe
         MAlonzo.Code.Interface.ComputationalRelation.du_InjectError'45'Id_730)
