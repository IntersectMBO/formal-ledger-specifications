...
du_Computational'45'CERT_2128 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Certs.Properties.d_Computational'45'CERT_1440
...
du_Computational'45'CERTBASE_2130 v0
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Certs.Properties.d_Computational'45'CERTBASE_1874
      (coe MAlonzo.Code.Ledger.Transaction.d_govStructure_2322 (coe v0))
...
d_Computational'45'GOV''_2182 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1706 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'GOV''_2182 v0 ~v1
  = du_Computational'45'GOV''_2182 v0
du_Computational'45'GOV''_2182 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
du_Computational'45'GOV''_2182 v0
  = coe
...
d__'8866'_'8640''10631'_'44'LEDGER'10632'__2192 a0 a1 a2 a3 a4 a5
  = ()
...
d_slot_2226 :: MAlonzo.Code.Ledger.Ledger.T_LEnv_2126 -> AgdaAny
d_slot_2226 v0
...
d_slot_2390 :: MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_1906 -> AgdaAny
d_slot_2390 v0 = coe MAlonzo.Code.Ledger.Utxo.d_slot_1914 (coe v0)
...
d_Computational'45'LEDGER_2686 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1706 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'LEDGER_2686 v0 v1
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (d_computeProof_2820 (coe v0) (coe v1))
...
d_computeUtxow_2712 ~v0 ~v1 ~v2 v3 = du_computeUtxow_2712 v3
du_computeUtxow_2712 ::
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_1906 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_1920 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2616 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
du_computeUtxow_2712 v0
  = coe
...
d_computeCerts_2714 ::
  ...
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_computeCerts_2714 ~v0 ~v1 ~v2 v3 = du_computeCerts_2714 v3
du_computeCerts_2714 ::
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232 ->
  MAlonzo.Code.Ledger.Certs.T_CertEnv_866 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1068 ->
  [MAlonzo.Code.Ledger.Certs.T_DCert_830] ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
du_computeCerts_2714 v0
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.d_computeProof_272
      (coe v0)
...
d_computeGov_2716 ::
  ...
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_computeGov_2716 ~v0 ~v1 ~v2 v3 = du_computeGov_2716 v3
du_computeGov_2716 ::
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Gov.T_GovEnv_2028 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
...
d_utxoΓ_2796 ::
  ...
  MAlonzo.Code.Ledger.Transaction.T_Tx_2616 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_1906
d_utxoΓ_2796 ~v0 ~v1 v2 ~v3 ~v4 = du_utxoΓ_2796 v2
du_utxoΓ_2796 ::
  MAlonzo.Code.Ledger.Ledger.T_LEnv_2126 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_1906
du_utxoΓ_2796 v0
...
d_certΓ_2812 ::
  ...
  MAlonzo.Code.Ledger.Transaction.T_Tx_2616 ->
  MAlonzo.Code.Ledger.Certs.T_CertEnv_866
d_certΓ_2812 v0 ~v1 v2 ~v3 v4 = du_certΓ_2812 v0 v2 v4
du_certΓ_2812 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Ledger.T_LEnv_2126 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2616 ->
  MAlonzo.Code.Ledger.Certs.T_CertEnv_866
du_certΓ_2812 v0 v1 v2
  = coe
...
d_govΓ_2814 ::
  ...
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1068 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Gov.T_GovEnv_2028
d_govΓ_2814 v0 ~v1 v2 ~v3 v4 v5 = du_govΓ_2814 v0 v2 v4 v5
du_govΓ_2814 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Ledger.T_LEnv_2126 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2616 ->
...
d_computeProof_2820 ::
  ...
  MAlonzo.Code.Ledger.Transaction.T_Tx_2616 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_computeProof_2820 v0 v1 v2 v3 v4
  = let v5
                                     ...
                                     -> coe
                                          ...
                                          (coe
                                             ...
                                             (coe
                                                ...
                                                (coe
                                                   MAlonzo.Code.Interface.ComputationalRelation.du_InjectError'45'Id_730))
                                             (coe du_certΓ_2812 (coe v0) (coe v2) (coe v4))
                                             (MAlonzo.Code.Ledger.Conway.Conformance.Ledger.d_certState_2184
                                                (coe v3))
                                                      ...
                                                      (coe
                                                         ...
                                                         (coe
                                                            ...
                                                            (coe
                                                               MAlonzo.Code.Interface.ComputationalRelation.du_InjectError'45'Id_730))
                                                         (coe
                                                            du_govΓ_2814 (coe v0) (coe v2) (coe v4)
                                                            (coe v13))
                                                         (coe
                                                                     ...
                                                                     (coe
                                                                        ...
                                                                        (coe
                                                                           ...
                                                                           (coe
                                                                              ...
                                                                              (coe v10))
                                                                           (coe
                                                                              MAlonzo.Code.Ledger.Utxo.du_updateDeposits_2324
                                                                              (coe v0)
                                                                              (let v18
                                                                                     = coe
...
d_completeness_2854 = erased
-- Ledger.Conway.Conformance.Ledger.Properties.Computational-LEDGERS
d_Computational'45'LEDGERS_3024 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1706 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'LEDGERS_3024 v0 v1
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.du_Computational'45'ReflexiveTransitiveClosure'7495'_774
      (coe
         MAlonzo.Code.Interface.ComputationalRelation.du_Computational'45'Id_738)
      (coe d_Computational'45'LEDGER_2686 (coe v0) (coe v1))
      (coe
         MAlonzo.Code.Interface.ComputationalRelation.du_InjectError'45''8869'_726)
      (coe
         MAlonzo.Code.Interface.ComputationalRelation.du_InjectError'45'Id_730)
