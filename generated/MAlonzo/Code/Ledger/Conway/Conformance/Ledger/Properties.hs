...
d__'8866'_'8640''10631'_'44'EPOCH'10632'__2002 a0 a1 a2 a3 a4 a5
  = ()
-- Ledger.Conway.Conformance.Ledger.Properties._.EpochState
d_EpochState_2010 a0 a1 = ()
...
d_Computational'45'CERT_2116 ::
  MAlonzo.Code.Ledger.Conway.Conformance.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Abstract.T_AbstractFunctions_1740 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'CERT_2116 v0 ~v1
  = du_Computational'45'CERT_2116 v0
du_Computational'45'CERT_2116 ::
  MAlonzo.Code.Ledger.Conway.Conformance.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
du_Computational'45'CERT_2116 v0
  = coe
...
d_Computational'45'CERTBASE_2118 ::
  MAlonzo.Code.Ledger.Conway.Conformance.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Abstract.T_AbstractFunctions_1740 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'CERTBASE_2118 v0 ~v1
  = du_Computational'45'CERTBASE_2118 v0
du_Computational'45'CERTBASE_2118 ::
  MAlonzo.Code.Ledger.Conway.Conformance.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
du_Computational'45'CERTBASE_2118 v0
  = coe
...
d__'8866'_'8640''10631'_'44'GOV'''10632'__2140 a0 a1 a2 a3 a4 a5
  = ()
...
d_Computational'45'GOV''_2240 ::
  MAlonzo.Code.Ledger.Conway.Conformance.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Abstract.T_AbstractFunctions_1740 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'GOV''_2240 v0 ~v1
  = du_Computational'45'GOV''_2240 v0
du_Computational'45'GOV''_2240 ::
  MAlonzo.Code.Ledger.Conway.Conformance.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
du_Computational'45'GOV''_2240 v0
  = coe
...
d__'8866'_'8640''10631'_'44'LEDGERS'10632'__2246 ::
  MAlonzo.Code.Ledger.Conway.Conformance.Transaction.T_TransactionStructure_24 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Abstract.T_AbstractFunctions_1740 ->
  ...
  [MAlonzo.Code.Ledger.Conway.Conformance.Transaction.T_Tx_2884] ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2138 -> ()
d__'8866'_'8640''10631'_'44'LEDGERS'10632'__2246 = erased
-- Ledger.Conway.Conformance.Ledger.Properties._._⊢_⇀⦇_,LEDGER⦈_
d__'8866'_'8640''10631'_'44'LEDGER'10632'__2248 a0 a1 a2 a3 a4 a5
  = ()
...
d_txgov_2258 ~v0 ~v1 = du_txgov_2258
du_txgov_2258 ::
  MAlonzo.Code.Ledger.Conway.Conformance.Transaction.T_TxBody_2782 ->
  [MAlonzo.Code.Data.Sum.Base.T__'8846'__30]
du_txgov_2258
  = coe MAlonzo.Code.Ledger.Conway.Conformance.Ledger.du_txgov_2154
...
du_updateCertDeposits_2500 v0 v1 v2 v3
  = coe
      MAlonzo.Code.Ledger.Conway.Conformance.Utxo.du_updateCertDeposits_1854
      (coe v0) v2 v3
...
du_certΓ_2768 v0 v1 v2
  = coe
      ...
      (coe
         ...
         (MAlonzo.Code.Ledger.Conway.Conformance.Transaction.d_epochStructure_1546
            (coe v0))
         (MAlonzo.Code.Ledger.Conway.Conformance.Ledger.d_slot_2126
            (coe v1)))
      (coe
         MAlonzo.Code.Ledger.Conway.Conformance.Ledger.d_pparams_2130
         (coe v1))
                                                 ...
                                                 -> coe
                                                      ...
                                                      (coe
                                                         ...
                                                         (MAlonzo.Code.Ledger.Conway.Conformance.Ledger.d_govSt_2148
                                                            (coe v3))
                                                         (coe
                                                            MAlonzo.Code.Ledger.Conway.Conformance.Ledger.du_txgov_2154
                                                            (coe
                                                               MAlonzo.Code.Ledger.Conway.Conformance.Transaction.d_body_2894
                                                               (coe v4))))
                                                      (\ v15 ->
                                                             ...
                                                             -> coe
                                                                  ...
                                                                  (coe
                                                                     ...
                                                                     (coe
                                                                        ...
                                                                        (coe v13))
                                                                     (coe
                                                                        MAlonzo.Code.Ledger.Conway.Conformance.Ledger.C_LEDGER'45'V_2300
                                                                        (coe
                                                                           MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                                                                           (coe v8)
                                                                           (coe
                                 ...
                                 -> coe
                                      ...
                                      (coe
                                         ...
                                         (coe
                                            ...
                                            (let v11
                                                   = coe
                                                       MAlonzo.Code.Ledger.Conway.Conformance.Ledger.C_mkGeneralizeTel_6749
                                                       (coe v3) (coe v4) (coe v2) (coe v9) in
                                             coe
                                               (coe
                                                  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.d_govSt_2148
                                                  (coe
                                                     MAlonzo.Code.Ledger.Conway.Conformance.Ledger.d_'46'generalizedField'45's_6739
                                                     (coe v11))))
                                            (let v11
                                                   = coe
                                                       MAlonzo.Code.Ledger.Conway.Conformance.Ledger.C_mkGeneralizeTel_6749
                                             ...
                                             coe
                                               (coe
                                                  ...
                                                  (coe
                                                     ...
                                                     (coe v11)))))
                                         (coe
                                            MAlonzo.Code.Ledger.Conway.Conformance.Ledger.C_LEDGER'45'I_2380
                                            (coe
...
d_completeness_2808 ::
  ...
  MAlonzo.Code.Ledger.Conway.Conformance.Transaction.T_Tx_2884 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2138 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T__'8866'_'8640''10631'_'44'LEDGER'10632'__2220 ->
...
data T_FreshTxs_3008
  = C_'91''93''45'Fresh_3010 |
    C_'8759''45'Fresh_3012 MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2138
                           MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T__'8866'_'8640''10631'_'44'LEDGER'10632'__2220
                           T_FreshTxs_3008
...
d_isValid_3106 ::
  ...
  MAlonzo.Code.Ledger.Conway.Conformance.Transaction.T_Tx_2884 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LEnv_2114 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Ledger.T_LState_2138 -> Bool
...
du_EPOCH'45'govDepsMatch_3692 v0 v1 v2 v3 v4
  = coe
      ...
      (coe
         seq (coe v4)
         (case coe v1 of
            MAlonzo.Code.Ledger.Conway.Conformance.Epoch.C_'10214'_'44'_'44'_'44'_'44'_'10215''7497'''_2310 v5 v6 v7 v8 v9
              -> coe
                   (\ v10 ->
                      coe
                        MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
