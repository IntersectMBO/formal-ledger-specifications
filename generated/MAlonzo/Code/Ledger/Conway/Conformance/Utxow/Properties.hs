...
d_Computational'45'UTXOW_1726 v0 v1
  = coe
      ...
      (d_computeProof_1766 (coe v0) (coe v1))
...
d_computeProof_1766 v0 v1 v2 v3 v4
  = let v5
                                                                   ...
                                                                   coe
                                                                     (case coe v16 of
                                                                        MAlonzo.Code.Data.Sum.Base.C_inj'8321'_38 v17
                                                                          -> coe
                                                                               ("\172\n(.Axiom.Set.Theory\7496.th List-Model\7496 Axiom.Set.Theory.\8838\n Ledger.Conway.Conformance.Utxo.getInputHashes txs abs tx\n (.Ledger.Conway.Conformance.Utxo.UTxOState.utxo s))\n(Class.IsSet.dom (.Axiom.Set.Theory\7496.th List-Model\7496)\n (.TransactionStructure.TxWitnesses.txdats\n  (.TransactionStructure.Tx.wits tx)))"
                                                                                ::
                                                                                Data.Text.Text)
                                                                                       ...
                                                                                       coe
                                                                                         (case coe
                                                                                            ...
                                                                                            MAlonzo.Code.Data.Sum.Base.C_inj'8321'_38 v21
                                                                                              -> coe
                                                                                                   ("\172\n(.Axiom.Set.Theory\7496.th List-Model\7496 Axiom.Set.Theory.\8838\n Ledger.Conway.Conformance.Utxow.languages txs abs tx\n (.Ledger.Conway.Conformance.Utxo.UTxOState.utxo s))\n(Ledger.Conway.Conformance.Utxow.allowedLanguages txs abs tx\n (.Ledger.Conway.Conformance.Utxo.UTxOState.utxo s))"
                                                                                                    ::
                                                                                                    Data.Text.Text)
