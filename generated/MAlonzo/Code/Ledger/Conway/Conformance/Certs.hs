...
d__'8866'_'8640''10631'_'44'CERTBASE'10632'__1480 a0 a1 a2 a3 a4
  = ()
data T__'8866'_'8640''10631'_'44'CERTBASE'10632'__1480
  = C_CERT'45'base_1558
-- Ledger.Conway.Conformance.Certs._.drepActivity
d_drepActivity_1502 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 ->
  T_GeneralizeTel_88443 -> AgdaAny
d_drepActivity_1502 ~v0 v1 = du_drepActivity_1502 v1
du_drepActivity_1502 :: T_GeneralizeTel_88443 -> AgdaAny
du_drepActivity_1502 v0
  = coe
      MAlonzo.Code.Ledger.PParams.d_drepActivity_376
      (coe d_'46'generalizedField'45'pp_88417 (coe v0))
...
data T_GeneralizeTel_50787
  = C_mkGeneralizeTel_50789 Integer
                            ...
                            MAlonzo.Code.Ledger.GovernanceActions.T_Anchor_684
-- Ledger.Conway.Conformance.Certs..generalizedField-pp
d_'46'generalizedField'45'pp_88417 ::
  T_GeneralizeTel_88443 -> MAlonzo.Code.Ledger.PParams.T_PParams_244
d_'46'generalizedField'45'pp_88417 v0
  = case coe v0 of
      C_mkGeneralizeTel_88445 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Certs..generalizedField-vs
d_'46'generalizedField'45'vs_88419 ::
  T_GeneralizeTel_88443 ->
  [MAlonzo.Code.Ledger.GovernanceActions.T_GovVote_724]
d_'46'generalizedField'45'vs_88419 v0
  = case coe v0 of
      C_mkGeneralizeTel_88445 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13
        -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Certs..generalizedField-e
d_'46'generalizedField'45'e_88421 ::
  T_GeneralizeTel_88443 -> AgdaAny
d_'46'generalizedField'45'e_88421 v0
  = case coe v0 of
      C_mkGeneralizeTel_88445 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13
        -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Certs..generalizedField-dReps
d_'46'generalizedField'45'dReps_88423 ::
  T_GeneralizeTel_88443 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_'46'generalizedField'45'dReps_88423 v0
  = case coe v0 of
      C_mkGeneralizeTel_88445 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13
        -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Certs..generalizedField-wdrls
d_'46'generalizedField'45'wdrls_88425 ::
  T_GeneralizeTel_88443 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_'46'generalizedField'45'wdrls_88425 v0
  = case coe v0 of
      C_mkGeneralizeTel_88445 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13
        -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Certs..generalizedField-voteDelegs
d_'46'generalizedField'45'voteDelegs_88427 ::
  T_GeneralizeTel_88443 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_'46'generalizedField'45'voteDelegs_88427 v0
  = case coe v0 of
      C_mkGeneralizeTel_88445 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13
        -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Certs..generalizedField-cc
d_'46'generalizedField'45'cc_88429 ::
  T_GeneralizeTel_88443 ->
  [MAlonzo.Code.Ledger.Address.T_Credential_16]
d_'46'generalizedField'45'cc_88429 v0
  = case coe v0 of
      C_mkGeneralizeTel_88445 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13
        -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Certs..generalizedField-stakeDelegs
d_'46'generalizedField'45'stakeDelegs_88431 ::
  T_GeneralizeTel_88443 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_'46'generalizedField'45'stakeDelegs_88431 v0
  = case coe v0 of
      C_mkGeneralizeTel_88445 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13
        -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Certs..generalizedField-rewards
d_'46'generalizedField'45'rewards_88433 ::
  T_GeneralizeTel_88443 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_'46'generalizedField'45'rewards_88433 v0
  = case coe v0 of
      C_mkGeneralizeTel_88445 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13
        -> coe v9
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Certs..generalizedField-ddep
d_'46'generalizedField'45'ddep_88435 ::
  T_GeneralizeTel_88443 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_'46'generalizedField'45'ddep_88435 v0
  = case coe v0 of
      C_mkGeneralizeTel_88445 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13
        -> coe v10
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Certs..generalizedField-stᵖ
d_'46'generalizedField'45'st'7510'_88437 ::
  T_GeneralizeTel_88443 -> MAlonzo.Code.Ledger.Certs.T_PState_908
d_'46'generalizedField'45'st'7510'_88437 v0
  = case coe v0 of
      C_mkGeneralizeTel_88445 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13
        -> coe v11
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Certs..generalizedField-ccHotKeys
d_'46'generalizedField'45'ccHotKeys_88439 ::
  T_GeneralizeTel_88443 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_'46'generalizedField'45'ccHotKeys_88439 v0
  = case coe v0 of
      C_mkGeneralizeTel_88445 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13
        -> coe v12
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Certs..generalizedField-gdep
d_'46'generalizedField'45'gdep_88441 ::
  T_GeneralizeTel_88443 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_'46'generalizedField'45'gdep_88441 v0
  = case coe v0 of
      C_mkGeneralizeTel_88445 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13
        -> coe v13
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Certs.GeneralizeTel
d_GeneralizeTel_88443 a0 = ()
data T_GeneralizeTel_88443
  = C_mkGeneralizeTel_88445 MAlonzo.Code.Ledger.PParams.T_PParams_244
