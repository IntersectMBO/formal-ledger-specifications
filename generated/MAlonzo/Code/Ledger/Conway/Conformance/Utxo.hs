...
du__'61''62''7495'__1854
  = coe MAlonzo.Code.Ledger.Utxo.du__'61''62''7495'__2566
-- Ledger.Conway.Conformance.Utxo.L._._≡?_
...
du__'8804''7495'__1858
  = coe MAlonzo.Code.Ledger.Utxo.du__'8804''7495'__2572
-- Ledger.Conway.Conformance.Utxo.L._._≥ᵇ_
...
du__'8805''7495'__1860
  = coe MAlonzo.Code.Ledger.Utxo.du__'8805''7495'__2574
...
du_Dec'45'ValidCertDeposits_1866 v0
  = coe
      MAlonzo.Code.Ledger.Utxo.du_Dec'45'ValidCertDeposits_2232 (coe v0)
...
du_HasCoin'45'UTxOState_1872 v0
  = coe
      MAlonzo.Code.Ledger.Utxo.du_HasCoin'45'UTxOState_2562 (coe v0)
...
d_Scripts'45'No'45'premises_1876 v0 v1
  = coe
      MAlonzo.Code.Ledger.Utxo.d_Scripts'45'No'45'premises_2952 (coe v0)
      (coe v1)
...
d_Scripts'45'Yes'45'premises_1880 v0 v1
  = coe
      MAlonzo.Code.Ledger.Utxo.d_Scripts'45'Yes'45'premises_2950 (coe v0)
      (coe v1)
...
d_UTXO'45'premises_1884 v0 v1
  = coe
      MAlonzo.Code.Ledger.Utxo.d_UTXO'45'premises_3142 (coe v0) (coe v1)
...
du_coinPolicies_1906 v0
  = coe MAlonzo.Code.Ledger.Utxo.du_coinPolicies_2590 (coe v0)
...
du_consumed_1908 ::
  ...
  MAlonzo.Code.Ledger.Transaction.T_TxBody_2514 -> AgdaAny
du_consumed_1908 v0
  = coe MAlonzo.Code.Ledger.Utxo.du_consumed_2772 (coe v0)
...
du_depositRefunds_1912 v0
  = coe MAlonzo.Code.Ledger.Utxo.du_depositRefunds_2756 (coe v0)
...
du_depositsChange_1914 v0
  = coe MAlonzo.Code.Ledger.Utxo.du_depositsChange_2430 (coe v0)
...
d_feesOK_1920 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Bool
d_feesOK_1920 v0 v1
  = coe MAlonzo.Code.Ledger.Utxo.d_feesOK_2596 (coe v0) (coe v1)
...
du_isAdaOnly'7495'_1928 v0
  = coe MAlonzo.Code.Ledger.Utxo.du_isAdaOnly'7495'_2592 (coe v0)
...
du_newDeposits_1936 v0
  = coe MAlonzo.Code.Ledger.Utxo.du_newDeposits_2764 (coe v0)
...
du_produced_1942 ::
  ...
  MAlonzo.Code.Ledger.Transaction.T_TxBody_2514 -> AgdaAny
du_produced_1942 v0
  = coe MAlonzo.Code.Ledger.Utxo.du_produced_2780 (coe v0)
...
du_proposalDepositsΔ_1944 v0
  = coe MAlonzo.Code.Ledger.Utxo.du_proposalDepositsΔ_2376 (coe v0)
...
du_updateCertDeposits_1958 v0
  = coe MAlonzo.Code.Ledger.Utxo.du_updateCertDeposits_2234 (coe v0)
...
du_updateDeposits_1960 v0
  = coe MAlonzo.Code.Ledger.Utxo.du_updateDeposits_2324 (coe v0)
...
du_updateProposalDeposits_1962 v0
  = coe
      MAlonzo.Code.Ledger.Utxo.du_updateProposalDeposits_2312 (coe v0)
...
du_'8799''45''8709''7495'_1970 v0 v1 v2
  = coe MAlonzo.Code.Ledger.Utxo.du_'8799''45''8709''7495'_2586 v1 v2
         ...
         (coe
            ...
            (coe
               ...
               (coe
                  MAlonzo.Code.Class.Decidable.Instances.du_Dec'45''215'_24
                  (coe
                     MAlonzo.Code.Ledger.Utxo.du_Dec'45'inInterval_2460 (coe v0)
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe MAlonzo.Code.Class.DecEq.Instances.d_DecEq'45'Bool_16)
                        (coe
                           MAlonzo.Code.Ledger.Utxo.d_feesOK_2596 (coe v0) (coe v1)
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe MAlonzo.Code.Ledger.Transaction.d_tokenAlgebra_2208 (coe v0)))
                           (coe
                              MAlonzo.Code.Ledger.Utxo.du_consumed_2772 (coe v0)
                              (coe MAlonzo.Code.Ledger.Utxo.d_pparams_1916 (coe v3)) (coe v4)
                              (coe MAlonzo.Code.Ledger.Transaction.d_body_2626 (coe v2)))
                           (coe
                              MAlonzo.Code.Ledger.Utxo.du_produced_2780 (coe v0)
                              (coe MAlonzo.Code.Ledger.Utxo.d_pparams_1916 (coe v3)) (coe v4)
                              (coe MAlonzo.Code.Ledger.Transaction.d_body_2626 (coe v2))))
                        (coe
                           MAlonzo.Code.Class.Decidable.Instances.du_Dec'45''215'_24
