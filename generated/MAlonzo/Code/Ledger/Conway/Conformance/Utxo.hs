...
du_Dec'45'inInterval_1876 v0
  = coe MAlonzo.Code.Ledger.Utxo.du_Dec'45'inInterval_2606 (coe v0)
...
du_To'45'UTxOState_1892
  = coe MAlonzo.Code.Ledger.Utxo.du_To'45'UTxOState_2048
...
du_balance_1906 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> AgdaAny
du_balance_1906 v0
  = coe MAlonzo.Code.Ledger.Utxo.du_balance_2066 (coe v0)
...
du_cbalance_1910 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> Integer
du_cbalance_1910 v0
  = coe MAlonzo.Code.Ledger.Utxo.du_cbalance_2072 (coe v0)
...
du_outs_1958 ::
  MAlonzo.Code.Ledger.Transaction.T_TxBody_2522 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_outs_1958 = coe MAlonzo.Code.Ledger.Utxo.du_outs_2060
...
d_refScriptsSize_1964 v0 v1
  = coe
      MAlonzo.Code.Ledger.Utxo.d_refScriptsSize_2076 (coe v0) (coe v1)
...
du_utxoEntrySize_1984 v0
  = coe MAlonzo.Code.Ledger.Utxo.du_utxoEntrySize_2008 (coe v0)
...
d_slot_2006 :: MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2012 -> AgdaAny
d_slot_2006 v0 = coe MAlonzo.Code.Ledger.Utxo.d_slot_2020 (coe v0)
...
d_fees_2016 :: MAlonzo.Code.Ledger.Utxo.T_UTxOState_2026 -> Integer
d_fees_2016 v0 = coe MAlonzo.Code.Ledger.Utxo.d_fees_2038 (coe v0)
-- Ledger.Conway.Conformance.Utxo.L._.UTxOState.utxo
d_utxo_2018 ::
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_2026 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_utxo_2018 v0 = coe MAlonzo.Code.Ledger.Utxo.d_utxo_2036 (coe v0)
...
du_utxo_2140 ::
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_2026 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_utxo_2140 v0 = coe MAlonzo.Code.Ledger.Utxo.d_utxo_2036 (coe v0)
...
du_utxo_2220 ::
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_2026 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_utxo_2220 v0 = coe MAlonzo.Code.Ledger.Utxo.d_utxo_2036 (coe v0)
         ...
         (coe
            ...
            (coe
               ...
               (coe
                  MAlonzo.Code.Ledger.ScriptValidation.d_collectPhaseTwoScriptInputs_2362
                  (coe v0) (coe v1)
                  (coe MAlonzo.Code.Ledger.Utxo.d_pparams_2022 (coe v2)) (coe v4)
                  (coe MAlonzo.Code.Ledger.Utxo.d_utxo_2036 (coe v3))))
...
du_curTreasury_2246 :: T_GeneralizeTel_28445 -> Maybe Integer
...
du_mint_2248 :: T_GeneralizeTel_28445 -> AgdaAny
du_mint_2248 v0
  = coe
...
du_txNetworkId_2258 :: T_GeneralizeTel_28445 -> Maybe AgdaAny
...
du_txsize_2274 :: T_GeneralizeTel_28445 -> Integer
du_txsize_2274 v0
  = coe
...
du_pparams_2286 v0
  = coe
      MAlonzo.Code.Ledger.Utxo.d_pparams_2022
...
du_slot_2288 :: T_GeneralizeTel_28445 -> AgdaAny
du_slot_2288 v0
  = coe
      MAlonzo.Code.Ledger.Utxo.d_slot_2020
      (coe d_'46'generalizedField'45'Γ_28439 (coe v0))
...
du_treasury_2290 :: T_GeneralizeTel_28445 -> Integer
du_treasury_2290 v0
  = coe
      MAlonzo.Code.Ledger.Utxo.d_treasury_2024
      (coe d_'46'generalizedField'45'Γ_28439 (coe v0))
-- Ledger.Conway.Conformance.Utxo._.utxo
d_utxo_2300 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
         ...
         (coe
                  ...
                  (\ v5 ->
                     coe
                       ...
                       (coe
                          ...
                          (coe MAlonzo.Code.Ledger.Utxo.d_utxo_2036 (coe v4)))))
               (coe
            ...
            (coe
               ...
               (coe
                  MAlonzo.Code.Class.Decidable.Instances.du_Dec'45''215'_24
                  (coe
                     MAlonzo.Code.Ledger.Utxo.du_Dec'45'inInterval_2606 (coe v0)
                     (coe MAlonzo.Code.Ledger.Utxo.d_slot_2020 (coe v3))
                     (coe
                        MAlonzo.Code.Ledger.Transaction.d_txvldt_2574
                        (coe MAlonzo.Code.Ledger.Transaction.d_body_2634 (coe v2))))
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (MAlonzo.Code.Ledger.Utxo.d_minfee_2082
                              (coe v0) (coe v1)
                              (coe MAlonzo.Code.Ledger.Utxo.d_pparams_2022 (coe v3))
                              (coe MAlonzo.Code.Ledger.Utxo.d_utxo_2036 (coe v4)) (coe v2))
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe
                                    ...
                                    (coe v2) (coe MAlonzo.Code.Ledger.Utxo.d_utxo_2036 (coe v4))))
                              (coe
                                 MAlonzo.Code.Class.Decidable.Instances.du_Dec'45''215'_24
                                 (coe
                                    MAlonzo.Code.Class.Decidable.Instances.du_Dec'45''215'_24
                                       ...
                                       (coe
                                          (\ v5 ->
                                             coe
                                               ...
                                               (coe v5)
                                               (coe
                                                  MAlonzo.Code.Ledger.Utxo.du_coinPolicies_2712
                                                  (coe v0))))
                                       (coe
                                               ...
                                               (coe
                                                  ...
                                                  (coe
                                                     ...
                                                     (coe
                                                        ...
                                                        (coe v4))))))
                                       (coe
                                          MAlonzo.Code.Ledger.Utxo.du_coinPolicies_2712 (coe v0))))
                                 (coe
                                    MAlonzo.Code.Class.Decidable.Instances.du_Dec'45''215'_24
                                    (coe
                                       MAlonzo.Code.Class.Decidable.Instances.d_ℕ'45'Dec'45''8804'_74
                                       (mulInt
                                          ...
                                          (coe
                                             ...
                                             (coe
                                                MAlonzo.Code.Ledger.Utxo.d_pparams_2022 (coe v3))))
                                       (mulInt
                                          (coe
                                             MAlonzo.Code.Ledger.TokenAlgebra.d_coin_200
                                             (MAlonzo.Code.Ledger.Transaction.d_tokenAlgebra_2216
                                             ...
                                             (coe
                                                ...
                                                (coe v2)
                                                (coe
                                                   MAlonzo.Code.Ledger.Utxo.d_utxo_2036 (coe v4))))
                                          (coe (100 :: Integer))))
                                    (coe
                                       MAlonzo.Code.Class.Decidable.Instances.du_Dec'45''8594'_22
                                       (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe MAlonzo.Code.Ledger.Utxo.d_pparams_2022 (coe v3)) (coe v4)
                              (coe MAlonzo.Code.Ledger.Transaction.d_body_2634 (coe v2)))
                           (coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe
                                    MAlonzo.Code.Class.Decidable.Instances.d_ℕ'45'Dec'45''8804'_74
                                    (MAlonzo.Code.Ledger.Utxo.d_refScriptsSize_2076
                                       (coe v0) (coe v1)
                                       (coe MAlonzo.Code.Ledger.Utxo.d_utxo_2036 (coe v4)) (coe v2))
                                               ...
                                               (coe
                                                  ...
                                                  (mulInt
                                                     (coe
                                                        ...
                                                        (coe
                                                           MAlonzo.Code.Ledger.Utxo.du_utxoEntrySize_2008
                                                           (coe v0)
                                                           (coe
...
d_'46'generalizedField'45'tx_28437 ::
  T_GeneralizeTel_28445 -> MAlonzo.Code.Ledger.Transaction.T_Tx_2624
...
d_'46'generalizedField'45'Γ_28439 ::
  T_GeneralizeTel_28445 -> MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2012
...
d_'46'generalizedField'45's_28441 ::
  T_GeneralizeTel_28445 -> MAlonzo.Code.Ledger.Utxo.T_UTxOState_2026
...
data T_GeneralizeTel_28445
  = C_mkGeneralizeTel_28447 MAlonzo.Code.Ledger.Transaction.T_Tx_2624
                            MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_2012
                            MAlonzo.Code.Ledger.Utxo.T_UTxOState_2026
                            MAlonzo.Code.Ledger.Utxo.T_UTxOState_2026
