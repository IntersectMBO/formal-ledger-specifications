  ...
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (let v3
                   = coe
                       MAlonzo.Code.Ledger.Conway.Conformance.Epoch.C_mkGeneralizeTel_23679
                       (coe v1)
                       (coe
             ...
             coe
               (coe
                  ...
                  (coe
                     MAlonzo.Code.Ledger.Conway.Conformance.Ledger.d_utxoSt_2194
                     (coe
                        MAlonzo.Code.Ledger.Conway.Conformance.Epoch.d_'46'generalizedField'45'lstate_23667
                        (coe v3)))))
            (let v3
                   = coe
                       MAlonzo.Code.Ledger.Conway.Conformance.Epoch.C_mkGeneralizeTel_23679
         ...
         (MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
            (coe
               ...
               (coe
                  ...
                  (let v3
                         = coe
                             MAlonzo.Code.Ledger.Conway.Conformance.Epoch.C_mkGeneralizeTel_30807
                             (coe
                                MAlonzo.Code.Ledger.Conway.Conformance.Epoch.d_fut_2328 (coe v1))
                             (coe
                                MAlonzo.Code.Ledger.Conway.Conformance.Epoch.d_ls_2324 (coe v1))
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              MAlonzo.Code.Ledger.Conway.Conformance.Ledger.d_certState_2198
                              (coe
                                 MAlonzo.Code.Ledger.Conway.Conformance.Epoch.d_'46'generalizedField'45'ls_30791
                                 (coe v3))))))
                  (let v3
                         = coe
                             MAlonzo.Code.Ledger.Conway.Conformance.Epoch.C_mkGeneralizeTel_30807
