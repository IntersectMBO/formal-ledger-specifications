...
d_cc_1570 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_cc_1570 v0 = coe MAlonzo.Code.Ledger.Enact.d_cc_856 (coe v0)
...
d_pv_1576 ::
  MAlonzo.Code.Ledger.Enact.T_EnactState_844 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_pv_1576 v0 = coe MAlonzo.Code.Ledger.Enact.d_pv_860 (coe v0)
...
d_GovEnv_2166 a0 a1 = ()
data T_GovEnv_2166
  = C_GovEnv'46'constructor_6017 AgdaAny AgdaAny
...
d_txid_2182 v0
  = case coe v0 of
      C_GovEnv'46'constructor_6017 v1 v2 v3 v4 v5 v6 v7 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.epoch
d_epoch_2184 :: T_GovEnv_2166 -> AgdaAny
d_epoch_2184 v0
  = case coe v0 of
      C_GovEnv'46'constructor_6017 v1 v2 v3 v4 v5 v6 v7 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.pparams
d_pparams_2186 ::
  T_GovEnv_2166 -> MAlonzo.Code.Ledger.PParams.T_PParams_244
d_pparams_2186 v0
  = case coe v0 of
      C_GovEnv'46'constructor_6017 v1 v2 v3 v4 v5 v6 v7 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.ppolicy
d_ppolicy_2188 :: T_GovEnv_2166 -> Maybe AgdaAny
d_ppolicy_2188 v0
  = case coe v0 of
      C_GovEnv'46'constructor_6017 v1 v2 v3 v4 v5 v6 v7 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.enactState
d_enactState_2190 ::
  T_GovEnv_2166 -> MAlonzo.Code.Ledger.Enact.T_EnactState_844
d_enactState_2190 v0
  = case coe v0 of
      C_GovEnv'46'constructor_6017 v1 v2 v3 v4 v5 v6 v7 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_certState_2192 v0
  = case coe v0 of
      C_GovEnv'46'constructor_6017 v1 v2 v3 v4 v5 v6 v7 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GovEnv.rewardCreds
d_rewardCreds_2194 ::
  T_GovEnv_2166 -> [MAlonzo.Code.Ledger.Address.T_Credential_16]
d_rewardCreds_2194 v0
  = case coe v0 of
      C_GovEnv'46'constructor_6017 v1 v2 v3 v4 v5 v6 v7 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_To'45'GovEnv_2196 ~v0 ~v1 = du_To'45'GovEnv_2196
du_To'45'GovEnv_2196 :: MAlonzo.Code.Class.To.T_To_8
du_To'45'GovEnv_2196
  = coe
                  ...
                  (coe
                     ...
                     (coe
                        ...
                        (coe
                           ...
                           (coe
                              (MAlonzo.RTE.QName
                                 (2166 :: Integer) (14950884968918448145 :: Integer)
                                 "Ledger.Conway.Conformance.Gov.GovEnv"
                              ...
                              (coe
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          (MAlonzo.RTE.QName
                                             (1534 :: Integer) (14950884968918448145 :: Integer)
                                             "Ledger.Conway.Conformance.Gov._.EnactState"
                                             (MAlonzo.RTE.Fixity
                                                MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                       (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          ...
                                          (coe
                                             (MAlonzo.RTE.QName
                                                (1664 :: Integer) (14950884968918448145 :: Integer)
                                                "Ledger.Conway.Conformance.Gov._.CertState"
                                                (MAlonzo.RTE.Fixity
                                                   MAlonzo.RTE.NonAssoc MAlonzo.RTE.Unrelated)))
                                          (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))
                                          ...
                                          (coe
                                             ...
                                             (coe
                                                ...
                                                (coe
                                                   MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
                                 (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))))))
         (coe C_GovEnv'46'constructor_6017))
-- Ledger.Conway.Conformance.Gov._⊢_⇀⦇_,GOVS⦈_
d__'8866'_'8640''10631'_'44'GOVS'10632'__2198 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1746 ->
  T_GovEnv_2166 ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> ()
d__'8866'_'8640''10631'_'44'GOVS'10632'__2198 = erased
...
d_certState_2214 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1096
d_certState_2214 v0 ~v1 ~v2 ~v3 = du_certState_2214 v0
du_certState_2214 ::
  T_GovEnv_2166 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1096
du_certState_2214 v0 = coe d_certState_2192 (coe v0)
...
d_enactState_2216 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.Enact.T_EnactState_844
d_enactState_2216 v0 ~v1 ~v2 ~v3 = du_enactState_2216 v0
du_enactState_2216 ::
  T_GovEnv_2166 -> MAlonzo.Code.Ledger.Enact.T_EnactState_844
du_enactState_2216 v0 = coe d_enactState_2190 (coe v0)
...
d_epoch_2218 v0 ~v1 ~v2 ~v3 = du_epoch_2218 v0
du_epoch_2218 :: T_GovEnv_2166 -> AgdaAny
du_epoch_2218 v0 = coe d_epoch_2184 (coe v0)
...
d_pparams_2220 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  MAlonzo.Code.Ledger.PParams.T_PParams_244
d_pparams_2220 v0 ~v1 ~v2 ~v3 = du_pparams_2220 v0
du_pparams_2220 ::
  T_GovEnv_2166 -> MAlonzo.Code.Ledger.PParams.T_PParams_244
du_pparams_2220 v0 = coe d_pparams_2186 (coe v0)
...
d_ppolicy_2222 v0 ~v1 ~v2 ~v3 = du_ppolicy_2222 v0
du_ppolicy_2222 :: T_GovEnv_2166 -> Maybe AgdaAny
du_ppolicy_2222 v0 = coe d_ppolicy_2188 (coe v0)
...
d_rewardCreds_2224 ::
  ...
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] ->
  [MAlonzo.Code.Ledger.Address.T_Credential_16]
d_rewardCreds_2224 v0 ~v1 ~v2 ~v3 = du_rewardCreds_2224 v0
du_rewardCreds_2224 ::
  T_GovEnv_2166 -> [MAlonzo.Code.Ledger.Address.T_Credential_16]
du_rewardCreds_2224 v0 = coe d_rewardCreds_2194 (coe v0)
...
d_txid_2226 ::
  ...
  [MAlonzo.Code.Data.Sum.Base.T__'8846'__30] ->
  [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] -> AgdaAny
d_txid_2226 v0 ~v1 ~v2 ~v3 = du_txid_2226 v0
du_txid_2226 :: T_GovEnv_2166 -> AgdaAny
du_txid_2226 v0 = coe d_txid_2182 (coe v0)
