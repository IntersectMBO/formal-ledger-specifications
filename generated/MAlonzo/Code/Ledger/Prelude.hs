...
d_HasSingletonSet'45'Map_8 ::
  () -> () -> MAlonzo.Code.Interface.HasSingleton.T_HasSingleton_302
d_HasSingletonSet'45'Map_8 v0 v1
  = coe
      MAlonzo.Code.Interface.HasSingleton.du_HasSingletonSet'45'Map_320
      (coe
...
d_'10100'_'10101'_12 v0
  = coe
      MAlonzo.Code.Interface.HasSingleton.d_'10100'_'10101'_310 (coe v0)
...
d_HasEmptySet'45'Map_20 v0 v1
  = coe
      MAlonzo.Code.Interface.HasEmptySet.Instances.du_HasEmptySet'45'Map_308
      (coe
         MAlonzo.Code.Axiom.Set.d_th_1470
         (coe MAlonzo.Code.Ledger.Set.Theory.d_List'45'Model'7496'_10))
...
d_HasCoin'45'Map_44 ~v0 v1 = du_HasCoin'45'Map_44 v1
du_HasCoin'45'Map_44 ::
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  MAlonzo.Code.Ledger.Interface.HasCoin.T_HasCoin_10
du_HasCoin'45'Map_44 v0
  = coe
      MAlonzo.Code.Ledger.Interface.HasCoin.C_HasCoin'46'constructor_9
      (coe
         (\ v1 ->
            coe
              MAlonzo.Code.Ledger.Set.Theory.du_indexedSum'7515'''_1170 (coe v0)
              (coe
...
d_HasCoin'45'Set_52 ::
  ...
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  MAlonzo.Code.Ledger.Interface.HasCoin.T_HasCoin_10
d_HasCoin'45'Set_52 ~v0 v1 = du_HasCoin'45'Set_52 v1
du_HasCoin'45'Set_52 ::
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10 ->
  MAlonzo.Code.Ledger.Interface.HasCoin.T_HasCoin_10
du_HasCoin'45'Set_52 v0
  = coe
      MAlonzo.Code.Ledger.Interface.HasCoin.C_HasCoin'46'constructor_9
      (coe
         (\ v1 ->
            coe
              MAlonzo.Code.Ledger.Set.Theory.du_indexedSum''_1176
              (coe
...
d_'8801''7497''45'getCoin_70 = erased
