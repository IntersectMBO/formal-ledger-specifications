...
d__'8866'_'8640''10631'_'44'UTXOS'10632'__1708 a0 a1 a2 a3 a4 a5
  = ()
-- Ledger.Utxo.Haskell.Properties._._⊢_⇀⦇_,UTXO⦈_
d__'8866'_'8640''10631'_'44'UTXO'10632'__1710 a0 a1 a2 a3 a4 a5
  = ()
-- Ledger.Utxo.Haskell.Properties.Computational-UTXOS
d_Computational'45'UTXOS_1860 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1598 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'UTXOS_1860 v0 v1
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (d_computeProof_1954 (coe v0) (coe v1))
...
d_computeProof_1954 v0 v1 v2 v3 v4
  = let v5
          = coe
                                                                ...
                                                                (coe
                                                                   ...
                                                                   (coe
                                                                      ...
                                                                      (coe
                                                                         ...
                                                                         (coe v3)))
                                                                   (coe
                                                                      MAlonzo.Code.Ledger.Utxo.Haskell.du_updateCertDepositsUtxo_1724
                                                                      (coe v0)
                                                                      (coe
                                                                      ...
                                                                      (coe
                                                                         ...
                                                                         (coe
                                                                            ...
                                                                            (coe v4)))
                                                                      (coe
                                                                         MAlonzo.Code.Ledger.Utxo.Haskell.du_updateProposalDeposits_1736
                                                                         (coe v0)
                                                                         (coe
                                                                   ...
                                                                   (coe
                                                                      ...
                                                                      (coe
                                                                         ...
                                                                         (coe v3))))
                                                                (coe
                                                                   MAlonzo.Code.Ledger.Utxo.Haskell.C_Scripts'45'Yes_1994
                                                                   v11))
                                                      _ -> coe v10
                                               _ -> coe v10
                                                              ...
                                                              (coe
                                                                 ...
                                                                 (coe
                                                                    ...
                                                                    (coe
                                                                       ...
                                                                       (coe v3)))
                                                                 (coe
                                                                    MAlonzo.Code.Ledger.Utxo.Haskell.C_Scripts'45'No_2074
                                                                    v14))
                                                       _ -> coe v10
                                                _ -> coe v10
                                         _ -> MAlonzo.RTE.mazUnreachableError
...
d_completeness_1964 ::
  ...
  MAlonzo.Code.Ledger.Transaction.T_Tx_2726 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_1812 ->
  MAlonzo.Code.Ledger.Utxo.Haskell.T__'8866'_'8640''10631'_'44'UTXOS'10632'__1914 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_completeness_1964 = erased
-- Ledger.Utxo.Haskell.Properties.Computational-UTXO''
d_Computational'45'UTXO''''_1994 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1598 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_Computational_232
d_Computational'45'UTXO''''_1994 v0 v1
  = coe
      MAlonzo.Code.Interface.ComputationalRelation.C_MkComputational_412
      (d_computeProof_2148 (coe v0) (coe v1))
...
d_genErr_2032 v0 v1 v2 v3 v4 ~v5 = du_genErr_2032 v0 v1 v2 v3 v4
du_genErr_2032 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1598 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_1798 ->
...
d_computeProofH_2112 ::
  ...
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_computeProofH_2112 v0 v1 v2 v3 v4 v5
  = case coe v5 of
      MAlonzo.Code.Relation.Nullary.Decidable.Core.C__because__32 v6 v7
        -> if coe v6
             then case coe v7 of
                                                                                                                             ...
                                                                                                                             (coe
                                                                                                                                ...
                                                                                                                                (coe
                                                                                                                                   (\ v37
                                                                                                                                      v38 ->
                                                                                                                                      coe
                                                                                                                                        MAlonzo.Code.Ledger.Utxo.Haskell.C_UTXO'45'inductive_2170
                                                                                                                                        (coe
                                                                                                                                           MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
                                                                                                                                           (coe
                                                                                                                                              v9)
                    ...
                    (coe
                       MAlonzo.Code.Interface.ComputationalRelation.C_failure_44
                       (coe du_genErr_2032 (coe v0) (coe v1) (coe v2) (coe v3) (coe v4)))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Utxo.Haskell.Properties._.Go.computeProof
d_computeProof_2148 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  ...
  MAlonzo.Code.Ledger.Transaction.T_Tx_2726 ->
  MAlonzo.Code.Interface.ComputationalRelation.T_ComputationResult_34
d_computeProof_2148 v0 v1 v2 v3 v4
  = coe
      d_computeProofH_2112 (coe v0) (coe v1) (coe v2) (coe v3) (coe v4)
      (coe
         MAlonzo.Code.Class.Decidable.Core.d_dec_16
         (coe
            MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
...
d_completeness_2152 ::
  ...
  MAlonzo.Code.Ledger.Transaction.T_Tx_2726 ->
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_1812 ->
  MAlonzo.Code.Ledger.Utxo.Haskell.T__'8866'_'8640''10631'_'44'UTXO'10632'__2076 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_completeness_2152 = erased
