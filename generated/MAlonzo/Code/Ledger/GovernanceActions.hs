...
d_GovAction_712 a0 = ()
data T_GovAction_712
  = C_'10214'_'44'_'10215''7501''7491'_722 T_GovActionType_694
                                           AgdaAny
-- Ledger.GovernanceActions.GovAction.gaType
d_gaType_718 :: T_GovAction_712 -> T_GovActionType_694
d_gaType_718 v0
  = case coe v0 of
      C_'10214'_'44'_'10215''7501''7491'_722 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovAction.gaData
d_gaData_720 :: T_GovAction_712 -> AgdaAny
d_gaData_720 v0
  = case coe v0 of
      C_'10214'_'44'_'10215''7501''7491'_722 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_HashProtected_726 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 -> () -> ()
d_HashProtected_726 = erased
-- Ledger.GovernanceActions.Vote
d_Vote_730 a0 = ()
data T_Vote_730 = C_yes_732 | C_no_734 | C_abstain_736
-- Ledger.GovernanceActions.GovVote
d_GovVote_738 a0 = ()
data T_GovVote_738
  = C_GovVote'46'constructor_3585 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                                  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 T_Vote_730
                                  (Maybe T_Anchor_684)
-- Ledger.GovernanceActions.GovVote.gid
d_gid_748 ::
  T_GovVote_738 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_gid_748 v0
  = case coe v0 of
      C_GovVote'46'constructor_3585 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_voter_750 v0
  = case coe v0 of
      C_GovVote'46'constructor_3585 v1 v2 v3 v4 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovVote.vote
d_vote_752 :: T_GovVote_738 -> T_Vote_730
d_vote_752 v0
  = case coe v0 of
      C_GovVote'46'constructor_3585 v1 v2 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovVote.anchor
d_anchor_754 :: T_GovVote_738 -> Maybe T_Anchor_684
d_anchor_754 v0
  = case coe v0 of
      C_GovVote'46'constructor_3585 v1 v2 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovProposal
d_GovProposal_756 a0 = ()
data T_GovProposal_756
  = C_GovProposal'46'constructor_3975 T_GovAction_712 AgdaAny
                                      (Maybe AgdaAny) Integer
                                      MAlonzo.Code.Ledger.Address.T_RwdAddr_76 T_Anchor_684
-- Ledger.GovernanceActions.GovProposal.action
d_action_770 :: T_GovProposal_756 -> T_GovAction_712
d_action_770 v0
  = case coe v0 of
      C_GovProposal'46'constructor_3975 v1 v2 v3 v4 v5 v6 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovProposal.prevAction
d_prevAction_772 :: T_GovProposal_756 -> AgdaAny
d_prevAction_772 v0
  = case coe v0 of
      C_GovProposal'46'constructor_3975 v1 v2 v3 v4 v5 v6 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovProposal.policy
d_policy_774 :: T_GovProposal_756 -> Maybe AgdaAny
d_policy_774 v0
  = case coe v0 of
      C_GovProposal'46'constructor_3975 v1 v2 v3 v4 v5 v6 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovProposal.deposit
d_deposit_776 :: T_GovProposal_756 -> Integer
d_deposit_776 v0
  = case coe v0 of
      C_GovProposal'46'constructor_3975 v1 v2 v3 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovProposal.returnAddr
d_returnAddr_778 ::
  T_GovProposal_756 -> MAlonzo.Code.Ledger.Address.T_RwdAddr_76
d_returnAddr_778 v0
  = case coe v0 of
      C_GovProposal'46'constructor_3975 v1 v2 v3 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovProposal.anchor
d_anchor_780 :: T_GovProposal_756 -> T_Anchor_684
d_anchor_780 v0
  = case coe v0 of
      C_GovProposal'46'constructor_3975 v1 v2 v3 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovActionState
d_GovActionState_782 a0 = ()
data T_GovActionState_782
  = C_GovActionState'46'constructor_4343 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                                         MAlonzo.Code.Ledger.Address.T_RwdAddr_76 AgdaAny
                                         T_GovAction_712 AgdaAny
-- Ledger.GovernanceActions.GovActionState.votes
d_votes_794 ::
  T_GovActionState_782 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_votes_794 v0
  = case coe v0 of
      C_GovActionState'46'constructor_4343 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovActionState.returnAddr
d_returnAddr_796 ::
  T_GovActionState_782 -> MAlonzo.Code.Ledger.Address.T_RwdAddr_76
d_returnAddr_796 v0
  = case coe v0 of
      C_GovActionState'46'constructor_4343 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovActionState.expiresIn
d_expiresIn_798 :: T_GovActionState_782 -> AgdaAny
d_expiresIn_798 v0
  = case coe v0 of
      C_GovActionState'46'constructor_4343 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovActionState.action
d_action_800 :: T_GovActionState_782 -> T_GovAction_712
d_action_800 v0
  = case coe v0 of
      C_GovActionState'46'constructor_4343 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovActionState.prevAction
d_prevAction_802 :: T_GovActionState_782 -> AgdaAny
d_prevAction_802 v0
  = case coe v0 of
      C_GovActionState'46'constructor_4343 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_DecEq'45'Vote_808 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'Vote_808 ~v0 = du_DecEq'45'Vote_808
du_DecEq'45'Vote_808 :: MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
du_DecEq'45'Vote_808
  = coe
      MAlonzo.Code.Class.DecEq.Core.C_DecEq'46'constructor_31
      (coe
         (\ v0 ->
                          ...
                          C_credVoter_678 v5 v6
                            -> coe
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       MAlonzo.Code.Class.DecEq.Core.d__'8799'__16
                                       (coe du_DecEq'45'GovRole_806) v5 v2))
                                 (coe
                                    MAlonzo.Code.Function.Bundles.du_mk'8660'_2298 erased
                                    (coe
                                       (\ v7 ->
...
d_To'45'GovVote_812 ~v0 = du_To'45'GovVote_812
du_To'45'GovVote_812 :: MAlonzo.Code.Class.To.T_To_8
du_To'45'GovVote_812
  = coe
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          ...
                                          (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16)))))))
                        (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))))))
         (coe C_GovVote'46'constructor_3585))
-- Ledger.GovernanceActions.getDRepVote
d_getDRepVote_814 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 ->
  T_GovVote_738 -> Maybe MAlonzo.Code.Ledger.Address.T_Credential_16
d_getDRepVote_814 ~v0 v1 = du_getDRepVote_814 v1
du_getDRepVote_814 ::
  T_GovVote_738 -> Maybe MAlonzo.Code.Ledger.Address.T_Credential_16
du_getDRepVote_814 v0
  = case coe v0 of
      C_GovVote'46'constructor_3585 v1 v2 v3 v4
        -> case coe v2 of
...
d_proposedCC_818 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 ->
  T_GovAction_712 -> [MAlonzo.Code.Ledger.Address.T_Credential_16]
d_proposedCC_818 ~v0 v1 = du_proposedCC_818 v1
du_proposedCC_818 ::
  T_GovAction_712 -> [MAlonzo.Code.Ledger.Address.T_Credential_16]
du_proposedCC_818 v0
  = case coe v0 of
      C_'10214'_'44'_'10215''7501''7491'_722 v1 v2
        -> let v3
                 = coe
