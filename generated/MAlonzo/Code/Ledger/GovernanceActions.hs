...
d_UpdateT_158 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 -> ()
d_UpdateT_158 = erased
-- _.ProtVer
d_ProtVer_170 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 -> ()
d_ProtVer_170 = erased
-- _.RwdAddr
d_RwdAddr_176 a0 a1 a2 a3 = ()
-- _.ScriptHash
d_ScriptHash_190 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 -> ()
d_ScriptHash_190 = erased
-- _.RwdAddr.net
...
d_Anchor_682 a0 = ()
data T_Anchor_682
  = C_Anchor'46'constructor_2047 MAlonzo.Code.Agda.Builtin.String.T_String_6
                                 AgdaAny
...
d_url_688 v0
  = case coe v0 of
      C_Anchor'46'constructor_2047 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.Anchor.hash
d_hash_690 :: T_Anchor_682 -> AgdaAny
d_hash_690 v0
  = case coe v0 of
      C_Anchor'46'constructor_2047 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
                ...
                (coe
                   ...
                   (coe
                      ...
                      (MAlonzo.Code.Ledger.PParams.d_ppUpd_1210
                         (coe
                            MAlonzo.Code.Ledger.Types.GovStructure.d_govParams_1016 (coe v0)))
                      v2)
                   (coe
...
d_GovVote_734 a0 = ()
data T_GovVote_734
  = C_GovVote'46'constructor_6015 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_gid_744 v0
  = case coe v0 of
      C_GovVote'46'constructor_6015 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_returnAddr_774 v0
  = case coe v0 of
      C_GovProposal'46'constructor_6385 v1 v2 v3 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovProposal.anchor
d_anchor_776 :: T_GovProposal_752 -> T_Anchor_682
d_anchor_776 v0
  = case coe v0 of
      C_GovProposal'46'constructor_6385 v1 v2 v3 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovActionState
d_GovActionState_778 a0 = ()
data T_GovActionState_778
  = C_GovActionState'46'constructor_6733 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_votes_790 v0
  = case coe v0 of
      C_GovActionState'46'constructor_6733 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_getDRepVote_806 v0
  = case coe v0 of
      C_GovVote'46'constructor_6015 v1 v2 v3 v4
        -> case coe v2 of
