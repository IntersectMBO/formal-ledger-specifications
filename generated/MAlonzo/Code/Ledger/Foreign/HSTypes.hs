...
module MAlonzo.Code.Ledger.Foreign.HSTypes where
...
instance Monad (ComputationResult e) where
  ...
  (Success a) >>= m = m a
  (Failure e) >>= _ = Failure e
-- Ledger.Foreign.HSTypes.Empty
d_Empty_6 = ()
type T_Empty_6 = Void
cover_Empty_6 :: Void -> ()
cover_Empty_6 x = case x of
-- Ledger.Foreign.HSTypes.Rational
d_Rational_8 = ()
...
cover_HSMap_16 x
  = case x of
      MkHSMap _ -> ()
-- Ledger.Foreign.HSTypes.HSMap.assocList
d_assocList_24 ::
...
cover_HSSet_30 x
  = case x of
      MkHSSet _ -> ()
-- Ledger.Foreign.HSTypes.HSSet.elems
d_elems_36 :: T_HSSet_30 AgdaAny -> [AgdaAny]
d_elems_36 v0
  = case coe v0 of
      C_MkHSSet_38 v1 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Foreign.HSTypes.ComputationResult
