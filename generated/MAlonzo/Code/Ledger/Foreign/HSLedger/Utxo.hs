...
data UTxOState = MkUTxOState {utxo :: (MAlonzo.Code.Ledger.Foreign.HSTypes.HSMap (Integer, Integer) ((Either MAlonzo.Code.Ledger.Foreign.HSLedger.Address.BaseAddr MAlonzo.Code.Ledger.Foreign.HSLedger.Address.BootstrapAddr), (Integer, ((Maybe (Either () ())), (Maybe (Either MAlonzo.Code.Ledger.Foreign.HSLedger.Transaction.HashedTimelock Integer)))))), fees :: Integer, deposits :: (MAlonzo.Code.Ledger.Foreign.HSTypes.HSMap MAlonzo.Code.Ledger.Foreign.HSLedger.Certs.DepositPurpose Integer), donations :: Integer}
  deriving (Show, Eq, Generic)
type UTxO = (MAlonzo.Code.Ledger.Foreign.HSTypes.HSMap (Integer, Integer) ((Either MAlonzo.Code.Ledger.Foreign.HSLedger.Address.BaseAddr MAlonzo.Code.Ledger.Foreign.HSLedger.Address.BootstrapAddr), (Integer, ((Maybe (Either () ())), (Maybe (Either MAlonzo.Code.Ledger.Foreign.HSLedger.Transaction.HashedTimelock Integer))))))
...
d_slot_136 :: MAlonzo.Code.Ledger.Utxo.T_UTxOEnv_1938 -> Integer
d_slot_136 v0 = coe MAlonzo.Code.Ledger.Utxo.d_slot_1946 (coe v0)
...
d_fees_146 :: MAlonzo.Code.Ledger.Utxo.T_UTxOState_1952 -> Integer
d_fees_146 v0 = coe MAlonzo.Code.Ledger.Utxo.d_fees_1964 (coe v0)
-- Ledger.Foreign.HSLedger.Utxo._.UTxOState.utxo
d_utxo_148 ::
  MAlonzo.Code.Ledger.Utxo.T_UTxOState_1952 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_utxo_148 v0 = coe MAlonzo.Code.Ledger.Utxo.d_utxo_1962 (coe v0)
...
d_Conv'45'UTxOEnv_252
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Utxo.C_UTxOEnv'46'constructor_8915 v1 v2 v3
                -> coe
         ...
         (\ v0 ->
            case coe v0 of
              C_MkUTxOEnv_723 v1 v2 v3
                -> coe
                     MAlonzo.Code.Ledger.Utxo.C_UTxOEnv'46'constructor_8915 (coe v1)
                     (coe
...
d_Conv'45'UTxOState_256
  = coe
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              MAlonzo.Code.Ledger.Utxo.C_'10214'_'44'_'44'_'44'_'10215''7512'_1970 v1 v2 v3 v4
                -> coe
                     C_MkUTxOState_1713
                     (coe
...
d_utxo'45'step_258 v0
  = coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.Ledger.Utxo.Properties.d_Computational'45'UTXO_2458
            (coe
...
d_utxo'45'step''_260 v0
  = coe
      ...
      (coe
         MAlonzo.Code.Interface.ComputationalRelation.du_compute_274
         (coe
            MAlonzo.Code.Ledger.Utxo.Properties.d_Computational'45'UTXO''_2132
            (coe
               MAlonzo.Code.Ledger.Foreign.HSLedger.Core.d_HSTransactionStructure_862)
            (coe
               MAlonzo.Code.Ledger.Foreign.HSLedger.Core.d_HSAbstractFunctions_2602))
...
d_utxow'45'step_262 v0
  = coe
      ...
      (coe
         MAlonzo.Code.Interface.ComputationalRelation.du_compute_274
         (coe
            MAlonzo.Code.Ledger.Utxow.Properties.d_Computational'45'UTXOW_2026
            (coe
               MAlonzo.Code.Ledger.Foreign.HSLedger.Core.d_HSTransactionStructure_862)
            (coe
               MAlonzo.Code.Ledger.Foreign.HSLedger.Core.d_HSAbstractFunctions_2602))
       ...
       (MAlonzo.Code.Foreign.Haskell.Pair.T_Pair_22
          ...
          (MAlonzo.Code.Foreign.Haskell.Pair.T_Pair_22
             ...
             (MAlonzo.Code.Agda.Builtin.Maybe.T_Maybe_10
                ...
                (MAlonzo.Code.Foreign.Haskell.Either.T_Either_22
                   () ()
                   MAlonzo.Code.Ledger.Foreign.HSLedger.Transaction.T_HashedTimelock_1985
                   Integer))))) ->
  Integer ->
  MAlonzo.Code.Ledger.Foreign.HSTypes.T_HSMap_16
