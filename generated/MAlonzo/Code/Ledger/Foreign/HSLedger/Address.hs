...
module MAlonzo.Code.Ledger.Foreign.HSLedger.Address where
...
data BaseAddr = BaseAddr {baseNet :: (), basePay :: MAlonzo.Code.Ledger.Foreign.HSLedger.Address.Credential, baseStake :: MAlonzo.Code.Ledger.Foreign.HSLedger.Address.Credential}
  deriving (Show, Eq, Generic)
data BootstrapAddr = BootstrapAddr {bootNet :: (), bootPay :: MAlonzo.Code.Ledger.Foreign.HSLedger.Address.Credential, bootAttrsSize :: Integer}
  deriving (Show, Eq, Generic)
...
d_HsTy'45'Credential_8 = erased
-- Ledger.Foreign.HSLedger.Address.Conv-Credential
d_Conv'45'Credential_10 ::
      ...
      (coe
         (\ v0 ->
            case coe v0 of
              ...
              _ -> MAlonzo.RTE.mazUnreachableError))
-- Ledger.Foreign.HSLedger.Address.HsTy-BaseAddr
d_HsTy'45'BaseAddr_12 ::
  MAlonzo.Code.Foreign.HaskellTypes.T_HasHsType_14
d_HsTy'45'BaseAddr_12 = erased
-- Ledger.Foreign.HSLedger.Address.Conv-BaseAddr
d_Conv'45'BaseAddr_14 ::
  MAlonzo.Code.Foreign.Convertible.T_Convertible_8
d_Conv'45'BaseAddr_14
  = coe
      MAlonzo.Code.Foreign.Convertible.C_Convertible'46'constructor_21
              ...
              C_BaseAddr_725 v1 v2 v3
                -> coe
                     ...
                     (coe
                        ...
                        v3)
              _ -> MAlonzo.RTE.mazUnreachableError))
-- Ledger.Foreign.HSLedger.Address.HsTy-BootstrapAddr
d_HsTy'45'BootstrapAddr_16 ::
  MAlonzo.Code.Foreign.HaskellTypes.T_HasHsType_14
d_HsTy'45'BootstrapAddr_16 = erased
-- Ledger.Foreign.HSLedger.Address.Conv-BootstrapAddr
d_Conv'45'BootstrapAddr_18 ::
  MAlonzo.Code.Foreign.Convertible.T_Convertible_8
d_Conv'45'BootstrapAddr_18
  = coe
      MAlonzo.Code.Foreign.Convertible.C_Convertible'46'constructor_21
            ...
            case coe v0 of
              C_BootstrapAddr_2373 v1 v2 v3
                -> coe
                     ...
                     (coe v3)
              _ -> MAlonzo.RTE.mazUnreachableError))
-- Ledger.Foreign.HSLedger.Address.HsTy-RwdAddr
d_HsTy'45'RwdAddr_20 ::
  MAlonzo.Code.Foreign.HaskellTypes.T_HasHsType_14
d_HsTy'45'RwdAddr_20 = erased
-- Ledger.Foreign.HSLedger.Address.Conv-RwdAddr
d_Conv'45'RwdAddr_22 ::
  MAlonzo.Code.Foreign.Convertible.T_Convertible_8
d_Conv'45'RwdAddr_22
  = coe
      MAlonzo.Code.Foreign.Convertible.C_Convertible'46'constructor_21
              ...
              C_RwdAddr_3769 v1 v2
                -> coe
                     ...
                     (coe
                        ...
                        v2)
              _ -> MAlonzo.RTE.mazUnreachableError))
-- Ledger.Foreign.HSLedger.Address.Credential
d_Credential_27 = ()
...
cover_Credential_27 x
  = case x of
      KeyHashObj _ -> ()
      ScriptObj _ -> ()
-- Ledger.Foreign.HSLedger.Address.BaseAddr
d_BaseAddr_723 = ()
...
cover_BaseAddr_723 x
  = case x of
      BaseAddr _ _ _ -> ()
-- Ledger.Foreign.HSLedger.Address.BootstrapAddr
...
cover_BootstrapAddr_2371 x
  = case x of
      BootstrapAddr _ _ _ -> ()
-- Ledger.Foreign.HSLedger.Address.RwdAddr
d_RwdAddr_3767 = ()
