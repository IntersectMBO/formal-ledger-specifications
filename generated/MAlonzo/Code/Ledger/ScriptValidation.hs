...
d_ScriptPurpose_1736 a0 a1 = ()
data T_ScriptPurpose_1736
  = C_Cert_1738 MAlonzo.Code.Ledger.Certs.T_DCert_840 |
    C_Rwrd_1740 MAlonzo.Code.Ledger.Address.T_RwdAddr_76 |
    C_Mint_1742 AgdaAny |
    C_Spend_1744 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 |
    C_Vote_1746 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 |
    C_Propose_1748 MAlonzo.Code.Ledger.GovernanceActions.T_GovProposal_748
-- Ledger.ScriptValidation.rdptr
d_rdptr_1750 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1732 ->
  MAlonzo.Code.Ledger.Transaction.T_TxBody_2528 ->
  T_ScriptPurpose_1736 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_rdptr_1750 v0 v1 v2 v3
  = case coe v3 of
      C_Cert_1738 v4
        -> coe
             ...
             (coe
                MAlonzo.Code.Ledger.Abstract.d_indexOfDCert_1720
                (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1748 (coe v1)) v4
                (MAlonzo.Code.Ledger.Transaction.d_txcerts_2582 (coe v2)))
      C_Rwrd_1740 v4
        -> coe
             MAlonzo.Code.Data.Maybe.Base.du_map_64
             (\ v5 ->
             ...
             (coe
                MAlonzo.Code.Ledger.Abstract.d_indexOfRwdAddr_1722
                (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1748 (coe v1)) v4
                (MAlonzo.Code.Ledger.Transaction.d_txwdrls_2584 (coe v2)))
      C_Mint_1742 v4
        -> coe
             MAlonzo.Code.Data.Maybe.Base.du_map_64
             (\ v5 ->
             ...
             (coe
                MAlonzo.Code.Ledger.Abstract.d_indexOfPolicyId_1726
                (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1748 (coe v1)) v4
                (coe
                   MAlonzo.Code.Ledger.TokenAlgebra.d_policies_204
                   (MAlonzo.Code.Ledger.Transaction.d_tokenAlgebra_2216 (coe v0))
                   (MAlonzo.Code.Ledger.Transaction.d_mint_2578 (coe v2))))
      C_Spend_1744 v4
        -> coe
             MAlonzo.Code.Data.Maybe.Base.du_map_64
             (\ v5 ->
             ...
             (coe
                MAlonzo.Code.Ledger.Abstract.d_indexOfTxIn_1724
                (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1748 (coe v1)) v4
                (MAlonzo.Code.Ledger.Transaction.d_txins_2570 (coe v2)))
      C_Vote_1746 v4
        -> coe
             MAlonzo.Code.Data.Maybe.Base.du_map_64
             (\ v5 ->
             ...
             (coe
                MAlonzo.Code.Ledger.Abstract.d_indexOfVote_1728
                (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1748 (coe v1)) v4
                (coe
                   ...
                   (MAlonzo.Code.Ledger.Transaction.d_txvote_2586 (coe v2))))
      C_Propose_1748 v4
        -> coe
             MAlonzo.Code.Data.Maybe.Base.du_map_64
             (\ v5 ->
             ...
             (coe
                MAlonzo.Code.Ledger.Abstract.d_indexOfProposal_1730
                (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1748 (coe v1)) v4
                (MAlonzo.Code.Ledger.Transaction.d_txprop_2588 (coe v2)))
...
d_indexedRdmrs_1826 ::
  ...
  T_ScriptPurpose_1736 ->
  Maybe MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_indexedRdmrs_1826 v0 v1 v2 v3
  = coe
...
d_getDatum_1860 ::
  ...
  MAlonzo.Code.Ledger.Transaction.T_Tx_2630 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  T_ScriptPurpose_1736 -> [AgdaAny]
d_getDatum_1860 v0 ~v1 v2 v3 v4 = du_getDatum_1860 v0 v2 v3 v4
du_getDatum_1860 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2630 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  T_ScriptPurpose_1736 -> [AgdaAny]
du_getDatum_1860 v0 v1 v2 v3
...
d_TxInfo_1900 a0 a1 = ()
data T_TxInfo_1900
  = C_TxInfo'46'constructor_17073 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_realizedInputs_1922 ::
  T_TxInfo_1900 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_realizedInputs_1922 v0
  = case coe v0 of
      C_TxInfo'46'constructor_17073 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_fee_1926 :: T_TxInfo_1900 -> AgdaAny
d_fee_1926 v0
  = case coe v0 of
      C_TxInfo'46'constructor_17073 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v3
...
d_mint_1928 :: T_TxInfo_1900 -> AgdaAny
d_mint_1928 v0
  = case coe v0 of
      C_TxInfo'46'constructor_17073 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v4
...
d_txcerts_1930 ::
  T_TxInfo_1900 -> [MAlonzo.Code.Ledger.Certs.T_DCert_840]
d_txcerts_1930 v0
  = case coe v0 of
      C_TxInfo'46'constructor_17073 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v5
...
d_vkKey_1936 :: T_TxInfo_1900 -> [AgdaAny]
d_vkKey_1936 v0
  = case coe v0 of
      C_TxInfo'46'constructor_17073 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v8
...
d_txid_1940 :: T_TxInfo_1900 -> AgdaAny
d_txid_1940 v0
  = case coe v0 of
      C_TxInfo'46'constructor_17073 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v10
...
d_txInfo_1942 ::
  ...
  MAlonzo.Code.Ledger.PParams.T_PParams_244 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2630 -> T_TxInfo_1900
d_txInfo_1942 v0 ~v1 ~v2 ~v3 v4 v5 = du_txInfo_1942 v0 v4 v5
du_txInfo_1942 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2630 -> T_TxInfo_1900
du_txInfo_1942 v0 v1 v2
  = coe
      C_TxInfo'46'constructor_17073
      (coe
      ...
      (coe
         ...
         (coe MAlonzo.Code.Ledger.Transaction.d_body_2640 (coe v2)))
      (coe
         MAlonzo.Code.Ledger.Transaction.d_reqSigHash_2606
         (coe MAlonzo.Code.Ledger.Transaction.d_body_2640 (coe v2)))
      (coe
         MAlonzo.Code.Ledger.Transaction.d_txdats_2624
         (coe MAlonzo.Code.Ledger.Transaction.d_wits_2642 (coe v2)))
...
d_DelegateOrDeReg_2066 a0 a1 a2 = ()
data T_DelegateOrDeReg_2066
  = C_reg_2072 | C_delegate_2082 | C_dereg_2088 | C_regdrep_2096 |
    C_deregdrep_2102
         ...
         (coe
            ...
            (coe
               ...
               (coe
                  ...
                  (coe MAlonzo.Code.Ledger.Transaction.d_txwdrls_2584 (coe v2)))))
         (coe
            MAlonzo.Code.Axiom.Set.du__'8746'__680
            (coe
               MAlonzo.Code.Axiom.Set.d_th_1470
...
d_valContext_2292 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  MAlonzo.Code.Ledger.Abstract.T_AbstractFunctions_1732 ->
  T_TxInfo_1900 -> T_ScriptPurpose_1736 -> AgdaAny
                 ...
                 = coe
                     ...
                     (coe
                        ...
                        (coe
                           MAlonzo.Code.Axiom.Set.Map.du__'738'_550
                           (coe
                              MAlonzo.Code.Ledger.Transaction.du_m_2762 (coe v0) (coe v3)
                              (coe v4)))) in
           coe
             (case coe v8 of
                                                      ...
                                                      (case coe v6 of
                                                         C_Cert_1738 v15
                                                           -> coe
                                                                ...
                                                                (coe
                                                                   MAlonzo.Code.Ledger.Abstract.d_indexOfDCert_1720
                                                                   (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1748
                                                                      (coe v1))
                                                                   v15
                                                                   (MAlonzo.Code.Ledger.Transaction.d_txcerts_2582
                                                                      (coe v14)))
                                                           ...
                                                           -> coe
                                                                ...
                                                                (coe
                                                                   ...
                                                                   (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1748
                                                                      (coe v1))
                                                                   v15
                                                                   (MAlonzo.Code.Ledger.Transaction.d_txprop_2588
                                                                      (coe v14)))
...
d_'10214'_'10215''44'_'44'_'44'__2382 v0 v1 v2 v3 v4
  = coe
      MAlonzo.Code.Ledger.Abstract.d_runPLCScript_1750 v0 v2 v1 v3 v4
                             ...
                             -> case coe v10 of
                                  MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v11 v12
                                    -> coe
                                         MAlonzo.Code.Data.Bool.Base.d__'8743'__24
                                         (coe
                                            MAlonzo.Code.Ledger.Abstract.d_runPLCScript_1750 v1 v12
                                            v8 v11 v9)
                                         (coe
