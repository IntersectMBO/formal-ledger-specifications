...
d_es_1758 v0 = coe MAlonzo.Code.Ledger.Ratify.d_es_1996 (coe v0)
...
du_exp'63'_1832 v0 v1 v2
  = coe
      MAlonzo.Code.Ledger.Ratify.d_expired'63'_2546 (coe v0)
      (coe MAlonzo.Code.Ledger.Ratify.d_currentEpoch_1976 (coe v1))
...
du_acceptConds'63'_1838 v0 v1 v2 v3
  = coe
      ...
      (coe
         MAlonzo.Code.Ledger.Ratify.d_accepted'63'_2530 (coe v0) (coe v1)
         (coe MAlonzo.Code.Ledger.Ratify.d_es_1996 (coe v2))
      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.Ledger.Ratify.d_delayed'63'_2486 (coe v0)
               (coe
               ...
               (coe
                  ...
                  (coe MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe v3)))
               (coe MAlonzo.Code.Ledger.Ratify.d_es_1996 (coe v2))
               (coe MAlonzo.Code.Ledger.Ratify.d_delay_2000 (coe v2)))
            (coe
         ...
         (coe
            ...
            (coe
               ...
               (coe MAlonzo.Code.Ledger.Ratify.d_treasury_1982 (coe v1))
               (coe MAlonzo.Code.Ledger.Ratify.d_currentEpoch_1976 (coe v1)))
            (coe MAlonzo.Code.Ledger.Ratify.d_es_1996 (coe v2))
            (coe
               MAlonzo.Code.Ledger.GovernanceActions.d_action_796
...
d_RATIFY'''45'total_1842 v0 v1 v2 v3
  = let v4
    ...
    coe
      (let v5
             = MAlonzo.Code.Ledger.Ratify.d_expired'63'_2546
                 (coe v0)
                 (coe MAlonzo.Code.Ledger.Ratify.d_currentEpoch_1976 (coe v1))
                                                          ...
                                                          coe
                                                            (coe
                                                               ...
                                                               (coe
                                                                  ...
                                                                  (coe v2))))
                                                         (coe
                                                            MAlonzo.Code.Ledger.Ratify.du_delayingAction_2368
                                                            (coe
                                                               MAlonzo.Code.Ledger.GovernanceActions.d_action_796
                                                               (coe
...
d_RATIFY'''45'completeness_1864 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Ratify.T_RatifyState_1988 ->
  MAlonzo.Code.Ledger.Ratify.T__'8866'_'8640''10631'_'44'RATIFY'''10632'__2562 ->
