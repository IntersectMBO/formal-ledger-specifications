...
data T_ScriptPurpose_1728
  = C_Cert_1730 MAlonzo.Code.Ledger.Certs.T_DCert_840 |
    ...
    C_Propose_1740 MAlonzo.Code.Ledger.GovernanceActions.T_GovProposal_746
      ...
      C_Cert_1730 v4
        -> coe
             ...
             (coe
                ...
                (MAlonzo.Code.Ledger.Transaction.d_txcerts_2590 (coe v2)))
      C_Rwrd_1732 v4
        -> coe
             MAlonzo.Code.Data.Maybe.Base.du_map_64
             (\ v5 ->
             ...
             (coe
                ...
                (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1740 (coe v1)) v4
                (MAlonzo.Code.Ledger.Transaction.d_txwdrls_2592 (coe v2)))
      C_Mint_1734 v4
        -> coe
             MAlonzo.Code.Data.Maybe.Base.du_map_64
             (\ v5 ->
      ...
      C_Spend_1736 v4
        -> coe
             ...
             (coe
                ...
                (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1740 (coe v1)) v4
                (MAlonzo.Code.Ledger.Transaction.d_txins_2578 (coe v2)))
      C_Vote_1738 v4
        -> coe
             MAlonzo.Code.Data.Maybe.Base.du_map_64
             (\ v5 ->
             ...
             (coe
                ...
                (coe
                   ...
                   () erased
                   (\ v5 ->
                      MAlonzo.Code.Ledger.GovernanceActions.d_voter_740 (coe v5))
      ...
      C_Propose_1740 v4
        -> coe
             ...
             (coe
                ...
                (MAlonzo.Code.Ledger.Abstract.d_indexOfImp_1740 (coe v1)) v4
                (MAlonzo.Code.Ledger.Transaction.d_txprop_2596 (coe v2)))
...
d_TxInfo_1892 a0 a1 = ()
data T_TxInfo_1892
  = C_TxInfo'46'constructor_17061 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_realizedInputs_1914 v0
  = case coe v0 of
      C_TxInfo'46'constructor_17061 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_txcerts_1922 ::
  T_TxInfo_1892 -> [MAlonzo.Code.Ledger.Certs.T_DCert_840]
d_txcerts_1922 v0
  = case coe v0 of
      C_TxInfo'46'constructor_17061 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
        -> coe v5
...
d_txInfo_1934 ::
  ...
  MAlonzo.Code.Ledger.PParams.T_PParams_244 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Ledger.Transaction.T_Tx_2638 -> T_TxInfo_1892
                 ...
                 = coe
                     ...
                     (coe
                        ...
                        (coe
                           MAlonzo.Code.Axiom.Set.Map.du__'738'_550
                           (coe
                              MAlonzo.Code.Ledger.Transaction.du_m_2770 (coe v0) (coe v3)
                              (coe v4)))) in
           coe
             (case coe v8 of
                                                           ...
                                                           -> coe
                                                                ...
                                                                (coe
                                                                   ...
                                                                   (coe
                                                                      ...
                                                                      () erased () erased
                                                                      (\ v16 ->
                                                                         MAlonzo.Code.Ledger.GovernanceActions.d_voter_740
                                                                           (coe v16))
