...
d_indexOf_1698 a0 = ()
data T_indexOf_1698
  = C_indexOf'46'constructor_3079 (MAlonzo.Code.Ledger.Certs.T_DCert_840 ->
...
d_indexOfDCert_1712 v0
  = case coe v0 of
      C_indexOf'46'constructor_3079 v1 v2 v3 v4 v5 v6 -> coe v1
...
d_indexOfRwdAddr_1714 v0
  = case coe v0 of
      C_indexOf'46'constructor_3079 v1 v2 v3 v4 v5 v6 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfTxIn_1716 v0
  = case coe v0 of
      C_indexOf'46'constructor_3079 v1 v2 v3 v4 v5 v6 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfPolicyId_1718 v0
  = case coe v0 of
      C_indexOf'46'constructor_3079 v1 v2 v3 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfVote_1720 v0
  = case coe v0 of
      C_indexOf'46'constructor_3079 v1 v2 v3 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfProposal_1722 v0
  = case coe v0 of
      C_indexOf'46'constructor_3079 v1 v2 v3 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Abstract.AbstractFunctions
d_AbstractFunctions_1724 a0 = ()
data T_AbstractFunctions_1724
  = C_AbstractFunctions'46'constructor_3371 (AgdaAny ->
                                             AgdaAny -> Integer)
...
d_txscriptfee_1736 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_3371 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Abstract.AbstractFunctions.serSize
d_serSize_1738 :: T_AbstractFunctions_1724 -> AgdaAny -> Integer
d_serSize_1738 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_3371 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_indexOfImp_1740 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_3371 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_runPLCScript_1742 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_3371 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_scriptSize_1744 v0
  = case coe v0 of
      C_AbstractFunctions'46'constructor_3371 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
