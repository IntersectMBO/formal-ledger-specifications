...
# Usage: This script is part of a five stage pipeline and is meant to be used in conjunction with
...
def generate_macros_json(sty_content : str) -> str:
    """
    Parse LaTeX .sty content to find simple Agda term macros;
    generate a JSON dictionary including Agda semantic class.
    """
