...
\Crefrange{thm:LedgerGovDepsMatch}{thm:ChainGovDepsMatch} assert that
...
The assertion, ``the \AgdaFunction{govDepsMatch} relation is an invariant of the
\LEDGER{} rule,'' means the following:  if \govDepsMatch{}~\ab{s} and
