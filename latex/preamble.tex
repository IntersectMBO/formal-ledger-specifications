...
\Crefname{thelemma}{Lemma}{Lemmas}
...
%% Custom Theorem Environment (for properties we have formally proved)
\newcounter{thetheorem} \setcounter{thetheorem}{0}
\newenvironment{theorem}[1][]{\bigskip\noindent%
\refstepcounter{thetheorem}%
{\textbf{Theorem \arabic{thetheorem}. (#1)} \label{thm:\arabic{thetheorem}} \rm}%
\medskip}

%% Custom Lemma Environment (for properties we have proved in support of a theorem)
\newenvironment{lemma}[1][]{\bigskip\noindent%
\refstepcounter{thetheorem}%
{\textit{Lemma \arabic{thetheorem}. (#1)} \label{lem:\arabic{thetheorem}} \rm}%
\medskip}

%% Custom Claim Environment (for properties we have yet to prove)
\newenvironment{claim}[1][]{\bigskip\noindent%
\refstepcounter{thetheorem}%
{\textit{Claim \arabic{thetheorem}. (#1)} \label{clm:\arabic{thetheorem}}  \rm}%
\medskip}
