...
data T_HeytingField_208
  = C_HeytingField'46'constructor_4923 (AgdaAny ->
                                        AgdaAny -> AgdaAny)
                                       (AgdaAny -> AgdaAny -> AgdaAny) (AgdaAny -> AgdaAny) AgdaAny
                                       AgdaAny
...
d_isHeytingField_250 v0
  = case coe v0 of
      C_HeytingField'46'constructor_4923 v4 v5 v6 v7 v8 v9 -> coe v9
      _ -> MAlonzo.RTE.mazUnreachableError
...
d__'45'__254 ~v0 ~v1 ~v2 v3 = du__'45'__254 v3
du__'45'__254 ::
  T_HeytingField_208 -> AgdaAny -> AgdaAny -> AgdaAny
du__'45'__254 v0
       ...
       coe
         (let v3
                = MAlonzo.Code.Algebra.Apartness.Structures.d_isCommutativeRing_312
                    (coe v2) in
          coe
            (let v4 = MAlonzo.Code.Algebra.Structures.d_isRing_2640 (coe v3) in
             coe
               (let v5
                      = coe
                          MAlonzo.Code.Algebra.Structures.du_isRingWithoutOne_2510
...
d_'42''45'isMagma_282 ::
  ...
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  T_HeytingField_208 -> MAlonzo.Code.Algebra.Structures.T_IsMagma_144
       ...
       coe
         (let v3
          ...
          coe
            (coe
               MAlonzo.Code.Algebra.Structures.du_'42''45'isMonoid_2596
               (coe MAlonzo.Code.Algebra.Structures.d_isRing_2640 (coe v3)))))
                ...
                coe
                  (let v6
                         = MAlonzo.Code.Algebra.Structures.d_'43''45'isAbelianGroup_2132
                             (coe v5) in
                   coe
                     (let v7 = MAlonzo.Code.Algebra.Structures.d_isGroup_992 (coe v6) in
                      coe
                        (let v8
                               = MAlonzo.Code.Algebra.Structures.d_isMonoid_906 (coe v7) in
                         coe
                           (let v9
                            ...
                            coe
                              (coe
                                 MAlonzo.Code.Algebra.Structures.du_'8729''45'cong'691'_174
                                 (coe
                                    MAlonzo.Code.Algebra.Structures.d_isMagma_448 (coe v9)))))))))))
-- Algebra.Apartness.Bundles.HeytingField._.∙-congˡ
                     ...
                     (let v7 = MAlonzo.Code.Algebra.Structures.d_isGroup_992 (coe v6) in
                      coe
                        (coe
                           MAlonzo.Code.Algebra.Structures.du_identity'691'_646
                           (coe
                              MAlonzo.Code.Algebra.Structures.d_isMonoid_906 (coe v7)))))))))
-- Algebra.Apartness.Bundles.HeytingField._.identityˡ
d_identity'737'_302 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
...
d_isGroup_312 ::
  ...
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  T_HeytingField_208 -> MAlonzo.Code.Algebra.Structures.T_IsGroup_892
                   ...
                   coe
                     (let v7
                            = MAlonzo.Code.Algebra.Apartness.Structures.d_isCommutativeRing_312
                                (coe v6) in
                      coe
                        (let v8 = MAlonzo.Code.Algebra.Structures.d_isRing_2640 (coe v7) in
                         coe
                           (let v9
                                  = coe
                                      MAlonzo.Code.Algebra.Structures.du_isSemiring_2606 (coe v1)
                        ...
                        (let v8
                         ...
                         coe
                           (let v9
                            ...
                            coe
                              (let v10
                                     = MAlonzo.Code.Algebra.Structures.d_isMagma_448 (coe v9) in
                               coe
                                 (coe
                                    MAlonzo.Code.Relation.Binary.Structures.du_isPartialEquivalence_42
                                    (coe
...
d_isRing_362 ::
  T_HeytingField_208 -> MAlonzo.Code.Algebra.Structures.T_IsRing_2478
d_isRing_362 v0
  = coe
      MAlonzo.Code.Algebra.Structures.d_isRing_2640
      (coe
                     ...
                     (let v7
                      ...
                      coe
                        (coe
                           MAlonzo.Code.Algebra.Structures.du_isSemiring_2606 (coe v1)
                           (coe v2) (coe v3) (coe v4)
                           (coe MAlonzo.Code.Algebra.Structures.d_isRing_2640 (coe v7)))))))))
                           ...
                           (let v9
                            ...
                            coe
                              (coe
                                 ...
                                 (coe v1) (coe v3) (coe v2)
                                 (coe
                                    MAlonzo.Code.Algebra.Structures.d_isGroup_992 (coe v9)))))))))))
