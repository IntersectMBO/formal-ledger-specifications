...
<p align="center">
  <a href="https://github.com/intersectmbo/formal-ledger-specifications/actions/workflows/nightly.yml"><img alt="Nightly build status (master)" src="https://img.shields.io/github/actions/workflow/status/intersectmbo/formal-ledger-specifications/nightly.yml?branch=master&style=for-the-badge&label=nightly"/></a>
  <a href="https://github.com/intersectmbo/formal-ledger-specifications/actions/workflows/ci.yml"><img alt="CI status (master)" src="https://img.shields.io/github/actions/workflow/status/intersectmbo/formal-ledger-specifications/ci.yml?branch=master&style=for-the-badge&label=CI"/></a>
  <a href="https://github.com/intersectmbo/formal-ledger-specifications/actions/workflows/properties-check.yml"><img alt="Property catalog/dashboard drift check (master)" src="https://img.shields.io/github/actions/workflow/status/intersectmbo/formal-ledger-specifications/properties-check.yml?branch=master&style=for-the-badge&label=properties"/></a>
